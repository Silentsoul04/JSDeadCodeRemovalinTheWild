    ...
    function c() {
        ...
        d.zeroProps = [a + "Height", a + "Width", b + "Height", b + "Width"], this.init = function(a) {}, this.validateNode = function(a) {
            var b, e = (document.body, !1),
                ...
                h = g(a);
            if (h && "undefined" == typeof naver_corp_da.ActiveViewEmpty) return e = !0, {
                result: e,
                ...
                if (null == a[d.nullProps[b]]) {
                    if (e = !0, void 0 !== window.getComputedStyle) {
                        ...
                        c.blockedDOMInfo.props = "nullProps", c.blockedDOMInfo.nodeName = a.nodeName.trim() || "", c.blockedDOMInfo.className = a.className.trim() || "", c.blockedDOMInfo.id = a.id.trim() || "", c.blockedDOMInfo.style = "none" === k.getPropertyValue("display").toLowerCase() ? k.getPropertyValue("display").toLowerCase() : k.getPropertyValue("visibility").toLowerCase() || "", c.blockedDOMInfo.parent = "visible", j(a, function(a) {
                            if (a && 1 !== a.nodeType) return void(f = !0);
    ...
    var e = a ? a.media : "",
        ...
        h = {
            ...
            BakeryManager: function() {
                this.checkTable = function() {
                    ...
                    if ("undefined" != typeof f[a]) {
                        a.indexOf("test") >= 0 && g.setHostUrl("//test-pb.m.naver.com");
                        var b, c;
                        "m.naver.com" === a || "test.m.naver.com" === a ? (b = f[a][e].id, c = f[a][e].su) : (b = f[a].id, c = f[a].su);
                        var d = document.getElementById(b);
                        if (null === d) return h._sendLog("/abpenable", c, "ad:null"), void h._sendLog("/abpblock", c, "ad:null");
                        var i = h._createBaitNode();
                        h._checkADBD(i) === !0 && h._sendLog("/abpenable", c, "bait:hidden"), h._clearBaitNode(i);
                        var j = h._checkBlocked(d);
                        if (j.result === !0) {
                            var k = "";
                            j.domInfo && (k = j.domInfo.nodeName + ":" + j.domInfo.style + ";props:" + j.domInfo.props + ";id:" + j.domInfo.id + ";class:" + j.domInfo.className, "nullProps" !== j.domInfo.props && "zeroProps" !== j.domInfo.props || (k += ";parent:" + j.domInfo.parent)), h._sendLog("/abpblock", c, k)
                        }
                    }
                }
            },
            activate: function() {
                null !== this._bakeryManager && (this._bakeryManager = null), AgentDetect.IS_IE && AgentDetect.searchBrowserVersion() < 8 || (this._bakeryManager = new this.BakeryManager, clearTimeout(this._timerId), this._timerId = setTimeout(this._bakeryManager.checkTable, 4e3))
            },
            deactivate: function() {
            ...
            _checkBlocked: function(a) {
                if ("none" === h._validCtActiveView()) return {
                    result: !1
                };
                var b = new c;
                return b.init(), b.validateNode(a)
            },
            _sendLog: function(a, b, c) {
                g.log(a + "?su=" + b + "&domInfo=" + c)
            },
            _createBaitNode: function() {
                var a = "pub_300x250 pub_300x250m pub_728x90 text-ad textAd text_ad text_ads text-ads text-ad-links",

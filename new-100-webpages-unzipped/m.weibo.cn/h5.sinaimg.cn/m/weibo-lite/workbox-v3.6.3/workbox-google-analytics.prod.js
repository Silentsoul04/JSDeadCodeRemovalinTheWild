this.workbox = this.workbox || {}, this.workbox.googleAnalytics = function(e, n, t, o, r, c, s) {
    "use strict";
    try {
    ...
    var a;
    const w = e => (u = babelHelpers.asyncToGenerator(function*(n) {
        let t, {
            url: o,
            requestInit: r,
            timestamp: c
        ...
        "function" == typeof e.hitFilter && e.hitFilter.call(null, t), r.body = t.toString(), r.method = "POST", r.mode = "cors", r.credentials = "omit", r.headers = {
    ...
    return e.initialize = ((e = {}) => {
        const i = t.cacheNames.getGoogleAnalyticsName(e.cacheName),
            a = new n.Plugin("workbox-google-analytics", {
                ...
                callbacks: {
                    requestWillReplay: w(e)
                }
            }),
            u = [(e => {
                const n = new c.NetworkFirst({
                    cacheName: e
                });
                return new o.Route(({
                    url: e
                }) => "www.google-analytics.com" === e.hostname && "/analytics.js" === e.pathname, n, "GET")
            })(i), (e => {
                const n = new c.NetworkFirst({
                    cacheName: e
                });
                return new o.Route(({
                    url: e
                }) => "www.googletagmanager.com" === e.hostname && "/gtag/js" === e.pathname, n, "GET")
            })(i), ...(e => {
                const n = ({
                        url: e
                    }) => "www.google-analytics.com" === e.hostname && l.test(e.pathname),
                    t = new s.NetworkOnly({
                        plugins: [e]
                    });

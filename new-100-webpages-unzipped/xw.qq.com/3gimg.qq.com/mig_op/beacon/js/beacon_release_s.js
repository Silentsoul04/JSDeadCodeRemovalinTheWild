(function() {
    ...
    function L(b) {
        M && (b = (new Date).getTime(), BeaconComm.exitSet(b), BeaconComm.addEvent({
    ...
    var K = {
        ...
        fileName: "beacon_release_s.js"
    };
    if (!(0 < navigator.userAgent.indexOf("MSIE") && (0 < navigator.userAgent.indexOf("MSIE 6.0") || 0 < navigator.userAgent.indexOf("MSIE 7.0") ||
            0 < navigator.userAgent.indexOf("MSIE 8.0") || 0 < navigator.userAgent.indexOf("MSIE 9.0") && !window.innerWidth))) {
        for (var l = K.fileName, r = document.getElementsByTagName("script"), B = "", N = 0, F = 0; F < r.length; F++)
            if (B = r[F].src, -1 !== B.indexOf(l)) {
                N = 1;
                break
            }
        if (N) {
            ...
            if (l && r) {
                var x = t.openid,
                    ...
                    S = function(b) {
                        ...
                        function d(b, c) {
                            var d = c.context;
                            if (!1 === c.beforeSend.call(d, b, c) || !1 === a(c, d, "ajaxBeforeSend", [b, c])) return !1;
                            a(c, d, "ajaxSend", [b, c])
                        }
                        ...
                        function n(a, b) {
                            ...
                            return c.add = function(a, b) {
                                this.push(encodeURIComponent(a) +
                                    "=" + encodeURIComponent(b))
                            }, l(c, a, b), c.join("&").replace("%20", "+")
                        }

                        function q(a) {
                            return Array.prototype.slice.call(arguments, 1).forEach(function(b) {
                                for (v in b) void 0 !== b[v] && (a[v] = b[v])
                            }), a
                        }
                        var w = 0,
                            r = b.document,
                            v, t, z = /^(?:text|application)\/javascript/i,
                            ...
                            m = function(a) {
                                var f = q({}, a || {});
                                for (v in m.settings) void 0 === f[v] && (f[v] = m.settings[v]);
                                c(f);
                                f.crossDomain || (f.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(f.url) && RegExp.$2 !=
                                    b.location.host);
                                var y = f.dataType;
                                a = /=\?/.test(f.url);
                                if ("jsonp" == y || a) return a || (f.url = (f.url + "&callback=?").replace(/[&?]{1,2}/, "?")), m.JSONP(f);
                                f.url || (f.url = b.location.toString());
                                p(f);
                                a = f.accepts[y];
                                var E = {},
                                    l = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : b.location.protocol,
                                    k = m.settings.xhr(),
                                    n;
                                f.crossDomain || (E["X-Requested-With"] = "XMLHttpRequest");
                                a && (E.Accept = a, -1 < a.indexOf(",") && (a = a.split(",", 2)[0]), k.overrideMimeType && k.overrideMimeType(a));
                                if (f.contentType || f.data && "GET" != f.type.toUpperCase()) E["Content-Type"] =
                                ...
                                k.onreadystatechange = function() {
                                    if (4 == k.readyState) {
                                        ...
                                        if (200 <= k.status && 300 > k.status || 304 == k.status || 0 == k.status && "file:" == l) {
                                            ...
                                            try {
                                                "script" == y ? (0, eval)(b) : "xml" == y ? b = k.responseXML : "json" == y && (b = D.test(b) ? null : JSON.parse(b))
                                            } catch (R) {
                                                a = R
                                            }
                                            a ? h(a, "parsererror", k, f) : g(b, k, f)
                                        } else h(null, "error", k, f)
                                    }
                                };
                                k.open(f.type, f.url, "async" in f ? f.async :
                                    !0);
                                for (t in f.headers) k.setRequestHeader(t, f.headers[t]);
                                return !1 === d(k, f) ? (k.abort(), !1) : (0 < f.timeout && (n = setTimeout(function() {
                                    k.onreadystatechange = C;
                                    k.abort();
                                    h(null, "timeout", k, f)
                                }, f.timeout)), k.send(f.data ? f.data : null), k)
                            };
                        m.active = 0;
                        m.JSONP = function(a) {
                            if ("type" in a) {
                                ...
                                return a.error && (d.onerror = function() {
                                    ...
                                    delete b[c];
                                    g(d, h, a)
                                }, p(a), d.src = a.url.replace(/=\?/, "=" + c), k.insertBefore(d, k.firstChild), 0 < a.timeout && (e = setTimeout(function() {
                                    h.abort();
                                    f("timeout", h, a)
                                }, a.timeout)), h
                            }
                        ...
                        m.post = function(a, b, c, d) {
                            return "function" == typeof b && (d = d || c, c = b, b = null), m({
                                type: "POST",
                                url: a,
                                data: b,
                                success: c,
                    ...
                    var b = function(a) {
                        ...
                        this.each = function(a, c, d) {
                            if (null !== a)
                                ...
                                for (f in a)
                                    if (a.hasOwnProperty(f) && c.call(d, a[f], f, a) === {}) break
                        };
                        ...
                        "object" == typeof a ?
                            (this.hasher = a.hasher, this.screen_resolution = a.screen_resolution, this.screen_orientation = a.screen_orientation, this.canvas = a.canvas, this.ie_activex = a.ie_activex) : "function" == typeof a && (this.hasher = a)
                    };
                    return b.prototype = {
                        get: function() {
                            var a = [];
                            ...
                            return a.push((new Date).getTimezoneOffset()), a.push(this.hasSessionStorage()),
                        ...
                        murmurhash3_32_gc: function(a, b) {
                            ...
                            for (c = 0; c < h;) {
                                var e = a.charCodeAt(c) &
                                    255 | (a.charCodeAt(++c) & 255) << 8 | (a.charCodeAt(++c) & 255) << 16 | (a.charCodeAt(++c) & 255) << 24;
                                ++c;
                            ...
                            switch (g) {
                                ...
                                case 1:
                                    e ^= a.charCodeAt(c) & 255, e = 3432918353 * (e & 65535) + ((3432918353 *
                                        (e >>> 16) & 65535) << 16) & 4294967295, e = e << 15 | e >>> 17, f ^= 461845907 * (e & 65535) + ((461845907 * (e >>> 16) & 65535) << 16) & 4294967295
                            }
                            return f ^= a.length, f ^= f >>> 16, f = 2246822507 * (f & 65535) + ((2246822507 * (f >>> 16) & 65535) << 16) & 4294967295, f ^= f >>> 13, f = 3266489909 * (f & 65535) + ((3266489909 * (f >>> 16) & 65535) << 16) & 4294967295, f ^= f >>> 16, f >>> 0
                        },
                        ...
                        getScreenResolution: function() {
                            var a;
                            return this.screen_orientation ? a = screen.height > screen.width ? [screen.height, screen.width] : [screen.width, screen.height] : a = [screen.height, screen.width], a
                        },
                        getCanvasFingerprint: function() {
                            var a = document.createElement("canvas"),
                                b = a.getContext("2d");
                            var d = "beacon.qq.com " + Math.random();
                            return b.textBaseline = "top", b.font = "12px 'Arial'", b.textBaseline = "alphabetic", b.fillStyle = "#ffc", b.fillRect(0, 0, 180, 20), b.fillStyle = "#069", b.fillText(d, 2, 15), b.fillStyle = "rgba(102, 204, 0, 0.7)",
                ...
                var D = function(b, a, c) {
                    ...
                    d = "";
                    c.expires && ("number" == typeof c.expires || c.expires.toUTCString) && ("number" == typeof c.expires ? (g = new Date, g.setTime(g.getTime() + 864E5 * c.expires)) : g = c.expires,
                ...
                p.localStorage = {
                    ...
                    addLocalStorage: function(b, a) {
                        window.localStorage &&
                            ("sessionId" == b && window.sessionStorage ? sessionStorage.setItem("__BEACON_" + b, a) : localStorage["__BEACON_" + b] = a)
                    },
                    delLocalStorage: function(b) {
                        window.localStorage && localStorage.removeItem("__BEACON_" + b)
                    },
                    getLocalStorage: function(b) {
                        if (window.localStorage) return "sessionId" == b && window.sessionStorage ? sessionStorage.getItem("__BEACON_" + b) : localStorage["__BEACON_" + b]
                    },
                    format: function(b) {
                        var a = {};
                        if (!b) return a;
                        ...
                        (function(e) {
                            if (0 < navigator.userAgent.indexOf("MSIE 9.0")) {
                                ...
                                if ("MSIE6.0" != f && "MSIE7.0" != f && window.XDomainRequest) {
                                    ...
                                    e.error && "function" == typeof e.error && (h.onerror =
                                        function() {
                                            e.error()
                                        });
                ...
                (function(b) {
                    ...
                    BeaconComm.unique = function(a) {
                        a.sort();
                        for (var b = [a[0]], d = 1; d < a.length; d++) a[d] !== b[b.length - 1] && b.push(a[d]);
                        return b
                    };
                    ...
                    BeaconComm.equal = function(a, b) {
                        if (typeof a != typeof b || typeof a.length != typeof b.length) return !1;
                        var c = !0,
                            e = [],
                            h = [];
                        for (f in a) "count" !== f && "start" !== f && e.push(f);
                        for (f in b) "count" !== f && "start" !== f && h.push(f);
                        if (e.length != h.length) return !1;
                        var f = 0;
                        for (var l = h.length; f < l; f++) e.push(h[f]);
                        e = BeaconComm.unique(e);
                        f = 0;
                        for (l = e.length; f < l; f++) {
                            if (!(e[f] in a && e[f] in b)) return !1;
                            if ("object" == typeof a[e[f]] && "object" == typeof b[e[f]]) c = BeaconComm.equal(a[e[f]], b[e[f]]);
                            else if (a[e[f]] !== b[e[f]]) return !1
                        }
                        return c
                    };
                    BeaconComm.addEvent = function(a, b, d) {
                        if (e.get("sessionMsg")) {
                            ...
                            if ("events" === b)
                                if (x && a.params && (a.params.openid = x), a.params && (a.params.A102 = encodeURIComponent(window.location.href)), 0 != c.length) {
                                    b = !1;
                    ...
                    BeaconComm.addMsg =
                        function(a) {
                            ...
                            } else e.add("sessionMsg", JSON.stringify({
                                msg: [a]
                            }))
                        };
                    BeaconComm.cleanMsg = function() {
                        if (e.get("sessionMsg")) {
                            var a = JSON.parse(e.get("sessionMsg")),
                                b = a.msg.length;
                            1 == b ? (b = a.msg[0], b.data.pages = [], b.data.events = [], e.delLocalStorage("sessionMsg"), e.add("sessionMsg", JSON.stringify(a))) : 1 < b && (b = a.msg[b - 1], b.data.pages = [], b.data.events = [], a.msg = [], a.msg.push(b), e.add("sessionMsg",
                                JSON.stringify(a)))
                        }
                    };
                    BeaconComm.concatMsg = function(a) {
                        var b = e.get("sessionMsg"),
                            d = a;
                        b && (d = JSON.parse(e.get("sessionMsg")), d.msg = d.msg ? d.msg.concat(a.msg) : a.msg);
                        e.add("sessionMsg", JSON.stringify(d))
                    }
                })(window);
                var e = p.localStorage,
                    ...
                    I = {
                        ...
                        setDeviceId: function() {
                            if (e.get("deviceId")) this.deviceId = e.get("deviceId");
                            else {
                        ...
                        setSession: function() {
                            ...
                            b = -1 < this.deviceId.indexOf("-") ? this.deviceId.split("-")[0] +
                                b : this.deviceId + b;
                            q.get("sessionId") ? b = q.get("sessionId") : q.add("sessionId", b);
                            if (0 < 32 - b.length)
                                for (var a = 0, c = 32 - b.length; a < c; a++) b += "0";
                        ...
                        setInitTime: function() {
                            e.get("initTime") ? H = parseInt(e.get("initTime")) : (H = w, e.add("initTime", w))
                        },
                        ...
                        addlastSession: function() {
                            ...
                            void 0 === b && (e.delLocalStorage("sessionMsg"), e.delLocalStorage("lastSession"));
                            b ? (b = JSON.parse(b), console.log("AppSession.id:" + n.id), b.id != n.id && (b = BeaconComm.getCommonMsg(b.id, b.start, 3, parseInt(e.get("exitSession"))), console.log("n:" + JSON.stringify(b)), BeaconComm.addMsg(b), this.timedif = parseInt(n.start -
                                e.get("exittime")), e.add("T-%%%-T", "{" + (new Date(parseInt(e.get("exittime")))).toLocaleString().replace(/\u5e74|\u6708/g, "-").replace(/\u65e5/g, " ") + "," + (new Date(parseInt(n.start))).toLocaleString().replace(/\u5e74|\u6708/g, "-").replace(/\u65e5/g, " ") + "}"), e.get("appkey") ? e.get("appkey") == A && BeaconComm.addSessionStart(this.timedif, 1) : BeaconComm.addSessionStart(this.timedif, 1))) : BeaconComm.addSessionStart(0, 1)
                        },
                        getAjax: function() {
                            var b = this,
                                a = new J;
                            localStorage.__BEACON_sessionMsg || BeaconComm.addSessionStart(0,
                                2);
                            ...
                            if (g) {
                                ...
                                h && (h.data.events = h.data.events.concat(JSON.parse(g)), console.log("s.data.events:" + JSON.stringify(h.data.events)))
                            }
                            g = function(a) {
                                console.log(a);
                ...
                var G = 0;
                window.BeaconAction = {};
                window.BeaconAction.onEvent = function(b, a, c) {
                    if (0 < arguments.length) try {
                        ...
                        if (O) BeaconComm.addEvent(d, "events");
                        else {
                            ...
                            } else e.add("hold_event", JSON.stringify(c));
                            O = 1
                        }
                        setTimeout(function() {
                            G || (G = 1, I.getAjax())
                ...
                if (void 0 !== window.beacon && "function" === typeof window.beacon.onSetJsClientID) window.beacon.onSetJsClientID(z)
            }
        } else console.log("none match params!")
    }
})();
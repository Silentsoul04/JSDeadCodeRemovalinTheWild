(function() {
    ...
    */
    ...
    var R = ["4", "2", "0", "38"].slice(0, 3).join(".") + "M";
    ...
    window.GLANCE.Cobrowse._originalpathname = window.location.pathname;
        ...
        if (window.localStorage && window.XMLHttpRequest && window.atob) {
            ...
            if (h.Loader) H("ERR_DUP_SCRIPTS");
                ...
                w("glance_load", function(a, c) {
                    a !== window.parent && a.parent !== window ? H("UNTRUSTED_LOAD_MSG") : (c.m && n(), c.u && null !==
                        r.a.getElementById("glance_visitor") && u(a, "glance_load", {
                            m: !0
                        }))
                });
                ...
                J(r, function() {
                    document.body && !O && (O = !0, c(), d(g.o), g.s &&
                        !p && I(r, [
                            ["src", D + "/GlancePresenceVisitor_" + E + ".js"]
                        ]))
                });
                w("forwardevent", function(a, c) {
                    if (a.top !== window) H("UNTRUSTED_KEYEVT");
                    else window.GLANCE.Cobrowse[c.namespace][c.funcname]()
                })
            }

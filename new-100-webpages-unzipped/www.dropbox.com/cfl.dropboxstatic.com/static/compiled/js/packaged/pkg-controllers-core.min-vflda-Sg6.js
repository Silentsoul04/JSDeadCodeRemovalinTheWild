define("modules/clean/dbmodal", ["require", "exports", "tslib", "external/keymaster", "jquery", "modules/clean/dbmodal_stack", "modules/core/controller_helpers", "modules/core/dom", "modules/core/exception"], function(t, e, o, i, n, r, s, l, _) {
    "use strict";
    ...
    var a = (function() {
        ...
        return t.initClass = function() {
            ...
            return this.click_out_to_close !== !1 && this.$overlay.on("click", this.__overlay_click_handler), this.$db_modal_x = this.$modal_window.find(".db-modal-x"), this.$db_modal_x.on("click", this.__x_click_handler), n.default(document).on("keydown", this.__keydown_handler), this.__listen_buttons()
            ...
            if (this.click_out_to_close !== !1 && this.$overlay.off("click"), this.$db_modal_x.off("click"), n.default(document).off("keydown", this.__keydown_handler), null != this.on_confirm_button_click && this.$confirm_button.off("click"), null != this.on_cancel_button_click) return this.$cancel_button.off("click")
            ...
            if (!this.visible) {
                ...
                try {
                    ...
                    t = document.createEvent("Event"), t.initEvent("modalOpened", !0, !0)
                }
            ...
            if (this.visible) {
                ...
                try {
                    ...
                    t = document.createEvent("Event"), t.initEvent("modalClosed", !0, !0)
                }
        ...
        return t.initClass = function() {
            this.SUCCESS_EVENT = "db:ajaxform:success", this.ERROR_EVENT = "db:ajaxform:error", this.extract_errors = function(t) {
                ...
                try {
                    ...
                    return "string" == typeof t ? t : a._("There was a problem completing this request.")
                }
            ...
            for (var a = 0, c = Array.from(this.$form.find("input:radio:checked:not(disabled)")); a < c.length; a++) {
                var r = c[a];
                t = i.default(r).attr("name"), e[t] = i.default(r).val()
            }
            return e
            ...
            if (s !== !1) return void this._handle_errors(s);
            try {
                n = JSON.parse(r)
            } catch (t) {
            ...
            return this.$form.trigger(t.ERROR_EVENT), c.Notify.error(a._("There was a problem completing this request.")), this._clear_pending(!0)
    ...
    var r = function(t, e, o) {
            for (var n = [t].concat(o), r = 0, s = Array.from(t); r < s.length; r++) {
                var l = s[r];
                i.default(l).data("jscontroller", new(e.bind.apply(e, [void 0].concat(n))))
            }
            return t
        },
        s = (function() {
            ...
            return t.initClass = function() {
                ...
                if (!this.controllers[e]) return void n.reportStack("No controller for " + e);
                var o = this.controllers[e];
                r(t, o.constructor, o.args)
            }, t.find_and_bind_controller = function(t) {
                if (!this.controllers[t]) return void n.reportStack("No controller for " + t);
                var e = this.controllers[t];
                r(i.default("[data-js-component-id='" + t + "']"), e.constructor, e.args)
            }, t
        })();
    s.initClass(), e.default = s
});
//# sourceMappingURL=pkg-controllers-core.min.js-vflJo80Qt.map
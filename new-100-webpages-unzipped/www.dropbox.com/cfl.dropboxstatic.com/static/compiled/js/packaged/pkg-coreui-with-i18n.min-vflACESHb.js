define("modules/clean/avatar/avatar_with_default", ["require", "exports", "tslib", "react", "external/prop-types", "modules/clean/avatar/photo_avatar", "modules/clean/avatar/size", "modules/clean/css"], function(e, t, o, n, r, i, a, s) {
    "use strict";
    ...
    var u = (function(e) {
        ...
        return o.__extends(t, e), t.prototype.componentDidMount = function() {
            if (this.props.loadScooterCss && s.require_css("/static/css/scooter/scooter-scoped-vflFpCY2P.css"), null == this.props.photoUrl && null != this.props.onLoad) return this.props.onLoad()
    ...
    t.default = u
}), define("modules/clean/avatar/initials_avatar", ["require", "exports", "tslib", "react", "external/react-dom-factories", "external/prop-types", "modules/clean/avatar/size", "modules/clean/avatar/style", "modules/clean/avatar/style", "modules/clean/css"], function(e, t, o, n, r, i, a, s, u, l) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var c = (function(e) {
        ...
        return o.__extends(t, e), t.prototype.componentDidMount = function() {
            this.props.loadScooterCss && l.require_css("/static/css/scooter/scooter-scoped-vflFpCY2P.css")
        }, t.prototype.render = function() {
    ...
    t.InitialsAvatar = c
}), define("modules/clean/avatar/photo_avatar", ["require", "exports", "tslib", "react", "external/react-dom-factories", "external/prop-types", "modules/clean/avatar/size", "modules/clean/avatar/style"], function(e, t, o, n, r, i, a, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
...
}), define("modules/clean/avatar/style", ["require", "exports", "tslib", "external/classnames", "modules/clean/accessibility/utils"], function(e, t, o, n, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    function s(e) {
        if (!r.Cookies.are_enabled()) return n.default(function() {
            return a.Notify.error(i._("Please enable browser-cookies to use the Dropbox website."))
        })
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), n = o.__importDefault(n), t.initialize_module = s
    ...
    function s(e) {
        ...
        if (null != t) return {
            ...
            campaignInfo: c(t.campaign_info),
            displayMessage: t.home_params.message,
            icon: d(t.image),
            surfaceAction: f(t.home_params.surface_action),
            buttonActions: (t.home_params.button_actions || []).map(f),
            preview: u(t.preview)
        }
    }
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.userNotificationDeserializer = r, t.parseGetAllResponse = S, t.userNotificationComparator = A
    ...
    })(t.BluenoteActionTypes || (t.BluenoteActionTypes = {}));
    var r;
    (function(e) {
        e[e.Unread = 0] = "Unread", e[e.Read = 1] = "Read", e[e.Invisible = 2] = "Invisible"
    })(r = t.NotificationStatuses || (t.NotificationStatuses = {}));
    var i;
    (function(e) {
    ...
    var s = (function() {
        ...
        return Object.defineProperty(e.prototype, "key", {
            ...
            get: function() {
                return Date.now() - 1e3 * this.feedTimeInSec > 6048e5 ? n.nice_date_with_month_name(this.feedTime, !1) : n.ago(this.feedTime)
            },
            enumerable: !0,
            configurable: !0
        }), e
...
//# sourceMappingURL=pkg-coreui-with-i18n.min.js-vflpLx4z8.map
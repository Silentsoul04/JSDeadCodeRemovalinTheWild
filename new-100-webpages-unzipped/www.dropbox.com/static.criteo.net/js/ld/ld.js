! function() {
    ...
    var i, e, O = function() {
        function a() {}
        return a.extractHostname = function(e) {
            ...
            var t, o = a.getHighestAccessibleWindow(e),
                i = o.topFrame;
            if (o.err) try {
                try {
    ...
    var p = function() {
            function e(e, t) {
                this.cookieValue = null, this.isCookieValueExternallySet = !1, this.isCookieRead = !1, this.cookieName = e, this.cookieRetentionTimeInMs = t, this.cookieOrigin = i.None, this.useLocalStorage = this.checkLocalStorage()
            }
            return e.prototype.checkLocalStorage = function() {
                try {
                ...
                this.remove(), this.useLocalStorage && window.localStorage.removeItem(this.cookieName)
                ...
                for (var i = "expires=" + o.toUTCString(), n = null === document.location ? [] : document.location.hostname.split("."), a = null, r = 0; r < n.length; ++r) {
                    var s = "domain=." + (a = n.slice(n.length - r - 1, n.length).join(".")),
        ...
        N = function() {
            ...
            return e.prototype.fillQueryStringParams = function(e) {
                ...
                this.guidCookie.setValueFromAllStorages(), this.optoutCookie.getFromAllStorages(), this.idfsCookie.setValueFromAllStorages(), this.secureIdCookie.setValueFromAllStorages(), this.bundleCookie.setValueFromAllStorages(), this.getOrSetLwidIfNotDefined(e)
                ...
                if (e.idfsRead && this.idfsCookie.setCookieRead(), e.callbacks)
                    for (var t = 0, o = "string" == typeof e.callbacks ? [e.callbacks] : e.callbacks; t < o.length; t++) {
                        ...
                        a.parentNode.insertBefore(n, a), O.removeLater(this.exceptionHandler, n)
        ...
        M = function() {
            ...
            return e.prototype.createIframe = function(e, t, o) {
                ...
                return "#gum-debug-mode" === window.location.hash ? c += "?debug=1&topUrl=" + r : c += "?topUrl=" + r, c += "#" + JSON.stringify(s), i.src = c, i.id = this.gumSyncFrameId, i.width = "0", i.height = "0", i.frameBorder = "0", i.setAttribute("style", "border-width:0px; margin:0px; display:none"), i.title = "Criteo GUM iframe", O.removeLater(o, i), i
    ...
    var L = new RegExp(/^Mozilla\/5\.0 \([^)]+\) AppleWebKit\/[^ ]+ \(KHTML, like Gecko\) Version\/([^ ]+)( Mobile\/[^ ]+)? Safari\/[^ ]+$/i),
        U = function() {
            function e() {
                this.timings = {
                    initTime: null,
    ...
    if (!window.criteo_q || window.criteo_q instanceof Array) {
        ...
        window.criteo_q = function() {
            ...
            var e, t, o, i, n, a, r, g = {
                ...
                s = (t = window.navigator.userAgent, o = t.match(L), i = t.toLowerCase(), n = null !== o, a = -1 < i.indexOf("android"), r = -1 < i.indexOf("firefox"), {
            ...
            function w(e, t, o, i, n, a, r, s) {
                e.waitingForSyncframe && (e.waitingForSyncframe = !1, h(e, t, o, i, n, a, r, s))
            }
            ...
            function u(d, h, p, f, m, g, v, y) {
                if (d.shouldInjectSyncframe()) {
                    ...
                    window.addEventListener && (x.addProtectedEventListener(window, "message", function(e) {
                        ...
                        t = d, o = h, i = p, n = f, a = m, r = g, s = v, c = y, (l = (u = e).data) && l.isCriteoMessage && (u.stopPropagation(), t.isSyncframeLoading = !1, n.checkCookies(l), t.waitingForSyncframe && w(t, o, i, n, a, r, s, c))
                    }, !0), h.queue.push({
                        event: "appendtag",
                        element: e
                    }))
                    ...
                    if (200 < e.length) t = !0;
                        ...
                        for (var o = 0, i = e; o < i.length; o++) {
                            ...
                            if (Object.keys) a = Object.keys(n).length;
                                ...
                                for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (a += 1);
                            if (200 < a) {
                                t = !0;
                                break
                            }
            ...
            function d() {
                ...
                x.catchAndStoreException(function() {
                    ...
                    h(k, g.app, g.cbs, y, v.shortNameMap, v.trackingCallData, v.hooks, v.workflow), l(v.trackingCallData, g.cbs), c.stopRecordingPush()
            ...
            function h(e, t, o, i, n, a, r, s) {
                for (var c = [], u = t.queue, l = 0; l < u.length; ++l) {
                    ...
                    else if (d && "[object Object]" === d.toString()) switch (p(t, o, i, n, a, r, s, d, l, u, c)) {
                        case 0:
                            c.push(d);
                            break;
                        case -1:
                ...
                r.afterEval instanceof Function && r.afterEval(), t.queue = c || [], s.manualFlush || s.noPartialFlush && 0 !== t.queue.length || e.waitingForSyncframe || C(t, o, i, n, a, r, s, 0 !== t.queue.length)
            }

            function S(e, t, o) {
                o.hasOwnProperty("account") || (o.account = t.accounts);
                var i = e.handlerResponseType;
                o.hasOwnProperty("type") && (i = o.type, delete o.type), b(o.account, t.disingScheduled), "sequential" === i && (o.dc = !0)
            }

            function P(e, t, o, i) {
                if (!e.bodyReady || t.container && document.body.contains(t.container) || (t.container = O.appendCriteoContainer(document.body)), i.url) {
                    var n = void 0;
                ...
                if (o.beforeAppend instanceof Function && (i.element = o.beforeAppend(i.element)), R(i), i.element && (i.element.tagName || i.isImgUrl))
                    if (t.container || "script" !== i.element.tagName.toLowerCase() && !i.isImgUrl) {
                        ...
                        var a = document.getElementsByTagName("script")[0];
                        i.element.setAttribute("data-owner", "criteo-tag"), a.parentNode.insertBefore(i.element, a), O.removeLater(x, i.element)
                    }
                return 1
            }

            function A(e, t) {
                return !e.domReady && t.requiresDOM && "no" !== t.requiresDOM ? "blocking" === t.requiresDOM ? -1 : 0 : (delete t.requiresDOM, t.event ? (t.account && b(t.account, e.accounts), t.event = t.event.toLowerCase(), null) : (R(t), 1))
            }
            ...
            function p(e, t, o, i, n, a, r, s, c, u, l) {
                ...
                switch (s.event) {
                    ...
                    case "setcustomerid":
                        return s.event = "setdata", s.customer_id = s.id, delete s.id, D(n.extraData, e.actions, s);
                    case "setretailervisitorid":
                        return t.enable(), s.event = "setdata", s.retailer_visitor_id = s.id, delete s.id, D(n.extraData, e.actions, s);
                    case "setgoogleadvertisingid":
                        return o.gaid = s.gaid, D(n.extraData, e.actions, {
                            event: "setdata",
                            site_type: "aa"
                        });
                    case "setappleadvertisingid":
                        return o.idfa = s.idfa, D(n.extraData, e.actions, {
                            event: "setdata",
                            site_type: "aios"
                        });
                    case "setemail":
                    ...
                    case "setsitetype":
                        var m = "d";
                        return "mobile" !== s.type && "m" !== s.type || (m = "m"), "tablet" !== s.type && "t" !== s.type || (m = "t"), s.event = "setdata", delete s.type, s.site_type = m, D(n.extraData, e.actions, s);
                    case "appendtag":
                        return P(e, r, a, s);
                    case "gettagstate":
                    ...
                    case "flush":
                    case "flushevents":
                        return C(e, t, o, i, n, a, r, c !== u.length - 1 || 0 !== l.length), 1;
                    case "setaccount":
                ...
                if (d.onFlush instanceof Function && (d.onFlush(), console.warn("on flush hook is deprecated and will soon be removed. Please do not use it and contact criteo if you think this may break your integration")), 0 !== c.actions.length) {
                    ...
                    var y, k, w, C = !1,
                        b = function(e, t, o, i, n) {
                            var a = e.actions,
                                r = [];
                            if (1 === e.accounts.length && (n.account = e.accounts[0]), null !== n.account && r.push("a=" + E(i, n.account, [])), "js" !== n.responseType && r.push("rt=" + E(i, n.responseType, [])), n.handlerParams) {
                            ...
                            for (var c = 0; c < a.length; ++c) {
                                var u = a[c];
                                u.account && I(null === n.account ? void 0 : n.account, null === u.account ? void 0 : u.account) && delete u.account, r.push("p" + c + "=" + E(i, u, []))
                            }
                            return o.fillQueryStringParams(r), null !== n.partnerPayload && r.push("pp=" + E(i, n.partnerPayload, [])), r.push("dtycbr=" + Math.floor(1e5 * Math.random())), r
                        }(c, u, e, t, l);
                    c.actions = [], u.tryRunActionAfterAdBlockDetectionOrImmediate(function() {
                        if (!C) {
                            C = !0, u.tryAppendAdBlockerParameter(b);
                            var e, t, o, i, n, a, r = b.join("&"),
                                s = (t = r, {
                                    event: "appendTag",
                                    isImgUrl: "gif" === (e = l).responseType,
                                    url: e.handlerUrlPrefix + "?" + t
                                });
                            i = h, n = d, null !== A(o = c, a = s) || P(o, i, n, a), h.disOnce || (c.disingScheduled = [])
                        }
                    }, function(e) {
                ...
                if (t instanceof Function) r = E(e, t(), o);
                    ...
                    for (var l in t)
                        if (t.hasOwnProperty(l)) {
                            var d = o.concat([l]);
                            u.push((i = e, n = l, a = d.join("."), (i.properties[a] ? i.properties[a] : n) + "=" + E(e, t[l], d)))
                        }
                    r += u.join("&")
            ...
            return x.catchAndStoreException(function() {
                ...
                return y.checkAcid(), y.checkClientSideIdentityStatus(function() {
                        ...
                        var o
                    }), y.setCop(window), e = k, t = g.app, o = g.cbs, i = y, n = v.shortNameMap, a = v.trackingCallData, r = v.hooks, s = v.workflow, e.setWaitingFlag(i), e.waitingForSyncframe && x.setProtectedTimeout(function() {
                        w(e, t, o, i, n, a, r, s)
                    }, 1e4), y.ccpCookie.setValueFromExistingCookie(), O.onBodyReady(x, function() {
                    ...
                    function(e) {
                        try {
                            ...
                            t && t.hostname !== document.location.hostname && T(e, {
                                event: "setData",
                                ref: t.protocol + "//" + t.hostname
                            })
                        } catch (e) {}
                    }(v.trackingCallData.extraData), q({
        ...
        }(), void 0 !== typeof t.adBlockDetector && (window.criteo_q.adBlockDetector = t.adBlockDetector), window.criteo_q.push.apply(window.criteo_q, t)
    }
}();
//tealium universal tag - utag.48 ut4.0.201905302131, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.map = {
            "fb_event:add_payment_info": "AddPaymentInfo",
            "fb_event:start_trial": "StartTrial"
        };
        u.extend = [function(a, b) {
            try {
                if (b['dom.pathname'].toString().toLowerCase().indexOf('/business/billing'.toLowerCase()) > -1) {
                    b['fb_event'] = 'add_payment_info'
                }
            } catch (e) {
                utag.DB(e)
            }
            ...
            try {
                if (b['dom.pathname'].toString().toLowerCase().indexOf('/team/setup/team_info'.toLowerCase()) > -1) {
                    b['fb_event'] = 'start_trial'
                }
            } catch (e) {
                utag.DB(e)
            }
        ...
        u.send = function(a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                u.loader_cb = function() {
                    ...
                    utag.DB("send:48:CALLBACK:COMPLETE");
                };
                u.callBack = function() {
                    var data = {};
                    u.initialized = true;

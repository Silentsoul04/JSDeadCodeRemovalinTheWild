//tealium universal tag - utag.42 ut4.0.201902230003, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.map = {
            "fb_event:Lead": "Lead",
            "fb_content_name": "lead.content_name"
        };
        u.extend = [function(a, b) {
            try {
                if ((typeof b['dom.referrer'] != 'undefined' && /pro\/try|buy\/professional/.test(b['dom.referrer']) && /showcases|smart_sync_setting|enjoy/.test(b['dom.url']))) {
                    b['fb_event'] = 'Lead';
                    b['fb_content_name'] = 'pro_trial_start'
                }
            } catch (e) {
                utag.DB(e)
            }
            ...
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                u.loader_cb = function() {
                    ...
                    for (i = 0; i < u.data.evt_list.length; i++) {
                        ...
                        if (_event === "ViewContent" || _event === "AddToCart") {} else if (_event === "Search") {
                            if (!g.content_category) {

...
(function(w, cs) {
    ...
    var config = {
        ...
        "publisher": {
            "name": "Dropbox (MAIN)",
            "active": true,
            "uuid": "7fe1f424-c09d-4781-af13-2352d2ee4229",
        ...
        "params": {
            ...
            "dfp_premium": true,
            "control_tag_namespace": "dropboxmain"
        },
        "prioritized_segments": [],
        "realtime_segments": [{
            "id": "t7lab8m3o",
            "test": ["and", ["and", ["or", ["intersects", "$page_attr_url_path_1", ["business"]]],
                ["and", ["intersects", "$user_attr_is_team", ["0"]],
                    ["intersects", "$user_attr_is_biz_trial", ["0"]]
                ]
            ]]
        }, {
            "id": "t7gzlp2ro",
            "test": ["and", ["and", ["or", ["notIntersects", "$user_attr_view_busi_landing_28d", ["0", "1"]]],
                ["and", ["intersects", "$user_attr_is_team", ["0"]]]
            ]]
        }],
        "services": {
            ...
            "remove": "https://consumer.krxd.net/consumer/remove/7fe1f424-c09d-4781-af13-2352d2ee4229",
            ...
            "consent_get": "https://consumer.krxd.net/consent/get/7fe1f424-c09d-4781-af13-2352d2ee4229",
            "consent_set": "https://consumer.krxd.net/consent/set/7fe1f424-c09d-4781-af13-2352d2ee4229",
            ...
            "portability": "https://consumer.krxd.net/consumer/portability/7fe1f424-c09d-4781-af13-2352d2ee4229",
        ...
        "site": {
            ...
            "cap": 255,
            "id": 1671067,
            "organization_id": 4049,
            "uid": "tpxf4nq03"
        },
        "tags": [{
            "id": 39100,
            "name": "Krux Standard DTC",
            ...
            "id": 39182,
            "name": "UTM Media Tracker - Paid Social",
            ...
            "id": 39405,
            "name": "Krux DTC - utag_data Whitelist",
            ...
            "id": 39437,
            "name": "Krux DTC - Generic URL Scraper",
            ...
            "id": 40729,
            "name": "Generic DTC - email_sha256 UID",

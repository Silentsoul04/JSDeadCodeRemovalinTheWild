webpackJsonp([0], {
    ...
    126:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__DataVizController__ = __webpack_require__(296);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__DataVizView__ = __webpack_require__(298);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__DataVizModel__ = __webpack_require__(300);
    ...
    128:
        ...
        (function(module, exports, __webpack_require__) {
            ...
            ! function(e, t) {
                true ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.multiclamp = t() : e.multiclamp = t()
            }(window, function() {
                return function(e) {
                    var t = {};
                    ...
                    t.default = function(e) {
                        ...
                        if (!e) return;
                        new r(e, t <= 0 ? 2 : t, n).init()
                    };
                    var r = function() {
                        function e(t, n, i) {
                            ! function(e, t) {
                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                            }(this, e), this.element = t, this.numLines = n, this.allowResize = i, this.prevWidth = 0, this.prevHeight = 0, this.textCtx = !1, this.LINE_CLAMP_RULES = {
                        ...
                        return i(e, [{
                            ...
                            value: function() {
                                if (this.LINE_CLAMP_RULES.LINE_CLAMP in document.body.style) this.element.style.display = this.LINE_CLAMP_RULES.BOX, this.element.style[this.LINE_CLAMP_RULES.BOX_ORIENT] = "vertical", this.element.style[this.LINE_CLAMP_RULES.LINE_CLAMP] = this.numLines;
                                    ...
                                    this.textCtx = e.getContext("2d"), this.clamp(), this.allowResize && requestAnimationFrame(this.resize.bind(this))
                                }
                            }
                        }, {
                            key: "clamp",
                            value: function() {
                                var e = getComputedStyle(this.element),
                                    ...
                                    i = e.fontWeight,
                                    r = e.lineHeight,
                                    l = (parseInt(r, 10) || 0) * this.numLines;
                                if (this.element.scrollHeight > l || this.element.dataset.fullText) {
                                    var o = this.element.dataset.fullText || this.element.innerText,
                                        s = o.split(" "),
                                        u = this.element.getBoundingClientRect().width;
                                    this.textCtx.font = i + " " + n + " " + t;
                                    for (var a = "", f = 0, h = 0; h < this.numLines - 1; h += 1) {
                                        for (var c = ""; this.textCtx.measureText(c + " " + s[f]).width < u && f < s.length - 1;) c = "" === c ? s[f] : c + " " + s[f], f += 1;
                                        a = "" === a ? c : a + " " + c
                                    }
                                    for (var d = o.slice(o.indexOf(s[f])); this.textCtx.measureText(d + "...").width > u;) d = d.substring(0, d.length - 1);
                                    var m = a + " " + d;
                                    m === o ? (this.element.innerText = o, this.element.dataset.fullText && delete this.element.dataset.fullText) : (this.element.innerText = m + "...", this.element.dataset.fullText || (this.element.dataset.fullText = o))
                                }
                            }
                        }, {
                            key: "resize",
                            value: function() {
                                if (this.allowResize) {
                                    var e = this.element.getBoundingClientRect(),
                                        t = e.width,
                                        n = e.height;
                                    this.prevWidth === t && this.prevHeight === n || (this.clamp(), this.prevWidth = t, this.prevHeight = n), requestAnimationFrame(this.resize.bind(this))
                                }
                            }
                        }]), e
                    }()
    ...
    19:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony export (immutable) */
            __webpack_exports__["a"] = checkStatus;
            /**
    ...
    2:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony export (immutable) */
            __webpack_exports__["c"] = insertMedianet;
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "a", function() {
                return adObservable;
            });
            /* harmony export (immutable) */
            __webpack_exports__["b"] = insertAd;
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbes_fbs_ads_dist_main__ = __webpack_require__(14);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__is_mobile__ = __webpack_require__(1);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__is_mobile___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__is_mobile__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__clientConfigService__ = __webpack_require__(0);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__throttle__ = __webpack_require__(4);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__Observable__ = __webpack_require__(5);
    ...
    293:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__shared_edittools__ = __webpack_require__(60);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__shared_adInsertion__ = __webpack_require__(2);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__shared_universal_header__ = __webpack_require__(7);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__shared_search_modal__ = __webpack_require__(6);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__shared_native_ads__ = __webpack_require__(92);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__shared_native_ads___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__shared_native_ads__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_5__homepage_sliders_featured__ = __webpack_require__(294);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_6__homepage_homepage_video_overlay__ = __webpack_require__(295);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_7__homepage_pop_picks__ = __webpack_require__(301);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_8__homepage_brandvoice_setup__ = __webpack_require__(303);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_8__homepage_brandvoice_setup___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__homepage_brandvoice_setup__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_9__homepage_edition_dropdown__ = __webpack_require__(304);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_9__homepage_edition_dropdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__homepage_edition_dropdown__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_10__homepage_lazy_load__ = __webpack_require__(305);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_11__homepage_marketo__ = __webpack_require__(307);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_11__homepage_marketo___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__homepage_marketo__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_12__homepage_404_disclaimer__ = __webpack_require__(308);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_12__homepage_404_disclaimer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__homepage_404_disclaimer__);
    ...
    294:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbes_fbs_carousel__ = __webpack_require__(10);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbes_fbs_carousel___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__forbes_fbs_carousel__);
    ...
    295:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__shared_clientConfigService__ = __webpack_require__(0);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__DataVizSingleton__ = __webpack_require__(126);
    ...
    296:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__DataVizCanvas__ = __webpack_require__(297);
            ...
            __webpack_exports__["a"] = (DataVizController);
    ...
    297:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            */
            ...
            /* harmony default export */
            __webpack_exports__["a"] = (DataVizCanvas);
    ...
    298:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbes_fbs_icons__ = __webpack_require__(127);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbes_fbs_icons___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__forbes_fbs_icons__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__forbesmedia_multiclamp__ = __webpack_require__(128);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__forbesmedia_multiclamp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__forbesmedia_multiclamp__);
            var _createClass = function() {
                function defineProperties(target, props) {
                    for (var i = 0; i < props.length; i++) {
                        var descriptor = props[i];
            ...
            /* harmony default export */
            __webpack_exports__["a"] = (DataVizView);
        ...
        (function(module, exports, __webpack_require__) {
            ...
            ! function(a, n) {
                true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (n),
                    ...
                    __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == typeof exports ? module.exports = n(require, exports, module) : a.CountUp = n()
            }(this, function(a, n, t) {
    ...
    300:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            var __WEBPACK_IMPORTED_MODULE_0__shared_clientConfigService__ = __webpack_require__(0);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__shared_checkStatus__ = __webpack_require__(19);
            var _createClass = function() {
                function defineProperties(target, props) {
                    for (var i = 0; i < props.length; i++) {
                        var descriptor = props[i];
            ...
            /* harmony default export */
            __webpack_exports__["a"] = (DataVizModel);
    ...
    301:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbesmedia_multiclamp__ = __webpack_require__(128);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__forbesmedia_multiclamp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__forbesmedia_multiclamp__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__shared_is_mobile__ = __webpack_require__(1);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__shared_is_mobile___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__shared_is_mobile__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__DataVizSingleton__ = __webpack_require__(126);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__shared_clientConfigService__ = __webpack_require__(0);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__shared_throttle__ = __webpack_require__(4);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_5__shared_checkStatus__ = __webpack_require__(19);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_6__dist_templates_editorsPicks__ = __webpack_require__(302);
            ...
            function template(locals) {
                ...
                (function(picksData) {
                    ...
                    pug_mixins["paidContentLabel"] = _pug_interp3 = function _pug_interp(pick) {
                        var block = this && this.block,
                            attributes = this && this.attributes || {};
                        pug_html = pug_html + "<span class=\"data-viz__paid-content-name\">" + pug_escape(null == (_pug_interp3 = pick.paidContentData.brandName) ? "" : _pug_interp3) + "</span><span" + (" class=\"data-viz__paid-content-logo\"" + pug_attr("style", pug_style({
                            'color': pick.paidContentData.primaryColor
                        }), true, false)) + ">" + pug_escape(null == (_pug_interp3 = " " + pick.paidContentData.label) ? "" : _pug_interp3) + "</span>";
                    };
    ...
    305:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            var __WEBPACK_IMPORTED_MODULE_0__forbes_fbs_icons___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__forbes_fbs_icons__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__shared_throttle__ = __webpack_require__(4);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__shared_clientConfigService__ = __webpack_require__(0);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__shared_is_mobile__ = __webpack_require__(1);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__shared_is_mobile___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__shared_is_mobile__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__shared_adInsertion__ = __webpack_require__(2);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_5__dist_templates_homepageChannelContent__ = __webpack_require__(306);
            ...
            function template(locals) {
                ...
                (function(row, rowLetterId, rowTitle, showDescription, svgIcons) {
                    ...
                    pug_mixins["paidContentLabel"] = _pug_interp12 = function _pug_interp7(item) {
                        var block = this && this.block,
                            attributes = this && this.attributes || {};
                        pug_html = pug_html + "<span class=\"paid-content__brand-name\">" + pug_escape(null == (_pug_interp12 = item.paidContentData.brandName) ? "" : _pug_interp12) + "</span><span" + (" class=\"paid-content__type\"" + pug_attr("style", pug_style({
    ...
    6:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__is_mobile__ = __webpack_require__(1);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__is_mobile___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__is_mobile__);
    ...
    60:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            "use strict";
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__clientConfigService__ = __webpack_require__(0);
    ...
    7:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            var __WEBPACK_IMPORTED_MODULE_0__is_mobile___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__is_mobile__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__adInsertion__ = __webpack_require__(2);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__clientConfigService__ = __webpack_require__(0);

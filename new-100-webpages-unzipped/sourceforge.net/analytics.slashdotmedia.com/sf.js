    ...
    window.Matomo = window.Piwik = (function() {
                    ...
                    for (ao = 0; ao < I.length; ao++) {
                        if (w(ar)) {
                            ...
                            if (am[ar]) {
                                ...
                                var au = "The method '" + ar + '\' was not found in "_paq" variable.  Please have a look at the Piwik tracker documentation: https://developer.piwik.org/api-reference/tracking-javascript';
                                ag(au);
                                if (!at) {
        ...
        function ai(aA) {
            ...
            for (aD = 0; aD < ak - 3; aD += 4) {
                aC = aA.charCodeAt(aD) << 24 | aA.charCodeAt(aD + 1) << 16 | aA.charCodeAt(aD + 2) << 8 | aA.charCodeAt(aD + 3);
                at.push(aC)
            }
            switch (ak & 3) {
                case 0:
            ...
            function al(aq, ax, ao, au, ar, av, at) {
                ...
                if (ap) {
                    if (("hidden" === ak(ap, "overflow") || "scroll" === ak(ap, "overflow"))) {
                        if (ar + aw > ap.offsetWidth + ap.scrollLeft || ar + av - aw < ap.scrollLeft || ax + aw > ap.offsetHeight + ap.scrollTop || ax + at - aw < ap.scrollTop) {
                            return false
                        }
                    }
                ...
                if (ak === "object") {
                    ...
                    if (ap && ap.length) {
                        ...
                        for (al = 0; al < ap.length; al++) {
                            if ("movie" === ab.getAttributeValueFromNode(ap[al], "name") && ab.hasNodeAttributeWithValue(ap[al], "value")) {
        ...
        function N(aq) {
            ...
            var al = new RegExp("index\\.php\\?module=Overlay&action=startOverlaySession&idSite=([0-9]+)&period=([^&]+)&date=([^&]+)(&segment=.*)?$");
        ...
        function Q(b5, b0) {
            ...
            function c0(db, c9, c8, da, c7, c6) {
                ...
                G.cookie = db + "=" + t(c9) + (c8 ? ";expires=" + c5.toGMTString() : "") + ";path=" + (da || "/") + (c7 ? ";domain=" + c7 : "") + (c6 ? ";secure" : "")
            }
            ...
            function cS(c6, c7, c5) {
                ...
                setTimeout(function() {
                    ...
                    var da;
                    try {
                        var c9 = T.XMLHttpRequest ? new T.XMLHttpRequest() : T.ActiveXObject ? new ActiveXObject("Microsoft.XMLHTTP") : null;
            ...
            function cH() {
                return bY((h.userAgent || "") + (h.platform || "") + JSON_PIWIK.stringify(cV) + (new Date()).getTime() + Math.random()).slice(0, 16)
            }
            ...
            function aF(c5) {
                ...
                var c8 = c5.uuid + "." + c5.createTs + "." + c5.visitCount + "." + c6 + "." + c5.lastVisitTs + "." + c5.lastEcommerceOrderTs;
                ...
                if (aV) {
                    if (ce) {
                        ...
                        if (i && i.timing && i.timing.requestStart && i.timing.responseEnd) {
                            c7 += "&gt_ms=" + (i.timing.responseEnd - i.timing.requestStart)
                        }
                    }
                }
                if (aE) {
            ...
            function aQ(c5) {
                return function(c6) {
                    ...
                    b7(bA);
                    if (ab.isLinkElement(c5) && ab.hasNodeAttributeWithValue(c5, "href") && ab.hasNodeAttributeWithValue(c5, v.CONTENT_TARGET_ATTR)) {
            ...
            function bp(c7, c8) {
                ...
                var c9 = [];
                for (c5 = 0; c5 < c7.length; c5++) {
                    c6 = ck(v.buildImpressionRequestParams(c7[c5].name, c7[c5].piece, c7[c5].target), undefined, "contentImpressions");
                    if (c6) {
                        c9.push(c6)
                    }
                }
            ...
            function ao(c7, c9, c5, c8, db, da) {
                if (a(String(c7)).length === 0 || a(String(c9)).length === 0) {
                    ag("Error while logging event: Parameters `category` and `action` must not be empty or filled with whitespaces");
                    return false
                }
            ...
            function bZ(c5, c8, c6, c9) {
                var c7 = ck("search=" + t(c5) + (c8 ? "&search_cat=" + t(c8) : "") + (J(c6) ? "&search_count=" + c6 : ""), c9, "sitesearch");
                bw(c7, bA)
            }
                    ...
                    if (ap[an] && ap[an][0]) {
                        ...
                        if (ak === al) {
                            ...
                            if (aq[al] > 1 && al !== "addTracker") {
                                ag("The method " + al + ' is registered more than once in "_paq" variable. Only the last call has an effect. Please have a look at the multiple Piwik trackers documentation: https://developer.piwik.org/guides/tracking-javascript-guide#multiple-piwik-trackers')
                            }
                            aq[al]++
                        }
                    }
        ...
        var C = ["addTracker", "disableCookies", "setTrackerUrl", "setAPIUrl", "enableCrossDomainLinking", "setCrossDomainLinkingTimeout", "setSecureCookie", "setCookiePath", "setCookieDomain", "setDomains", "setUserId", "setSiteId", "enableLinkTracking", "requireConsent", "setConsentGiven"];

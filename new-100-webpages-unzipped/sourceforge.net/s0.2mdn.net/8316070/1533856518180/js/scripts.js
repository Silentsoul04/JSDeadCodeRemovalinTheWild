...
function animate() {
    if (t1) {
        ...
        t1
            ...
            .fromTo('.middleground', 0.2, {
                y: settings.offscreen_y,
                opacity: 0
            }, {
                y: settings.f1_y,
                opacity: 1
            }, '+=0.1')
            .staggerFromTo('.frame-1 span', 0.1, {
                opacity: 0
            }, {
                opacity: 1
            }, 0.03, '+=0.1')
        ...
        t1
            ...
            .to('.foreground .frame-1', 0.3, {
                opacity: 0
            }, "frame2")
            .to('.frame-2', 0.3, {
                opacity: 1
            }, "frame2")
            .staggerFromTo('.frame-2 span', 0.1, {
                opacity: 0
            }, {
                opacity: 1
            }, 0.03, '+=0.1')
        ...
        // 	t1.to('#gd_logo path',0.2,{opacity: 1})
        // }
        t1
            .to(svg_mg, 0.3, {
                morphSVG: {
        ...
        t1
            ...
            .fromTo('.frame-3 .textbox-mid', 0.4, {
                opacity: 0
            }, {
                opacity: 1
            }, '-=0.2')
            .fromTo('.middleground .overlay', 0.3, {
                y: G_AD_SETUP.height
            }, {
                y: 0
            }, '-=0.2')
            .fromTo('.frame-3 .textbox-foot', 0.3, {
                opacity: 0
            }, {
                opacity: 1
            }, '-=0.2')

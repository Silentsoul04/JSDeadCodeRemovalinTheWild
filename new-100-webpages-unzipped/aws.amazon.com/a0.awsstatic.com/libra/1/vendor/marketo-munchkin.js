...
(function(l) {
    if (!l.MunchkinTracker) {
        var k = l.document,
            ...
            M = e(l.XMLHttpRequest) && e((new l.XMLHttpRequest).withCredentials),
            q = function(b) {
                var a = null,
                    c;
                if (e(b))
            ...
            z = function(b, a) {
                var c = {},
                    ...
                    g = f.length,
                    h, m, k;
                for (h = 0; h < g; h += 1) m = f[h].split(d), e(m) && 1 < m.length && (k = m.shift(), m = m.join(d), c[q(k)] = q(m));
                return c
            },
            A = function(b) {
                try {
            ...
            n =
            null,
            N = l.navigator.cookieEnabled || k.hasOwnProperty("cookie") && (0 < k.cookie.length || -1 < (k.cookie = "testcookie=test; max-age=10000").indexOf.call(k.cookie, "testcookie=test;")),
            u = !1,
            v = [],
            E = null,
            O = function(b, a, c) {
            ...
            H = function(b, a, c, d, e) {
                ...
                a = (new Date).getTime();
                e = !e && !h.asyncOnly;
                M ? O(b, e, h.clickTime) : (new l.Image(1, 1)).src = b;
                E = a + h.clickTime
            },
            P = function() {
                var b;
            ...
            s = function(b, a, c, d) {
                ...
                var k = p.protocol,
                    m = "webevents/" + b;
                if (!u) v.push(["post", arguments]);
                else if (e(n) &&
                    (a._mchId = n.id, a._mchTk = n.token, e(h.mkt_tok) && (a.mkt_tok = h.mkt_tok), e(h.wsInfo) && (a._mchWs = h.wsInfo), "clickLink" === b && (a._mchCn = e(h.customName) ? h.customName : ""), a._mchHo = g, a._mchPo = p.port, e(a._mchRu) || (a._mchRu = q(p.pathname)), a._mchPc = k, a._mchVr = "150", e(g) && 0 !== g.length && "file:" !== k))
                    for (f in m += "?_mchNc=" + (new Date).getTime(), H(h.notifyPrefix, m, a, c, d), h.altIds) h.altIds.hasOwnProperty(f) && (g = h.altIds[f], a._mchId = g, H(h.notifyPrefix.replace(/\w{3}\-\w{3}\-\w{3}\.mktoresp\.com/i, g + ".mktoresp.com"), m,
                        a, c, d))
            },
            J = function(b) {
                var a = b || l.event,
                ...
                if (f && !a._mchDone) {
                    ...
                    a === k || a === l || "A" !== a.tagName && "AREA" !== a.tagName ? a = null : (c = a.href.replace(/^\s+|\s+$/g, ""), a = e(c) && 0 < c.length && 0 !== c.indexOf("#") && 0 !== c.indexOf(f + "#") && 0 !== c.indexOf("javascript") &&
                        0 !== c.indexOf("mailto") && !y(a, "mchNoDecorate") ? a : null);
                    e(a) && !P(b, a) && (d._mchHr = q(a.href), s("clickLink", d))
                }
            },
            t = function(b) {
                if (u) {
                    ...
                    if (e(c.id) || h.cookieAnon || b) {
                        if (c.id = D, e(c.token) || (e(h.visitorToken) && "VISITOR_MKTTOK_REPLACE" !== h.visitorToken ?
                                c.token = h.visitorToken : c.token = "_mch-" + a + "-" + (new Date).getTime() + "-" + (Math.floor(9E4 * Math.random()) + 1E4)), c.store(h.cookieLifeDays, "/", a, d), d && (c = G("_mkto_trk")), !d || e(c.id)) return n = c, I(), c
                    } else return null
            ...
            F = {
                ...
                init: function(b,
                    ...
                    if (N && e(b) && 0 !== b.length) {
                        ...
                        h.notifyPrefix = p.protocol + "//" + D + ".mktoresp.com/";
                        e(a) && C(h, a);
                        ...
                        if (!("preview" === c && /\/lpeditor\/preview$/.test(p.pathname) ||
                            ...
                            if (e(c)) d._mchCn = e(h.customName) ? h.customName : "", f._mchHa = q(p.hash), f._mchRe = q(k.referrer), f._mchQp = q(p.search.substr(1).replace(/&/g, "__-__")), s("visitWebPage", d, f, !0);
                                ...
                                for (f = 0; f < d; f += 1)
                                    if (y(g[f], "lpeRegForm"))
                                        for (m = g[f].elements, r = m.length, n = 0; n < r; n +=
                                            1) "submit" !== m[n].type || y(m[n], "mchNoDecorate") || c.push(m[n]);
                ...
                munchkinFunction: function(b, a, c) {
                    ...
                    switch (b) {
                        case "associateLead":
                            ...
                            break;
                        case "clickLink":
                            e(a.href) && (d._mchHr = d._mchLr = q(a.href));
                            s("clickLink", d);
                            break;
                        case "visitWebPage":
                            e(a.url) && (d._mchRu = q(a.url)), e(a.params) && (d._mchQp = q(a.params.replace(/&/g, "__-__"))), e(a.name) && (d._mchCn = a.name),
                                f._mchRe = q(p.href), s("visitWebPage", d, f)
                    }
                },
        ...
        r(l, "beforeunload", function() {
            for (var b; 0 < x.length;) b = x.shift(), L.apply(this, b);
            if (e(E)) {
                do b = new Date; while (b.getTimeAlias() < E)
            }
        });
        r(k, "click", J, !0);
        (function(b) {
            ...
            if ("complete" === k.readyState) b.call(l, "lazy");
                ...
                r(k, "DOMContentLoaded", e);
                r(k, "readystatechange", e);
                r(l, "load", e)
            }
        })(function() {
            I();
            var b = 0;
            if (e(k.links))
                for (b = 0; b < k.links.length; b += 1) r(k.links[b], "click", J, !0)
        });

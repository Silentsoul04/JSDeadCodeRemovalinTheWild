...
! function() {
    function e(e, s) {
        ...
        function d(e, t) {
            for (var n = {}, r = s.getElementsByTagName(t), o = 0; o < r.length; o++) e.href = r[o].src || r[o].href, e.href.match(/^https?:\/\//) && (n[e.href] = r[o]);
            return n
        }
        ...
        if (!f.version && "undefined" != typeof e.AKSB.version && void 0 !== Object.keys) {
            ...
            f.init = function() {
                ...
                for (var n = this.data; e;) {
                    var r = this.get_prefix(e, Object.keys(n)),
                        o = r[0],
                        a = r[1];
                    ...
                    if (o !== a) {
                        var s = a.slice(i, a.length),
                            u = n[a];
                        u === this.value && (u = JSON.parse(JSON.stringify(u))), n[o] = {}, n[o][s] = u, delete n[a]
                    } else n[o] === this.value && (n[o] = JSON.parse(JSON.stringify(this.value)));
                    e = e.slice(i, e.length), n = n[o]
                }
                return n[e] = e ? t : null, !0
            }, u.prototype.get_prefix = function(e, t) {
                function n(e, t) {
    ...
    function t(e) {
        for (var t = 0; t < e.length; t++) "number" == typeof e[t] && (e[t] < 0 || e[t] > s) && (e[t] = null);
        return e
    }

    function n(e) {
        if ("performance" in window && "function" == typeof window.performance.getEntriesByType)
            for (var t = window.performance.getEntriesByType("paint"), n = 0; n < t.length; n++)
                if ("first-paint" === t[n].name) return Math.round(t[n].startTime);
        return e.msFirstPaint ? e.msFirstPaint - e.navigationStart : window.chrome && "function" == typeof window.chrome.loadTimes ? Math.round(1e3 * window.chrome.loadTimes().firstPaintTime) - e.domainLookupStart : void 0
    }
    var r, o, a, i;
    ! function(t) {
        t.parent !== t && void 0 == t.AKSB && (t = t.parent);
        var s = t.document;
        "undefined" == typeof t.AKSB && (t.AKSB = {});
        var u = t.AKSB;
        ...
        if (u.q = u.q || [], u.autorun = "undefined" == typeof u.autorun || u.autorun, !u.version && "X" !== t.AKSB.prof.akTT) {
            ...
            u.init = function() {
                ...
                e && (u.mark("starttime", e), u.addEventListener("DOMContentLoaded", u.onready, !1), u.addEventListener("load", u.onload, !1), "complete" === s.readyState && (u.onloadHasFired = !0, window.setTimeout(u.onload, 1)), u.processQ())
            }, u.processQ = function() {

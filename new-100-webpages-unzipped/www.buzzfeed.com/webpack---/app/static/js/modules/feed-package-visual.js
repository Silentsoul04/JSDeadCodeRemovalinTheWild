...
import {
    name as autoTruncateDescription
} from '@buzzfeed/buzzblocks/js/behaviors/auto-truncate-description';
import {
    name as lazyImage
} from '@buzzfeed/buzzblocks/js/behaviors/lazy-image';
import {
    name as viewable
} from '@buzzfeed/buzzblocks/js/behaviors/viewable';
import {
    name as lazyImageBackground
} from '@buzzfeed/buzzblocks/js/behaviors/lazy-image-background';
...
class FeedPackage {
    ...
    init() {
        ...
        if (solid.isXsmall()) {
            dom.find(this.element, '.js-xs-impressions').map(i => dom.setAttr(i, {
                'data-bfa-impressions': 'true'
            }));
        } else {
            dom.find(this.element, '.js-impressions').map(i => dom.setAttr(i, {
                'data-bfa-impressions': 'true'
            }));
        }
    }

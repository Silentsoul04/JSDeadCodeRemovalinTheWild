...
class NotificationsFeatureFlag extends Component {
    ...
    render() {
        ...
        return this.state.renderDev ? < div > {
            this.props.notifUserMenu
        } < /div> : <div>{this.props.userMenu}</div > ;
    }
}
...
class MainNav extends Component {
    render({
            ...
            const {
                topics = [], badges = [], destinations = []
            } = navItems;
            return ( <
                div className = {
                    `${styles.mainNavContainer} ${theme.mainNavContainer} ${
          isSticking ? styles.stickyMainNav : ''
                ...
                I18n.Consumer > {
                    i18n => ( <
                        ...
                        /> <
                        Search / > {
                            userInfo && ( < NotificationsFeatureFlag notifUserMenu = { <
                                    ThemedNotifUserMenu
                                    isVisible = {
                                        showNotifMenu
                                    }

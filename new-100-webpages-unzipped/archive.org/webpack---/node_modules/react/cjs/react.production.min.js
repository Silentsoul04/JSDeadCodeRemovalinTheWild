...
function N(a, b, e) {
    var c = void 0,
        ...
        h = null;
    if (null != b)
        for (c in void 0 !== b.ref && (h = b.ref), void 0 !== b.key && (g = "" + b.key), b) L.call(b, c) && !M.hasOwnProperty(c) && (d[c] = b[c]);
...
function T(a, b, e, c) {
    ...
    if (Array.isArray(a))
        for (var h = 0; h < a.length; h++) {
            ...
            var f = b + U(d, h);
            g += T(d, f, e, c)
        } else if (null === a || "object" !== typeof a ? f = null : (f = C && a[C] || a["@@iterator"], f = "function" === typeof f ? f : null), "function" === typeof f)
            for (a = f.call(a), h =

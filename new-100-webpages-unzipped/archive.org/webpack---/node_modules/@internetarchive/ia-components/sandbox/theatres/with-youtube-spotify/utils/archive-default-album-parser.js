 ...
 *
 */
const archiveDefaultAlbumParser = ({
    fileDirectoryPrefix,
    files
}) => {
    let itemPhoto = '';
    ...
    const tracks = files.reduce((neededItems = [], currentFile) => {
        ...
        if (isOriginal && isAudioFile) {
            ...
            flattenedImportantRelatedFiles = relatedFiles.reduce((fetchedData = {}, relatedFile) => {
                ...
                if (isSpectrogram && !name.match(/_spectrogram.png/g)) {
                    fetchedData.waveformURL = fullFilePath;
                }

                const normalizedAudioFile = Object.assign({}, relatedFile, {
                    fullFilePath
                });
            ...
            const enhancedOriginalAudioFile = Object.assign({},
                currentFile, {
                    relatedFiles,
                    fullFilePath: originalFileFullURL
                },

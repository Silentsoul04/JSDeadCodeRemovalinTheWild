...
'use strict';
(function(L, q) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = q() : "function" === typeof define && define.amd ? define(q) : L.React = q()
})(this, function() {
    ...
    function q(a) {
        ...
        L(!1, "Minified React error #" + a + "; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ", d)
    }
    ...
    function P() {
        if (-1 === l && null !== c && 1 === c.priorityLevel) {
            w = !0;
            try {
                do O(); while (null !== c && 1 === c.priorityLevel)
            } finally {
                w = !1, null !== c ? t() : B = !1
            }
        }
            ...
            if (a)
                for (; null !== c;) {
                    ...
                    if (c.expirationTime <= d) {
                        do O(); while (null !== c && c.expirationTime <= d)
                    } else break
                } else if (null !== c) {
                    do O(); while (null !== c && !F())
                }
    ...
    function da(a, b, d) {
        var f = void 0,
            ...
            e = null;
        if (null != b)
            for (f in void 0 !== b.ref && (e = b.ref), void 0 !== b.key && (c = "" + b.key), b) ea.call(b, f) && !fa.hasOwnProperty(f) && (p[f] = b[f]);
    ...
    function S(a, b, d, f) {
        ...
        if (Array.isArray(a))
            for (var g = 0; g < a.length; g++) {
                ...
                var h = b + T(c, g);
                e += S(c, h, d, f)
            } else if (null === a || "object" !== typeof a ? h = null : (h = ja && a[ja] || a["@@iterator"], h = "function" === typeof h ? h : null), "function" === typeof h)
                for (a = h.call(a), g = 0; !(c = a.next()).done;) c = c.value, h = b + T(c, g++), e += S(c, h, d, f);
            else "object" === c && (d = "" + a, q("31",
    ...
    function T(a, b) {
        return "object" === typeof a && null !== a && null != a.key ? ua(a.key) : b.toString(36)
    }
    ...
    function xa(a, b, d) {
        ...
        Array.isArray(a) ? V(a, f, d, function(a) {
            return a
        }) : null != a && (R(a) && (a = ta(a, c + (!a.key || b && b.key === a.key ? "" : ("" + a.key).replace(ka, "$&/") + "/") +
            d)), f.push(a))
    }
    ...
    var e = "function" === typeof Symbol && Symbol.for,
        ...
        Ca = e ? Symbol.for("react.forward_ref") :
        60112,
        ...
        H = function() {
            ...
            for (var c, e = 1; e < arguments.length; e++) {
                ...
                if (la) {
                    c = la(g);
                    for (var h = 0; h < c.length; h++) Ha.call(g, c[h]) && (d[c[h]] = g[c[h]])
                }
            }
            return d
        },
    ...
    var c = null,
        ...
        ma = "function" === typeof requestAnimationFrame ? requestAnimationFrame : void 0,
        na = "function" === typeof cancelAnimationFrame ? cancelAnimationFrame : void 0,
        oa, pa, X = function(a) {
            oa = ma(function(b) {
                Ka(pa);
                a(b)
    ...
    n = {
        ...
        cloneElement: function(a,
            ...
            if (null != b) {
                ...
                for (c in b) ea.call(b, c) && !fa.hasOwnProperty(c) && (e[c] = void 0 === b[c] && void 0 !== l ? l[c] : b[c])
            }

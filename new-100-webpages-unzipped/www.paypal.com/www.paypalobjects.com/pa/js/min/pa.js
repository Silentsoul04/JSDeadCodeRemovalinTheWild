/*@ 2019 PayPal (v1.3.25) */ ! function() {
    ...
    function M(t) {
        t = N(t), "complete" === document.readyState ? t() : (B(window, "load", t), B(window, "DOMContentLoaded", function() {
            setTimeout(t, 3e3)
        }))
    }
    ...
    function Pt(t, e) {
        if (t === I.V3P.GA) ! function n(e) {
            ...
            r = N(r), kt(yt + "/gajs/gtag.js", function() {
                function t() {
                            ...
                            if (function r(t) {
                                ...
                                n.forEach(function(t) {
                                    ...
                                    if ("fn" === e) {
                                        ...
                                        Bt(n) ? Bt(n)(o) : t("Invalid trigger function", o.trigger, I.MI_ERR)
    ...
    function Tt(t) {
        ...
        if (t && t.hasOwnProperty("enable")) {
            ...
            var e = t.enable,
                ...
                i = e.args,
                o = void 0 === i ? [] : i;
            if ("fn" === n && r) return !!Bt(r) && Bt(r).apply(null, o)
        }
        return !1
    }
            ...
            if (n && !n[e]) {
                var r = function c(o) {
                        ...
                        return t.forEach(function(t) {
                            var e, n, r = t.vars;
                            for (var i in r) r.hasOwnProperty(i) && (r[i] = (e = Ot(r[i], o.options), n = void 0, (n = decodeURIComponent(e)) ? n.replace(RegExp(/[^@]+@[^\\.]+\..+/gi), "") : ""))
                        }), t
                    }(t),
                    i = Ct("ga"),
                    o = Ct("gtag");
    ...
    $t.Analytics = function(t) {
        ...
        _enableUnloadDelay: function() {
            ...
            J(window, "beforeunload", e), B(window, "beforeunload", e)
        },
        ...
        trackClicks: function(t) {
            for (var e = this._getElements(t.elements), n = this._recordClick(t), r = 0; r < e.length; r++) {
                var i = e[r];
                i.setAttribute(I.IS_MARKED, 1), J(i, "click", n), B(i, "click", n)
            }
        },
        ...
        t.trackImpression && (Qt = !0, M(function() {
            $t.isUnloading || e()
        }))
        ...
        return "object" === d(r.customClicks) && l.trackClicks({
            ...
            request: f
        }), r.trackScroll && zt(r.scroll, $t), B(document.body, "click", function(t) {
            var e, n, r, i = 0,
                o = !1,
                a = t.target,
                c = {
    ...
    function ce() {
        ...
        }, B(window, "hashchange", ce), u.subscribe(I.E.BEACON, function() {
            ae = !1
        })
    }();
    var se = !1;

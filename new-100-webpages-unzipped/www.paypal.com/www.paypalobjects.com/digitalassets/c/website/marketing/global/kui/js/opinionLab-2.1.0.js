...
(function(b, a) {
    ...
    window.OOo = {
        __detectBrowser: function(b) {
            var a = Object.prototype.toString.call(window.opera) === '[object Opera]',
                ...
                e = false;
            c.isMobile = (c.MobileSafari || c.BlackBerry || c.Fennec || c.IEMobile || c.OperaMobile || c.Kindle || c.iOs || c.Android || c.WindowsPhone || c.WindowsTablet);
    ...
    (function() {
        ...
        function D(b, a) {
            ...
            if (f) {
                b.metrics.referer = OOo.referrerRewrite(f)
            }
        ...
        function J(c) {
            ...
            for (var s in o) {
                if (o.hasOwnProperty(s)) {
                    ...
                    n.href = '#';
                    n.innerHTML = String(s).replace(/_/g, ' ') + '<span class="screen_reader">This will open a new window</span>';
                    ...
                    if (typeof k.categories[s].oCode === 'string') {
                        OOo.addEventListener(n, 'click', (function(d) {
                            return function(b) {
            ...
            for (p = 0; p < a.length; p += 16) {
                ...
                for (q = 0; q < 80; q += 1) {
                    if (q < 16) {
                        ...
                        d[q] = t(d[q - 3] ^ d[q - 8] ^ d[q - 14] ^ d[q - 16], 1)
                    }
    ...
    (function() {
        ...
        function m() {
            var b = this.options,
                ...
                c, e, f = 'resizable=yes,location=no,status=no,scrollbars=1,width=' + a[0] + ',height=' + a[1] + ',top=' + d[0] + ',left=' + d[1],
                g = 'OnlineOpinion';
            if (b.newWindow) {
                g = g + (l++)
            }
    ...
    (function() {
        function i() {
            ...
            if (c[0]) {
                OOo.addEventListener(window, f, function(b) {
                    var a = b || window.event;
                    this.show(a, 'exit')
                }.bind(this), false)
            }
    ...
    OOo.extend(OOo.Ocode.prototype, {
        setupOnPageCC: function() {
            var e = document,
                ...
                r, s, n, t = false,
                v = this,
                z, w, u, C, x, D, A, B = e.createElement('span');
    ...
    OOo.extend(OOo.Ocode, {
        postMessageHandler: function(c, e, f) {
            return function(b) {
                ...
                if ((b && !(b.origin === a || b.origin.indexOf(e) !== 0)) || (!b && f.hash.search('OL=') === -1)) {
                    return false
                }
...
(function(w, d, o) {
    ...
    var OpinionLabInit = function() {
        ...
        if (opVars.showSitefbIcon) {
            ...
            sfLink.appendChild(sfImg);
        }
    };

    OpinionLabInit(); // This file is lazy-loaded (See diff with v2.0.0);
})(window, document, OOo);
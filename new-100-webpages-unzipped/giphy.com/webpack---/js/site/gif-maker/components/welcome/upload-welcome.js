...
class Welcome extends PureComponent {
    ...
    render() {
        ...
        return ( <
            ...
            onError = {
                (error, message) => this.onFullscreenError(error, message)
            }
            onDrag = {
                (x, y) => this.setState({
                    dragX: x,
            ...
            <
            div className = {
                isProcessing && isEmpty(error) ? css.fadeAway : css.container
            }
            data - upload >
            <
            div className = {
            ...
            Upload your GIF collection to share on Facebook, Twitter, < br / > Instagram, text message, email, and everywhere
            else . <
                /div> <
                FilePortal / >
                <

...
// Action
export const setSlideshow = files => ({
    files,
    type: SLIDESHOW
})
...
export const setStartFileId = startFileId => ({
    startFileId,
    type: SET_START_FILE_ID
})
export const setDurations = durations => ({
    durations,
    type: SET_DURATIONS
})
export const setStillDuration = stillDuration => ({
    stillDuration,
    type: SET_STILL_DURATION
})
export const setStillMaxDuration = stillMaxDuration => ({
    stillMaxDuration,
    type: SET_STILL_MAX_DURATION
})
export const setReady = ready => ({
    ready,
    type: SET_READY
})
export const setLetterbox = letterbox => ({
    letterbox,
    type: SET_LETTERBOX
})
...
export const getTotalFileSize = state =>
    fileSizeToMB(getSlideshow(state).reduce((sum, {
        file = {}
    }) => sum + (file.size || 0), 0))
// Reducer

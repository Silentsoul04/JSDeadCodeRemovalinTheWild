...
const FavoritesPage = lazy(() =>
    import ( /* webpackChunkName: "mobileFavoritesPage" */ '../pages/user/favorites'))
const GifVideoPage = lazy(() =>
    import ( /* webpackChunkName: "mobileGifVideoPage" */ '../pages/gif-video'))
const AboutPage = lazy(() =>
    import ( /* webpackChunkName: "mobileAboutPage" */ '../pages/about'))
const TrendingPage = lazy(() =>
    import ( /* webpackChunkName: "mobileTrendingPage" */ '../pages/trending'))
...
const LoginPage = lazy(() =>
    import ( /* webpackChunkName: "mobileLoginPage" */ '../pages/user/login'))
const JoinPage = lazy(() =>
    import ( /* webpackChunkName: "mobileJoinPage" */ '../pages/user/join'))
const ApplyPage = lazy(() =>
    import ( /* webpackChunkName: "mobileApplyPage" */ '../pages/user/apply'))
...
const ChannelPage = lazy(() =>
    import ( /* webpackChunkName: "mobileChannelPage" */ '../pages/channel/channel-root'))
...
const TeamPage = lazy(() =>
    import ( /* webpackChunkName: "mobileTeamPage" */ '../pages/team'))
const DashboardPage = lazy(() =>
    import ( /* webpackChunkName: "mobileDashboard" */ '../pages/user/dashboard'))
const FilmFestPage = lazy(() =>
    import ( /* webpackChunkName: "mobileFilmFest" */ '../pages/film-fest'))
const FourZeroFourPage = lazy(() =>
    import ( /* webpackChunkName: "mobile404" */ '../pages/404'))

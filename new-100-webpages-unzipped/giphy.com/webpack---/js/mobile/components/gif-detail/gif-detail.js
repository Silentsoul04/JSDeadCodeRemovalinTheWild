...
export default class GifDetail extends PureComponent {
    ...
    componentWillMount() {
        ...
        setIsMetaVisible({
            id,
            isVisible: !user || tags.indexOf('ad') > -1
        })
    }
    ...
    render() {
        ...
        return ( <
            ...
            <
            div className = {
                isSticker ? css.sticker : css.media
            } >
            <
            Carousel currentGif = {
                gif
            ...
            height = {
                appHeight - 150
            } // fill screen with room for header + attribution
            onProgress = {
                swipeProgress => this.setState({
                    swipeProgress
                })
            }
            onComplete = {

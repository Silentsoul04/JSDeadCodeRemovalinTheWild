...
class EndCard extends PureComponent {
    ...
    static getDerivedStateFromProps({
        ...
        return isEqual(moreStories, prevState.moreStories) ? null : {
            moreStories
        }
    }
    ...
    render() {
        ...
        return ( <
            ...
            Info >
            <
            SubtitleWrapper > That & apos; s All! < /SubtitleWrapper> <
            Title > {
                title
            } < /Title> {

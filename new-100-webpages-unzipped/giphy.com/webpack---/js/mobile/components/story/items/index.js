    ...
    render() {
        ...
        return ( <
            ...
            Covers style = {
                {
                    height: size.height,
                    transform: `translateX(${fullWidth ? 0 : translateX}px)`
                }
            }
            minPeek = {
                minPeek
            ...
            {!fullWidth && ( <
                    ...
                    isActive = {
                        horizontalPanProgress > 0 && isPrevious
                    }
                    isDragging = {
            ...
            /> {
                !fullWidth && ( <
                    ...
                    isActive = {
                        horizontalPanProgress > 0 && isNext
                    }
                    isDragging = {
                        horizontalPanProgress !== 0
                    }

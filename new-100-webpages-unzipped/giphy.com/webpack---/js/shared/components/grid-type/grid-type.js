...
export default class GridType extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            a className = {
                `${css.grid} ${css[gridType === 'grid' ? 'iconActive' : 'iconInactive']}`
            }
            href = "?view=grid"
            onClick = {
                e => onViewTypeClick(e, 'grid', onGridTypeClick)
            }
            /> <
            a className = {
                `${css.feed} ${css[gridType === 'feed' ? 'iconActive' : 'iconInactive']}`
            }
            href = "?view=feed"
            onClick = {
                e => onViewTypeClick(e, 'feed', onGridTypeClick)
            }
            /> <
            /div>
        )

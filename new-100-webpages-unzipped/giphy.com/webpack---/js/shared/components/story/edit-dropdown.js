...
class Intro extends PureComponent {
    ...
    render() {
        ...
        return permissions && !!permissions.create_stories ? ( <
            EllipsisContainer >
            <
            EllipsisDropdown extendDirectionUp = {!isOpenDown
            }
            isHover = {
                true
            } >
            ...
            <
            StoryEditLink shouldUseLinkFallback = {
                true
            }
            href = {
                `/create/story/finalize/${story_id}`
            } >
            Edit Story <
            /StoryEditLink> {
                showPrivacyOption && ( <
                    StoryEditItemBase onClick = {
                        this.onStoryEditItemBaseClick
                    } > {
            ...
            href = {
                `/create/story/delete/${story_id}`
            } >
            Delete Story <
            /StoryEditLink> <
            StoryCardExport padding exporting = {
                isExporting
            }
            onClick = {
                this.onExportCover

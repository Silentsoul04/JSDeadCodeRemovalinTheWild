...
export const isFetchingChannels = fetching => ({
    type: IS_FETCHING_CHANNELS,
    fetching
})
export const initChannelSelector = channels => ({
    type: INIT_CHANNEL_SELECTOR,
    channels
})
export const updateChannelSection = (id, channel) => ({
    type: UPDATE_CHANNEL_SECTION,
    id,
    channel
})
export const showChannelSection = id => ({
    type: SHOW_CHANNEL_SECTION,
    id
})
export const saveChannelSelection = id => ({
    type: SAVE_CHANNEL_SELECTION,
    id
})

! function(e) {
        ...
        for (var f, n, o = 0, h = 0, u = 0, d = 0, g = 0, A = 0, C = 0, w = 0, m = 0, $ = 0, y = 0, O = 0, j = 0, z = 0, R = 0, we = 0, $e = 0, Oe = 0, je = 0, ze = s.length, Je = ze - 1, Re = "", Te = "", Ue = "", Ve = "", Xe = "", Ye = ""; R < ze;) {
            ...
            switch (C) {
                ...
                case I:
                    ...
                    if (h === Z) h = 0;
                    else if (ge + O === 0 && t !== te && Te.length > 0) we = 1, Te += "\0";
    ...
    function Ie(e, a, r) {
        ...
        switch (i) {
            ...
            default:
                ...
                var l = 0;
                for (s = []; f < t; ++f)
                    for (var h = 0; h < i; ++h) s[l++] = Je(e[h] + " ", c[f], r, i).trim()
        }
        return s
    }
    ...
    function Ke(e, a, r, c) {
        ...
        switch (u) {
            ...
            case 953:
                if (true === j.test(e))
                    if (115 === (l = e.substring(e.indexOf(":") + 1)).charCodeAt(0)) return Ke(e.replace("stretch", "fill-available"), a, r, c).replace(":fill-available", ":stretch");

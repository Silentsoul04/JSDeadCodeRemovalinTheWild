...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_ignoreCase": true,
                "vtp_map": ["list", ["map", "key", "gtm.js", "value", "paget0"],
                    ["map", "key", "TypeformSubmit", "value", "leadg0"]
                ]
            }, {
                "function": "__u",
                "vtp_component": "HOST",
                ...
                "vtp_map": ["list", ["map", "key", "giphy.typeform.com", "value", "9197322"],
                    ["map", "key", "giphy.com", "value", "9197322"]
                ]
            }, {
                "function": "__r"
            }, {
            ...
            "tags": [{
                ...
                "vtp_fieldsToSet": ["list", ["map", "fieldName", "allowLinker", "value", "false"],
                    ...
                    ["map", "fieldName", "userId", "value", ["macro", 11]]
                ],
                "vtp_useHashAutoLink": false,
                ...
                "vtp_dimension": ["list", ["map", "index", "1", "dimension", ["macro", 12]],
                    ...
                    ["map", "index", "3", "dimension", ["macro", 14]],
                    ["map", "index", "4", "dimension", ["macro", 15]],
                    ["map", "index", "5", "dimension", ["macro", 16]],
                    ["map", "index", "6", "dimension", ["macro", 17]],
                    ["map", "index", "7", "dimension", ["macro", 18]],
                ...
                "vtp_useDebugVersion": false,
                "vtp_fieldsToSet": ["list", ["map", "fieldName", "allowLinker", "value", "false"],
                    ["map", "fieldName", "page", "value", ["macro", 20]],
                    ["map", "fieldName", "title", "value", ["macro", 21]],
                    ["map", "fieldName", "userId", "value", ["macro", 11]]
                ],
                "vtp_useHashAutoLink": false,
                "vtp_trackType": "TRACK_PAGEVIEW",
            ...
            "rules": [
                ...
                [
                    ["if", 0, 1],
                    ["block", 0, 1, 4, 5, 6, 7, 8, 10, 11, 14, 15, 16, 17, 20]
                ]
            ]
        },
        "runtime": [
    ...
    var tc = sc,
        ...
        vc = null,
        wc = null,
        xc = "//www.googletagmanager.com/a?id=" + oc.m + "&cv=52",
        yc = {},
        zc = {},
        Ac = function() {
            var a = pc.sequence || 0;
    ...
    Z.a.cegg = ["nonGoogleScripts"],
        function() {
            ...
            (function(b) {
                ...
                Z.__cegg.b = "cegg";
                Z.__cegg.g = !0;
                Z.__cegg.priorityOverride = 0
            })(function(b) {
                try {
                    var c = b.vtp_usersNumericId;
                    if (c)
                        if (a.hasOwnProperty(c) && !0 === a[c]) b.vtp_gtmOnSuccess();
                        else {
                            b.vtp_snapshotName && (C.CE_SNAPSHOT_NAME = b.vtp_snapshotName);
                            for (var d = c.toString(); 8 > d.length;) d = "0" + d;
                            var e = d.replace(/(\d+)(\d{4})$/, "/pages/scripts/$1/$2.js");
                            K("//script.crazyegg.com" + e + "?" + Math.floor((new Date).getTime() / 36E5), b.vtp_gtmOnSuccess, b.vtp_gtmOnFailure);
                            a[c] = !0
                        }
                    else G(b.vtp_gtmOnFailure)
                } catch (g) {
                    G(b.vtp_gtmOnFailure)
                }
            })
        }();
    Z.a.awct = ["google"],
    ...
    Z.a.fsl = [],
        function() {
            function a() {
                ...
                Pb(e, "click", function(k) {
                    var l = k.target;
                    if (l && (l = Ub(l, ["button", "input"], 100)) && ("submit" == l.type || "image" == l.type) && l.name && Rb(l, "value")) {
                        var m;
                        (m = l.form ? l.form.tagName ? l.form : D.getElementById(l.form) : Ub(l, ["form"], 100)) && g.store(m, l)
                    }
                }, !1);
                Pb(e, "submit", function(k) {
                    var l = k.target;
                    if (!l) return k.returnValue;
                    var m = k.defaultPrevented || !1 === k.returnValue,
                        n = b(l) && !m,
                        p = g.get(l),
                        t = !0;
                    if (d(l, function() {
                            if (t) {
                                var q;
                                p && (q = e.createElement("input"), q.type = "hidden", q.name = p.name, q.value = p.value, l.appendChild(q));
                                h.call(l);
                                q && l.removeChild(q)
                            }
                        }, m, n, p)) t = !1;
                    else return m || (k.preventDefault && k.preventDefault(), k.returnValue = !1), !1;
            ...
            function b(e) {
                var g = e.target;
                return g && "_self" !== g && "_parent" !== g && "_top" !== g ? !1 : !0
            }
            ...
            function d(e, g, h, k, l) {
                var m = wg("fsl", h ? "nv.mwt" : "mwt", 0),
                    n;
                n = h ? wg("fsl", "nv.ids", []) : wg("fsl", "ids", []);
                ...
                if (k && m) {
                    if (!Gi(p, Of(g), m)) return !1
                } else Gi(p, function() {}, m || 2E3);
                return !0
            }(function(e) {
                Z.__fsl = e;
                Z.__fsl.b =

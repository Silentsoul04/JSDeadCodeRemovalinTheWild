        ...
        M("auth", {
            callback: function() {
                ...
                d.checkSessionState(e, function(f) {
                    ...
                    Eb("savedUserState", g);
                    (h || k) && Kb(f) && !O("disableRealtimeCallback") && d._pimf(f, !0)
                })
            }
        });
        return !0
...
gapi.load("client", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_US.ysvV9EtEi0w.O/am\u003dwQE/d\u003d1/rs\u003dAGLTcCMcYZL5zQsWyujyfqZUWUukFuVxmQ/m\u003d__features__",
            "u": "https://apis.google.com/js/client:platform.js",
            "hee": true,
            "fp": "63f6ff1402e22a9574616ad4524140870b22d8c8",
            "dpo": false
        },

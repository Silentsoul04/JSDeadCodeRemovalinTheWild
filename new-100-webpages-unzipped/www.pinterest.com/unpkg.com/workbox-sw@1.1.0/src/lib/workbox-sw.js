...
} from '../../../workbox-broadcast-cache-update/src/index.js';
import {
    RevisionedCacheManager
} from '../../../workbox-precaching/src/index.js';
import {
    getDefaultCacheName
...
class WorkboxSW {
    ...
    _registerInstallActivateEvents(skipWaiting, clientsClaim) {
        self.addEventListener('install', (event) => {
            ...
            cache-first strategy.`,
                    data: {
                        'Precached URLs': JSON.stringify(cachedUrls)
                    },
                });
            }
    ...
    _getCacheMatchPlugin(ignoreUrlParametersMatching, directoryIndex) {
        ...
        return {
            cacheWillMatch: cacheMatchFunction
        };
    }

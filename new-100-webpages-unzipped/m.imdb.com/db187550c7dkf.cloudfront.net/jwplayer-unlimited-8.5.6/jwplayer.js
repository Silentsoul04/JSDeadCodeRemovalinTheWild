...
window.jwplayer = function(t) {
    ...
    function d(t) {
        return l || (l = function(t) {
            ...
            if (e && l && d) return v = n.e(8).then(function(t) {
                n(35);
                var e = n(19).default;
                return a.a.controls = n(20).default, Object(u.a)(n(122).default), e
    ...
    var r = "8.5.6+commercial_v8-5-6.287.commercial.1068f82.hlsjs..jwplayer.409c173.dai.ac94f63.freewheel.503251f.googima.8001841.vast.85cf67a.analytics.706e657.gapro.f664e4e.related.b0b8e78"
}, function(t, e, n) {
    "use strict";
    n.d(e, "b", function() {
        return c
    ...
    var g = function(t, e) {
            ...
            i.flashplayer = function(t) {
                ...
                return function(t, e, n) {
                    if (e) {
                        var r = e.client || v(n);
                        t[r] = e, delete e.client
                    }
                }(e, t.ga, "gapro"), e
            }(i);
            var g, m = i.ab;
            return m && Object.keys(m.tests).forEach(function(t) {
                m.tests[t].forEach(function(t) {
                    t.addConfig && t.addConfig(i, t.selection)
                })
            }), g = i.playlist, Object(r.x)(g) && g.indexOf(h) > -1 && (i.playlist = function(t, e) {
                var n = function(t) {
                ...
                if (!1 !== t.get("controls") || o) {
                    ...
                    return o || (r = {
                        ...
                        if (!t.attributes._destroyed) {
                            var o = new E.b;
                            o.name = "related", o.js = n(143).default, Object(E.a)(o, r, e)
                        }
    ...
    var M = n(23),
        N = function(t) {
            ...
            this.start = function(n) {
                var r = y.a.all([Object(m.c)(t), Object(M.a)(t, n), A(t, n, [])]),
                    i = new y.a(function(t, n) {
                        e = setTimeout(function() {
                            var t = new d.p(d.j, d.x);
                            n(t)
                        }, 3e4);
                        var i = function() {
                            clearTimeout(e), t()
    ...
    Object(r.j)(Y.prototype, {
        ...
        init: function(t, e) {
            ...
            return i.on("change:errorEvent", $), this.setup.start(e).then(function(t) {
                if (!t) throw Object(d.z)(null, d.w);
                var u = t[0];
                if (n.setup) {
                ...
                n.setup && function(t, e, n) {
                    y.b.then(function() {
                        var r = Object(d.A)(d.o, d.y, n),
                            i = t._model || t.modelShim;
                        r.message = r.message || i.get("localization").errors[r.key], delete r.key;
                        var o = i.get("contextual");
                        if (!o) {
                            var u = Object(V.a)(t, r);
                            V.a.cloneIcon && u.querySelector(".jw-icon").appendChild(V.a.cloneIcon("error")), G(t, u)
                        }
                        i.set("errorEvent", r), i.set("state", b.Ka), t.trigger(b.Ha, r), o && e.remove()
                    })
                }(n, e, t)
            })
        },
    ...
    var T = Object(r.j)({}, y, b, i, {
            ...
            tryCatch: function(t, e) {
                ...
                if (d.a.debug) return t.apply(e || this, n);
                try {
                    return t.apply(e || this, n)
                } catch (e) {
                    return new w(t.name, e)
                }
            },
            Error: w,
            Timer: g.a,
    ...
    var I = N,
        ...
        Q = r.f.extend,
        V = {};
    V.api = l, V._ = r.f, V.version = "8.5.6+commercial_v8-5-6.287.commercial.1068f82.hlsjs..jwplayer.409c173.dai.ac94f63.freewheel.503251f.googima.8001841.vast.85cf67a.analytics.706e657.gapro.f664e4e.related.b0b8e78", V.utils = Object(r.j)(T, {
        key: L.a,
        extend: Q,
        scriptloader: B.a,
        rssparser: {

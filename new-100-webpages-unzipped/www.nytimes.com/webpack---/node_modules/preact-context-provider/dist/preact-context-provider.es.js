...
Provider.prototype.getChildContext = function getChildContext() {
    ...
    var context = {};
    for (var i in this$1.props) {
        if (i !== 'children') {
            context[i] = this$1.props[i];
        }
    }
    return context;
};
...
MergingProvider.prototype.getChildContext = function getChildContext() {
    ...
    for (var i in props) {
        if (i !== 'children' && i !== 'mergeProps') {
            context[i] = (!mergeIsArray || ~mergeProps.indexOf(i)) ? deepAssign(this$1.context[i], props[i]) : props[i];
        }
    }
    return context;
};
...
var provide = function(ctx) {
    return function(Child) {
        return function(props) {
            return h(Provider, ctx, h(Child, props));
        };
    };
};
...
var mergingProvide = function(ctx) {
    return function(Child) {
        return function(props) {
            return h(MergingProvider, ctx, h(Child, props));
        };
    };
};
...
//////////////////
// WEBPACK FOOTER
// ./node_modules/preact-context-provider/dist/preact-context-provider.es.js
// module id = 41
// module chunks = 5
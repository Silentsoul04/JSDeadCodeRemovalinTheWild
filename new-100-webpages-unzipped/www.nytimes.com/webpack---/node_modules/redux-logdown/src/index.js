...
const reduxLogdown = (name, opts = {}) => {
    ...
    const prevLogger = opts.logger || logdown('prev state', {
        prefixColor: '#999999'
    })
    const actionLogger = opts.logger || logdown('action', {
        prefixColor: '#FFCC66'
    })
    const nextLogger = opts.logger || logdown('next state', {
        prefixColor: '#6699CC'
    })
...
// WEBPACK FOOTER //
// ./node_modules/redux-logdown/src/index.js
...
const FastForward10Seconds = ({
    ...
    return ( <
        button className = {
            `${styles['fast-forward']} ${themeClass} ${layoutClass}`
        }
        title = "Fast Forward"
        ...
        theme >
        <
        FastForward10SecondsIcon / >
        <
        /button>
    );
};

const FastForward10SecondsIcon = () => ( <
    svg width = "30"
    height = "30"
    viewBox = "0 0 30 30" >
    <
...
export default FastForward10Seconds;



// WEBPACK FOOTER //
// ./src/plugins/audio-controls/componentV2/fast-forward-10-seconds/index.js
...
const PublisherEventToAnalyticsEvent = {
    ...
    [Event.ACTION_SUBSCRIPTIONS_LANDING_PAGE]: AnalyticsEvent.ACTION_SUBSCRIPTIONS_LANDING_PAGE,
    [Event.ACTION_OFFER_SELECTED]: AnalyticsEvent.ACTION_OFFER_SELECTED,
    [Event.ACTION_PAYMENT_FLOW_STARTED]: AnalyticsEvent.ACTION_PAYMENT_FLOW_STARTED,
...
const AnalyticsEventToPublisherEvent = {
    ...
    [AnalyticsEvent.ACTION_PAYMENT_FLOW_STARTED]: Event.ACTION_PAYMENT_FLOW_STARTED,

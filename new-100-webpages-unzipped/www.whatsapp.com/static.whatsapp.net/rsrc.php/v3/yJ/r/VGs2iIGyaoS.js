...
(function(a) {
    ...
    function p(a) {
        ...
        while (a.length) {
            ...
            if (!f || P(f)) continue;
            if (f.dependencies)
                for (c = 0; c < f.dependencies.length; c++) g = f.dependencies[c], P(g) || a.push(g.id)
        }
        for (e in b) n.call(b, e) && a.push(e);
        b = [];
        for (c = 0; c < a.length; c++) {
            ...
            else if (P(f)) h += " is ready";
            else {
                e = [];
                for (var i = 0; i < f.dependencies.length; i++) g = f.dependencies[i], (!d[g] || !P(d[g])) && e.push(g.id);
    ...
    var r = (a.Env || {}).profile_require_factories,
        s = a.performance || a.msPerformance || a.webkitPerformance || {},
        t;
    ...
    function z(c) {
        var f = a.ErrorGuard;
        if (f && !f.inGuard()) return f.applyWithGuard(z, null, [c]);
        f = d[c];
        if (!f) {
        ...
        var h, i;
        if (f.hasError) throw new q('Requiring module "' + c + '" which threw an exception: ' + f.error.message);
        if (!P(f)) throw new q('Requiring module "' + c + '" with unresolved dependencies: ' + p([c]));
        g = f.exports = {};
        var k = f.factory;
        if (o.call(k) === "[object Function]") {
            ...
            try {
                ...
                var w = [],
                    B = s;
                f.special & l && (w = b.slice(0), w[b.length - 2] = f, w[b.length - 1] = g, B += w.length);
                if (f.special & j) {
                    g = y(f);
                ...
                var D, E, F;
                r && (F = t(), D = a.ProfilingCounters, D && (D.incrementCounter("FACTORY_COUNT", 1), E = D.startTiming("FACTORY_EXEC_TIME")));
                try {
                    ...
                    if (r) {
                        ...
                        s.factoryStart = F;
                        if (k.__SMmeta)
                            for (var H in k.__SMmeta) Object.prototype.hasOwnProperty.call(k.__SMmeta, H) && (s[H] = k.__SMmeta[H])
                    }
                }
            } catch (a) {
                f.hasError = !0;
    ...
    function A(b, c) {
        ...
        if (d) {
            ...
            e.message.indexOf(' from module "%s"') < 0 && (e.message += ' from module "%s"', e.params = e.params || [], e.params.push(c), b.message = d.stringify(e))
        }
        throw b
    }
    ...
    function G(b, d, f, g, h, i, j) {
        d === void 0 ? (d = [], f = b, b = L()) : f === void 0 && (f = d, o.call(b) === "[object Array]" ? (d = b, b = L(d.join(","))) : d = []);
        var k = {
        ...
        if (c.length > 0) {
            ...
            j(function() {
                while (m.length > 0) x.call(null, m.pop().id)
            })()
        }
        return k
    }
    ...
    function M(a, b, c) {
        ...
        if (c.dependencies != null)
            for (var d = c.depPosition; d < c.dependencies.length; d++) {
                ...
                e.tarjanGeneration != g ? (M(a, b, e), c.tarjanLow = Math.min(c.tarjanLow, e.tarjanLow)) : e.tarjanOnStack && (c.tarjanLow = Math.min(c.tarjanLow, e.tarjanIndex))
            }
    ...
    function N(a) {
        g++, M(a.dependencies, [], a), a.depPosition++, S(a)
    }
    ...
    if (a.__rl_stub) {
        for (var V = 0; V < a.__rl_stub.length; V++) K.apply(null, a.__rl_stub[V]);
        delete a.__rl_stub
    }
    B = function() {};
    a.$RefreshReg$ = B;
...
__d("ErrorNormalizeUtils", ["ErrorSerializer", "FBLoggerMetadata"], (function(a, b, c, d, e, f) {
    ...
    function c(c, d) {
        ...
        } : (typeof e !== "string" && (v = e, e = String(e) + " (" + typeof e + ")"), u = b("ErrorSerializer").parse(e));
        u = {
            _originalError: c,
    ...
    var g = typeof window === "undefined" ? "<self.onerror>" : "<window.onerror>",
        ...
        n = {
            ...
            reportNormalizedError: function(a) {
                ...
                l.length > 0 && (a.guard = a.guard || l[0], a.guardList = l.slice());
                a.reactComponentStack && n.popGuard();
                j.length > k && j.splice(k / 2, 1);
                j.push(a);
                m = !0;
                for (var b = 0; b < i.length; b++) try {
                    var c;
...
__d("ErrorGuard", ["Env", "ErrorNormalizeUtils", "ErrorPubSub"], (function(a, b, c, d, e, f) {
    ...
    var g, h, i = "<anonymous guard>",
        j = "<generated guard>",
        k = /\bnocatch\b/.test(location.search);
...
__d("BlueCompatRouter", ["BlueCompatBroker", "Env", "MessengerEnvironment", "URI", "isCdnURI"], (function(a, b, c, d, e, f) {
    ...
    var i = {
            convertUri: function(a) {
                ...
                } else if (a.getDomain().endsWith("messenger.com")) return a.setDomain(a.getDomain().replace(/messenger\.com/i, "facebook.com")).setPath("/messages" + a.getPath());
                else return a
            },
            go: function(a) {
                __p && __p();
                if ((h || (h = b("Env"))).isCQuick) {
                    ...
                    if (b("isCdnURI")(a)) return !1;
                    a = function() {
                        if (b("MessengerEnvironment").messengerui && d.getPath().startsWith("/messages")) return [!1, "/messages"];
                        if (c.getPath().startsWith("/settings") && d.getPath().startsWith("/settings")) return [!1, "/settings"];
                        if (c.getPath().startsWith("/games") && d.getPath().startsWith("/games")) return [!1, "/games/web"];
                        if (/\/[A-Za-z\-0-9]+\/settings/.test(c.getPath())) return [!1, "/pages/settings"];
...
__d("URIBase", ["invariant", "URIRFC3986", "URISchemes", "ex", "setHostSubdomain"], (function(a, b, c, d, e, f, g) {
    ...
    var m = [],
        n = function() {
            ...
            function a(a, b) {
                b || g(0, 2966), this.$9 = b, this.$7 = "", this.$1 = "", this.$6 = "", this.$5 = "", this.$3 = "", this.$4 = !1, this.$8 = {}, this.$2 = !1, l(this, a, !0, b)
            }
            var c = a.prototype;
            ...
            c.toString = function() {
                var a = this;
                for (var b = 0; b < m.length; b++) a = m[b](a);
                return a.$10()
            };
            c.$10 = function() {
                __p && __p();
    ...
    var m = function(d) {
        ...
        c.goURIOnWindow = function(d, e, f, g) {
            ...
            b("ifRequired")("PageNavigationStageLogger", function(b) {
                h ? b.setNote("force") : a.PageTransitions || b.setNote("no_pagetrans"), b.setCookieForNavigation(j)
            });
...
__d("CSSLoader", ["CSSLoaderConfig", "ResourceTimingsStore", "TimeSlice", "clearInterval", "ifRequired", "isEmpty", "setIntervalAcrossTransitions"], (function(a, b, c, d, e, f) {
    ...
    function q(a, c, d, e) {
        ...
        if (!c) var j = b("setIntervalAcrossTransitions")(function() {
            p() && b("clearInterval")(j)
        }, h)
    }
...
__d("Bootloader", ["invariant", "requireCond", "Arbiter", "BootloaderConfig", "BootloaderEndpoint", "CallbackDependencyManager", "CSRBitMap", "CSSLoader", "ErrorPubSub", "FBLogger", "cr:696703", "NetworkStatus", "ResourceTimingsStore", "TAAL", "TimeSlice", "createTrustedScriptURLFromFacebookURI", "ex", "ifRequired", "performanceAbsoluteNow", "setImmediateAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    ...
    var h, i, j = function() {},
        ...
        ba = b("BootloaderConfig").jsRetryAbortTime,
        J = H.length > 0,
        K = Object.freeze({
    ...
    function L(a) {
        return b("BootloaderConfig").retryQueuedBootloads ? a.every(function(a) {
            return o[a]
        }) : C
    }

    function M(a) {
        if (!o[a]) throw new Error(b("TAAL").blameToPreviousFile(b("ex")("Bootloader: %s is not in the component map", a)));
        return o[a]
    }
    ...
    function O() {
        ...
        if (a < I) return !0;
        a = x[a - 1] - x[a - I];
        a < ba && (b("FBLogger")("bootloader").warn("JS retry abort"), J = !1);
        return J
    }
    ...
    function S(a, c, d) {
        ...
        a.onload = g.bind(void 0, function() {
            w[e] && b("FBLogger")("bootloader").info("JS retry success [%s] at %s | time: %s | retries: %s", c, e, (i || (i = b("performanceAbsoluteNow")))() - f, w[e]), b("ResourceTimingsStore").measureResponseReceived("js", h), d()
        });
        ...
        a.onerror = g.bind(void 0, function() {
            b("ResourceTimingsStore").measureResponseReceived("js", h), w[e] || (w[e] = 0), O() && w[e] < H.length ? (x.push((i || (i = b("performanceAbsoluteNow")))()), setTimeout(function() {
                if (!O()) return;
                var b = a.parentNode;
                b.removeChild(a);
                Q(e, c, d, b)
            }, H[w[e]]), w[e]++) : (v[e] = !0, b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, e, (i || (i = b("performanceAbsoluteNow")))() - f, w[e], Object.keys(t).length), b("NetworkStatus").reportError(), d())
        })
    }

    function T(a, c, d) {
        return function() {
            b("FBLogger")("bootloader").warn("CSS timeout [%s] at %s | concurrency: %s", a, c, Object.keys(t).length), v[c] = !0, b("NetworkStatus").reportError(), d()
        }
    }
    ...
    function W(c, d, e, f) {
        ...
        c.forEach(function(a) {
            ...
            for (var c = 0; c < a.length; c++) {
                ...
                m[f] || (m[f] = !0, g[f] = d, k && k.measureResources({
                    name: f,
                    type: d.type
                }, e))
            }
        ...
        c = d;
        if (f) {
            var l = (i || (i = b("performanceAbsoluteNow")))(),
                n = b("ifRequired")("CometInteractionTracingMetrics", function(a) {
                    return a
                }),
                o;
            n && (o = n.currentInteractionLogger());
            c = function() {
                __p && __p();
                var a = Math.round((i || (i = b("performanceAbsoluteNow")))() - l),
                ...
                c = babelHelpers["extends"]({}, f, e, {
                    timeslice_context: c && c.name,
                    start_time: l,
                    duration: a
                });
                if (o && f != null && f.components != null) {
                    var k = f.components;
                    o.addBootload(k, l, a, e.all_resources_downloaded)
                }
        ...
        if (b("cr:696703") && c) {
            var p = b("cr:696703").getCallbackScheduler(),
                q = c;
            c = function() {
                p(q)
            }
        ...
        c && D.registerCallback(c, Object.keys(h));
        ...
        Object.entries(g).forEach(function(a) {
            ...
            var c = a.type;
            a = a.src;
            c === "async" ? U(a, b) : (P(a, c, b, s), V(c, a, b, s))
        });
        N().appendChild(s)
    }
    ...
    function ca(a, c) {
        ...
        if (d) {
            ...
            for (var c = d.substr(1).split(","), d = Array.isArray(c), e = 0, c = d ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                ...
                f = f;
                s[f] || (s[f] = a, b("CSRBitMap").add(parseInt(f, 10)))
            }
        }
    }
    ...
    function X(a) {
        ...
        for (var c = c.src.substr(1).split(","), d = Array.isArray(c), e = 0, c = d ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            ...
            f = f;
            f = s[f];
            f in r ? (r[f].type !== "csr" || g(0, 19126, f), a[f] = r[f]) : b("FBLogger")("bootloader").mustfix("CSR references unknown resource %s.", f)
        }
    ...
    function Y(a) {
        ...
        c || window._btldr && window._btldr[d] ? g() : (m[d] = !0, e ? S(a, d, g) : b("CSSLoader").setupEventListeners(d, f.src, N(), g, T(d, f.src, g), a))
    }
    ...
    function ea(a, b) {
        ...
        for (var a = X(a), c = Array.isArray(a), d = 0, a = c ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
            ...
            e = e[1];
            if (m[f]) continue;
            e.type === "async" ? (m[f] = !0, U(e.src, f)) : P(e.src, e.type, f, b)
        }
    }
    var $ = {
        ...
        loadModules: function(a, c, e) {
            ...
            h = !1;
            var s = 0,
                t = (i || (i = b("performanceAbsoluteNow")))();
            a.forEach(function(a) {
                var c, d = M(a);
                d.be && (s++, a in p ? k.push(p[a]) : b("ifRequired").call(null, a, null, function() {
                    r.push(a)
                }));
                a in y || (h = !0, y[a] = t);
                k.push.apply(k, d.r);
            ...
            W(n, function() {
                D.registerCallback(d.bind(null, q, j), [A])
            });
            return g
        },
        ...
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            c != null && (u[c] = (i || (i = b("performanceAbsoluteNow")))() - t[c], delete t[c]), window.CavalryLogger && window.CavalryLogger.done_js(a), a.forEach(function(a) {
                a != null && (m[a] = !0, D.satisfyPersistentDependency(a))
            })
        },
        ...
        loadPredictedResourceMap: function(a, b) {
            $.setResourceMap(a), W(Object.keys(a), b)
        },
        getLoadingUrls: function() {
            var a = {},
                c = (i || (i = b("performanceAbsoluteNow")))();
            for (var d in t) a[d] = c - t[d];
            return a
        },
        getCSSResources: function(a) {
            ...
            for (var a = a, c = Array.isArray(a), d = 0, a = c ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                ...
                e = e;
                for (var e = X(e), f = Array.isArray(e), g = 0, e = f ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                    var h;
                    if (f) {
                        if (g >= e.length) break;
                        h = e[g++]
...
__d("$-core", ["ErrorSerializer", "TAALOpcodes"], (function(a, b, c, d, e, f) {
    ...
    function g(a, c) {
        if (!c) throw new Error(b("ErrorSerializer").stringify({
...
__d("replaceTransportMarkers", ["BanzaiLazyQueue", "ErrorGuard", "ge", "memoize"], (function(a, b, c, d, e, f) {
    ...
    function i(a, c, e) {
        ...
        if (Array.isArray(f))
        ...
        else if (f.__rc) f.__rc[0] === null ? c[e] = null : c[e] = b.call(null, f.__rc[0]), f.__rc[1] && (h.has(f.__rc[1]) || (h.add(f.__rc[1]), b("BanzaiLazyQueue").queuePost("require_cond_exposure_logging", {
            identifier: f.__rc[1]
        })));
            ...
            d.call(null, [f.__deferredElement], function(a) {
                l = a, k.length && (k.forEach((g || (g = b("ErrorGuard"))).guard(function(b) {
                    b(a)
                }, "JS::deferredElement callback: '" + f.__deferredElement + "'")), k.length = 0)
            });
            j = {
                then: function(a) {
                    l ? a(l) : k.push(a)
...
__d("ServerJS", ["ContextualComponent", "ErrorGuard", "ServerJSDefine", "ex", "ge", "replaceTransportMarkers", "__debug"], (function(a, b, c, d, e, f) {
    ...
    a = function() {
        ...
        c.$5 = function(a, b, c) {
            __p && __p();
            this.$3 = b;
            if (a.__guard != null) throw new Error("ServerJS.handle called on data that has already been handled");
            a.__guard = !0;
        ...
        c.$12 = function(a, c, d, e) {
            ...
            var o = this.$3 && this.$3.bigPipeContext,
                p = (g || (g = b("ErrorGuard"))).guard(function(a) {
                    ...
                    if (m != null) {
                        if (!a[m]) throw k(new TypeError(b("ex")('Module %s has no method "%s"', f, m)), l);
                        a[m].apply(a, e || []);
...
__d("getAsyncParams", ["CSRBitMap", "CurrentCommunity", "CurrentUserInitialData", "DTSG", "DTSG_ASYNC", "DTSGUtils", "Env", "ISB", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebSession", "asyncParams", "isSocialPlugin"], (function(a, b, c, d, e, f) {
    ...
    function a(a) {
        ...
        var c, d = babelHelpers["extends"]({}, b("asyncParams").get(), (c = {
            ...
            __req: (i++).toString(36)
        }, c[b("StaticSiteData").be_key] = b("SiteData").be_mode, c[b("StaticSiteData").pkg_cohort_key] = b("SiteData").pkg_cohort, c[b("StaticSiteData").dpr_key] = b("SiteData").pr, c.__rev = b("SiteData").client_revision, c.__s = b("WebSession").getId(), c[b("StaticSiteData").haste_session_id_key] = b("SiteData").hsi, c));
...
__d("Heartbeat", ["Env", "ExecutionContextObservers", "FBLogger", "LogBuffer", "OnDemandExecutionContextObserver", "TimeSlice", "performanceAbsoluteNow"], (function(a, b, c, d, e, f) {
        ...
        e.$HeartbeatObserver12 = function(a) {
            ...
            while (this.$HeartbeatObserver8.length > 0) {
                var c = this.$HeartbeatObserver8[0],
                    d = c[0];
                c = c[1];
                if (a - d > j.MAX_SINGLE_INTEREST_TIME_MS) c(), this.$HeartbeatObserver8.shift();
                else break
            }
            d = this.$HeartbeatObserver10;
            a - d > j.MAX_ENABLE_TO_DISABLE_TIME_MS && this.$HeartbeatObserver16()
        };
    ...
    var i = new c();
    b("TimeSlice").registerExecutionContextObserver(i);
    var j = {
...
__d("ProfilingCounters", ["ErrorPubSub", "ExecutionContextObservers", "OnDemandExecutionContextObserver", "ProfilingCountersStore", "TimeSlice", "performanceAbsoluteNow"], (function(a, b, c, d, e, f) {
    ...
    var j = {
        ...
        m = function(c) {
            ...
            d.onNewContextCreatedWhileEnabled = function(a, b, c) {
                return n.currentContext().getPropagatedContextForChild(!!(c && c.isContinuation))
            };
                ...
                if (a.executionNumber > 0 && b) {
                    ...
                    for (var g = 0; g < f.length; g++) {
                        var h = f[g],
                            i = h[0];
                        h = h[1];
                        var k = h.propagationType;
                        k !== "ONLY_ON_CONTINUATIONS_AND_FIRST_EXEC" && (e = e || {}, e[i] = h)
                    }
                } else e = b;
                k = n.currentContext().getExecutionContext(!!(c && c.isContinuation), e);
                i = new n(!1, k, a.contextID);
                d != null && i.addAttribution(d, j.ALL);
                n.nestContext(i);
                return null
            };
        ...
        n = function() {
                ...
                if (this.newAttributions == null)
                    if (this.propagatedAttributions == null || b) return this.propagatedAttributions;
                        ...
                        for (var e = 0; e < c.length; e++) {
                            ...
                            f[0];
                            f = f[1];
                            if (f.propagationType === j.ONLY_ON_CONTINUATIONS_AND_FIRST_EXEC) {
                                d = !1;
                                break
                            }
                        }
            ...
            b.getActiveCounters = function() {
                this.active == null && (this.active = new o());
                return this.active
            };
            b.$7 = function() {
            ...
            a.unnestContext = function() {
                if (l.length === 1) throw new Error("popping off the global context");
                var b = l.pop();
            ...
            b.$3 = function(a, b) {
                b === void 0 && (b = !0);
                if (this.$7()) return;
                else b && this.processedNestedContexts != null && this.processedNestedContexts.length >= k || (this.processedNestedContexts = this.processedNestedContexts || [], this.processedNestedContexts.push(a))
            };
    ...
    var o = function() {
        ...
        c.stopTiming = function(a) {
            ...
            var c = (g || (g = b("performanceAbsoluteNow")))(),
                ...
                e = this.$1;
            if (d == null || e == null) {
                (i || (i = b("ErrorPubSub"))).reportError(new Error("token does not match the counter context"));
                return 0
            }
            var f = d[a];
            delete d[a];
            ...
            while (e.length - 1 > f) {
                ...
                h += j.value;
                delete d[j.id];
                a == null && j.lastStartTime != null && (a = j.lastStartTime)
            }
            j = e.pop();
            j.value += c - (a || j.lastStartTime);
            j.value += h;
            f = this.$4 || {};
            f[j.counter] = f[j.counter] || 0;
            f[j.counter] += j.value;
    ...
    o.$5 = 1;
    l.push(new n(!0, null, 0));
    b("TimeSlice").registerExecutionContextObserver(n.getObserver());
    var p = n.getObserver().expressInterest();
    a.ProfilingCounters = n;
    e.exports = n
}), 3);
__d("ArtilleryRequestDataCollector", ["ArtilleryUserTimingProfiler", "Env", "FBLogger", "Heartbeat", "ProfilingCounters", "ProfilingCountersStore", "TimeSlice", "requireWeak"], (function(a, b, c, d, e, f) {
    ...
    a = function() {
        ...
        c.disable = function() {
            var a = this.$5;
            a != null && i != null && (i.stopRecording(a), this.$5 = null);
            this.$8()
        };
        c.$8 = function() {
            __p && __p();
...
__d("DataStore", ["DataStoreConfig", "gkx", "isEmpty"], (function(a, b, c, d, e, f) {
    ...
    function m(a) {
        ...
        else return "elem_" + (a.__FB_TOKEN || (a.__FB_TOKEN = [l++]))[0]
    }
...
__d("ErrorUtils", ["ErrorNormalizeUtils", "ErrorPubSub", "ErrorGuard"], (function(a, b, c, d, e, f) {
    ...
    var g, h, i = {
        ...
        addListener: function(a, c) {
            c === void 0 && (c = !1), (g || (g = b("ErrorPubSub"))).addListener(a, c)
        },
        removeListener: function(a) {
...
__d("BigPipe", ["ix", "requireDeferred", "Arbiter", "BigPipeExperiments", "BigPipeInstance", "BigPipePlugins", "Bootloader", "Env", "ErrorUtils", "FBLogger", "JSCC", "PageEvents", "PageletEventConstsJS", "PageletSet", "RunBlue", "ServerJS", "TimeSlice", "UserTimingUtils", "$", "bx", "captureUsageSnapshot", "clearTimeout", "fastDeepCopy", "ge", "gkx", "performanceAbsoluteNow", "qex", "requestAnimationFrame", "requestAnimationFrameAcrossTransitions", "setTimeout", "__getTotalFactories", "__getCompileTime", "__getFactoryTime"], (function(a, b, c, d, e, f, g) {
    __p && __p();
    var h, i, j = document.documentMode || +(/MSIE.(\d+)/.exec(navigator.userAgent) || [])[1],
        k = console.timeStamp && window.location.search.indexOf("pagelet_ts=1") > 0;
    ...
    a = function() {
        ...
        c._displayPagelet = function(a) {
            ...
            for (var f in a.content) {
                ...
                if (g) {
                    if (a.append) r(h, g, d);
                    else if (g.nodeType) h.innerHTML = "", r(h, g, d);
                    else {
                        j = p(g);
                        h.innerHTML = j;
                        e[f] = j;
            ...
            if (a.static_templates) {
                ...
                g && (j = p(a.static_templates), a.replace_static_templates_if_exists && (j = s(g, j, d)), r(g, j, d))
            }
        ...
        c._nextPhase = function() {
            this.config.flush_pagelets_asap ? j <= 8 ? b("setTimeout")(this._tryRenderingNextPhase.bind(this), 20) : this._tryRenderingNextPhase() : (this._currentPhase++, j <= 8 ? b("setTimeout")(this._beginPhase.bind(this, this._currentPhase), 20) : this._beginPhase(this._currentPhase))
        };
        ...
        c._downloadJsForPagelet = function(a) {
            ...
            this._informPageletEvent(b("PageletEventConstsJS").JS_START, a), b("Bootloader").loadResources(a.allResources || [], function() {
                ...
                var d = function() {
                        c._informPageletEvent(b("PageletEventConstsJS").ONLOAD_START, a), c._isRelevantPagelet(a) && n(a.onload), c._informPageletEvent(b("PageletEventConstsJS").ONLOAD_END, a), c.arbiter.inform("pagelet_onload", !0), a.provides && c.arbiter.inform(a.provides, !0, "state")
                    },
                    e = function() {
        ...
        c._informEventExternal = function(a, c, d) {
            c = c || {}, d = d || this.arbiter, c.ts = (i || (i = b("performanceAbsoluteNow")))(), k && (console.timeStamp && console.timeStamp(a + " " + (Object.prototype.hasOwnProperty.call(c, "arbiter") ? JSON.stringify(babelHelpers["extends"]({}, c, {
                arbiter: null
    ...
    Object.assign(a.prototype, {
        ...
        setPageID: function(a) {
            ...
            }), this._awaitingLIDEventQueue = [], this.lid && l("display_done", this.lid)
        },
...
__d("TimeSliceExecutionLogger", ["ExecutionContextObservers", "IntervalTrackingBoundedBuffer", "OnDemandExecutionContextObserver", "TimeSlice", "TimingAnnotations", "performanceAbsoluteNow"], (function(a, b, c, d, e, f) {
    ...
    a = function(a) {
        ...
        function c() {
            var c, d;
            for (var e = arguments.length, f = new Array(e), g = 0; g < e; g++) f[g] = arguments[g];
            return (c = d = a.call.apply(a, [this].concat(f)) || this, d.$TimeSliceExecutionLogger1 = new(b("IntervalTrackingBoundedBuffer"))(h), c) || babelHelpers.assertThisInitialized(d)
        }
        var d = c.prototype;
...
__d("TimeSliceInteraction", ["invariant", "Arbiter", "ArtilleryComponentSaverOptionsStatic", "ArtilleryTraceIDUtils", "Bootloader", "CircularBuffer", "ErrorUtils", "FBLogger", "Heartbeat", "InteractionAsyncRequestJoinDataSource", "ProfilingCounters", "ProfilingCountersStore", "Random", "ResourceTimingsStore", "ResourceTypes", "TimeSlice", "TimeSliceExecutionDataSource", "TimeSliceInteractionBootloadForPost", "TimeSliceInteractionReliability", "TimeSliceInteractionSV", "TimingAnnotations", "TSIAdsReliabilityHook", "Visibility", "compactArray", "nullthrows", "performance", "performanceAbsoluteNow", "performanceNavigationStart", "requestIdleCallbackAcrossTransitions", "requireWeak"], (function(a, b, c, d, e, f, g) {
    ...
    var D = function() {
        ...
        d.countDown = function() {
            this.$23--, this.$23 === 0 ? this.$19 && this.$19() : this.$23 < 0 && b("FBLogger")("TimeSliceInteraction").warn("some hook counted down twice")
        };
        d.countUp = function() {
        ...
        d.inform = function(a, c) {
            ...
            if (!this.isEnabledForMode("full") && !(this.isEnabledForMode("lite") && d)) return t;
        ...
        d.informPointWithOverride = function(a, c) {
            ...
            if (!this.isEnabledForMode("full") && !(this.isEnabledForMode("lite") && e) || !this.$28) return t;
        ...
        d.finish = function(a) {
            ...
            if (this.$7) b("FBLogger")("TimeSliceInteraction").warn("Trace was already marked as ended");
                ...
                if (j || k) {
                    var v = function(a) {
                            j && c.$30(n), k && (u != null && c.recordWithExtraSaver("user_timing_saver", "data", u), c.$31(m, n, a, o, p, r, t)), s && s === c.$3 && (b("Arbiter").inform("time_slice_trace_posted", {
                                traceId: c.$3
                            }), s = null), c.$32()
                        },
                        w = v;
        ...
        d.disable = function(a) {
            ...
            q["delete"](this);
            this.$5 && this.$5();
            this.$8 !== void 0 && (l || g(0, 1439), l.stopRecording(this.$8));
            if (!a && this.$4)
        ...
        d.$30 = function(a) {
            ...
            b("Bootloader").loadModules(["Banzai", "BanzaiODS", "PerfXSharedFields"], function(a, d, f) {
                b("TimeSliceInteractionReliability").bumpLifecycleCounter("posting", c.$1, "lite"), a.post(w, f.addCommonValues(e), a.VITAL)
        ...
        d.$31 = function(a, c, d, e, f, g, i) {
            ...
            b("TimeSliceInteractionBootloadForPost")(function(c, o, p, q, r, s, t) {
                ...
                if ((j || (j = b("performance"))) && (j || (j = b("performance"))).timing && (j || (j = b("performance"))).timing.navigationStart) {
                    ...
                    u = q.data;
                    q = q.diagnostics;
                    q && (k.$15.addStringAnnotation("number_of_valid_entries", q.numValidEntries.toString()), k.$15.addStringAnnotation("number_of_success_metrics", q.numSuccessfulMetrics.toString()));
        ...
        d.$32 = function() {
            delete this.$11, this.$12 = [], this.$13 && (this.$13.forEach(function(a) {
                return a()
            }), this.$13 = []), this.$14 = [], delete this.$28, delete this.$19, delete this.$26
        };
    ...
    a = function(a) {
        ...
        function c(c, d) {
            ...
            if (e.isEnabled()) {
                ...
                if (d == null) e.disable(), (g || (g = b("ErrorUtils"))).reportError(new Error("starting autoclosed interaction outside of a timeslice."));
                else {
...
__d("BrowserEventBasedInteraction", ["Bootloader", "FBLogger", "PageDOMMutationObserver", "TimeSliceAutoclosedInteraction", "TimeSliceInteractionCancelHook", "TimeSliceInteractionEventHook", "TimeSliceInteractionLeaveHook", "TimeSliceInteractionPageStatsHook", "TimeSliceInteractionResourcesDataSource", "performanceAbsoluteNow"], (function(a, b, c, d, e, f) {
    ...
    a = function(a) {
        ...
        d.markManualStart = function(a, c) {
            ...
            this.$BrowserEventBasedInteraction4 || (this.$BrowserEventBasedInteraction4 = c || (g || (g = b("performanceAbsoluteNow")))(), this.$BrowserEventBasedInteraction3 = a, this.isEnabled() && (this.countUp(), this.registerOnBeforeFinish(function() {
        ...
        d.markManualEnd = function(a) {
            ...
            this.$BrowserEventBasedInteraction5 = a || (g || (g = b("performanceAbsoluteNow")))();
        ...
        __wrapEventListenHandler: function(a) {
            ...
            return b("EventConfig").disable_event_profiler ? a : function(c, d) {
                ...
                if (i[x] === void 0) {
                    ...
                    var F = !1;
                    m.has(c) && (!k && l < y && (k = !0, F = !0), h[x].is_first_in_frame = F, h[x].is_first_overlapping = F, p && p.eventListener(c, d.target));
                    if (n) {
                        r = n.trace();
...
__d("PageNavigationStageLogger", ["Arbiter", "Base64", "BigPipe", "Cookie", "Run", "ScriptPath", "URI", "emptyFunction", "setImmediateAcrossTransitions"], (function(a, b, c, d, e, f) {
    ...
    b("Run").onAfterLoad(function() {
        j = "onafterload", i && i.unsubscribe(), i = null
    });
    var k = !1,
        l = null,
        m = {
            init: function() {
                m.init = b("emptyFunction"), h = b("Arbiter").subscribe(b("BigPipe").Events.init, function(a, c) {
                    h && h.unsubscribe(), h = null, j = b("BigPipe").Events.init, i = c.arbiter.subscribe(Object.values(b("BigPipe").Events), function(a) {
                        j = a
                    })
                })
            },
            ...
            setCookieForNavigation: function(a, c) {
                ...
                if (!k) {
                    ...
                    l = (d = {}, d.a = j, d.c = b("ScriptPath").getScriptPath(), d.b = c ? c.getModifiers().any || c.which && c.which !== 1 : !1, d.d = a, d.e = [], d);
                    k = !0;
                    b("setImmediateAcrossTransitions")(function() {
                        l = null, k = !1
                    })
...
__d("Primer", ["invariant", "Bootloader", "CSS", "Env", "Event", "PageNavigationStageLogger", "Parent", "PhotoSnowliftLoader", "PrimerInlineHandlers", "ReactServerPrimer", "TimeSlice", "clickRefAction", "firstClickTimestamp", "ifRequired", "performanceNow", "trackReferrer"], (function(a, b, c, d, e, f, g) {
    ...
    c = function(a, c) {
        ...
        n();
        a === "mouseover" && (o(), d == null && m && (d = b("ReactServerPrimer").handleEvent("data-sr-onmouseover", c, m)))
    };
    d = function(a, b) {
...
__d("SyntaxErrorMonitor", ["Cookie", "ErrorUtils"], (function(a, b, c, d, e, f) {
    ...
    a = {
        init: function(a) {
            k = a, (g || (g = b("ErrorUtils"))).addListener(m)
        }
    };
    e.exports = a
}), null);
        ...
        guard: function(a, c, d) {
            ...
            q = function() {
                ...
                if (f != null) {
                    ...
                    f.isRoot ? (m.indirectParentID = f.contextID, m.isEdgeContinuation = q) : (m.indirectParentID = f.indirectParentID, m.isEdgeContinuation = !!(q && f.isEdgeContinuation))
                }
                var t = b("WorkerUtils").isWorkerContext();
                o = !0;
                try {
                    if (!m.isRoot || t) return a.apply(this, arguments);
                    else {
                        var u = "TimeSlice" + (c ? ": " + c : "");
                    ...
                    var v = C();
                    if (v == null) b("FBLogger")("TimeSlice").mustfix("timeslice stack misaligned, not logging the block"), o = !1;
                    else {
                        var y = v.isRoot,
                            z = v.contextID,

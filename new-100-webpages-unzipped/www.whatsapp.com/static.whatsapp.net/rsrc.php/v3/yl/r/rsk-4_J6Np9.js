...
__d("CavalryLoggerImpl", ["Arbiter", "Banzai", "Bootloader", "ImageTimingHelper", "ISB", "KillabyteProfilerConfig", "NavigationTimingHelper", "PageEvents", "PageletEventConstsJS", "PageletEventsHelper", "PerfXLogger", "ResourceTimingBootloaderHelper", "ScriptPath", "performance", "performanceAbsoluteNow", "__getTotalFactories", "__getCompileTime", "__getFactoryTime"], (function(a, b, c, d, e, f) {
    ...
    var g, h, i = b("KillabyteProfilerConfig").htmlProfilerModule,
        ...
        k = "cavalry",
        l = ["t_start", "t_paint", "t_cstart"],
        m = window.CavalryLogger;
    Object.assign(m.prototype, {
        initializeInstrumentation: function() {
            __p && __p();
            if (this.instrumentation_started) return;
            var c = this;
            b("Arbiter").subscribe("BigPipe/init", function(a, b) {
                b.lid == c.lid && b.arbiter && (c._recordTTIEvent(b.arbiter, "tti_bigpipe"), c._recordDisplayedEvent(b.arbiter, "all_pagelets_displayed"), c._recordLoadedEvent(b.arbiter, "all_pagelets_loaded"), c._recordPageletEventsTime(b.arbiter))
            });
            b("Arbiter").subscribe("MRenderingScheduler/init", function(a, b) {
                b.lid == c.lid && (c._recordTTIEvent(b.arbiter, "MRenderingScheduler/tti"), c._recordDisplayedEvent(b.arbiter, "MRenderingScheduler/dd"), c._recordLoadedEvent(b.arbiter, "MRenderingScheduler/e2e"), c._recordPageletEventsTime(b.arbiter))
            });
            b("Arbiter").subscribe(b("PageEvents").BIGPIPE_ONLOAD, function(d, e) {
                a.bigPipe && c.lid === a.bigPipe.lid && c.addPiggyback("cjs_factory_count_e2e", b("__getTotalFactories")()).addPiggyback("cjs_compile_time_e2e", b("__getCompileTime")()).addPiggyback("cjs_factory_time_e2e", b("__getFactoryTime")())
            });
            c.addPiggyback("script_path", b("ScriptPath").getScriptPath());
        ...
        _recordTTIEvent: function(a, b) {
            ...
            a.subscribe(b, function(a, b) {
                if (b.lid == c.lid) {
                    if (b.metrics)
                        for (var d in b.metrics) c.addPiggyback(d, b.metrics[d]);
        ...
        log: function() {
            ...
            b("Banzai").post(k, a, b("Banzai").VITAL);
            d = this.values;
            this.values = {};
            this.piggy_values = {};
            for (var c = 0; c < l.length; c++) this.values[l[c]] = d[l[c]];
        ...
        _getBootloadsUntil: function(a) {
            var c = this;
            return Object.entries(b("Bootloader").getBootloadedComponents()).filter(function(b) {
                b[0];
                b = b[1];
        ...
        collectBrowserTiming: function(a) {
            if ((h || (h = b("performance"))).timing) {
                ...
                this.log_resources && (this.addPiggyback("resource_timing_bootloader", b("ResourceTimingBootloaderHelper").getMetrics(0, !1).data), this._collectTTIAndE2EWithImages())
            }
        },
        collectTimingForAsync: function(a, c) {
            ...
            if ((h || (h = b("performance"))).timing && (h || (h = b("performance"))).getEntriesByName) {
                ...
                this.log_resources && (this.addPiggyback("resource_timing_bootloader", b("ResourceTimingBootloaderHelper").getMetrics(a[0].startTime, !1).data), this._collectTTIAndE2EWithImages())
            }
        },
    ...
    Object.assign(m, {
        ...
        hookLogOnLoad: function(a) {
            b("Arbiter").registerCallback(function() {
                m.setPageID(a), m.instances[a].log()
            }, [b("PageEvents").NATIVE_ONLOAD])
        },
        hookCollectAndLogOnLoad: function(a) {
            b("Arbiter").registerCallback(function() {
                m.getInstance(a).collectBrowserTiming(), m.getInstance(a).log()

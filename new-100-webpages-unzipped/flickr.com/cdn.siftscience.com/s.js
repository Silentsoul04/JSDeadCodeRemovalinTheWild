...
var Sift = Sift || function() {
    function u(b, l) {
        for (var k = q(b), g = b.length; 0 < k.length && k.length > l;) g = Math.floor(g / 2), k = q(b.substring(0, g));
        return k
    }
    ...
    function D(b) {
        ...
        for (g in b)
            if (b.hasOwnProperty(g)) {
                var i = b[g];
                void 0 === i || (null === i || "undefined" === i || "null" === i) || (0 < k && (l += "&"), l += g + "=" + i, k++)
            }
        return l
    }
    ...
    function s(b, l, k) {
        ...
        g ? b[l] = g : -0.25 <= PluginDetect.isMinVersion(k, 0) && (b[l] = "unk")
    }
    ...
    function L(b, l) {
        function k() {
            var i = (new Date).getTime(),
                h = !1;
            do
                if (g < b.length) window.SIFT_DEBUG && window.performance &&
                    window.performance.mark(b[g].toString().substring(0, 50)), b[g](), g += 1, window.SIFT_DEBUG && window.performance && b[g] && (window.performance.mark(b[g].toString().substring(0, 50)), window.performance.measure(b[g - 1].toString().substring(0, 50), b[g - 1].toString().substring(0, 50), b[g].toString().substring(0, 50)));
                else {
                    h = !0;
                    break
                }
    ...
    function M() {
        ...
        L([function() {
                ...
                a: {
                    ...
                    var m = g.indexOf(";", h); - 1 == m && (m = g.length);g = O(g.substring(h + i.length, m))
                }
                if (!g || 15 > g.length || "undefined" === g || "null" === g) {
                    i = g = void 0;
                    g = o && (o.crypto || o.msCrypto) || {};
                    if ("function" === typeof g.getRandomValues)
                        for (var i = "", h = ["8", "9", "a", "b"], m = new Uint8Array(1), a = 0; 36 > a; a += 1) {
                            var c = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".charAt(a);
                            "x" === c ? (g.getRandomValues(m), i += (m[0] % 16).toString(16)) :
                                "y" === c && (i += Math.floor(Math.random() * h.length))
                        } else
                            for (i = g = ""; 36 > g++; i += 51 * g & 52 ? (g ^ 15 ? 8 ^ Math.random() * (g ^ 20 ? 16 : 4) : 4).toString(16) : "-");
                    g = i;
                    h = g;
                    m = new Date;
                    ...
                    m = m.toGMTString();
                    a = void 0 === y ? J() : y;
                    document.cookie = i + "=" + h + (m ? ";expires=" + m : "") + ";path=/" + (a ? ";domain=." + a : "")
                }
                b.userUuid_ = g
            }, function() {
                var g;
            ...
            function() {
                w && (b.title_ = u(w.title, Q), b.characterSet_ = q(w.characterSet || w.charset))
            },
            function() {
                if (o) {
            ...
            function() {
                r && (b.screenHeight_ = r.height, b.screenWidth_ = r.width, b.colorDepth_ = r.colorDepth)
            },
            function() {
                n && (b.platform_ =
                    q(n.platform), b.language_ = q(n.language || n.browserLanguage), b.userAgent_ = u(n.userAgent, 200), b.cookieEnabled_ = n.cookieEnabled, b.doNotTrack_ = n.doNotTrack, b.maxTouchPoints_ = n.maxTouchPoints, b.online_ = n.onLine, b.product_ = q(n.product), b.productSub_ = q(n.productSub), b.vendor_ = q(n.vendor), b.vendorSub_ = q(n.vendorSub), b.hardwareConcurrency_ = n.hardwareConcurrency, b.javaEnabled_ = n.javaEnabled(), b.cpuClass_ = q(n.cpuClass))
            },
            function() {
                var g = new Date;
            ...
            function() {
                A ? b.sessionId_ = t.MD5(A.toString()) : b.userUuid_ && (b.sessionId_ = t.MD5(b.userUuid_))
            },
            function() {
                B && (b.partnerUserId_ = q(B))
            },
            function() {
                for (var g = n.mimeTypes, i = g ? g.length : 0, h = "", m = 0; m < i; m++) h += g[m].type;
                b.numMimeTypes_ = i;
                b.mimeTypesHash_ = t.MD5(h)
            },
            function() {
                for (var g = n.plugins, i = g ? g.length : 0, h = "", m = 0; m < i; m++) var a = g[m],
                    h = h + (a.name + a.description +
                        a.filename + a.length);
                b.numPlugins_ = i;
            ...
            function() {
                r && (b.tamperedResolution_ = r.width < r.availWidth || r.height < r.availHeight)
            },
            function() {
                if (n) {
                    var g = n.userAgent.toLowerCase(),
                        ...
                        g = 0 <= g.indexOf("windows phone") ? "Windows Phone" : 0 <= g.indexOf("win") ? "Windows" : 0 <= g.indexOf("android") ? "Android" : 0 <= g.indexOf("linux") ? "Linux" : 0 <= g.indexOf("iphone") || 0 <= g.indexOf("ipad") ? "iOS" : 0 <= g.indexOf("mac") ? "Mac" : "Other";
                    if (("ontouchstart" in
                            window || 0 < n.maxTouchPoints || 0 < n.msMaxTouchPoints) && "Windows Phone" !== g && "Android" !== g && "iOS" !== g && "Other" !== g) b.tamperedOS_ = !0;
                    else {
                        if ("undefined" !== typeof i) {
                            i = i.toLowerCase();
                            if (0 <= i.indexOf("win") && "Windows" !== g && "Windows Phone" !== g) {
                                b.tamperedOS_ = !0;
                                return
                            }
                            if (0 <= i.indexOf("linux") && "Linux" !== g && "Android" !== g) {
                                b.tamperedOS_ = !0;
                                return
                            }
                            ...
                            if ((-1 === i.indexOf("win") && -1 === i.indexOf("linux") && -1 === i.indexOf("mac")) !== ("Other" === g)) {
                                b.tamperedOS_ = !0;
                                return
                            }
                        }
                        b.tamperedOS_ = 0 <= h.indexOf("win") && "Windows" !== g && "Windows Phone" !== g ? !0 : (0 <= h.indexOf("linux") || 0 <= h.indexOf("android") || 0 <= h.indexOf("pike")) && "Linux" !== g && "Android" !== g ? !0 : (0 <= h.indexOf("mac") || 0 <= h.indexOf("ipad") || 0 <= h.indexOf("ipod") || 0 <= h.indexOf("iphone")) && "Mac" !== g && "iOS" !== g ? !0 : (-1 === h.indexOf("win") && -1 === h.indexOf("linux") && -1 === h.indexOf("mac")) !== ("Other" === g) ? !0 : "undefined" === typeof n.plugins && "Windows" !== g && "Windows Phone" !== g ? !0 : !1
                    }
                }
            },
            function() {
                var g = navigator.userAgent.toLowerCase(),
                    ...
                    g = 0 <= g.indexOf("firefox") ? "Firefox" : 0 <= g.indexOf("opera") || 0 <= g.indexOf("opr") ? "Opera" : 0 <= g.indexOf("chrome") ? "Chrome" : 0 <= g.indexOf("safari") ? "Safari" : 0 <= g.indexOf("trident") ? "Internet Explorer" : "Other";
                if (("Chrome" === g || "Safari" === g || "Opera" === g) && "20030107" !== i) b.tamperedBrowser_ = !0;
                else if (i = eval.toString().length, 37 === i && "Safari" !== g && "Firefox" !== g && "Other" !== g) b.tamperedBrowser_ = !0;
                else if (39 === i && "Internet Explorer" !== g && "Other" !== g) b.tamperedBrowser_ = !0;
                else if (33 ===
                    i && "Chrome" !== g && "Opera" !== g && "Other" !== g) b.tamperedBrowser_ = !0;
                else {
                    var h;
                    try {
                        throw "a";
                    ...
                    b.tamperedBrowser_ = h && "Firefox" !== g && "Other" !== g ? !0 : !1
                }
            },
            function() {
                ...
                var i = !1;
                try {
                    document.body.appendChild(g), i = 0 === document.getElementsByClassName("adsbox")[0].offsetHeight, document.body.removeChild(g)
                } catch (h) {
                    i = !1
                }
                b.adBlock_ = i
            ...
            function() {
                ...
                if (i.getContext &&
                    ...
                    h.rect(0, 0, 10, 10);
                    h.rect(2, 2, 6, 6);
                    g.push("canvas winding:" + (!1 === h.isPointInPath(5, 5, "evenodd") ? "yes" : "no"));
            ...
            function() {
                if (!k) {
                    ...
                    (i = D(l)) && (g += "&" + i);
                    g += "&z=z";
                    (i = w.getElementById("plugindetect")) && i.parentNode.removeChild(i);
                    K(g)
                }
            }
        ], S)
    ...
    function I() {
        var b, l, k;
        for (b = 0; b < arguments.length; b += 1) k = arguments[b], l = k.shift(), "string" === typeof l || l instanceof String ? x[l] && x[l].apply(x, k) : l.apply(x, k)
    }
    var t = {};
    (function() {
        var b = t = {},
            l = b.util = {
                ...
                endian: function(b) {
                    if (b.constructor ==
                        Number) return l.rotl(b, 8) & 16711935 | l.rotl(b, 24) & 4278255360;
                    for (var i = 0; i < b.length; i++) b[i] = l.endian(b[i]);
                    return b
                },
                randomBytes: function(b) {
                    for (var i = []; 0 < b; b--) i.push(Math.floor(256 * Math.random()));
                    return i
                },
                bytesToWords: function(b) {
                    for (var i = [], h = 0, m = 0; h < b.length; h++, m += 8) i[m >>> 5] |= (b[h] & 255) << 24 - m % 32;
                    return i
                },
                wordsToBytes: function(b) {
                    for (var i = [], h = 0; h < 32 * b.length; h += 8) i.push(b[h >>> 5] >>> 24 - h % 32 & 255);
                    return i
                },
                bytesToHex: function(b) {
                    for (var i = [], h = 0; h < b.length; h++) i.push((b[h] >>> 4).toString(16)),
                        i.push((b[h] & 15).toString(16));
                    return i.join("")
                },
                hexToBytes: function(b) {
                    for (var i = [], h = 0; h < b.length; h += 2) i.push(parseInt(b.substr(h, 2), 16));
                    return i
                },
                bytesToBase64: function(b) {
                    if ("function" == typeof btoa) return btoa(k.bytesToString(b));
                    for (var i = [], h = 0; h < b.length; h += 3)
                        for (var m = b[h] << 16 | b[h + 1] << 8 | b[h + 2], a = 0; 4 > a; a++) 8 * h + 6 * a <= 8 * b.length ? i.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(m >>> 6 * (3 - a) & 63)) : i.push("=");
                    return i.join("")
                },
                base64ToBytes: function(b) {
                    if ("function" ==
                        typeof atob) return k.stringToBytes(atob(b));
                    for (var b = b.replace(/[^A-Z0-9+\/]/ig, ""), i = [], h = 0, m = 0; h < b.length; m = ++h % 4) 0 != m && i.push(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(h - 1)) & Math.pow(2, -2 * m + 8) - 1) << 2 * m | "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(h)) >>> 6 - 2 * m);
                    return i
                }
            },
            b = b.charenc = {};
        ...
        var k = b.Binary = {
            stringToBytes: function(b) {
                for (var i = [], h = 0; h < b.length; h++) i.push(b.charCodeAt(h) & 255);
                return i
            },
            bytesToString: function(b) {
                for (var i = [], h = 0; h < b.length; h++) i.push(String.fromCharCode(b[h]));
                return i.join("")
            }
        }
    })();
    (function() {
        var b = t,
            ...
            h = b.MD5 = function(b, a) {
                ...
                return a && a.asBytes ? c : a && a.asString ? i.bytesToString(c) : l.bytesToHex(c)
            };
        h._md5 = function(b) {
            b.constructor == String && (b = g.stringToBytes(b));
            for (var a = l.bytesToWords(b),
                    c = 8 * b.length, b = 1732584193, d = -271733879, e = -1732584194, f = 271733878, j = 0; j < a.length; j++) a[j] = (a[j] << 8 | a[j] >>> 24) & 16711935 | (a[j] << 24 | a[j] >>> 8) & 4278255360;
            a[c >>> 5] |= 128 << c % 32;
            a[(c + 64 >>> 9 << 4) + 14] = c;
            for (var c = h._ff, i = h._gg, p = h._hh, k = h._ii, j = 0; j < a.length; j += 16) var T = b,
                n = d,
                o = e,
                q = f,
    ...
    (function() {
        var b = {
            ...
            addPlugin: function(a, c) {
                a && (b.isString(a) && c && b.isFunc(c.getVersion)) && (a = a.replace(/\s/g, "").toLowerCase(), b.Plugins[a] =
                    c, b.isDefined(c.getVersionDone) || (c.installed = null, c.version = null, c.version0 = null, c.getVersionDone = null, c.pluginName = a))
            },
            uniqueName: function() {
                return b.name + "998"
            },
            ...
            compareNums: function(a, c, d) {
                ...
                if (b.isStrNum(a) && b.isStrNum(c)) {
                    if (b.isDefined(d) &&
                        d.compareNums) return d.compareNums(a, c);
            ...
            pd: {
                ...
                findNavPlugin: function(a) {
                    ...
                    if (window.navigator) {
                        var d = {
                            ...
                            e, f, j, g = navigator.mimeTypes,
                            h = navigator.plugins;
                        if (a.mimes && g) {
                            j = b.isArray(a.mimes) ? [].concat(a.mimes) : b.isString(a.mimes) ? [a.mimes] : [];
                            for (e = 0; e < j.length; e++) {
                                f = 0;
                                try {
                                    b.isString(j[e]) &&
                                        /[^\s]/.test(j[e]) && (f = g[j[e]].enabledPlugin)
                                } catch (i) {}
                ...
                findNavPlugin_: function(a, b) {
                    var d = a.description || "",
                        e = a.name || "",
                        f = {};
                    if (b.Find.test(d) && (!b.Find2 || b.Find2.test(e)) && (!b.Num || b.Num.test(RegExp.leftContext + RegExp.rightContext)) || b.Find.test(e) && (!b.Find2 || b.Find2.test(d)) && (!b.Num || b.Num.test(RegExp.leftContext + RegExp.rightContext)))
                ...
                findPlugin: function(a) {
                    ...
                    if (1 == a.length) return this.getVersionDelimiter =
                        a, c;
            ...
            getPluginFileVersion: function(a, c, d, e) {
                ...
                for (e = 0; e < a.length; e++)
                    if (-1 < j && e > j && "0" != a[e] || d[e] != a[e] && (-1 == j && (j = e), "0" != a[e])) return c;
                return f
            },
            AXO: function() {
                var a;
            ...
            browser: {
                detectPlatform: function() {
                    var a, c = window.navigator ? navigator.platform || "" : "";
                    b.OS = 100;
                    if (c) {
                ...
                detectIE: function() {
                    var a = document,
                        c, d = window.navigator ? navigator.userAgent || "" : "",
                        e, f;
            ...
            ev: {
                ...
                call0: function(a) {
                    ...
                    if (0 < c && b.isFunc(a[0])) a[0](b,
                        1 < c ? a[1] : 0, 2 < c ? a[2] : 0, 3 < c ? a[3] : 0);
                    else b.isFunc(a) && a(b)
                },
                callArray0: function(a) {
                    var c;
                    if (b.isArray(a))
                        for (; a.length;) c = a[0], a.splice(0, 1), (!b.win || !(b.win.unload && a !== b.win.unloadHndlrs)) && this.call0(c)
                },
                call: function(a) {
                    this.call0(a);
                ...
                ifDetectDoneCallHndlrs: function() {
                    ...
                    if (this.allDoneHndlrs.length && (!b.win || b.win.loaded && !b.win.loadPrvtHndlrs.length && !b.win.loadPblcHndlrs.length)) {
                        if (b.Plugins)
                            for (a in b.Plugins)
                                if (b.hasOwn(b.Plugins,
                                        a) && (c = b.Plugins[a]) && b.isFunc(c.getVersion) && (3 == c.OTF || c.DoneHndlrs && c.DoneHndlrs.length || c.BIHndlrs && c.BIHndlrs.length)) return;
            ...
            isMinVersion: function(a, c, d, e) {
                ...
                null !== f.installed && (a = 0.5 >= f.installed ? f.installed : 0.7 == f.installed ? 1 : null ===
                    f.version ? 0 : 0 <= b.compareNums(f.version, c, f) ? 1 : -0.1);
                return a
            },
            ...
            onWindowLoaded: function(a) {
                b.win.loaded ? b.ev.call(a) :
                    b.ev.fPush(a, b.win.loadPblcHndlrs)
            },
            codebase: {
                isDisabled: function() {
                ...
                isMin: function(a, c, d) {
                    ...
                    if (!d || this.isActiveXObject(a, b.formatNum(a.DIGITMIN.join(",")))) {
                        ...
                        a.L.v && (d = this.convert(a, c, 1), 0 <= d.x && (e = (a.L.x ==
                            d.x ? this.isActiveXObject(a, d.v) : 0 >= b.compareNums(c, a.L.v)) ? 1 : -1))
                    }
                    return e
                },
                search: function(a, c) {
                    ...
                    if (!c || d.isActiveXObject(a, b.formatNum(a.DIGITMIN.join(",")))) {
                        var j, g = a.DIGITMAX,
                            ...
                            m = function(b, c) {
                                var f = [].concat(k);
                                f[b] = c;
                                (f = d.isActiveXObject(a, f.join(","))) ? (e = 1, k[b] = c) : l[b] = c;
                                return f
                            };
                        for (f = 0; f < l.length; f++) {
                            ...
                            h = k.join(",");
                            i = k.slice(0,
                                f).concat([99999999, 99999999, 99999999, 99999999]).slice(0, k.length).join(",");
                            for (j = 0; j < g.length; j++) b.isArray(g[j]) && (g[j].push(0), g[j][f] > l[f] && (0 <= b.compareNums(i, a.Lower[j]) && 0 > b.compareNums(h, a.Upper[j])) && (l[f] = Math.floor(g[j][f])));
                            for (j = 0; 30 > j; j++) {
                                if (16 >= l[f] - k[f]) {
                ...
                onUnload: function(a, b) {
                    ...
                    for (d = 0; d < e.length; d++)
                        if (f = e[d]) e[d] = 0, b.emptyNode(f.span()), f.span = 0, f.spanObj = 0;
                    b.iframe = 0
                },
                init: function(a) {
                    if (!this.iframe) {
                    ...
                    if (!a.init) {
                        ...
                        a.tagB = '" ' + (/clsid\s*:/i.test(c) ? 'classid="' :
                            'type="') + c + '">' + (a.ParamTags ? a.ParamTags : "") + b.openTag + "/object>";
                ...
                convert: function(a, c, d) {
                    ...
                    if (c)
                        for (e = 0; e < a.Lower.length; e++)
                            if ((j = this.convert_(a, e, a.Lower[e])) && 0 <= b.compareNums(c, d ? j : a.Lower[e]) && (!e || 0 > b.compareNums(c, d ? this.convert_(a, e, a.Upper[e]) : a.Upper[e]))) {
            ...
            win: {
                ...
                onLoad: function() {
                    var a = b.win;
                    !a.loaded && (!a.unload &&
                        !a.cancel) && (a.loaded = !0, b.ev.callArray(a.loadPrvtHndlrs), b.ev.callArray(a.loadPblcHndlrs))
                }
            },
            DOM: {
                isEnabled: {
                    ...
                    objectProperty: function(a) {
                        return a && a.tagName && b.browser.isIE ? /applet/i.test(a.tagName) ? !this.objectTag() || b.isDefined(b.pd.getPROP(document.createElement("object"), "object")) ? 1 : 0 : b.isDefined(b.pd.getPROP(document.createElement(a.tagName),
                            "object")) ? 1 : 0 : 0
                    }
                },
                HTML: [],
                ...
                onUnload: function(a, b) {
                    ...
                    if (e = d.length)
                        for (e -= 1; 0 <= e; e--)
                            if (f = d[e]) d[e] = 0, b.emptyNode(f.span()), b.removeNode(f.span()), f.span = 0, f.spanObj = 0, f.doc = 0, f.objectProperty = 0;
                    d = b.getDiv();
                    b.emptyNode(d);
                    b.removeNode(d);
                    b.div = 0
                ...
                objectProperty: function() {
                    var a;
                    this.DOM.isEnabled.objectProperty(this) && (a = b.pd.getPROP(this.obj(),
                        "object"));
                    return a
                },
                ...
                getTagStatus: function(a, c, d, e, f, j, g) {
                    ...
                    if (i) return 1.5;
                    var k = /clsid\s*\:/i,
                        l = d && k.test(d.outerHTML || "") ? d : e && k.test(e.outerHTML || "") ? e : 0,
                    ...
                    g && (!a.pi && b.isDefined(i) && b.browser.isIE && a.tagName == d.tagName && a.time <= d.time && f === e && 0 === h && 0 !== l) && (a.pi = 1);
                    return e < k || !a.loaded || !c.loaded || !d.loaded ? a.pi ? -0.1 : 0 : f != k && j && f == this.pluginSize && j && (!b.isNum(h) || 4 === h) ? 1 : a.pi ? -0.5 : -1
                },
                setStyle: function(a, b) {
                    var d = a.style,
                        e;
                    if (d && b)
                        for (e = 0; e < b.length; e += 2) try {
                            d[b[e]] = b[e + 1]
                        } catch (f) {}
                },
                getStyle: {
                    ...
                    span: function(a) {
                        var c = b.DOM;
                        return a ? this.plugin() : [].concat(this.Default).concat(["display", "inline", "fontSize",
                            c.pluginSize + 3 + "px", "lineHeight", c.pluginSize + 3 + "px"
                        ])
                    },
                    div: function() {
                        var a = b.DOM;
                    ...
                    plugin: function(a) {
                        var c = b.DOM;
                        return "background-color:transparent;background-image:none;vertical-align:baseline;outline-style:none;border-style:none;padding:0px;margin:0px;visibility:" + (a ?
                            "hidden;" : "visible;") + "display:inline;font-size:" + (c.pluginSize + 3) + "px;line-height:" + (c.pluginSize + 3) + "px;"
                    },
                ...
                iframe: {
                    ...
                    insert: function(a, c) {
                        ...
                        e[b.uniqueName()] = [];
                        d = b.ev.handlerOnce(b.isNum(a) && 0 < a ? b.ev.handlerWait(a, this.onLoad, e[b.uniqueName()], c) : b.ev.handler(this.onLoad, e[b.uniqueName()],
                            c));
                ...
                insert: function(a, c, d, e, f, j, g) {
                    ...
                    g && (/div/i.test(g.tagName) && (h = g.ownerDocument), /iframe/i.test(g.tagName) && (h = this.iframe.doc(g)));
                    if (!h || !h.createElement) h = document;
                    b.isDefined(e) || (e = "");
                    if (b.isString(a) && /[^\s]/.test(a)) {
                        for (var a = a.toLowerCase().replace(/\s/g, ""), f = b.openTag + a + " ", f = f + ('style="' + this.getStyle.plugin(j) + '" '), i = 1, k = 1, j = 0; j < c.length; j += 2) /[^\s]/.test(c[j + 1]) && (f += c[j] + '="' + c[j + 1] + '" '), /width/i.test(c[j]) &&
                            (i = 0), /height/i.test(c[j]) && (k = 0);
                        f += (i ? 'width="' + this.pluginSize + '" ' : "") + (k ? 'height="' + this.pluginSize + '" ' : "");
                        if ("embed" == a || "img" == a) f += " />";
                        else {
                            f += ">";
                            for (j = 0; j < d.length; j += 2) /[^\s]/.test(d[j + 1]) && (f += b.openTag + 'param name="' + d[j] + '" value="' + d[j + 1] + '" />');
                            f += e + b.openTag + "/" + a + ">"
                        }
                    } else a = "", f = e;
                    a = {
                    ...
                    if (g && g.parentNode)
                        if (/iframe/i.test(g.tagName)) this.iframe.addHandler(g, [this.onLoadHdlr, a]), a.loaded = 0, a.spanId = b.name + "Span" + this.HTML.length, h = '<span id="' + a.spanId + '" style="' + this.getStyle.span(1) + '">' + f + "</span>", a.time = (new Date).getTime(), g = this.iframe.write(g, h), 0 <= g && (a.insertDomDelay = g);
                        else if (/div/i.test(g.tagName)) {
                        h = h.createElement("span");
                        this.setStyle(h, this.getStyle.span());
                        g.appendChild(h);
                        try {
                            a.time = (new Date).getTime(), h.innerHTML = f, a.insertDomDelay = (new Date).getTime() -
                                a.time
                        } catch (l) {}
                        a.spanObj = h
                    }
            ...
            file: {
                ...
                getValid: function(a, b) {
                    return a && a[this.valid] ? this.get(a[this.valid], b) :
                        null
                },
                getAny: function(a, b) {
                ...
                query: function(a) {
                    ...
                    if (null === this.done) {
                        if (b.hasMimeType(this.mimeType)) {
                            d = this.detect(1);
                            d.installed && (c = this.detect(0), this.result = [c, c.installed ? c :
                                d
                            ]);
                            var e = this.result[0],
                                f = this.result[1];
                ...
                query: function() {
                    ...
                    for (c = 0; c < this.progID.length; c++)
                        if (a = b.getAXO(this.progID[c]))
                            if (this.installed = 1, (a = b.pd.getPROP(a, "QuickTimeVersion")) && a.toString)
                                if (a = a.toString(16), this.version = parseInt(a.charAt(0) || "0",
                                        16) + "." + parseInt(a.charAt(1) || "0", 16) + "." + parseInt(a.charAt(2) || "0", 16), !b.dbug) break;
                    return this
                }
            }
        };
        ...
        var k = {
            ...
            navPlugin: {
                ...
                query: function() {
                    ...
                    c && /(\d+[_,]\d+[_,]\d+[_,]\d+)[^\d]+$/.test(d.filename) &&
                ...
                query: function() {
                    ...
                    for (c = 0; 10 > c; c++)
                        if (d = b.getAXO(this.progID + (c ? "." + c : ""))) {
                            ...
                            if (a && (this.version = a, this.precision = k.getPrecision(a), !b.dbug)) break
                        }
                    return this
                }
            },
                    ...
                    if (c)
                        for (c = 0; c < this.progID.length; c++)
                            if (a = b.getAXO(this.progID[c])) {
                                ...
                                /(\d[\d\.\,]*)(?:\s*r\s*(\d+))?/i.test(e) && (a = RegExp.$2,
                                    d = b.formatNum(RegExp.$1), a && (d = d.split(b.splitNumRegx), d[3] = a, d = d.join(",")));
        ...
        var g = {
            ...
            getVersion: function(a, c) {
                ...
                if ((!d && !e || c || b.dbug) &&
                    this.FirefoxPlugin.query().version) d = 1, e = this.FirefoxPlugin.version;
                this.setPluginStatus(e, d)
            },
            ...
            plugins: ["Microsoft" + String.fromCharCode(174) +
                " Windows Media Player Firefox Plugin", "Windows Media Player Plug-in Dynamic Link Library"
            ],
            nav: {
                hasRun: 0,
                installed: 0,
            ...
            FirefoxPlugin: {
                ...
                isDisabled: function() {
                    var a = g,
                        c = b.browser;
                    return this.hasRun || c.isGecko && 0 > b.compareNums(c.verGecko, b.formatNum("1.8")) ||
                        c.isOpera && 0 > b.compareNums(c.verOpera, b.formatNum("10")) || b.DOM.isEnabled.objectTagUsingActiveX() || !b.hasMimeType(a.mimeType) || !b.pd.findNavPlugin({
                            find: a.find[0],
                            avoid: a.avoid,
                            mimes: a.mimeType,
                            plugins: a.plugins[0]
            ...
            axo: {
                ...
                query: function() {
                    ...
                    if (c)
                        for (c = 0; c < this.progID.length; c++)
                            if (a = b.getAXO(this.progID[c]))
                                if (this.installed = 1, (a = b.pd.getPROP(a, "versionInfo", 0)) && (a = b.getNum(a)), a && (this.version = a, !b.dbug)) break;
                    return this
                }
            }
        };
        ...
        b.addPlugin("silverlight", {
            getVersion: function() {
                ...
                if ((!c || b.dbug) && this.nav.query().installed) c = 1;
                if ((!a || b.dbug) &&
                    this.nav.query().version) a = this.nav.version;
                ...
                query: function() {
                    ...
                    if (c && this.IsVersionSupported(c, this.mindigit)) {
                        ...
                        for (a = 0; a < this.maxdigit.length; a++) {
                            for (e = 0; 1 < this.maxdigit[a] - this.mindigit[a] && 20 > e;) e++, f++, d[a] = Math.round((this.maxdigit[a] + this.mindigit[a]) /
                                2), this.IsVersionSupported(c, d) ? this.mindigit[a] = d[a] : this.maxdigit[a] = d[a];
                            d[a] = this.mindigit[a]
                        }
        ...
        var i = {
            ...
            getVersion: function(a, c) {
                ...
                if (!e || b.dbug)
                    if (f = this.codebase.search()) d = 1, e = f;
                if (!e && c || b.dbug)
            ...
            instance: {
                ...
                isDisabled: function() {
                    var a = 1;
                    this.hasRun || (b.dbug ? a = 0 : i.nav.installed && b.hasMimeType(this.mimeType) && (a = 0));
                    return a
                },
                query: function() {
                    var a = b.DOM.altHTML,
                    ...
                    this.hasRun = 1;
                    if (d) return this;
                    this.HTML = b.DOM.insert("object", ["type", this.mimeType], "autoplay no loop no volume 0".split(" "), a, i);
                    if (d = this.HTML.obj()) {
                        try {
                    ...
                    c &&
                        (this.version = c, this.installed = 1);
                    return this
                }
            },
            axo: {
                ...
                query: function() {
                    ...
                    if (a = b.getAXO(this.progID))
                        if (this.installed = 1, a = b.getNum(b.pd.getPROP(a, "VersionInfo"), "[\\d][\\d\\.]*[a-z]*")) this.version = a;
                    return this
                }
            },
            codebase: {
        ...
        var h = {
            ...
            setPluginStatus: function() {
                ...
                else if (b.browser.isIE && (!b.browser.ActiveXEnabled || b.browser.ActiveXFilteringEnabled)) c = -1.5;
                this.installed = c;
            ...
            nav: {
                ...
                attempt3: function() {
                    var a = null;
                    1 == b.OS && (b.hasMimeType("application/vnd.adobe.pdfxml") ?
                        a = "9" : b.hasMimeType("application/vnd.adobe.x-mars") ? a = "8" : b.hasMimeType("application/vnd.adobe.xfdf") && (a = "6"));
                    return a
                }
            },
            activexQuery: function(a) {
                ...
                if (c && b.isString(c) && (a = /\=\s*[\d\.]+/g, e = c.match(a))) {
                    for (a = 0; a < e.length; a++)
                        if ((d = b.formatNum(b.getNum(e[a]))) && (!f.version || 0 < b.compareNums(d, f.version))) f.version = d;
            ...
            axo: {
                ...
                precision: 0,
                progID: ["AcroPDF.PDF",
                    "AcroPDF.PDF.1", "PDF.PdfCtrl", "PDF.PdfCtrl.5", "PDF.PdfCtrl.1"
                ],
            ...
            doc: {
                ...
                query: function() {
                    ...
                    this.HTML =
                        b.DOM.insert("object", ["classid", this.classID], [], c, a, 1, d);
            ...
            doc2: {
                ...
                onMessage: function() {
                    ...
                    return function(c) {
                        if (!a.version && (a.detected = 1, b.isArray(c) && (c = c[0]), c = b.getNum(c + ""))) /^(\d+)[.,_]?$/.test(c) ? (c = RegExp.$1 + ",0,0,0", a.precision = 3) : /^(\d+)[.,_](\d)(\d\d)$/.test(c) || /^(\d+)[.,_](\d\d\d)(\d\d\d\d\d)$/.test(c) ? (c = RegExp.$1 + "," + RegExp.$2 + "," + RegExp.$3 + ",0", a.precision = 3) : /^(\d+)[.,_](\d\d\d)(\d\d\d\d\d)(\d+)$/.test(c) ? (c = RegExp.$1 + "," + RegExp.$2 + "," + RegExp.$3 + "," + RegExp.$4, a.precision = 4) : /^(\d+)[.,_](\d)(\d)$/.test(c) ? (c = RegExp.$1 + "," + RegExp.$2 + "," + RegExp.$3 + ",0", a.precision = 3) :
                            /^(\d+)[.,_](\d)$/.test(c) && (c = RegExp.$1 + "," + RegExp.$2 + ",0,0", a.precision = 3), a.version = b.formatNum(c), h.setPluginStatus()
                    }
                },
                ...
                queryObject: function() {
                    ...
                    if (a = a ? a.obj() : 0) {
                        ...
                        this.detected || (3 < this.count && !this.handlerSet ?
                            this.detected = -1 : this.time2 && (this.count - this.count2 >= this.maxCount && (new Date).getTime() - this.time2 >= this.intervalLength * this.maxCount) && (this.detected = -0.5))
                    }
                },
        ...
        var m = {
            ...
            navObj: {
                ...
                plugins: ["RealPlayer(tm) G2 LiveConnect-Enabled Plug-In (32-bit) ", "RealPlayer(tm) G2 LiveConnect-Enabled Plug-In (64-bit) ",
                    "RealPlayer Plugin"
                ],
                query: function() {
                    var a = m,
            ...
            JS: {
                ...
                isEnabled: function() {
                    return !this.hasRun && 1 ==
                        b.OS && b.hasMimeType(this.mimetype) ? 1 : 0
                },
                query: function() {
                    var a, c;
                    c = this.isEnabled();
            ...
            getVersion: function(a, c) {
                ...
                this.setPluginStatus(e,
                    d)
            }
        };
        b.addPlugin("realplayer", m)
    })();
    for (var R = (new Date).getTime(), w = document, n = navigator, r = screen, o = window, q = o.encodeURIComponent, O = o.decodeURIComponent, E = "hexagon-analytics.com", v, S = 0, G = "__ssid", A, B, z, F, y, P = 4, N = 105, Q = 100, H = function() {
            for (var b = 3, l = document.createElement("b"), k = l.all || []; l.innerHTML = "<\!--[if gt IE " + ++b + "]><i><![endif]--\>", k[0];);
        ...
        }, C = 0; C < _sift.length; C++) I(_sift[C]);
    _sift = {
        push: I
    }
}();

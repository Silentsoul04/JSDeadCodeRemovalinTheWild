(function(E) {
    ...
    var r = function(a, b) {
        ...
        ua = function(a, b) {
            for (var c = a.length, e = [], d = 0, f = "string" === typeof a ? a.split("") : a, g = 0; g < c; g++)
                if (g in f) {
                    var h = f[g];
        ...
        va = function(a, b) {
            for (var c = a.length, e = Array(c), d = "string" === typeof a ? a.split("") : a, f = 0; f < c; f++) f in d && (e[f] = b.call(void 0, d[f], f, a));
            return e
        },
        wa = function(a, b) {
            a: {
        ...
        xa = function(a, b) {
            a: {
                for (var c = "string" === typeof a ? a.split("") : a, e = a.length - 1; 0 <= e; e--)
    ...
    var Ca = function(a) {
            return a instanceof v && a.constructor === v && a.c === Ba ? a.b : "type_error:Const"
        },
        Ba = {},
        u = {},
        Da = new v(u, "");
    ...
    var Ga = function(a) {
            return a instanceof y && a.constructor === y && a.g === Fa ? a.c : "type_error:TrustedResourceUrl"
        },
        Ha = /^([^?#]*)(\?[^#]*)?(#[\s\S]*)?/,
        Fa = {},
        Ia = function(a, b, c) {
    ...
    var Wa = function(a) {
            return a instanceof z && a.constructor === z && a.g === Va ? a.c : "type_error:SafeUrl"
        },
    ...
    var cb = function(a) {
            return a instanceof B && a.constructor === B && a.i === bb ? a.c : "type_error:SafeHtml"
        },
        db = function(a) {
        ...
        hb = function(a) {
            var b = db(gb),
                ...
                e = [],
                d = function(f) {
                    m(f) ? r(f, d) : (f = db(f), e.push(cb(f).toString()), f = f.b(), 0 == c ? c = f : 0 != f && c != f && (c = null))
                };
            r(a, d);
    ...
    var G = function() {},
        ...
        H = function(a, b, c, e) {
            ...
            a: {
                if (b = a.h.length) {
                    --b;
                    var d = a.h[b];
                    if (!(null === d || "object" != typeof d || m(d) || lb && d instanceof Uint8Array)) {
                        a.g = b - a.c;
                        a.b = d;
                        break a
                    }
            ...
            a.i = {};
            if (c)
                for (b = 0; b < c.length; b++) d = c[b], d < a.g ? (d += a.c, a.h[d] = a.h[d] || mb) : (nb(a), a.b[d] = a.b[d] || mb);
            if (e && e.length)
                for (b = 0; b < e.length; b++) ob(a, e[b])
        },
        mb = [],
        nb = function(a) {
            var b = a.g + a.c;
        ...
        L = function(a, b, c) {
            a.a || (a.a = {});
            if (!a.a[c]) {
                for (var e = I(a, c), d = [], f = 0; f < e.length; f++) d[f] = new b(e[f]);
                a.a[c] = d
            }
            b = a.a[c];
            b == mb && (b = a.a[c] = []);
    ...
    var zb = function(a, b) {
            if (!wb() && !xb()) {
                var c = Math.random();
                if (c < b) return c = yb(k), a[Math.floor(c * a.length)]
            }
            return null
        },
        yb = function(a) {
        ...
        Ab = /^(-?[0-9.]{1,30})$/,
        Bb = function(a, b) {
            return Ab.test(a) && (a = Number(a), !isNaN(a)) ? a : void 0 == b ? null : b
        },
        Cb = function() {
            try {
                return ma()
    ...
    var Qb = function() {
        ...
        this[3] = (a[8] = function(b) {
            ...
            b = oa(b);
            var c;
            if (c = "function" == qa(b)) b = b && b.toString && b.toString(), c = "string" === typeof b && -1 != b.indexOf("[native code]");
            return c
        }, a[10] = function() {
    ...
    var Xb = function(a, b) {
        ...
        ac = function(a) {
            var b = N.f().a;
            if (b) {
                var c = xa(L(a, Vb, 5), function(e) {
                    return Pb(K(e, Kb, 1), b)
                });
                if (c) return K(c, Sb, 2)
            }
            return K(a, Sb, 4)
        },
        $b = function() {
    ...
    var O = function(a) {
        ...
        Bc = function(a) {
            ...
            P(zc, function(b) {
                for (var c = N.f(), e = ba([3, 4, 5]), d = e.next(); !d.done; d = e.next()) d = d.value, ta(c.a[d], b[d])
            }, a)
        },
        Cc = function(a) {
    ...
    var Nc = [12, 13],
        ...
        Sc = function(a, b) {
            var c = [],
                e = Pc(a.a, b);
            e.length && (9 !== b && (a.a = Qc(a.a, b)), r(e, function(d) {
                if (d = Rc(a, d)) {
                    var f = d.getId();
                    c.push(f);
                    a.g.push(f);
        ...
        Tc = function(a, b) {
            a.a.push.apply(a.a, ca(ua(va(b, function(c) {
                return new R(c)
            }), function(c) {
                return !ya(Nc, c.l())
            })))
        ...
        Rc = function(a, b) {
            ...
            if (f) {
                ...
                b = Uc(b, d);
                return !b || c && !Pb(K(b, Kb, 3), c) ? null : Vc(a, [b], 1)
            }
            e = c ? ua(e, function(g) {
                return Pb(K(g, Kb, 3), c)
            }) : e;
            return e.length ? (b = J(b, 4, 0)) ? Wc(a, b, d, e) : Vc(a, e, d / 1E3) : null
        },
        Wc = function(a, b, c, e) {
            var d = null != a.c[b] ? a.c[b] : 1E3;
            if (0 >= d) return null;
            e = Vc(a, e, c / d);
            a.c[b] = e ? 0 : d - c;
            return e
        ...
        Uc = function(a, b) {
            ...
            a = J(a, 8, 0);
            var f = (b - a) % e;
            return b < a || b - a - f >= e * (d - 1) ? null : c[f]
        };
    var Yc = function() {
        this.a = function() {
            return !1
    ...
    var cd = function(a, b) {
            ...
            var e = void 0 === e ? Dc() : e;
            e.hasOwnProperty("init-done") ? (Q(xc, e)(va(L(a, R, 2), function(d) {
                return d.h
            })), Q(yc, e)(va(L(a, M, 1), function(d) {
                return d.h
            })), b && Q(zc, e)(b), bd(e)) : (Xc(new Oc(L(a, R, 2), c), e), Ac(e), Bc(e), Cc(e), bd(e), gc(L(a, M, 1)), ad(Qb.f()), b && ad(b))
        },
        bd = function(a) {
        ...
        try {
            ...
            if (b instanceof y) var f = b.L ? b.L : Ga(b).toString();
                ...
                if (b instanceof z) var g = Wa(b);
                    ...
                    else b = "object" == typeof b && b.j ? b.a() : String(b), Xa.test(b) || (b = "about:invalid#zClosurez"), h = new z(Ua, b);
                    g = Wa(h)
                }
                f = g
            }
    ...
    var ed = /^\.google\.(com?\.)?[a-z]{2,3}$/,
        ...
        md = function(a) {
            "complete" == k.document.readyState || "loaded" == k.document.readyState || k.document.currentScript && k.document.currentScript.async ? ld(3) : a()
        },
        nd = 0,
        od = {
            m: function() {
        ...
        if (!od.m()) {
            var a = k.document,
                b = function(d) {
                    ...
                    jb(f, d);
                    try {
                        (a.head || a.body || a.documentElement).appendChild(f), od.w()
                    } catch (g) {}
                },
                c = V[1];
            b(c);
    ...
    var qd = function(a) {
        ...
        sd = function() {
            k.processGoogleToken = k.processGoogleToken || function(a, b) {
                return rd(od, a, b)
            };
            qd(od)
        },
        td = function() {
            k.processGoogleTokenSync = k.processGoogleTokenSync || function(a, b) {
                return rd(pd, a, b)
            };
            qd(pd)
        },
        rd = function(a, b, c) {
            ...
            if (!e && a.K()) gd(".google.com") && (V[1] = ".google.com"), a.s();
                ...
                var n = T.googleToken = T.googleToken || {},
                    w = 0 == c && e && "string" === typeof e && !d && "number" === typeof f && 0 < f && "number" === typeof g && 0 < g && "string" === typeof h;
                d = d && !a.m() && (!(U[3] >= +new Date) || "NT" == U[1]);
                var t = !(U[3] >= +new Date) && 0 != c;
                if (w || d || t) d = +new Date, f = d + 1E3 * f, g = d + 1E3 * g, ld(c), n[5] = c, n[1] = e, n[2] = f, n[3] = g, n[4] = h, n[6] = b, jd();
                if (w || !a.m()) {
                    c = a.C();
    ...
    var X = k.performance,
        vd = !!(X && X.mark && X.measure && X.clearMarks),
        wd = za(function() {
            var a;
            if (a = vd) a = Hb(), a = !!a.indexOf && 0 <= a.indexOf("1337");
            return a
        });
    ...
    xd.prototype.i = function(a, b, c, e, d) {
        c = void 0 === c ? this.c : c;
        d = void 0 === d ? this.g : d;
        ...
        k.error_rep_loaded || (b = k.document, a = b.createElement("script"), jb(a, tb(k.location.protocol + "//pagead2.googlesyndication.com/pagead/js/err_rep.js")), (b = b.getElementsByTagName("script")[0]) && b.parentNode && b.parentNode.insertBefore(a, b), k.error_rep_loaded = !0);
        return !1
    };
    var zd = function(a, b) {
        try {
            ...
            if (a.a && c && (b = c) && X && wd() && (X.clearMarks("goog_" + b.label + "_" + b.uniqueId + "_start"), X.clearMarks("goog_" + b.label + "_" + b.uniqueId + "_end")), !a.o(420, e, a.c, void 0, a.g)) throw e;
        }
    };
    var Ad = new v(u, "https://securepubads.g.doubleclick.net/gpt/pubads_impl_"),
        Bd = new v(u, ".js");
    var Cd = function(a) {
    ...
    var Dd = function(a, b, c) {
            ...
            return function() {
                ...
                try {
                    ...
                    e.google_measure_js_timing && d && (d = {
                        label: a.toString(),
                        value: d,
                        duration: (ud() || 0) - d,
                        type: f
                    }, f = e.google_js_reporting_queue = e.google_js_reporting_queue || [], 2048 > f.length && f.push(d))
                }
                return g
            }
        },
        Ed = function(a, b) {
            return Dd(a, b, function(c, e) {
                (new xd).i(c, e)
            })
        };
    var Y = function() {
            ...
            this.i = !1;
            this.D = new PerformanceObserver(Ed(640, function(b) {
                b = ba(b.getEntries());
                for (var c = b.next(); !c.done; c = b.next()) {
                    c = c.value;
                    if ("layout-shift" === c.entryType) {
                        var e = c;
                        e.hadRecentInput || (a.a += Number(e.value), Number(e.value) > a.b && (a.b = Number(e.value)))
                    }
                    "largest-contentful-paint" === c.entryType && (e = c, a.o = Math.floor(e.renderTime || e.loadTime));
                    "first-input" === c.entryType && (a.g = Number((c.processingStart - c.startTime).toFixed(3)), a.i = !0)
                }
            }));
            this.F = !1;
    ...
    Y.prototype.c = function() {
        ...
        if (2 === ({
            ...
            window.LayoutShift && (a += "&cls=" + this.a.toFixed(3), a += "&mls=" + this.b.toFixed(3));
    ...
    var Td = function() {
        var a = {};
        this[3] = (a[3] = Pd, a[2] = Nd, a[17] = function(b) {
            for (var c = [], e = 0; e < arguments.length; ++e) c[e] = arguments[e];
            e = String;
            var d = void 0 === d ? window : d;
            if (d = (d = d.location.href.match(vb)[3] || null) ? decodeURI(d) : d) {
                var f = d.length;
                if (0 == f) d = 0;
                else {
                    for (var g = 305419896, h = 0; h < f; h++) g ^= (g << 5) + (g >> 2) + d.charCodeAt(h) & 4294967295;
    ...
    var Ud = [],
        Wd = function(a) {
            a = Vd(new Lc(S(246)), new Lc(a || Ud));
            var b = Td.f();
            b[3][6] = function(c) {
                return ya(Ec.f().b(), parseInt(c, 10))
            };
            cd(a, b);
            Kd(230, $b.f().a)
        },
        Vd = function(a, b) {
            if (!L(a, M, 1).length && L(b, M, 1).length) {
                var c = L(b, M, 1);
                rb(a, 1, c)
            }!L(a, R, 2).length && L(b, R, 2).length && (b = L(b, R, 2), rb(a, 2, b));
            return a
        };
    var Xd;
    a: {
        ...
        var e = new xd(null, "gpt_exception", .01);
        yd(e, function(d) {
            d.methodId = 420
        });
        zd(e, function() {
            ...
            if (g.evalScripts) g.evalScripts();
                ...
                Ec.f().a(12);
                Ec.f().a(5);
                Zc(200) || Zc(220) || (h = S(150), jd(), gd(h) && (V[1] = h));
                try {
                    if (d.PerformanceObserver && (d.PerformanceLongTaskTiming && Cd(d), Zc(203))) {
                        var t = new Y;
                        t.D.observe({
                ...
                if (t = ud(d)) t = {
                    ...
                    type: 9,
                    value: t
                }, d = d.google_js_reporting_queue = d.google_js_reporting_queue || [], 2048 > d.length && d.push(t);
                ...
                d = new y(Ea, t, null);
                var A = void 0 === A ? 0 : A;
                (A = Yc.f().b(24, A)) ? (A = String(A), d = Ha.exec(Ga(d).toString()), t = d[3] || "", A = new y(Ea, d[1] + Ia("?", d[2] || "", A) + Ia("#", t, void 0), null)) : A = d;
                d = f.currentScript;
                if (!("complete" == f.readyState || "loaded" == f.readyState || d && d.async)) {
                    ...
                    try {
                        ...
                        var p = {};
                        h = {};
                        for (var x in n) h[x] = n[x];
                        for (x in p) h[x] = p[x];
                        if (w)
                            for (x in w) {
                                var W = x.toLowerCase();
                                if (W in n) throw Error("");
                                W in p && delete h[W];
                                h[x] = w[x]
                            }
                        x = null;
                        ...
                        if (h)
                            for (var C in h) {
                                ...
                                if (null != ic) {
                                    ...
                                    w = C;
                                    p = ic;
                                    if (p instanceof v) p = Ca(p);
                                    else {
                                        if ("style" == w.toLowerCase()) throw Error("");
                                        if (/^on/i.test(w)) throw Error("");
                                        if (w.toLowerCase() in fb)
                                            if (p instanceof y) p = Ga(p).toString();
                                            else if (p instanceof z) p = Wa(p).toString();
                                        else if ("string" === typeof p) {
                                            var D = p;
                                            if (D instanceof z) var jc = D;
                                            else D = "object" == typeof D && D.j ? D.a() : String(D), Xa.test(D) || (D = "about:invalid#zClosurez"), jc = new z(Ua, D);
                                            p = jc.a()
                                        } else throw Error("");
                                    }
                                    p.j && (p = p.a());
                                    var Zd = w + '="' + Ra(String(p)) + '"';
                                    W = n + (" " + Zd)
                                }
                            }
                        var ab = "<script" + W;
                    ...
                    f.getElementById(d) && (g._loadStarted_ = !0, Zc(200) || td())
                }
                g._loadStarted_ || (Zc(200) || sd(), na = f.createElement("script"), jb(na, A), na.async = !0, (f.head || f.body || f.documentElement).appendChild(na), g._loadStarted_ = !0)
            }
        })
    })(void 0, void 0, Xd);
    ...
    [
        ...
        [3, [
            ...
            [1000, [
                    [21064580, null, [4, null, 6, null, null, null, null, ["21064578"]]],
        ...
        [5, [
            ...
            [50, [
                [21064766, null, [4, null, 8, null, null, null, null, ["googletag.fifWin"]]]
            ]]
        ]],
        [6, [
            [null, [

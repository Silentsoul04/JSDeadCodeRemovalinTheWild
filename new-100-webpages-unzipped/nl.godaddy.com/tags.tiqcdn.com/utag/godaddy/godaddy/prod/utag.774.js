//tealium universal tag - utag.774 ut4.0.201812051934, Copyright 2018 Tealium.com Inc. All Rights Reserved.
var dotq = dotq || [];
try {
    (function(id, loader) {
        var u = {};
        ...
        u.send = function(a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                if (isConversionEvent || isConversionEventPending) {
                    u.data.order_subtotal = b.order_total_usd || '';
                    if (isConversionEventPending) {
                        u.data.ec = 'delayed-payment'
                    }
                }

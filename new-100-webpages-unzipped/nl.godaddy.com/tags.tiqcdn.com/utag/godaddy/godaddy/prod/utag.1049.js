//tealium universal tag - utag.1049 ut4.0.201812051934, Copyright 2018 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.map = {
            "order_id": "order_id",
            "order_total_usd": "order_total,event_value",
            "product_id": "product_id",
            "product_category_name": "content_type",
            "currency_usd": "order_currency"
        };
        u.extend = [];
        u.loader_cb = function(a, b, c) {
            utag.DB("send:1049:CALLBACK");
            ...
            if (b.conversion_event === "true" || b.conversion_event_pending === "true") {
            ...
            utag.DB("send:1049:CALLBACK:COMPLETE");
        };
        u.callBack = function() {
            var data = {};
        ...
        u.send = function(a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                var c, d, e, f, g, h, i;
                u.data = {
                    "twitter_pixel_id": tagUtils.equals(b.webproEvent, 'true') ? 'o0gfw' : 'nw20g',
                    "event_name": "",
                    "event_value": "",
                    "content_type": "",
                    "num_items": "",
                ...
                utag.DB("send:1049:COMPLETE");
            }
        };
        utag.o[loader].loader.LOAD(id);
    }("1049", "godaddy.godaddy"));
} catch (error) {
    utag.DB(error);
}
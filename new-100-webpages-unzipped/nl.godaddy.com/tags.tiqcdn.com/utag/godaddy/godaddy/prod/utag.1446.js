//tealium universal tag - utag.1446 ut4.0.201903050218, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.send = function(a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                u.data = {
                    ...
                    "qs_delim": "?" || "?",
                    "tag_type": "img",
                    "base_url": "https://d.agkn.com/pixel/9818/",
                    "secure_base_url": "",
                    "static_params": "",
                    "cachebust": "enabled",
                    "cachevar": "che" || "_rnd",
                ...
                utag.DB("send:1446:COMPLETE");
            }
        };
        utag.o[loader].loader.LOAD(id);
    }("1446", "godaddy.godaddy"));
} catch (error) {
    utag.DB(error);
}
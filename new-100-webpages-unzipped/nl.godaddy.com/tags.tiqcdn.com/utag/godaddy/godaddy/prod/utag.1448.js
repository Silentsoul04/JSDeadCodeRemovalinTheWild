//tealium universal tag - utag.1448 ut4.0.201903060037, Copyright 2019 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {
            "id": id
        ...
        u.send = function(a, b) {
            if (u.ev[a] || u.ev.all !== undefined) {
                ...
                u.data = {
                    ...
                    "qs_delim": "?" || "?",
                    "tag_type": "img",
                    "base_url": "https://www.facebook.com/tr",
                    "secure_base_url": "",
                    "static_params": "id=1462380620558839&ev=PageView",
                    "cachebust": "disabled",
                    "cachevar": "" || "_rnd",
                    "requestscriptonce": "disabled"
                };
                utag.DB("send:1448:EXTENSIONS");
                utag.DB(b);
                c = [];
                ...
                utag.DB("send:1448:COMPLETE");
            }
        };
        utag.o[loader].loader.LOAD(id);
    }("1448", "godaddy.godaddy"));
} catch (error) {
    utag.DB(error);
}
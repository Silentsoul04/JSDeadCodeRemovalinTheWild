...
if (typeof TV2Track !== "object") {
    TV2Track = (function() {
        ...
        function w(ak, aL) {
            ...
            function at(bn, bC, bD, bp) {
                var bA, bm = new Date(),
                    bs = Math.round(bm.getTime() / 1000),
                    bF, bB, bq, bv, by, br, bx, bz = V,
                    bw = Q(),
                    bE = aC || bj;
                if (aa) {
                    P()
                ...
                bn += "&idsite=" + a9 + "&rec=1&r=" + String(Math.random()).slice(2, 8) + "&h=" + bm.getHours() + "&m=" + bm.getMinutes() + "&s=" + bm.getSeconds() + "&url=" + j(be(bE)) + (aS.length ? "&urlref=" + j(be(aS)) : "") + "&_id=" + bB + "&_idts=" + bv + "&_idvc=" + bq + "&_idn=" + bF + "&_viewts=" + br + (bt ? "&cs=" + j(bt) : "");
                var bo = JSON2.stringify(aH);
                if (bo.length > 2) {
                    bn += "&cvar=" + j(bo)
                }
                for (bA in ba) {
                    if (Object.prototype.hasOwnProperty.call(ba, bA)) {
                        bn += "&" + bA + "=" + ba[bA]
                    }
                }
                if (bC) {
                    bn += "&data=" + j(JSON2.stringify(bC))
                } else {
                    if (Z) {
                ...
                if (V) {
                    ...
                    for (bA in bz) {
                        if (Object.prototype.hasOwnProperty.call(bz, bA)) {
                            if (V[bA][0] === "" || V[bA][1] === "") {
                                delete V[bA]
                            }
                        }
                ...
                ab(bB, bv, bq, bs, br, r(bp) && String(bp).length ? bp : bx);
                bn += I(bD);
                if (aN.length) {
                    bn += "&" + aN
                }

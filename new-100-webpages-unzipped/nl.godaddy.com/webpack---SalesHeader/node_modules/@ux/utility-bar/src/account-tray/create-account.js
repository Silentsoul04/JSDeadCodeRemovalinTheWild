...
class CreateMyAccount extends NamespaceConsumer {
    constructor(props) {
        ...
        this.eids = {
            createAccount: eidBuilder({
                key: golf.createAccount,
    ...
    render() {
        ...
        return ( <
            ...
            <
            div className = {
                this.namespace('col-xl-5', 'pull-xl-7', 'col-lg-6', 'pull-lg-6', 'col-md-6', 'sign-up', 'divider')
            } >
            <
            TrayTitle >
            <
            FormattedMessage id = {
                golf.newCustomerHeading
            }
            /> <
            /TrayTitle> <
            p >
            ...
            /p> <
            Link className = {
                this.namespace('btn', 'btn-sm', 'btn-default-purchase')
            }
            urlArgs = {
                props.urlArgs

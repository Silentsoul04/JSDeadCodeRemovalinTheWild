...
class SalesFooterComponent extends NamespaceConsumer {
    ...
    linkListBuilder(items = [], options = {}) {
        ...
        return items.map((item, i) => {
            ...
            const linkChildren = item.title ? < span > {
                item.title
            } < /span> : void 0;
            ...
            return ( <
                ...
                data - eid = {
                    golfToEid(captionOrId, this.footerLinkEid)
                } > {
                    linkChildren
                } <
                /Link> <
    ...
    renderWeChat(currItem) {
            ...
            className = {
                this.namespace('wechat-qr')
            }
            src = {
                `${cdn}${imgPath.replace('{market}', market.toLowerCase())}`
            }
            height = '247px'
            width = '218px'
            alt = {
            ...
            return ( <
                    FormattedMessage id = {
                        'Sales:Footer:SocialMedia:WeChatIcon'
                    } > {
                        text => ( <
                            Tooltip data - eid = {
                                golfToEid(currItem.caption || currItem.id, {
                            ...
                            text = { < FormattedMessage id = {
                                    ...
                                    altText => ( < WeChatIcon className = {
                                            this.namespace('wechat-icon')
                                        }
                                        altText = {
                                            altText
                                        }
                                        ...
                                        /FormattedMessage> }
                                        message = {
                                            currItem.caption ? < IntlProvider locale = {
                                                props.market
                                            }
                                            messages = {
                                                props.messages
                                ...
                                return links.map((link, index) => {
                                        ...
                                        if (props.privateLabelId === 3153 &&
                                            ~['Shared:LegalBar:LinkList:PrivacyPolicy',
                                                'Shared:LegalBar:LinkList:ResellerPrivacyPolicy'
                                            ].indexOf(link.caption)) {
                                            return;
                                        }
                                        ...
                                        return ( <
                                            ...
                                            data - eid = {
                                                golfToEid(link.caption || link.id, this.footerLinkEid)
                                            } > {
                                                link.caption ? < FormattedMessage id = {
                                                    link.caption
                                                }
                                                /> : link.title } <
                                                /Link> <
                                ...
                                buildFooterLinks(props) {
                                        ...
                                        return upperLinks.map((curr, index) => {
                                                ...
                                                const columnBreak = ((index + 1) % 2 === 0 && seechange) ?
                                                    <
                                                    div className = {
                                                        this.namespace('hidden-sm-down', 'hidden-lg-up', 'clearfix')
                                                    } > < /div> :
                                                null;
                                                return ( <
                                                    React.Fragment key = {
                                                    ...
                                                    <
                                                    div className = {
                                                        this.namespace(!seechange ? 'col-md-2' : 'col-lg-2',
                                                            seechange ? 'col-md-6' : '',
                                                            'col-sm-12', 'col-12',
                                                            'footer-links-column',
                                                    ...
                                                    className = {
                                                        ...
                                                        curr.caption ? < FormattedMessage id = {
                                                            curr.caption
                                                        }
                                                        /> : curr.title } <
                                                        /button> {
                                        ...
                                        buildLinksWithImg(items, spanClass, urlArgs) {
                                                ...
                                                return items.children.map((currItem, index) => {
                                                        ...
                                                        if (!imgPath) return;
                                                        const imgFromAlt = (altText) => < img src = {
                                                            `${cdn}${imgPath}`
                                                        }
                                                        alt = {
                                                            altText
                                                        ...
                                                        return ( <
                                                            ...
                                                            <
                                                            span className = {
                                                                this.classNames(spanClass, this.namespace(className))
                                                            } > {
                                                                currItem.caption ? < FormattedMessage id = {
                                                                    currItem.caption
                                                                } > {
                                                                    imgFromAlt
                                                                } <
                                                ...
                                                renderAppStoreSection() {
                                                        ...
                                                        return ( <
                                                            div className = {
                                                                this.namespace('app-store-section')
                                                            } >
                                                            <
                                                            span className = {
                                                                this.namespace('font-primary-bold')
                                                            } > {
                                                                appStores.caption ? < FormattedMessage id = {
                                                                    appStores.caption
                                                                }
                                                                /> : appStores.title } <
                                                                /span> <
                                                                ul className = {
                                                                    this.namespace('list-inline')
                                                                } > {
                                                                ...
                                                                const rows = props.legal.map((section, index) => { // eslint-disable-line max-statements
                                                                            ...
                                                                            if (~firstCaption.indexOf('Disclaimer')) {
                                                                                const disclaimer = ( <
                                                                                    ...
                                                                                    className = {
                                                                                        this.namespace('footer-disclaimer')
                                                                                    } >
                                                                                    <
                                                                                    span > {
                                                                                        section.caption ? < FormattedMessage id = {
                                                                                            section.caption
                                                                                        }
                                                                                        /> : section.title }{ ' ' }</span >
                                                                                        <
                                                                                        ...
                                                                                        data - eid = {
                                                                                            golfToEid(firstCaption, this.footerLinkEid)
                                                                                        } > {
                                                                                            firstChild.caption ? < FormattedMessage id = {
                                                                                                firstCaption
                                                                                            }
                                                                                            /> : firstChild.title } <
                                                                                            /Link> <
                                                                                        ...
                                                                                        const links = ( <
                                                                                            ...
                                                                                            className = {
                                                                                                this.namespace('list-inline', 'footer-legal-links')
                                                                                            } > {
                                                                                        ...
                                                                                        const copyright = ( <
                                                                                            ...
                                                                                            className = {
                                                                                                this.namespace('footer-copyright')
                                                                                            } > {
                                                                                                section.caption ? < FormattedHTMLMessage id = {
                                                                                                    section.caption
                                                                                                }
                                                                                                values = {
                                                                                                    {
                                                                            ...
                                                                            buildSeeChangeLegalSection(props, sections) {
                                                                                return ( <
                                                                                    div className = {
                                                                                        this.namespace('footer-seechange-legal')
                                                                                    } >
                                                                                    <
                                                                                    div className = {
                                                                                        this.namespace('container')
                                                                                    ...
                                                                                    <
                                                                                    div className = {
                                                                                        this.namespace('col-lg-5', 'col-12', 'pull-lg-right')
                                                                                    } > {
                                                                                        sections.links
                                                                                    } <
                                                                                    /div> <
                                                                                    div className = {
                                                                                        this.namespace('col-lg-7', 'col-12')
                                                                                    } > {
                                                                                        sections.copyright
                                                                                    } <
                                                                                    /div> <
                                                                                    div className = {
                                                                                        this.namespace('col-lg-6', 'col-12', 'legal-right')
                                                                                    } > {
                                                                                        sections.disclaimer
                                                                                    } <
                                                                                    /div> <
                                                                            ...
                                                                            buildSupportPhone(supportContacts = {}) {
                                                                                ...
                                                                                if (this.isMobile) {
                                                                                    return <div className = {
                                                                                            this.namespace('support-short')
                                                                                        } >
                                                                                        <
                                                                                        FormattedMessage id = {
                                                                                            'Sales:Footer:SupportBar:MobileCallSupportTeam'
                                                                                        }
                                                                                    /><a href={ phone.href }
                                                                                    className = {
                                                                                            this.namespace('support-footer-number')
                                                                                        } > {
                                                                                            phone.number
                                                                                        } < /a> <
                                                                                        /div>;
                                                                                ...
                                                                                return <div >
                                                                                    <
                                                                                    FormattedMessage id = {
                                                                                        'Sales:Footer:SupportBar:NeedHelp'
                                                                                    }
                                                                                /> <FormattedMessage
                                                                                id = {
                                                                                    'Sales:Footer:SupportBar:CallSupportTeam'
                                                                                }
                                                                                /> <a href={ phone.href }
                                                                                className = {
                                                                                        this.namespace('support-footer-number')
                                                                            ...
                                                                            nextStateFromProps(props = {}) {
                                                                                ...
                                                                                if (displayTaxesAndFees) {
                                                                                    nextState.vatDisclaimer = < div className = {
                                                                                            this.namespace('row', 'footer-vat-disclaimer')
                                                                                        } >
                                                                                        <
                                                                                        div >
                                                                                        <
                                                                                        FormattedMessage id = {
                                                                                            vatInclusionCodes[displayTaxesAndFees]
                                                                                        }
                                                                                    /> <
                                                                                    /div> <
                                                                                    hr className = {
                                                                                        this.namespace('main-hr')
                                                                                    }
                                                                                    /> <
                                                                                    /div>;
                                                                                }
                                                                            ...
                                                                            renderGoDaddyGuides() {
                                                                                    ...
                                                                                    return ( <
                                                                                            ...
                                                                                            className = {
                                                                                                this.namespace('footer-godaddy-guides', 'clearfix')
                                                                                            } >
                                                                                            <
                                                                                            span className = {
                                                                                                this.namespace('guides-left')
                                                                                            } >
                                                                                            <
                                                                                            span className = {
                                                                                                this.namespace('godaddy-guides-line', 'guides-line-1')
                                                                                            } >
                                                                                            <
                                                                                            ...
                                                                                            /span> <
                                                                                            span className = {
                                                                                                this.namespace('godaddy-guides-line', 'guides-line-2')
                                                                                            } >
                                                                                            <
                                                                                            FormattedMessage id = 'Sales:Footer:GoDaddyGuides:LogoAlt' > {
                                                                                                altText => < img src = {
                                                                                                    props.urls.cdn.href + 'ux/sales-header/gd-guides.svg'
                                                                                                }
                                                                                                style = {
                                                                                                    {
                                                                                                        height: '30px'
                                                                                                ...
                                                                                                /span> <
                                                                                                span className = {
                                                                                                    this.namespace('godaddy-guides-line', 'guides-line-3', 'guides-right', 'float-lg-left')
                                                                                                } >
                                                                                                <
                                                                                                FormattedMessage id = 'Sales:Footer:GoDaddyGuides:LogoAlt' > {
                                                                                                    altText => < img src = {
                                                                                                        props.urls.cdn.href + 'ux/sales-header/care-arrow.svg'
                                                                                                    }
                                                                                                    alt = {
                                                                                                        altText
                                                                                                    }
                                                                                            ...
                                                                                            renderSeeChangeTopSection() {
                                                                                                ...
                                                                                                if (~['desktop', 'large'].indexOf(this.state.breakpoint)) {
                                                                                                    return ( <
                                                                                                        div className = {
                                                                                                            this.namespace('footer-seechange-top-section')
                                                                                                        } >
                                                                                                        <
                                                                                                        div className = {
                                                                                                            this.namespace('container')
                                                                                                        ...
                                                                                                        <
                                                                                                        div className = {
                                                                                                            this.namespace('footer-seechange-top-left', 'col-md-8')
                                                                                                        } >
                                                                                                        <
                                                                                                        EmailForm messages = {
                                                                                                            messages
                                                                                                        ...
                                                                                                        /div> <
                                                                                                        div className = {
                                                                                                            this.namespace('footer-seechange-top-right', 'col-md-4')
                                                                                                        } > {
                                                                                                ...
                                                                                                return ( <
                                                                                                    ...
                                                                                                    <
                                                                                                    div className = {
                                                                                                        this.namespace('footer-seechange-top-right', 'col-xs-12')
                                                                                                    } > {
                                                                                                        this.renderGoDaddyGuides()
                                                                                                    } <
                                                                                                    /div> <
                                                                                                    div className = {
                                                                                                        this.namespace('footer-seechange-top-left', 'col-xs-12')
                                                                                                    } >
                                                                                                    <
                                                                                                    EmailForm messages = {
                                                                                                        messages
                                                                                            ...
                                                                                            renderFooterLowerSeechange(socialMediaLinks, marketSelectorProps, currencySelectorProps) {
                                                                                                ...
                                                                                                return ( <
                                                                                                    ...
                                                                                                    <
                                                                                                    div className = {
                                                                                                        this.namespace('footer-lower')
                                                                                                    } >
                                                                                                    <
                                                                                                    div className = {
                                                                                                        this.namespace('footer-lower-container')
                                                                                                    } >
                                                                                                    <
                                                                                                    Logo market = {
                                                                                                        props.market
                                                                                                    ...
                                                                                                    href = {
                                                                                                        props.urls.home.href
                                                                                                    }
                                                                                                    privateLabelId = {
                                                                                                        1 /* This is GoDaddy only */
                                                                                                    }
                                                                                                    ...
                                                                                                    className = {
                                                                                                        this.namespace('logo-link')
                                                                                                    }
                                                                                                    isMobile = {
                                                                                                        false /* Always show full logo here */
                                                                                                    }
                                                                                                    includeGDHead = {
                                                                                                        false
                                                                                                    }
                                                                                                    ...
                                                                                                    <
                                                                                                    div className = {
                                                                                                        this.namespace('hr', 'hidden-lg-up')
                                                                                                    }
                                                                                                    /> <
                                                                                                    div className = {
                                                                                                        this.namespace('selectors')
                                                                                                    } >
                                                                                                    <
                                                                                                    ...
                                                                                                    /div> {
                                                                                                        socialMediaLinks && socialMediaLinks.length > 0 ?
                                                                                                            <
                                                                                                            div className = {
                                                                                                                this.namespace('follow-us')
                                                                                                            } >
                                                                                                            <
                                                                                                            ul className = {
                                                                                                                this.namespace('list-inline', 'social-media-links')
                                                                                                            } > {
                                                                                                                socialMediaLinks
                                                                                                            } <
                                                                                                            /ul> <
                                                                                                            ...
                                                                                                            /div> <
                                                                                                            div className = {
                                                                                                                this.namespace('hr', 'hidden-md-down')
                                                                                                            }
                                                                                                        /> <
                                                                                                        /React.Fragment>
                                                                                                    );
                                                                                                ...
                                                                                                renderFooterLower(socialMediaLinks, marketSelectorProps, currencySelectorProps) {
                                                                                                        ...
                                                                                                        return ( <
                                                                                                                ...
                                                                                                                <
                                                                                                                div className = {
                                                                                                                    this.namespace('col-md-6', 'col-xs-12', 'selectors')
                                                                                                                } >
                                                                                                                <
                                                                                                                div className = {
                                                                                                                ...
                                                                                                                /div> <
                                                                                                                div className = {
                                                                                                                    this.namespace('col-md-6', 'col-xs-12')
                                                                                                                } > {
                                                                                                                    socialMediaLinks && socialMediaLinks.length > 0 ?
                                                                                                                    <
                                                                                                                    div className = {
                                                                                                                        ...
                                                                                                                        <
                                                                                                                        FormattedMessage id = {
                                                                                                                            'Sales:Footer:SocialMedia:Heading'
                                                                                                                        }
                                                                                                                        /> <
                                                                                                                        /span> } <
                                                                                                                        ul className = {
                                                                                                                ...
                                                                                                                render() {
                                                                                                                    ...
                                                                                                                    return ( <
                                                                                                                            ...
                                                                                                                            <
                                                                                                                            div className = {
                                                                                                                                this.namespace(this.classNames('footer', {
                                                                                                                                ...
                                                                                                                                div className = {
                                                                                                                                    this.namespace('footer-link-section')
                                                                                                                                } >
                                                                                                                                <
                                                                                                                                div > {
                                                                                                                                    seechange &&
                                                                                                                                    ...
                                                                                                                                    div className = {
                                                                                                                                        this.namespace('row', 'footer-links')
                                                                                                                                    } > {
                                                                                                                                    ...
                                                                                                                                    !seechange && < div className = {
                                                                                                                                        ...
                                                                                                                                        /div> {
                                                                                                                                            props.features.footerEmailForm &&
                                                                                                                                                <
                                                                                                                                                div className = {
                                                                                                                                                    this.namespace('row', 'footer-apps')
                                                                                                                                                } >
                                                                                                                                                <
                                                                                                                                                div className = {
                                                                                                                                                    this.namespace('col-lg-5', 'col-sm-6')
                                                                                                                                                } >
                                                                                                                                                <
                                                                                                                                                EmailForm messages = {
                                                                                                                                                    props.messages
                                                                                                                                            ...
                                                                                                                                            /div> <
                                                                                                                                            div className = {
                                                                                                                                                this.namespace('col-lg-7', 'col-lg-offset-3', 'col-sm-6', 'text-right')
                                                                                                                                            }
                                                                                                                                            /> <
                                                                                                                                            /div> } {

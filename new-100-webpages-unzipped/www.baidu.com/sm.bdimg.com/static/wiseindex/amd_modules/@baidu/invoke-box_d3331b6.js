define("@baidu/invoke-box/index", ["require", "@baidu/invoke-box/src/invoke", "@baidu/invoke-box/src/getScheme", "@baidu/invoke-box/src/getControlByPos", "@baidu/invoke-box/src/consts", "@baidu/invoke-box/src/utils"], function(require) {
        ...
        if (c) {
            ...
            switch (+c) {
                ...
                case h.XCX:
                    ...
                    break;
                case h.VOICE:
                    var S = "baiduboxapp://voicesearch?opennewwindow&caller=wise_search&args=",
                        A = v.browserid + "|" + v.browserVersion,
                        P = ["source_app=" + A, "referer=" + window.location.href].join("&");
                    S += encodeURIComponent(P), U.iosScheme = S, U.androidCommand = {
                        mode: "0",
                        minver: "6.9.1",
                        intent: ["intent:#Intent", "action=com.baidu.searchbox.action.VOICESEARCH", "package=com.baidu.searchbox", "category=android.intent.category.DEFAULT", "S.search_source=api_mbaiducom_voice", "end"].join(";")
                    }
            }
            var D = v.backQuery,
                N = "object" == typeof v.backQueryMore ? b.stringifyQuery(v.backQueryMore) : "",
                T = v.backURL;
            if (D) {
                var B = "" + g + "://v1/browser/open?url=" + encodeURIComponent("search://" + encodeURIComponent(D) + (N ? "?" + N : "")) + "&newwindow=0&upgrade=1&append=1&fromwise=1";
                U.iosScheme && (U.iosScheme = B + "&simple=1&next=" + encodeURIComponent(U.iosScheme)), U.androidCommand && "string" == typeof U.androidCommand && (U.androidCommand = B + "&next=" + encodeURIComponent(U.androidCommand))
            } else if (T) {
                var F = "" + g + "://v1/browser/open?url=" + encodeURIComponent(T) + "&newwindow=0&upgrade=1&append=1&fromwise=1";
                U.iosScheme && (U.iosScheme = F + "&simple=1&next=" + encodeURIComponent(U.iosScheme)), v.app === k.BD && U.androidCommand && "string" == typeof U.androidCommand && (U.androidCommand = F + "&next=" + encodeURIComponent(U.androidCommand))
            }
            return U
        }
    }
    ...
    function v(a) {
        ...
        var I = {};
        I = a.copyTokenData ? a.copyTokenData : +a.mode === _.OPEN_URL && a.invokeURL ? {
            url: w,
            activity_id: 220
        } : +a.mode === _.XCX ? {
        ...
        var O;
        if (1 === +a.fail && a.invokeURL && /https?:\/\//gi.test(a.invokeURL)) O = a.invokeURL;
        else if (+a.app === E.KDD) {
            var S = a.kddParams || {};
            O = a.defaultURL || "https://haokan.baidu.com/activity/h5/chaihongbao?productid=6&inviteCode=B36CCC5X010&pd=" + (S.pd || "") + "&tab=guide&source=" + (S.source || "") + "&idfrom=" + (S.idfrom || "")
        } else if (+a.app === E.LITE) {
            var A = a.liteParams || {};
            O = a.defaultURL || "https://eopa.baidu.com/page/litetwtj-oA8Aiml9?idfrom=" + (A.idfrom || "") + "&type=" + (A.type || "") + "&nid=" + (A.nid || "")
        } else O = b(a.defaultURL, /^https?:\/\/boxer.baidu.com\/scheme/, "https://boxer.baidu.com/scheme", {
            source: v,
            channel: k,
            p1: k,
            p2: c,
            p3: v,
            tokenData: encodeURIComponent(encodeURIComponent(JSON.stringify(I)))
        });
        var P;
        R.isSupportULink() && +a.fail === L.FAIL.APPATORE && !R.ua.isUC() && (P = O, O = L.APP_STORE);
        var D = navigator.userAgent,
            N = {
                ...
                failCallback: function() {
                    var c = +a.fail;
                    4 !== c && (3 === c ? y(O) : window.location.href = O)
                },
                copyTokenData: I,
                extLog: {
                    ext_content: C({
                ...
                iosForceScheme: /iP(ad|hone|od)/.test(D) && /MQQBrowser\//i.test(D) || 4 === +a.fail
            };
        return P && (N.originFailURL = P), a.iosScheme || (a.iosScheme = function(c) {
    ...
    function R(a, c, b) {
        if (N.isIOS() && N.iOSVersion()[0] >= 9) window.location.href = a;
        else if (N.isAndroid() && N.getChromeVersion()[0] > 55) window.location.href = a;
        else {
    ...
    function L() {
        return N.isIOS() && N.iOSVersion()[0] >= 9
    }
    ...
    var N = require("@searchfe/user-agent"),

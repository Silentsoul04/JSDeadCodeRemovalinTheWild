    ...
    !(function() {
            ...
            var invokeApp = {
                ...
                openBdAppSearch: function(data) {
                    ...
                    boxJS.invokeAndroid(
                        ...
                        'invokePlugin', [JSON.stringify(opt), 'console.log']);
                },
        ...
        define('rmbGrowth/invoke/appAdDownload', function() {
            ...
            var appAdDwonload = {
                ...
                check: function() {
                    var self = this;
                    var status = window.Box.android.invokeApp('bd_searchbox_interface', 'getNativeAppStatus', [encodeURIComponent('com.baidu.haokan'), '__checkcallback__']);
                    if (!status.error) {
                ...
                if (window.Box && window.Box.os) {
                    ...
                    cuid = Box.os.ios ?
                        Box.ios.invokeApp('utils', {
                            action: 'getcuid',
                            minver: '6.1.0.0'
                        }, 'window.rmbvideogetcuid') : Box.android.invokeApp('Bdbox_android_utils', 'getcuid', []) ||
                        '';
                }
        ...
        define('rmbGrowth/log/appAdLog', [
            ...
            addAdLog.prototype.sendLog = function(logtype, tpltype, data, callback) {
                ...
                if (logtype === 'show') { /*展现日志*/
                    ...
                    logObj = $.extend(logObj, {
                        tid: this.logTid.show
                    });

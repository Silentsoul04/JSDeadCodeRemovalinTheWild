...
shaka.dash.DashParser.prototype.processManifest_ =
    function(mpd, finalManifestUri) {
        ...
        let baseUris = ManifestParserUtils.resolveUris(manifestBaseUris, uris);
...
shaka.dash.DashParser.prototype.setUpdateTimer_ = function(offset) {
    ...
    let interval = Math.max(period - offset, 0);
...
shaka.dash.DashParser.prototype.createFrame_ = function(
    ...
    let containsEmsgBoxes = !!XmlUtils.findChildren(elem, 'InbandEventStream').length;
    ...
    return {
        ...
        segmentTemplate: XmlUtils.findChild(elem, 'SegmentTemplate') || parent.segmentTemplate,

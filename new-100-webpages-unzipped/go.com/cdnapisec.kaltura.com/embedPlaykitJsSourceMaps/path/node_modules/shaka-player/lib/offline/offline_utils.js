 ...
 * @public
 */
shaka.offline.OfflineUtils.getAudioStreamDb = function(manifestDb) {
    return manifestDb.periods[0].streams.filter(
        shaka.offline.OfflineUtils.isAudio_)[0];
};
 ...
 * @public
 */
shaka.offline.OfflineUtils.getVideoStreamDb = function(manifestDb) {
    return manifestDb.periods[0].streams.filter(
        shaka.offline.OfflineUtils.isVideo_)[0];
};

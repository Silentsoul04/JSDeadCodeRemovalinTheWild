...
shaka.offline.OfflineUri.uriToManifestId = function(uri) {
    let parts = /^offline:manifest\/([0-9]+)$/.exec(uri);

    /** @type {?number} */
    let id = parts ? Number(parts[1]) : null;
...
shaka.offline.OfflineUri.uriToSegmentId = function(uri) {
    let parts = /^offline:segment\/([0-9]+)$/.exec(uri);
...
// WEBPACK FOOTER //
// ../node_modules/shaka-player/lib/offline/offline_uri.js
...
/**
 * Reset the list of segments that should be downloaded
 * @public
 */
shaka.offline.DownloadManager.prototype.resetSegments = function() {
    this.segments_ = {};
};
 ...
 */
shaka.offline.DownloadManager.prototype.downloadAndStore =
    function(manifest, manifestId) {
        ...
        let async = MapUtils.values(this.segments_).map(function(segments) {
            let i = 0;
            let downloadNext = (function() {
                ...
                return this.downloadSegment_(segment, manifestId, this.manifest_)
                    .then(downloadNext);
            }.bind(this));
            return downloadNext();
        }.bind(this));
        ...
        this.promise_ = Promise.all(async).then(function() {
            if (manifestId == null || typeof manifestId == 'undefined') {
                return Promise.reject(new shaka.util.Error(
                    shaka.util.Error.Severity.CRITICAL,
                    shaka.util.Error.Category.STORAGE,
                ...
                return this.storageEngine_.updateManifest(manifestId, manifest);
            }
 ...
 * @param {?number=} manifestId
 * @param {shakaExtern.ManifestDB=} currentManifest
 * @return {!Promise}
 * @private
 */
shaka.offline.DownloadManager.prototype.downloadSegment_ =
    function(segment, manifestId, currentManifest) {
        if (segment.dataKey != null &&
        ...
        return this.netEngine_.request(type, request).promise
            ...
            .then(function(id) {
                ...
                segment.onStore(id);
                if (manifestId != null && currentManifest != null) {
                    this.storageEngine_.updateManifest(manifestId, this.manifest_);
                }

...
class FlashHLSAdapter extends FakeEventTarget {
    ...
    attach(): HTMLDivElement {
        ...
        let flashlsEvents = {
            ...
            manifest: (duration, levels_) => {
                ...
                this._trigger(EventType.TRACKS_CHANGED, {
                    tracks: videoTracks.concat(parsedAudioTracks)
                });
            },
            seekState: newState => {
    ...
    selectAudioTrack(audioTrack: AudioTrack): void {
        if (this._api) {
            ...
            this._trigger(EventType.AUDIO_TRACK_CHANGED, {
    ...
    selectVideoTrack(videoTrack: VideoTrack): void {
        if (this._api) {
            if (this.isABR()) {
                this._trigger(EventType.ABR_MODE_CHANGED, {
                    mode: 'manual'
                });
            }
            this._api.setCurrentLevel(videoTrack.index);
            this._trigger(EventType.VIDEO_TRACK_CHANGED, {

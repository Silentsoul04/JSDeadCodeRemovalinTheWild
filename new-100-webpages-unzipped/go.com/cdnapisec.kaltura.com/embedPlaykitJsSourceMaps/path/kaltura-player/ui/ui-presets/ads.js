...
} from '../components/time-display-ads-container';
import {
    AdSkip
} from '../components/ad-skip';
import {
    AdLearnMore
} from '../components/ad-learn-more';
import {
    TopBar
...
import {
    AdNotice
} from '../components/ad-notice/ad-notice';
import {
    PlaybackControls
...
export function adsUI(props: any): ? React$Element < any > {
        ...
        return ( <
            ...
            /TopBar> {
                adsUiCustomization.skipButton ? < AdSkip player = {
                    props.player
                }
                /> : undefined} <
                /div> <

...
class UnmuteIndication extends BaseComponent {
    ...
    render(props: any): ? React$Element < any > {
        ...
        return ( <
            ...
            onKeyDown = {
                e => this._keyDownHandler(e)
            } >
            <
            a className = {
                [style.btn, style.btnDarkTransparent, style.unmuteButton].join(' ')
            } >
            <
            div className = {
                style.unmuteIconContainer
            } >
            <
            Icon type = {
                IconType.VolumeBase
...
// WEBPACK FOOTER //
// ./components/unmute-indication/unmute-indication.js


// WEBPACK FOOTER //
// ui/components/unmute-indication/unmute-indication.js
...
class PrePlaybackPlayOverlay extends BaseComponent {
    ...
    render(props: any): React$Element < any > | void {
        ...
        return ( <
            ...
            onClick = {
                ...
                a
                className = {
                    style.prePlaybackPlayButton
                }
                tabIndex = "0"
                aria - label = { < Text id = {
                        props.isPlaybackEnded ? 'controls.startOver' : 'controls.play'
                    }
                    />}
                    onKeyDown = {
                        e => {
                        ...
                        props.isPlaybackEnded ? < Icon type = {
                            IconType.StartOver
                        }
    ...
    // WEBPACK FOOTER //
    // ./components/pre-playback-play-overlay/pre-playback-play-overlay.js


    // WEBPACK FOOTER //
    // ui/components/pre-playback-play-overlay/pre-playback-play-overlay.js
    ...
    render(props: any): ? React$Element < any > {
        ...
        if (props.prePlayback) {
            ...
            return ( <
                ...
                <
                a className = {
                    [style.btn, style.btnDarkTransparent, style.castOnTvButton].join(' ')
                } >
                <
                div className = {
                    style.castOnTvIconContainer
                } >
                <
                Icon type = {
                    props.icon
...
// WEBPACK FOOTER //
// ./components/cast-on-tv/cast-before-play.js


// WEBPACK FOOTER //
// ui/components/cast-on-tv/cast-before-play.js
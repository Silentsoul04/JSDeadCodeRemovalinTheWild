...
class FullscreenControl extends BaseComponent {
    ...
    render(): React$Element < any > {
        return ( <
            div className = {
                [style.controlButtonContainer, style.controlFullscreen].join(' ')
            } >
            <
            Localizer >
            <
            ...
            className = {
                this.props.fullscreen ? [style.controlButton, style.isFullscreen].join(' ') : style.controlButton
            }
            onClick = {
...
// WEBPACK FOOTER //
// ui/components/fullscreen/fullscreen.js
...
class PlaylistCountdown extends BaseComponent {
    ...
    render(props: any): React$Element < any > | void {
        ...
        return ( <
            ...
            <
            div className = {
                style.playlistCountdownPoster
            }
            style = {
                `background-image: url(${next.sources.poster});`
            }
            /> <
            div className = {
                style.playlistCountdownContentPlaceholder
            } >
            <
            div className = {
                style.playlistCountdownContentBackground
            } >
            <
            div className = {
                style.playlistCountdownContent
            } >
            <
            Localizer >
            <
            div className = {
                style.playlistCountdownText
            } >
            <
            div className = {
                style.playlistCountdownTextTitle
            } >
            <
            ...
            /div> <
            div className = {
                style.playlistCountdownTextName
            } > {
                `${next.sources.metadata ? next.sources.metadata.name : ''}`
            } < /div> <
            /div> <
            /Localizer> <
            div className = {
                [style.controlButtonContainer, style.playlistCountdownCancel].join(' ')
            } >
            <
            Localizer >
            <
            ...
            className = {
                [style.controlButton, style.playlistCountdownCancelButton].join(' ')
            }
            onClick = {
                e => this.cancelNext(e)
            }
            ...
            /div> <
            div className = {
                style.playlistCountdownIndicatorBar
            } >
            <
            div className = {
                style.playlistCountdownIndicatorProgress
            }
            style = {
                {
                    width: progressWidth
...
// WEBPACK FOOTER //
// ./components/playlist-countdown/playlist-countdown.js


// WEBPACK FOOTER //
// ui/components/playlist-countdown/playlist-countdown.js
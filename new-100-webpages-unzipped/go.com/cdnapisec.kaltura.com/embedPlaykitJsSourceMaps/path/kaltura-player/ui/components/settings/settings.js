...
class SettingsControl extends BaseComponent {
    ...
    render(props: any): React$Element < any > | void {
        ...
        return ( <
            div ref = {
                c => (this._controlSettingsElement = c)
            }
            className = {
                [style.controlButtonContainer, style.controlSettings].join(' ')
            } >
            <
            Localizer >
            <
                ...
                !this.state.smartContainerOpen ? (
                    ...
                    onClose = {
                        ...
                        qualityOptions.length <= 1 ? (
                            ...
                            Localizer >
                            <
                            SmartContainerItem icon = "quality"
                        ...
                        props.isLive || speedOptions.length <= 1 ? (
                            ...
                            Localizer >
                            <
                            SmartContainerItem icon = "speed"
                            label = { < Text id = "settings.speed" / >
                            }
                            options = {
                                speedOptions
                            }
                            onSelect = {
                                o => this.onSpeedChange(o)
                            }
                            /> <
                            /Localizer>
                        )

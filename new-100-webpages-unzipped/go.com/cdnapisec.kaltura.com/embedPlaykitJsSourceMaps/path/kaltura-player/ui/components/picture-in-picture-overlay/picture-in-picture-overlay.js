...
class PictureInPictureOverlay extends BaseComponent {
    ...
    render(): ? React$Element < any > {
        ...
        return ( <
            ...
            /div> <
            div className = {
                style.pictureInPictureControl
            } >
            <
            Localizer >
            <
            span className = {
                style.pictureInPictureText
            } >
            <
            ...
            <
            button className = {
                [style.pictureInPictureButton, style.controlButtonContainer].join(' ')
            }
            onClick = {
                () => this._handleClick()
            } >
...
// WEBPACK FOOTER //
// ./components/picture-in-picture-overlay/picture-in-picture-overlay.js


// WEBPACK FOOTER //
// ui/components/picture-in-picture-overlay/picture-in-picture-overlay.js
...
class Menu extends Component {
    ...
    renderNativeSelect(): React$Element < any > {
        ...
        return ( <
            ...
            onChange = {
                e => this.onSelect(this.props.options[e.target.value])
            } > {
    ...
    render(props: any): React$Element < any > {
        return props.isMobile || [PLAYER_SIZE.SMALL, PLAYER_SIZE.EXTRA_SMALL].includes(this.props.playerSize) ? (
            ...
            div ref = {
                c => (this._menuElement = c)
            }
            className = {
                [style.dropdownMenu, ...this.state.position].join(' ')
            } > {
                props.options.map((o, index) => ( <
                    ...
                    className = {
                        this.isSelected(o) ? [style.dropdownMenuItem, style.active].join(' ') : style.dropdownMenuItem
                    }
                    onClick = {
                        () => this.onSelect(o)
                    }
                    onKeyDown = {
                        e => this.onKeyDown(e, o)
                    } >
                    <
                    span > {
                        o.label

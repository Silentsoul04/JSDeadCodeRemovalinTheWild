...
class VrStereoToggleControl extends BaseComponent {
    ...
    constructor(obj: Object) {
        super({
            name: VrStereoToggleControl.displayName,
            player: obj.player
        });
    }
    ...
    render(): React$Element < any > | void {
        return ( <
            div className = {
                [style.controlButtonContainer, style.controlVrStereo].join(' ')
            } >
            <
            Localizer >
            <
            ...
            aria - label = { < Text id = {
                ...
                />}
                className = {
                    this.props.vrStereoMode ? [style.controlButton, style.vrStereoMode].join(' ') : style.controlButton
                }
                onClick = {
                    () => this.onClick()
                }
    ...
    // WEBPACK FOOTER //
    // ./components/vr-stereo-toggle/vr-stereo-toggle.js


    // WEBPACK FOOTER //
    // ui/components/vr-stereo-toggle/vr-stereo-toggle.js
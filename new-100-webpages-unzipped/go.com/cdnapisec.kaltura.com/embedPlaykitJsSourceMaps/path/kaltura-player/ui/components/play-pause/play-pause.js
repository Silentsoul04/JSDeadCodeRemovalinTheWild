...
class PlayPauseControl extends BaseComponent {
    ...
    render(props: any): React$Element < any > | void {
        ...
        return ( <
            div className = {
                [style.controlButtonContainer, style.controlPlayPause].join(' ')
            } >
            <
            Localizer >
            <
            ...
            aria - label = { <
                Text id = {
                    props.isPlaybackEnded ? 'controls.startOver' : this.props.isPlayingAdOrPlayback ? 'controls.pause' : 'controls.play'
                }
                />
            }
            className = {
...
// WEBPACK FOOTER //
// ui/components/play-pause/play-pause.js
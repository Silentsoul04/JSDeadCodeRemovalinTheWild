...
class ErrorOverlay extends BaseComponent {
    ...
    renderRetryButton(): React$Element < any > | void {
        if (this.player.getMediaInfo()) {
            return ( <
                ...
                <
                button className = {
                    [style.controlButton, style.retryBtn].join(' ')
                } >
                <
                Text id = "error.retry" / >
                <
        ...
        if (this.props && this.props.hasError) {
            return ( <
                ...
                div className = {
                    ...
                    this.props.errorHead ? this.props.errorHead : < Text id = {
                        'error.default_error'
                    }
                    />}</div > {
    ...
    // WEBPACK FOOTER //
    // ./components/error-overlay/error-overlay.js


    // WEBPACK FOOTER //
    // ui/components/error-overlay/error-overlay.js
...
class SeekBarLivePlaybackContainer extends BaseComponent {
    ...
    render(props: any) {
        ...
        return ( <
            ...
            changeCurrentTime = {
                time => (this.player.currentTime = time)
            }
            playerPoster = {
                this.props.poster
            }
            updateSeekbarDraggingStatus = {
                data => this.props.updateSeekbarDraggingStatus(data)
            }
            updateSeekbarHoverActive = {
                data => this.props.updateSeekbarHoverActive(data)
            }
            updateCurrentTime = {
                data => this.props.updateCurrentTime(data)
            }
            isDvr = {
                this.props.isDvr
            }
            ...
            notifyChange = {
                payload => this.notifyChange(payload)
            }
            />
        );
    }
...
// WEBPACK FOOTER //
// ./components/seekbar-live-playback-container/seekbar-live-playback-container.js


// WEBPACK FOOTER //
// ui/components/seekbar-live-playback-container/seekbar-live-playback-container.js
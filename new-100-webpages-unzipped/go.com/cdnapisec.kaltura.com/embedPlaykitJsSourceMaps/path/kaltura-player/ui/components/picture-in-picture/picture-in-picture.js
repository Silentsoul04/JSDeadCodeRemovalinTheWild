...
class PictureInPicture extends BaseComponent {
    ...
    render(): React$Element < any > | void {
        if (this.props.isPictureInPictureSupported && this.props.playerSize !== PLAYER_SIZE.EXTRA_SMALL) {
            return ( <
                div className = {
                    [style.controlButtonContainer, style.pictureInPicture].join(' ')
                } >
                <
                Localizer >
                <
                ...
                aria - label = { < Text id = {
                    ...
                    />}
                    className = {
                        `${style.controlButton} ${this.state.animation ? style.rotate : ''}`
                    }
                    onClick = {
                        () => this._onClick()
                    }
    ...
    // WEBPACK FOOTER //
    // ./components/picture-in-picture/picture-in-picture.js


    // WEBPACK FOOTER //
    // ui/components/picture-in-picture/picture-in-picture.js
...
import {
    bindActions
} from '../../utils/bind-actions';
import {
    actions as cvaaActions
} from '../../reducers/cvaa';
import {
    actions as shellActions
} from '../../reducers/shell';
...
class CVAAOverlay extends BaseComponent {
    ...
    isAdvancedStyleApplied(): boolean {
        return (!isEqual(this.props.player.textStyle, this.captionsStyleDefault) &&
    ...
    renderMainState(): React$Element < any > {
        return ( <
            div className = {
                this.state.state === cvaaOverlayState.Main ? [style.overlayScreen, style.active].join(' ') : style.overlayScreen
            } >
            <
            div className = {
                style.title
            ...
            div tabIndex = "0"
            className = {
                [style.sample, style.blackBg].join(' ')
            }
            onClick = {
            ...
            div tabIndex = "0"
            className = {
                [style.sample, style.yellowText].join(' ')
            }
            onClick = {
            ...
            /div> {
                !this.isAdvancedStyleApplied() ? ( <
                    ...
                    div className = {
                        style.customCaptionsApplied
                    } >
                    <
                    div tabIndex = "0"
                    className = {
                        [style.sample, style.custom].join(' ')
                    }
                    style = {
                        this.state.customTextStyle.toCSS()
                    } >
                    <
    ...
    changeCustomStyle(styleChanges: Object): void {
        this.setState({
            customTextStyle: Object.assign(this.state.customTextStyle, styleChanges)
        });
    }
    ...
    renderCustomCaptionsState(props: any): React$Element < any > {
        ...
        return ( <
            div className = {
                this.state.state === cvaaOverlayState.CustomCaptions ? [style.overlayScreen, style.active].join(' ') : style.overlayScreen
            } >
            <
            form className = {
                [style.form, style.customCaptionForm].join(' ')
            } >
            <
            div className = {
                [style.formGroupRow, style.fontSize].join(' ')
            } >
            <
            label >
            <
            ...
            /label> <
            DropDown onSelect = {
                fontScale => this.changeCustomStyle({
                    fontScale
                })
            }
            options = {
            ...
            /div> <
            div className = {
                [style.formGroupRow, style.fontColor].join(' ')
            } >
            <
            label >
            <
            Text id = {
                'cvaa.font_color_label'
            }
            /> <
            /label> <
            DropDown onSelect = {
                fontColor => this.changeCustomStyle({
                    fontColor
                })
            }
            options = {
            ...
            /div> <
            div className = {
                [style.formGroupRow, style.fontFamily].join(' ')
            } >
            <
            label >
            <
            Text id = {
                'cvaa.font_family_label'
            }
            /> <
            /label> <
            DropDown onSelect = {
                fontFamily => this.changeCustomStyle({
                    fontFamily
                })
            }
            options = {
            ...
            /div> <
            div className = {
                [style.formGroupRow, style.fontStyle].join(' ')
            } >
            <
            label >
            <
            Text id = {
                'cvaa.font_style_label'
            }
            /> <
            /label> <
            DropDown onSelect = {
                fontEdge => this.changeCustomStyle({
                    fontEdge
                })
            }
            options = {
            ...
            /div> <
            div className = {
                [style.formGroupRow, style.fontOpacity].join(' ')
            } >
            <
            label >
            <
            ...
            value = {
                this.state.customTextStyle.fontOpacity * 100
            }
            onChange = {
                fontOpacity => this.changeCustomStyle({
                    fontOpacity: fontOpacity / 100
                })
            }
            /> <
            /div> <
            div className = {
                [style.formGroupRow, style.backgroundColor].join(' ')
            } >
            <
            label >
            <
            ...
            /label> <
            DropDown onSelect = {
                backgroundColor => this.changeCustomStyle({
                    backgroundColor
                })
            }
            options = {
            ...
            /div> <
            div className = {
                [style.formGroupRow, style.backgroundOpacity].join(' ')
            } >
            <
            label >
            <
            ...
            value = {
                this.state.customTextStyle.backgroundOpacity * 100
            }
            onChange = {
                backgroundOpacity => this.changeCustomStyle({
            ...
            className = {
                [style.btn, style.btnBranded, style.btnBlock].join(' ')
            } >
            <
            Text id = {
                'cvaa.apply'
...
// WEBPACK FOOTER //
// ui/components/cvaa-overlay/cvaa-overlay.js
...
class RemotePlayerUI {
    _uis: Array < UIPreset > = [{
            template: props => this.idleUI(props),
            condition: state => state.engine.isIdle
        },
        {
            template: props => this.errorUI(props),
            condition: state => state.engine.hasError
        },
        {
            template: props => this.adsUI(props),
            condition: state => state.engine.adBreak
        },
        {
            template: props => this.liveUI(props),
...
// WEBPACK FOOTER //
// ./common/cast/remote-player-ui.js
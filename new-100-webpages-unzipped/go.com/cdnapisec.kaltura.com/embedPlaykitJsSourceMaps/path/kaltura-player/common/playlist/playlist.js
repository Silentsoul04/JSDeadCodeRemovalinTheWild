...
class Playlist {
    ...
    get prev(): {
        ...
        return {
            item: this._items[this._activeItemIndex - 1] || null,
            index: this._activeItemIndex - 1
        };
    }

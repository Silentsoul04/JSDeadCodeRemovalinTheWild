(window.QJP = window.QJP || []).push([
    [18], {
        ...
        "7H+L": function(e, t, n) {
            "use strict";
            t.__esModule = !0, t.observerElementsMap = void 0, t.getPooled = o, t.findObserverElement = s, t.callback = a, t.createObserver = function(e) {
                return o(e) || new IntersectionObserver(a, e)
            }, t.observeElement = function(e) {
                i.has(e.observer) || i.set(e.observer, new Set);
                i.get(e.observer).add(e), e.observer.observe(e.target)
            }, t.unobserveElement = function(e) {
                if (i.has(e.observer)) {
        ...
        GKkb: function(e, t, n) {
            "use strict";
            t.__esModule = !0, t.isDOMTypeElement = function(e) {
                return o.default.isValidElement(e) && "string" == typeof e.type
            }, t.parseRootMargin = function(e) {
                ...
                if (Array.isArray(t) && Array.isArray(n) && t.length === n.length) return t.some(function(r, i) {
                    return e(t[i], n[i])
                });
                return t !== n
            };
            ...
            var r = n("8OQS"),
                ...
                g = function(e) {
                    ...
                    return Object(o.useEffect)(function() {
                        var e;
                        (e = g.id, Object(c.a)().then(function(t) {
            ...
            var g = ["root", "rootMargin", "threshold"],
                ...
                _ = function(e) {
                    function t() {
                        ...
                        return n = i = u(this, e.call.apply(e, [this].concat(c))), i.handleChange = function(e) {
            ...
            QWait("Quizlet.Common.i18n", function() {
                ...
                var p = n("7RXM"),
                    ...
                    M = function() {
                        function e(e, t) {
                            var n = this;
                            this._handleMediaQueryChange = function(e) {
                            ...
                            }, this._convertSetToArray = function(e) {
                                var t = [];
                                return e.forEach(function(e) {
                                    return t.push(e)
                                }), t
                            }, this.handleSlotRenderEnded = function(e) {
                        ...
                        var t = e.prototype;
                        return t.setupHeaderBiddingLibrary = function() {
                            var e = this,
                                t = window;
                            return t.apstag ? t.apstag : (t.apstag = {
                                ...
                                _Q: []
                            }, Object(b.b)() || QWait("Quizlet.apstag", function() {
                                e.apstag = t.apstag
                            }), t.apstag)
                        }, t.addUserScreenSizeToConfig = function() {
                            this.config.keyValues.sh = Object(f.a)().toString(), this.config.keyValues.sw = Object(f.b)().toString()
                        }, t.init = function() {
                            var e = this;
                            this.config.allAdsDisabled || (this.addUserScreenSizeToConfig(), this.googletag.cmd.push(function() {
                            ...
                            }), Object.keys(this.config.registeredAds).forEach(function(t) {
                        ...
                        }, t.collapseAdContainer = function(e) {
                            return function() {
                                var t = document.getElementById(e);
                                t && (t.style.display = "none")
                            }
                        }, t.initHeaderBidding = function() {
                        ...
                        }, t.defineSlot = function(e, t) {
                            var n = this;
                            this._slots[e] = {}, this.googletag.cmd.push(function() {
                        ...
                        }, t.displayAd = function(e) {
                            var t = this;
                            this.isShowing(e) ? (this.addResizeListenersForAd(e), this.googletag.cmd.push(function() {
                                var n = Object(m.a)(e);
                        ...
                        }, t.getResizeListenerForSize = function(e) {
                            var t = e[0],
                                n = e[1],
                                r = t + "x" + n;
                        ...
                        }, t.addResizeListenersForAd = function(e) {
                            var t = this,
                                n = this.config.registeredAds[e];
                            (Object(v.a)(e, n) || []).forEach(function(n) {
                                var r = n[0],
                                    i = t.getResizeListenerForSize(r);
                                i && i.adsToRefresh.add(e)
                            })
                        }, t.displayVideoAd = function(e) {
                            var t = window;
                        ...
                        }, t.getAutoPlayAdsMuted = function(e) {
                            var t = this.config.registeredAds[e].autoPlayAdsMuted;
                            return void 0 === t || t
                        }, t.generateAdScheduleId = function(e) {
                            var t = 0,
                                n = e.length,
                                r = 0;
                            if (n > 0)
                        ...
                        }, t.getBaseVideoAdConfigObject = function(e) {
                        ...
                        }, t.getOutStreamVideoAdConfigObject = function(e) {
                            var t = {
                        ...
                        }, t.getInStreamVideoAdConfigObject = function(e) {
                            var t = {
                                    autoplayadsmuted: this.getAutoPlayAdsMuted(e),
                                    client: "googima"
                                },
                            ...
                            }), n.length !== e.length && this.prepareAdsForRefresh(e).then(function() {
                                t.googletag.cmd.push(function() {
                        ...
                        }, t.getMatchMedia = function(e) {
                            return c()(e)
                        }, t.getShowAdHeading = function(e) {
                        ...
                        }, t.getAdHeadingContainer = function(e) {
                            return document.getElementById(Object(m.b)(e))
                        }, t.logError = function(e, t) {
                            l.a.warning(e, t)
                        }, t.hideAdHeadingForEmptySlot = function(e, t, n, r) {
                        ...
                        }, t.hasRegisteredAdsWithHeaderBidding = function(e) {
                            return (Object.values ? Object.values(e) : Object.getOwnPropertyNames(e).map(function(t) {
                                return e[t]
                            })).filter(function(e) {
                                return !0 === e.useHeaderBidding
                            }).length > 0
                        }, t.handleSponsoredRewardsMessage = function(e) {
                ...
                N.init(), h.a.QAdManager = N, QLoad("Quizlet.Ads"), QWait("dom", function() {
                    if (Object(b.b)()) {
                    ...
                    h.a.setPageFooterAdData && Object(O.a)("SetPageFooterAd").then(function(e) {
                        var t = e.target,
                            n = e.data;
                        return Object(I.a)(r.a.createElement(P, n), t)
                    })
                }), Object.keys(h.a.adConfig.registeredAds).forEach(function(e) {
                    h.a.adConfig.registeredAds[e].isServerRendered && Object(O.a)("SiteAd" + e).then(function(e) {
                        var t = e.target,
                            n = e.data;

        ...
        window.JSON && window.JSON.stringify && window.JSON.parse ? t = window.JSON : _t && (t = _t.getCleanObject("JSON")), Tumblr.LikeButtonUpdate = function() {
            ...
            update_like_state: function(e) {
                if (e.post_id) {
                    ...
                    i && i.contentWindow.postMessage("state_update;" + t.stringify(e), "https://assets.tumblr.com")
                }
            }
        }
...
Tumblr.IndashBlog || (Tumblr.IndashBlog = {}), Tumblr.TumblelogPopover || (Tumblr.TumblelogPopover = {}),
    ...
    function(t, e) {
        ...
        var i = Backbone.View.extend({
            ...
            initialize: function() {
                this.logged_in = !t(document.body).hasClass("logged_out"), this.auto_paginate = Tumblr.auto_paginate || !1, this.animate_scroll = void 0 !== Tumblr.animate_scroll && Tumblr.animate_scroll, this.scroll_speed = 100, this.set_scroll_offset(), this.pressed_keys = [], this.current_post = null, Tumblr.enable_dashboard_key_commands || this.suspend(), this.blog_switcher_detection(), this.is_xbox = Tumblr.Flags.bool("is_xbox"), this.is_xbox && (this.animate_scroll = !1), Tumblr.Events && (this.listenTo(Tumblr.Events, "keycommands:suspend", this.suspend), this.listenTo(Tumblr.Events, "keycommands:resume", this.resume), this.listenTo(Tumblr.Events, "fastCompose:create", this.create_new), this.listenTo(Tumblr.Events, "notificationBannerManager:update", this.set_scroll_offset))
            },
            set_scroll_offset: function() {
                var e = 15,
                    i = t(".l-header-container");
                i.length ? this.scroll_offset = i.position().top + i.height() + e : this.scroll_offset = e
            },
            suspend: function(t) {
...
Tumblr.IndashBlog || (Tumblr.IndashBlog = {}),
    ...
    function(t, e, i, o) {
        var s = o.EditableText.extend({
            ...
            initialize: function(i) {
                if (o.EditableText.prototype.initialize.call(this, e.extend({
                        character_limit: 50
                    }, i)), this.all_fonts = this.options.all_fonts, this.current_font = e.result(this.all_fonts, this.model.get_theme_param("title_font")), !this.current_font) {
                    var s = e.first(e.keys(this.all_fonts));
                    this.current_font = this.all_fonts[s]
                }
                this.$current_font = t(), this.$current_font_label = t(), this.popover = new o.Popover({
                    direction: "up",
                    edit_field: this.$el,
                    trigger: !1,
        ...
        var n = e.get(o, "Prima.LivePhotos"),
            ...
            l = i.View.extend({
                ...
                events: {
                    ...
                    "click .post_content figure.tmblr-full a.post_media_photo_anchor": "__post_content_inline_clicked",
                ...
                __post_content_inline_clicked: function(e) {
                    e.preventDefault();
                    var i = t(e.currentTarget),
                        s = i.find("img").attr("src"),
                        n = i.attr("data-big-photo"),
                        r = i.attr("data-big-photo-width"),
                        a = i.attr("data-big-photo-height");
                    if (void 0 !== s && void 0 !== n && void 0 !== r && void 0 !== a) {
                        var l = {
                            width: r,
                            height: a,
                            low_res: s,
                        ...
                        o.Events.trigger("lightbox-open-request", [l], 1)
                    }
                },
    ...
    function(t) {
        ...
        Tumblr.PostsView = Backbone.View.extend({
            ...
            setupMoatForVideo: function(t, e) {
                var i = _.get(e, "attributes.viewability", !1);

/*! scripts/settings/utils/settings_validators.js */ ! function(e, n) {
    var t = {
        is_blank: function(n) {
            return "" === e.trim(n)
        },
        min_length: function(e, n) {
            return e.length >= n
        },
        max_length: function(e, n) {
            return e.length <= n
        },
        range: function(e, n, t) {
            return e.length >= n && e.length <= t
        },
    ...
    n.settings_validators = t
}(jQuery, Tumblr), /*! scripts/antispam/client_profiling.js */
function(e, n, t, i) {
    i.CLP = n.View.extend({
        el: "body",
...
function(e, n) {
    ...
    function(e, n, t, i) {
        ...
        function n(n) {
            z.current_view = n, e("body").addClass("show_form").addClass(n), loading_next_page = !0, i(n), s(), J.track_event("update_view", n)
        }
        ...
        function t(n) {
            ...
            }), e("#signup_button_signup").length && e("#signup_button_signup").removeClass("shallow").addClass("other_blue"), loading_next_page = !1, z.current_view = null, M = null, reset_form && d(), reset_form && J.track_event("reset_view")
        }
        ...
        function i(n) {
            ...
            if (e(".signup_forms_panel .signup_view:not(#" + s + ")").removeClass("active"), e(".signup_forms_submit span").removeClass("active"), "signup_login" === n ? e("#signup_account").addClass("active") : i.addClass("active"), e(".signup_forms_submit ." + n + "_btn").addClass("active"), o(), r(), R(n) && (u(), L.attr("action", L.attr("data-secure-action")), M = e('#signup_account input:not("#signup_username")'), e("#signup_button_signup").length && e("#signup_button_signup").addClass("shallow").removeClass("other_blue"), z.errors && (p(z.errors), z.errors = null), e("body").hasClass("has_login_captcha") ? (G(function() {
                    Tumblr.NoCaptcha({
                        target: "g-recaptcha",
                ...
                }, 50), e(".forgot_password_container").css("display", "none"), e(".magiclink_password_container").css("display", "inline-block"), e(".magiclink_password_container").off("click").click(w), e(".magiclink_send_magic_link").off("click").click(w), e(".email_user").text(e("#signup_determine_email").val()), e(".input_email").val(e("#signup_determine_email").val()), 0 !== e(".signup_forms_container").find(".magiclink").length && e(".signup_forms_container").css("background", "transparent"), e(".back_container").off("click").click(w)), "signup_magiclinkemail" == n && (e(".signup_forms_submit").css("display", "none"), e(".forgot_password_container").css("display", "none"), e("body").removeClass("signup_determine signup_magiclink"), Tumblr.Events.trigger("Kraken:MagicLink:SendSuccess"), setTimeout(function() {
                    e("#signup_magiclinkemail").focus()
                }, 50), e(".magiclink_password_container").css("display", "inline-block").off("click").click(w), e(".magiclink_send_magic_link").off("click").click(w), e(".email_user").html(e("#signup_determine_email").val()), e(".input_email").val(e("#signup_determine_email").val()), 0 !== e(".signup_forms_container").find(".magiclink").length && e(".signup_forms_container").css("background", "transparent"), e(".back_container").off("click").click(w)), "signup_login" == n && (e(".forgot_password_container").css("display", "inline-block"), e("body").hasClass("signup_determine") && (!e("#signup_password").val() && e("#signup_password_hidden").val() && e("#signup_password").val(e("#signup_password_hidden").val()), e("#signup_email").val(e("#signup_determine_email").val()), e("#signup_email").attr("readonly", "readonly"), e("#signup_password").focus())), "signup_account" == n && (e("body").hasClass("mobile_splash_active") || e("#signup_email").focus(), e("body").hasClass("signup_determine") && (e("#signup_email").val(e("#signup_determine_email").val()), e("#signup_email").attr("readonly", "readonly"), e("#signup_password").focus()), Z && (q ? q.update() : q = new Tumblr.PasswordStrengthMeter), i.keydown(function(n) {
                ...
                var g;
                try {
                    g = JSON.parse(e("#random_username_suggestions").val())
                } catch (_) {
                    g = !1
                }
                g && (e("#signup_username").on("focus", function() {
                    e(this).val() || l(g, Tumblr.Flags.bool("autopopulate_username_suggestion"))
                }), e(".signup_username").on("keyup", function() {
                    e(".signup_username_checkmark").toggle(g.indexOf(e(this).val()) > -1)
                }))
            }
            "signup_birthday" == n ? (setTimeout(function() {
                ...
                t = e(n.target), t.hasClass("signup_age") && c(t)
            }), e(".signup_terms_link").attr("tabindex", 0)) : e(".signup_terms_link").attr("tabindex", -1), "signup_register" == n && G(function() {
                Tumblr.NoCaptcha({
                    target: "g-recaptcha",
                    sitekey: e(".g-recaptcha").data("sitekey"),
                    callback: w
        ...
        function a() {
            H || (H = new Tumblr.TFACode), H.resend_token_sms(e("#signup_email").val(), e("#tfa_form_key"))
        }

        function r() {
            e("#" + z.current_view + " input").each(function(n) {
        ...
        function l(n, t) {
            ...
            s.removeClass("hidden"), E = new Tumblr.Popover({
                el: "#suggested_usernames_container",
                direction: "left",
                skip_glass: !0
            }), E.show(), new Tumblr.UsernameSuggester, e("#seen_suggestion")[0].value++
        }
        ...
        function g(n) {
            ...
            for (s.html(""), i = a - 1; i >= 0; i--) {
                ...
                J.track_event("error", r)
            }
        }

        function p(n) {
            n && n.length && (g(n), e("#signup_forms").addClass("has_errors")), G(function() {
            ...
            }), I || e("#signup_forms_container").addClass("shake").addClass("animated");
            setTimeout(function() {
        ...
        function b(n) {
            ...
            if ("" !== s) {
                if (f(n) && !s.match(/\@ymail.com$/i)) {
                    var a, r, o, u, c, l;
                    Tumblr.SpellChecker.init(D, {
                        costMultiplier: .05
                    }), o = (r = s.match(/[^@]+$/)) ? r[0] : "", !/\@/.test(s) || 0 !== window.location.pathname.indexOf("/login") && !Tumblr.settings_validators.is_email(s) ? t = "That's not a valid email address. Please try again." : s.toLowerCase().indexOf("@tumblr.com") != -1 ? t = S(["That email address is already in use. Please try again.", "That email address is already associated with another account."]) : !X && (a = Tumblr.SpellChecker.suggest(o)).length && (c = s.split("@")[0] + "@" + a[0], c != s && (l = __("Oops. Did you mean %1$s ?"), email_placeholder = "%1$s", u = '<a href="#" id="' + n.attr("id") + '_suggestion">' + c + "</a>", t = l.replace(email_placeholder, u, "g"), X = !0))
                }
                if ("signup_password" == n.attr("id") && ("" == e.trim(s) && (t = "Don't forget your password!"), q && q.block_registration_step && (t = q.block_registration_step)), "signup_username" == n.attr("id") && (s.length > 0 && s.indexOf("-", s.length - 1) === s.length - 1 && (t = "Can't do dashes at the start or end. Middles only."), 0 === s.lastIndexOf("-", 0) && (t = "Can't do dashes at the start or end. Middles only."), s.toLowerCase().indexOf("tumblr") != -1 && (t = "Rule #14: You can't put Tumblr in your username.")), "signup_age" == n.attr("id")) {
                    var g = parseInt(s),
                        _ = new String(g),
                        d = s.replace(/^\s+|\s+$/g, "");
                    _ != d ? t = "Please enter your age as a number only!" : g < 1 && (t = "Please enter a number!")
                }
                t && i.push(__(t))
            }
        ...
        function k() {
            e(E).length && (e("#suggested_usernames_container").addClass("hidden"), e(E).hide())
        }

        function w(i) {
            if (!te) return !1;
            if (te = !1, m(), R(z.current_view)) return L.submit(), !0;
            if ("signup_magiclink" === z.current_view) {
            ...
            return "signup_magiclinkemail" === z.current_view ? (e(".signup_forms_container").css("background", "white"), e(".signup_forms_submit").css("display", "block"), e(".signup_forms_submit.mobile.login").css("display", "none"), e(".magiclink_password_container").css("display", "none"), e("body").removeClass("signup_determine"), "magiclink_password_container chrome" == i.currentTarget.className ? (e("body").removeClass("signup_magiclinkemail"), e("body").removeClass("signup_magiclink"), Tumblr.Events.trigger("Kraken:MagicLink:UsePasswordButtonPressed"), n("signup_login"), e("#signup_login_button").css("display", "none")) : "back_container" == i.currentTarget.className && (e("body").removeClass("signup_magiclinkemail"), e("body").removeClass("signup_magiclink"), Tumblr.Events.trigger("Kraken:MagicLink:BackButtonPressed"), n("signup_determine"), e("#signup_login_button").css("display", "none")), void(te = !0)) : void("signup_account" !== z.current_view || L.find("#signup_username").val() || e("body").hasClass("openid_connect_registration") ? v() ? (k(), u(), s = L.serialize() + "&action=" + encodeURIComponent(z.current_view) + "&tracking_url=" + encodeURIComponent(A) + "&tracking_version=" + encodeURIComponent($), e.ajax(L.attr("action"), {
                ...
                error: function(e, n, t) {
                    ...
                    }), e.redirect ? (J.track_event("error", "redirect"), window.location.replace(e.redirect)) : (p(e.errors), e.usernames && setTimeout(function() {
                        I || l(e.usernames, Tumblr.Flags.bool("autopopulate_username_suggestion"))
                    }, 750)), "signup_register" == z.current_view && J.track_event("fail", Q), te = !e.redirect
                },
                success: function(i) {
                    i.signup_success && (J.track_event("success", Q), Tumblr.Events.trigger("Kraken:loginregister:flowComplete")), i.redirect ? "POST" === i.redirect_method ? (L.attr("action", i.redirect), L.submit()) : window.location.replace(i.redirect) : i.next_view ? ("signup_account" === i.next_view && t(), n(i.next_view)) : n(e("#" + z.current_view).next().attr("id")), te = !(i.redirect && "POST" === i.redirect_method)
                }
        ...
        function P() {
            K = e(".like_button, .reblog_button, .everyone_i_follow, .my_posts, .send_to_signup")
        }
        ...
        var E, B, F, M, N, O, L, z, D, K, $, A, Q, U, I, V, Y, q, Z, J, H, G, W, X = !1,
            ee = [],
            ...
            initialize: function(t) {
                t = t || {}, ne = e("#tumblr_form_key").attr("content"), G = Tumblr.Flags("captcha_use_recaptcha2"), U = document.body.className.match("is_login_register"), U = !(!U || !U.length), V = e(document.body).hasClass("is_tablet"), Y = e(document.body).hasClass("is_mobile_handset"), I = V || Y, Z = e(document.body).hasClass("show_password_strength"), L = e("#signup_form"), N = e("#signup_forms_submit"), O = e("#signup_login_button"), B = e(".signup_buttons .login_signup_button, #logo"), F = e(".signup_view"), signup_form_fields = e("#signup_form input"), z = this, $ = "modal", A = document.location.pathname, Q = "?url=" + A + "&version=" + $, P(), W = !1, t.clp_url && t.clp_url.length && Tumblr.CLP && (W = new Tumblr.CLP({
                    ...
                    e(this).on("change", _.partial(b, this)), e(this).on("blur", function() {
                        W && !W.rendered && "signup_account" == z.current_view && W.render(), Tumblr.Events.trigger("Kraken:loginregister:beginFlow")
                    })
                ...
                }), T(), z.errors && (p(z.errors), z.errors = null)), x()
            },

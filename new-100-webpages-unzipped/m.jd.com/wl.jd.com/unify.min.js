/* 2019-09-16 18:04:46 unify.min.js @issue to lijiwen@jd.com Thanks */ ! function() {
    var ScriptStartTime = new Date;
    try {
        window.fingerprint = {}, fingerprint.config = {
            ...
            rB: function() {
                ...
                for (var a in t) r = t[a], window.document[r] && e.push({
                    key: "window_document",
                    value: r
                });
                for (var n in window.document) n.match(/\$[a-z]dc_/) && window.document[n].cache_ && e.push({
                    key: "document",
                    value: n
                });
            ...
            getCanvas: function() {
                try {
                    ...
                    return o.rect(0, 0, 10, 10), o.rect(2, 2, 6, 6), t.push("canvas winding:" + (!1 === o.isPointInPath(5, 5, "evenodd") ? "yes" : "no")), o.textBaseline = "alphabetic", o.fillStyle = "#f60", o.fillRect(125, 1, 62, 20), o.fillStyle = "#069", o.font = "11pt no-real-font-123", o.fillText("Cwm fjordbank glyphs vext quiz, 😃", 2, 15), o.fillStyle = "rgba(102, 204, 0, 0.2)", o.font = "18pt Arial", o.fillText("Cwm fjordbank glyphs vext quiz, 😃", 4, 45), o.globalCompositeOperation = "multiply", o.fillStyle = "rgb(255,0,255)", o.beginPath(), o.arc(50, 50, 50, 0, 2 * Math.PI, !0), o.closePath(), o.fill(), o.fillStyle = "rgb(0,255,255)", o.beginPath(), o.arc(100, 50, 50, 0, 2 * Math.PI, !0), o.closePath(), o.fill(), o.fillStyle = "rgb(255,255,0)", o.beginPath(), o.arc(75, 100, 50, 0, 2 * Math.PI, !0), o.closePath(), o.fill(), o.fillStyle = "rgb(255,0,255)", o.arc(75, 75, 75, 0, 2 * Math.PI, !0), o.arc(75, 75, 25, 0, 2 * Math.PI, !0), o.fill("evenodd"), t.push("canvas fp:" + fingerprint.util.MD5.hex_md5(r.toDataURL())), fingerprint.config.api.canvas_spendtime = (new Date).getTime() - e.getTime(), t.join("~")
                } catch (i) {
                    return ""
                }
            },
            ...
            getTimeZone: function() {
                return window.Intl && window.Intl.DateTimeFormat ? (new window.Intl.DateTimeFormat).resolvedOptions().timeZone : undefined
            }
        }, fingerprint.webview = {
            getIosFingerprint: function() {
                0 == navigator.userAgent.indexOf("jdapp") && (-1 != navigator.userAgent.indexOf("supportJDSHWK/1") || 1 == window._is_jdsh_wkwebview ? window.webkit.messageHandlers.JDAppUnite.postMessage({
                    method: "callSyncRouterModuleWithParams",
                    params: JSON.stringify(fingerprint.config.unionwsws_param.iOS)
                }) : window.JDAppUnite.callRouterModuleWithParams(JSON.stringify(fingerprint.config.unionwsws_param.iOS)))
            },
            getAndroidFingerprint: function() {
                this.isWKWebView() ? window.webkit.messageHandlers.JDAppUnite.postMessage({
                    method: "notifyMessageToNative",
                    params: JSON.stringify(fingerprint.config.unionwsws_param.android)
                }) : window.JdAndroid && window.JdAndroid.notifyMessageToNative(JSON.stringify(fingerprint.config.unionwsws_param.android))
            },
            fingerPrintCallback: function(e) {
                try {
                    0 == (e = JSON.parse(e)).status && fingerprint.util.setStorage("unionwsws", e.data)
                } catch (t) {}
            },
            getAppFingerprint: function() {
                try {
                    var e = navigator.userAgent.toLowerCase();
                    /iphone|ipad|ios|ipod/.test(e) ? this.getIosFingerprint() : /android/.test(e) && this.getAndroidFingerprint()
                } catch (t) {}
            ...
            getFpb: function(e) {
                ...
                if (window.navigator.cookieEnabled) {
                    ...
                    if (-1 != o) {
                        var i = e.length + 1;
                        o += i;
                        var a = window.document.cookie.indexOf(";", o); - 1 == a && (a = window.document.cookie.length);
                        try {
                            t = decodeURIComponent(window.document.cookie.substring(o, a)) || ""
                        } catch (n) {
            ...
            MD5: {
                ...
                str2binl: function(e) {
                    for (var t = Array(), r = (1 << this.chrsz) - 1, o = 0; o < e.length * this.chrsz; o += this.chrsz) t[o >> 5] |= (e.charCodeAt(o / this.chrsz) & r) << o % 32;
                    return t
                },
                binl2hex: function(e) {
                    for (var t = "0123456789abcdef", r = "", o = 0; o < 4 * e.length; o++) r += t.charAt(e[o >> 2] >> o % 4 * 8 + 4 & 15) + t.charAt(e[o >> 2] >> o % 4 * 8 & 15);
                    return r
                }
            },
            Base64: {
                ...
                encode: function(e) {
                    var t, r, o, i, a, n, d, l = "",
                        c = 0;
                    for (e = this._utf8_encode(e); c < e.length;) i = (t = e.charCodeAt(c++)) >> 2, a = (3 & t) << 4 | (r = e.charCodeAt(c++)) >> 4, n = (15 & r) << 2 | (o = e.charCodeAt(c++)) >> 6, d = 63 & o, isNaN(r) ? n = d = 64 : isNaN(o) && (d = 64), l = l + this._keyStr.charAt(i) + this._keyStr.charAt(a) + this._keyStr.charAt(n) + this._keyStr.charAt(d);
                    return l
                },
    ...
    function genHash(e) {
        var t, r = 1,
            o = 0;
        if (e)
            for (r = 0, t = e.length - 1; t >= 0; t--) r = 0 !== (o = 266338304 & (r = (r << 6 & 268435455) + (o = e.charCodeAt(t)) + (o << 14))) ? r ^ o >> 21 : r;
        return r
    }
    ...
    function delCookie(e, t, r, o) {
        var i = new Date;
        i.setMinutes(i.getMinutes() - 1e3), t = t || "/", document.cookie = e + "=;expires=" + i.toGMTString() + (t ? ";path=" + t : "") + (r ? ";domain=" + r : "") + (o ? ";secure" : "")
    }

    function flashChecker() {
        var e, t = "";
        return navigator.plugins && navigator.plugins.length > 0 && (e = navigator.plugins["Shockwave Flash"]) && (t = e.description.split(" ")) && t.length >= 4 && (t = t[2] + " " + t[3]), t
    }
    ...
    function getSkuid() {
        var e;
        return "undefined" != typeof pageConfig && (e = pageConfig.product ? pageConfig.product.skuid : 0), e || ""
    }

    function getShopid() {
        var e;
        return "undefined" != typeof pageConfig && (e = pageConfig.product ? pageConfig.product.shopId : 0), e || ""
    }

    function getOrderid() {
        return ("undefined" != typeof SucInfo_OrderId ? SucInfo_OrderId : getParameter("suc_orderid")) || ""
    }
    ...
    function getCommonData(e) {
        var t, r = {},
            o = e.logType;
        for (r.pin_sid = getParameter("sid") || getCookie("sid") || "", r.report_ts = getCurTime(), r.scr = lr.resolution, r.token = lr.hex_md5(r.report_ts + lr.md5Key), r.ut = "s", r.clt = "web", r.jvr = lr.jvr || "3.0.5", r.std = lr.siteId, r.tpc = (e.topic || lr.topic) + "." + (o === lr.logType.pv ? "pv" : o === lr.logType.cl ? "cl" : "ot"), r.uuid = lr.uuid, t = 0; t < lr.getCommonDataF.length; t++) lr.getCommonDataF[t](e, r);
        return r
    }

    function getJdv() {
        var e = getCookie(lr.ckJdv || "__jdv", 1),
            t = getHashDomain(),
            r = "direct",
            o = "none",
            i = "-",
            a = "-",
            n = (new Date).getTime();
        return e && e.indexOf("|") < 0 && (e = urlDecode(e)), 6 == (e = e.split("|")).length && (t = e[0], r = e[1], i = e[2], o = e[3], a = e[4], n = e[5]), {
    ...
    function setJdv(e, t) {
        var r = "";
        r = isPrey(10) && (!e || e.length > 400) ? t + "|direct|-|none|-|" + (new Date).getTime() : e;
        var o = isEmbedded() ? lr.ckJdvEmbeddedExp : lr.ckJdvExp;
        setCookie(lr.ckJdv || "__jdv", r, lr.ckDomain, o)
    }

    function isWX() {
        return !!(",wq.jd.com,wqs.jd.com,wqitem.jd.com,wqcoss.jd.com,wqsou.jd.com,wqdeal1.jd.com,wqdeal2.jd.com,wqsitem.jd.com,wqitem.jd.hk,wqitem.jdworldwide.com,".indexOf("," + window.location.host + ",") >= 0) || !!getParameter("debugIsWQ")
    }

    function isWxapp() {
        var e = navigator.userAgent.toLowerCase();
        return /miniprogram/gi.test(e) || "miniprogram" === window.__wxjs_environment
    }
    ...
    lr.getCommonDataF = [], lr.updateCookieF = [], lr.initBF = [], lr.initAF = [], lr.getPrivateDataF = [], lr.clickCBF = [], lr.logOldF = [], lr.data_version = "0.1", lr.refCls = "";
    var businessDomain = function() {
            for (var e = ".jd.com", t = document.domain.toLowerCase(), r = ["jd.ru", "joybuy.com", "joybuy.es"], o = 0; o < r.length; o++) {
                var i = r[o];
    ...
    function hasTransmitFunc() {
        return !(!window.JDMAUnifyBridge || !window.JDMAUnifyBridge.JDMAGetMPageParam) || (!!window.JDMAGetMPageParam || !!(window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.JDMASetMPageParam))
    }

    function getPageParamFromSdk() {
        var t, r;
        try {
            window.JDMAUnifyBridge && window.JDMAUnifyBridge.JDMAGetMPageParam ? r = JDMAUnifyBridge.JDMAGetMPageParam() : window.JDMAGetMPageParam ? r = JDMAGetMPageParam() : window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.JDMASetMPageParam && (r = window.prompt("JDMAGetMPageParam", "")), r && (t = JSON.parse(r))
        } catch (e) {}
        return t
    }

    function setPageParamForSdk(e) {
        window.JDMAUnifyBridge && window.JDMAUnifyBridge.JDMASetMPageParam ? JDMAUnifyBridge.JDMASetMPageParam(e) : window.JDMASetMPageParam ? JDMASetMPageParam(e) : window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.JDMASetMPageParam && window.webkit.messageHandlers.JDMASetMPageParam.postMessage(e)
    }
    var urlEncode = encodeURIComponent,
        ...
        osInfo = getOsInfo(),
        a590, a591, a592, a593, a587, a584, a583, a579, a575, a576, a550, a551, a552, a553, a554, a555;
    ...
    function getMtaData() {
        var t, r = window;
        try {
            r.MtaHelper && r.MtaHelper.getMtaData ? t = r.MtaHelper.getMtaData() : r.jdmataData && (t = r.jdmataData)
        } catch (e) {}
        return t
    }
    if (isWxapp()) {
        ...
        if (cookie) {
            ...
            ckArray.length >= 2 && (lr.wxAppUuid = ckArray[0], lr.wxAppSiteId = ckArray[1], lr.wxAppAppid = ckArray[2], lr.wxAppAppkey = ckArray[3])
        }
        ...
        if (begin > -1 && begin + paramName.length + 1 < url.length - 1) {
            ...
            if (-1 === end || end > begin) {
                var seriesStr = decodeURIComponent(url.substring(begin + paramName.length + 1, end > -1 ? end : url.length)),
                    series = null;
                try {
                    if (series = JSON.parse(seriesStr), series) {
                        if (lr.wxAppUuid = series.uuid, lr.wxAppSiteId = series.std, lr.wxAppAppid = series.appid, lr.wxAppAppkey = series.appkey, lr.wxAppUuid || lr.wxAppSiteId) {
                            var wxAppCk = [lr.wxAppUuid, lr.wxAppSiteId, lr.wxAppAppid, lr.wxAppAppkey];
                            setCookie(lr.ckWxAppCk, wxAppCk.join("."), lr.ckDomain, lr.ckWxAppCkExp)
                        }(series.vts || series.seq) && (lr.wxAppSidSeq = series.vts + "." + series.seq)
                    }
                } catch (e) {}
            }
        }
    ...
    function compareAndUpdateCookie(e, t) {
        ...
        if (getCookie(lr.ckmba_sid)) r = getCookie(lr.ckmba_sid);
            ...
            if (3 === i.length) {
                var a = i[1],
                    n = parseInt(i[2]);
                r = (new Date).getTime() - n > lr.ckmba_sidExp ? [1 * a + 1, 0].join(".") : [a, 0].join(".")
            } else r = "1.0"
        }
        o = compare(e, r), lr._mbaSidSeq[0] = o.split(".")[0], lr._mbaSidSeq[1] = 1 * (o.split(".")[1] ? o.split(".")[1] : 0) + (t ? 1 : 0), lr._mbaMuidSeq[1] = lr._mbaSidSeq[0], lr._mbaMuidSeq[2] = (new Date).getTime(), setCookie(lr.ckmba_sid, encodeURI(lr._mbaSidSeq.join(".")), lr.ckDomain, lr.ckmba_sidExp), setCookie(lr.ckmba_muid, encodeURI(lr._mbaMuidSeq.join(".")), lr.ckDomain, lr.ckmba_muidExp)
    }
    ...
    function getReservedCookies() {
        for (var e = [lr.ckJda, lr.ckJdv, lr.ckJdb, lr.ckJdu, lr.ckJdb, "mu_subsite", "mt_xid", "unpl"], t = [], r = 0, o = e.length; r < o; r++) t.push(getCookie(e[r]));
    ...
    function updateMFLSeries(e) {
        if (isEmbedded()) {
            ...
            r && (lr.eventSeries.event_id = t, lr.eventSeries.event_level = parseInt(r), lr.eventSeries.event_param = e.event_param, lr.eventSeries.page_name = e.page_name, lr.eventSeries.page_param = e.page_param)
        }
    }
    ...
    function quickClick(e, t) {
        var r = !0;
        return isWX() && (r = !1), "undefined" == typeof window.ontouchstart || r ? (e.addEventListener("click", function(e) {
            t(e)
        }, !1), !0) : new QuickClick(e, t)
    }
    ...
    function QuickClick(e, t) {
        ...
        for (var r = ["onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], o = 0, i = r.length; o < i; o++) this[r[o]] = bind(this[r[o]], this);
        e.addEventListener("touchstart", this.onTouchStart, !1), e.addEventListener("touchmove", this.onTouchMove, !1), e.addEventListener("touchend", this.onTouchEnd, !1), e.addEventListener("touchcancel", this.onTouchCancel, !1)
    }
    ...
    if (lr.getCommonDataF.push(function(e, t) {
            var r, o = {
                    IOS_M: {
                        UAname: "iPhone",
                        value: "IOS-M"
                ...
                a = [];
            isJdLog() ? ((a = i.split(";"))[2].toLowerCase() === o.IOS_M.UAname.toLowerCase() ? t.cli = o.IOS_M.value : a[2].toLowerCase() === o.ANDROID_M.UAname.toLowerCase() ? t.cli = o.ANDROID_M.value : a[2].toLowerCase() === o.IPAD_M.UAname.toLowerCase() && (t.cli = o.IPAD_M.value), lr.appv = a[3], t.osv = a[4], t.uid = a[5]) : isEmbedded() ? ((a = i.split(";"))[1].toLowerCase() === o.IOS_M.UAname.toLowerCase() ? t.cli = o.IOS_M.value : a[1].toLowerCase() === o.ANDROID_M.UAname.toLowerCase() ? t.cli = o.ANDROID_M.value : a[1].toLowerCase() === o.IPAD_M.UAname.toLowerCase() && (t.cli = o.IPAD_M.value), lr.appv = a[2], t.osv = a[3], t.uid = a[4]) : i.indexOf(o.MICRO_M.UAname) > -1 ? t.cli = o.MICRO_M.value : t.cli = o.MM.value;
            for (r in lr.commonData) lr.commonData[r] && "page_id" !== r && (t[r] = lr.commonData[r]);
            t.biz = lr.Biz, t.mba_muid = lr._mbaMuidSeq[0], t.mba_sid = lr._mbaSidSeq[0], t.proj_id = "3", t.reserved3 = getReservedCookies(), t.osp = lr.os, lr.uid && (t.uid = lr.uid)
        }), QuickClick.prototype.onTouchStart = function(e) {
            var t, r = this.opts;
            return e.targetTouches.length > 1 || (r.trackingClick = !0, r.trackingClickStart = e.timeStamp, r.targetElement = e.target, t = e.targetTouches[0], r.touchPos = t, r.touchStartX = t.pageX, r.touchStartY = t.pageY, !0)
        }, QuickClick.prototype.touchHasMoved = function(e) {
            var t = e.changedTouches[0],
                r = this.opts,
                o = r.touchBoundary;
            return Math.abs(t.pageX - r.touchStartX) > o || Math.abs(t.pageY - r.touchStartY) > o
        }, QuickClick.prototype.onTouchMove = function(e) {
            var t = this.opts;
            return !t.trackingClick || ((t.targetElement !== e.target || this.touchHasMoved(e)) && (t.trackingClick = !1, t.targetElement = null), !0)
        }, QuickClick.prototype.onTouchEnd = function(e) {
            var t = this.opts;
            return !t.trackingClick || (e.timeStamp - t.lastClickTime < t.tapDelay || (e.timeStamp - t.trackingClickStart > t.tapTimeout || (e.clientX = 0 | t.touchPos.clientX, e.clientY = 0 | t.touchPos.clientY, e.pageX = 0 | t.touchPos.pageX, e.pageY = 0 | t.touchPos.pageY, t.callback(e), t.lastClickTime = e.timeStamp, t.trackingClick = !1, t.trackingClickStart = 0, !1)))
            ...
            if ("undefined" != typeof jaq && jaq instanceof Array)
                for (e = 0; e < jaq.length; e++) "account" === jaq[e][0] && (lr.siteId = jaq[e][1]);
            for (function() {
                    var e = "";
                    ...
                    e.match("/wl.js") ? JA.isWl = !0 : e.match("/joya.js") ? JA.isJoya = !0 : e.match("/ja.js") ? JA.isJa = !0 : e.toLowerCase().match("/mping.min.js") && (JA.isMping = !0)
                }(), e = 0; e < lr.initBF.length; e++) lr.initBF[e]();
            lr.isWQ = lr.isWQ || 0, lr.rpDomain = lr.rpDomain || ("1" == lr.isWQ ? "rockets.jd.com" : "uranus.jd.com"), lr.logUrl = "//" + lr.rpDomain + "/log/m", lr.logType = {
                pv: "1",
                pf: "2",
                cl: "3",
                od: "4",
            ...
            i.length > 5 ? (r = i[0], o = i[1], e = parseInt(i[2], 10), t = parseInt(i[3], 10), l = parseInt(i[4], 10), s = parseInt(i[5], 10) || s) : (o = genUuid(), e = l, t = l), lr.uuid = o, a.length > 3 && (r || (r = a[0]), c = parseInt(a[1], 10) || 0), n.length > 4 && (r || (r = n[0]), u = n[1], p = n[2], g = n[3], m = n[4]), d && "" !== d && (r || (r = d));
            var f, M = [],
                S = a.length < 4,
                w = getParameter("utm_source"),
                v = !1;
            if (w) {
                var P = getParameter("utm_campaign"),
                    y = getParameter("utm_medium"),
                    C = getParameter("utm_term");
                M.push(w || u), M.push(P || p), M.push(y || g), M.push(C || m), m = M[3], v = !0
            } else {
                var k, b = lr.refUrl && lr.refUrl.split("/")[2],
                    T = !1;
                if (b && b.indexOf(lr.ckDomain) < 0) {
                    for (k = lr.seo, _ = 0; _ < k.length; _++) {
                        var A = k[_].split(":");
                        if (b.indexOf(A[0].toLowerCase()) > -1 && lr.refUrl.indexOf((A[1] + "=").toLowerCase()) > -1) {
                            var D = getParameter(A[1], lr.refUrl);
                            /[^\x00-\xff]/.test(D) && (D = encodeURIComponent(D)), M.push(A[0]), M.push("-"), M.push("organic"), M.push(D || "not set"), m = M[3], T = !0;
                            break
                        }
                    }
                    T || (b.indexOf("zol.com.cn") > -1 ? (M.push("zol.com.cn"), M.push("-"), M.push("cpc"), M.push("not set")) : (M.push(b), M.push("-"), M.push("referral"), M.push("-")))
                }
            }
            if (1 == lr.isWQ && (0 === M.length || "direct" === M[0])) {
                var x = function() {
                    var e = {
            ...
            f = M.length > 0 && (M[0] !== u || M[1] !== p || M[2] !== g) && "referral" !== M[2], S || !S && f ? (u = M[0] || u, p = M[1] || p, g = M[2] || g, m = M[3] || m, i.length > 5 ? (e = parseInt(i[2], 10), t = parseInt(i[4], 10), l = parseInt((new Date).getTime() / 1e3), s++, c = 1) : (s = 1, c = 1)) : c++;
            var O = getPageParamFromSdk();
            if (O && O.vts) {
                var I = 1 * O.vts,
                    J = 1 * O.seq;
                (I > s || I === s && J >= c) && (s = I, c = J + 1)
            }
            if (r || (r = getHashDomain()), setCookie(lr.ckJda, [r, o, e, t, l, s || 1].join("."), lr.ckDomain, lr.ckJdaExp), setCookie(lr.ckJdb, [r, c, o + "|" + s, l].join("."), lr.ckDomain, lr.ckJdbExp), v || f || n.length < 5) {
                var B = [r, u || "direct", p || "-", g || "none", m || "-", (new Date).getTime()].join("|");
                setJdv(B = urlEncode(B), r)
            }
            for (setCookie(lr.ckJdc, r, lr.ckDomain), lr.utm_source = u, lr.utm_campaign = p, lr.utm_medium = g, lr.utm_term = m, lr.sequenceNum = c, lr.firSesTime = e, lr.preSesTime = t, lr.curSesTime = l, lr.visitTimes = s, lr.hashDomain = r, _ = 0; _ < lr.updateCookieF.length; _++) lr.updateCookieF[_]()
        }(), lr.getPrivateDataF.push(function(t, r) {
            if (t.logType === lr.logType.od) r.mba_seq = String(lr._mbaSidSeq[1]), r.prod_id = String(t.prod_id), lr.appv && (r.apv = lr.appv);
            else if (lr.appv && (r.apv = lr.appv), t.logType === lr.logType.pv) {
                r.mba_seq = String(lr._mbaSidSeq[1]);
                try {
                    var o = new Date;
                    r.mba_finger = String(getFingerprint()), r.fpstime = fingerprintScriptTime, r.fpftime = new Date - o
                } catch (e) {}
                lr.preSession && (r.psn = lr.preSession), lr.preSeqnum && (r.psq = lr.preSeqnum)
            } else t.logType === lr.logType.cl ? (r.mba_seq = String(lr._mbaSidSeq[1]), r.event_id = t.event_id, t.event_param && (r.event_param = t.event_param), t.event_level && (r.event_level = t.event_level)) : t.logType === lr.logType.hm || (t.logType, lr.logType.pd);
            if (lr.commonData.page_id && (r.page_id = lr.commonData.page_id), t.request) {
                var i, a = t.request;
                for (i in a) "function" != typeof a[i] && a[i] !== t && (r[i] = a[i] ? a[i] + "" : "")
            }
            isEmbedded() && (r.pv_sid = String(lr._mbaSidSeq[0]), r.pv_seq = String(lr._mbaSidSeq[1]))
        }), 1 == lr.isWQ || 2 == lr.isWQ && isPrey(100)) {
        var getTpc = function(e) {
                var t = "";
                return e.logType === lr.logType.pv ? t = "wg_wx.000000" : e.logType === lr.logType.cl && (t = "wg_wx.000001"), e.request && (e.request.t || e.request.hitType) ? t = e.request.t || e.request.hitType : e.pdsvj && e.pdsvj.p0 && e.pdsvj.p0.hitType && (t = e.pdsvj.p0.hitType), "user_share" === t && (t = "wg_wx.000007"), t
            },
            isItemPage = (a550 = /(\/\/wq\.jd\.(com|hk)\/m?item\/view|\/\/wqs\.jd\.com\/app\/item\/style10\/detail\.shtml)/.test(location.href), a551 = /\/\/wqm?item\.jd\.(hk|com)\/m?item\/(ad)?view/.test(location.href), a552 = /\/\/wqs\.jd\.com\/qiangbao\/detail/.test(location.href), a553 = /\/\/wqs\.jd\.com\/my\/pingou\/buy\.shtml/.test(location.href), a554 = /\/\/wqs\.jd\.com\/pingou\/item\.shtml/.test(location.href), a555 = location.href.indexOf("isTestItemPage=1") > -1, a550 || a551 || a552 || a553 || a554 || a555),
            load_sec, calcLoadTime = function() {
                if (window.JD && window.JD.GLOBAL_CONFIG && window.JD.GLOBAL_CONFIG.NOW && !load_sec) {
            ...
            channelType = function() {
                ...
                "jdapp" === t || "skapp" === t || 2 != getUrlParam("sceneval") && "shop.m.jd.com" != i && "coupon.m.jd.com" != i && "s.m.jd.com" != i && "so.m.jd.com" != i && "p.m.jd.com" != i && "home.m.jd.com" != i && "item.m.jd.com" != i && "m.yiyaojd.com" != i && "mitem.jd.hk" != i && "mitem.jdworldwide.com" != i || (t = "jdmobile");
                var a = getCookie("wxapp_type"),
                    n = getUrlParam("wxappver");
                (isWxapp() || a || n) && (t = "xcx");
                var d = location.hostname + location.pathname || "";
                d && -1 !== d.indexOf("wqs.jd.com/dataproduct") && (t = "gx");
            ...
            netType = (a575 = getCookie("network"), a576 = 99, /wifi/i.test(a575) ? a576 = 1 : /4g|3g+/i.test(a575) ? a576 = 4 : /3g/i.test(a575) ? a576 = 3 : /2g/i.test(a575) && (a576 = 2), a576),
            sessionrefer = (a579 = "", window.sessionStorage && sessionStorage.getItem("refer") && (a579 = sessionStorage.getItem("refer"), sessionStorage.removeItem("refer")), a579),
            openId = (a583 = "weixin" == channelType ? "open_id" : "sq_open_id", window.localStorage && (a584 = localStorage.getItem("_tj_" + a583) || getCookie(a583) || ""), a584 && localStorage.setItem("_tj_" + a583, a584), a584 || ""),
            wqOsInfo = (a587 = osInfo.os, "android" === a587 || "iphone" === a587 || "ipad" === a587 || "ipod" === a587 ? osInfo : {
                os: "other",
                ver: ""
            }),
            wqSid = (a590 = (a590 = getCookie("__wga")) ? a590.split(".") : [], a591 = (new Date).getTime(), a592 = a590[0] && a591 - a590[0] <= 18e5, a593 = a590[5] ? a592 ? a590[5] : 1 * a590[5] + 1 : 1, getCookie("visitkey") + "|" + a593),
            initPvData = function(e, t) {
                ...
                if (i && (t.rvurl = i), t.vurl) {
                    ...
                    a && (t.ptag = a[1]), t.vurl = window.location.protocol + t.vurl.replace(/^http[s]{0,1}\:/, ""), setCookie(lr.rvurlCookieName, encodeURIComponent(t.vurl), lr.ckDomain, 18e5), vurl = t.vurl
                }
                vurl || delCookie(lr.rvurlCookieName, "/", lr.ckDomain), t.ptag && setCookiePtag(t.ptag), t.cookie_ptag = getCookiePtag(), t.ldt = calcLoadTime();
        ...
        lr.getPrivateDataF.push(function(e, t) {
            if (e.logType !== lr.logType.magic) {
                if (pvCount > 0 && (logid = getLogid()), t.t = getTpc(e), e.logType === lr.logType.pv) pvCount++, initPvData(e, t);
                else if (e.logType === lr.logType.cl) t.ptag && (t.target = t.ptag, delete t.ptag), t.cookie_ptag = getCookiePtag(), (vurl || window._vurl) && (t.vurl = vurl || window._vurl);
                else if ("exp_log.100000" === e.topic && e.logType === lr.logType.pd) {
                    var r = {};
                    t.sfj && t.sfj.p0 && (r = t.sfj.p0, delete t.sfj.p0.hitType), "wg_wx.000002" !== t.t && "wg_wx.000003" !== t.t && "wg_wx.000004" !== t.t || (t.cookie_ptag = getCookiePtag()), "wg_wx.000005" == t.t && 1 == r.action && (t.nextPageReport = !0), "wg_wx.000003" == t.t && (r.ptag && (t.target = r.ptag, delete r.ptag), (vurl || window._vurl) && (t.vurl = vurl || window._vurl))
                }
                delete t.hitType, t.logid = logid, t.chan_type = chanType, t.net_type = netType, t.wq_refer = document.referrer || getUrlParam("wdref") || sessionrefer, t.buy_uin = getCookie("buy_uin") || "", t.wq_unionid = getCookie("wq_unionid") || "", t.ptag_uuid = getPPRD_PValue("UUID") || "", t.openid = openId, "wg_wx.000002" !== t.t && (t.device_type = wqOsInfo.os), t.wxapp_type = getCookie("wxapp_type") || "", t.is_wq = lr.isWQ || 0, t.wxapp_uuid = getCookie("wxapp_uuid") || "", t.user_type_gx = window.localStorage && localStorage.getItem("accountType") || "", t.wq_sid = wqSid, t.wq_os = wqOsInfo.os + "/" + wqOsInfo.ver
            }
        })
    }
    ...
    function logByGet(e, t, r) {
        var o = encodeURIComponent(JSON.stringify(t)),
            i = ("https:" === document.location.protocol ? "https:" : "http:") + e + "&data=" + o,
            a = new Image(1, 1);
        a.onload = function() {
    ...
    function logByPost(e, t, r) {
        ...
        o.open("POST", ("https:" === document.location.protocol ? "https:" : "http:") + e, !0), o.setRequestHeader("Content-Type", "text/plain"), o.timeout = r ? 200 : 1e4, o.onreadystatechange = function() {
    ...
    function logCmd(t) {
        if (t && !isSpider()) {
            var r, o = getCommonData(t),
                i = {};
            o.data = [], lr.anchorpvflag && t.logType === lr.logType.pv && lr.curUrl !== document.location.href && (lr.refUrl = lr.curUrl, lr.curUrl = document.location.href);
            var a = getSeparatedUrl(lr.refUrl);
            a[0] && (i.ref = a[0]), a[1] && (i.rpr = a[1]), i.ctm = getCurTime();
            var n = getCookie("pwdt_id") || getCookie("pin") || getCookie("pt_pin");
            lr.account && "-" !== lr.account ? i.pin = lr.account : n && (i.pin = n), lr.pinId && (i.pid = lr.pinId), a = getSeparatedUrl(lr.curUrl), i.ctp = t.page_name || a[0], i.par = t.page_param || a[1];
            var d = getJdv();
            i.usc = d.source, i.umd = d.medium, i.utr = d.term, i.ucp = d.campaign, i.jdv = d.jdv, i.vts = lr.visitTimes, i.seq = lr.sequenceNum, lr.adsCookieName && (i.adk = lr.adsCookieName), lr.ads && (i.ads = lr.ads), lr.jdpts && lr.jdpts._st && (i.ldt = (new Date).valueOf() - lr.jdpts._st), i.browser_ver = lr.browser.version, i.browser = lr.browser.name, i.fst = lr.firSesTime, i.pst = lr.preSesTime, i.vct = lr.curSesTime, i.clr = lr.color, i.bsl = lr.language, i.bsc = lr.characterSet, i.jav = lr.javaEnabled, i.flv = lr.flash_ver, i.tit = lr.title, i.hash = encodeURIComponent(document.location.hash) || "", i.tad = document.cookie ? "1" : "0", i.dataver = lr.data_version, getCookie("_mjdcl") && (i.mjdcl = getCookie("_mjdcl")), lr.rpd && (i.rpd = lr.rpd), lr.app_device && (i.app_device = lr.app_device), lr.pre_app && (i.pap = lr.pre_app);
            var l = getParameter("wjfrom") || "",
                c = getParameter("wjwxpubid") || "",
                s = getParameter("wjunionid") || "",
                u = getParameter("wjopenid") || "";
            if ((l || c || s || u) && (i.wjfrom = l, i.wjwxpubid = c, i.wjunionid = s, i.wjopenid = u), lr.wxAppUuid && (i.wxapp_uuid = lr.wxAppUuid), lr.wxAppSiteId && (i.wxapp_siteid = lr.wxAppSiteId), lr.wxAppAppid && (i.wxapp_appid = lr.wxAppAppid), lr.wxAppAppkey && (i.wxapp_appkey = lr.wxAppAppkey), t.logType === lr.logType.pv) {
                i.typ = "pv", i.lgt = "pv", lr.skuId && (i.sku = lr.skuId), lr.orderId && (i.ord = lr.orderId), lr.shopId && (i.shp = lr.shopId), i.ext = lr.extParams;
                var p = getCookie(lr.ckRefCls),
                    g = lr.refCls || p;
                p && setCookie(lr.ckRefCls, "", lr.ckDomain, -1e4), g && (i.ref_cls = g)
            } else if (t.logType === lr.logType.cl) {
                i.typ = "cl", i.lgt = "cl", i.tar = t.tarUrl || "", t.cls && (i.cls = t.cls), lr.refCls = t.event_id || t.cls || "", setCookie(lr.ckRefCls, encodeURIComponent(lr.refCls), lr.ckDomain);
                try {
                    setPageParamForSdk(MPing.EventSeries.getSeries())
                } catch (e) {}
            } else t.logType === lr.logType.hm ? (i.typ = "sr", i.lts = "hm", i.lgt = "hm", t.cls && (i.cls = t.cls), t.x && (i.x = String(t.x)), t.y && (i.y = String(t.y)), document.body.scrollWidth && (i.scw = String(document.body.scrollWidth)), document.body.scrollHeight && (i.sch = String(document.body.scrollHeight)), t.offset_left && (i.ofl = String(t.offset_left))) : t.logType === lr.logType.pd ? (i.typ = "sr", i.lts = "ot", i.lgt = t.pdlogType, t.lgv && (i.lgv = t.lgv), t.pdsvj && (i.sfj = t.pdsvj)) : t.logType === lr.logType.magic ? (i.typ = "mg", i.lts = "ot", i.lgt = "mg", t.pdsvj && (i.sfj = t.pdsvj)) : t.logType === lr.logType.od && (i.typ = "sr", i.lts = "od");
            for (r = 0; r < lr.getPrivateDataF.length; r++) lr.getPrivateDataF[r](t, i);
            t.logType !== lr.logType.cl && t.logType !== lr.logType.od && t.logType !== lr.logType.pv || (i.unpl = getCookie("unpl")), t.logType !== lr.logType.cl && t.logType !== lr.logType.pv || (i.mjds = getCookie("_mjds")), lr.debugId && (i.originStd = o.std, i.debugId = lr.debugId, o.std = lr.debugStd), lr.aid && (i.aid = lr.aid), lr.oaid && (i.oaid = lr.oaid), lr.osv_int && (i.osv_int = lr.osv_int), lr.mta_data && (i.mta_data = lr.mta_data), o.data.push(i);
            var m = lr.logUrl,
                _ = lr.siteId;
            lr.debugId && (m = "//" + lr.debugReportDomain + "/log/m", _ = lr.debugStd);
            var h = o.data[0] && o.data[0].nextPageReport;
            if (lr.getRequest) {
                var f = m + "/log.gif?std=" + lr.siteId;
                h ? (delete o.data[0].nextPageReport, StorageBridge.set("npr", {
                    addr: f,
                    method: "GET",
                    data: o
                }), t.callback && t.callback()) : logByGet(f, o, t.callback)
            } else {
                f = m + "?std=" + _;
                h ? (delete o.data[0].nextPageReport, StorageBridge.set("npr", {
                    addr: f,
                    method: "POST",
                    data: o
                }), t.callback && t.callback()) : logByPost(f, o, t.callback)
            }
        }
    }
    ...
    function lg(e, t, r) {
        var o = {};
        o.pdsvj = {}, 2 === arguments.length && "object" == typeof arguments[1] ? o.pdsvj = arguments[1] : 3 === arguments.length && "object" == typeof arguments[2] && (o.pdsvj = arguments[2]), "object" != typeof t && (o.lgv = t), o.logType = lr.logType.pd, o.pdlogType = e, logCmd(o)
    }
    ...
    function PV(e) {
        Request.call(this, "PV", null), this.cmdParam.logType = lr.logType.pv, this.setPageId(e)
    }

    function Click(e) {
        Request.call(this, "Click", null), this.cmdParam.logType = lr.logType.cl, this.cmdParam.clickType = lr.clickType.Jtag, this.cmdParam.event_id = e;
        var t = getSeparatedUrl(document.location.href);
        this.page_name = t[0], this.page_param = t[1]
    }

    function Order(e) {
        Request.call(this, "Order", null), this.cmdParam.logType = lr.logType.od, this.cmdParam.prod_id = e
    }
    ...
    window.lg = lg, JA.lg = lg, window.lgPv = logPv, JA.lgPv = logPv, MPing.prototype.send = function(e, t) {
            e && e.cmdParam && (e.cmdParam.callback = t, e.cmdParam.request = e, updateMuid(), updateMSid(), logCmd(e.cmdParam))
        }, MPing.prototype.ready = function() {}, MPing.prototype.initUid = function() {}, MPing.prototype.sendByRequest = function(e, t) {
            this.send(e, t)
        }, MPing.prototype.sendByImg = function() {
            this.send(request, callback)
        }, MPing.prototype.getReportData = function() {}, MPing.prototype.isSpider = isSpider, MPing.prototype.options = {}, MPing.prototype.privates = {}, window.MPing = MPing, MPing.Request = Request, Request.prototype.getReportObj = function() {}, Request.prototype.getTime = function() {}, Request.prototype.setTs = function() {}, Request.prototype.setPageParam = function() {}, Request.prototype.getUrlInfo = function() {}, PV.prototype = new Request, PV.prototype.setSourceParam = function() {}, PV.prototype.setPvParams = function() {}, PV.prototype.setPageId = function(e) {
            var t;
            if ("string" == typeof e || "number" == typeof e) this.cmdParam.page_id = e;
            else if (e && "object" == typeof e) {
                for (t in e) this.cmdParam[keysMap(t)] = e[t];
                this.cmdParam.cli && (this.cmdParam.cli += "-M")
            }
            for (t in lr.commonData) this.cmdParam[t] && (lr.commonData[t] = this.cmdParam[t])
        ...
        }, Click.prototype.setPageId = function() {}, Click.attachEvent = function(e) {
            Click.attachedEvent || (lr.cClass = e || "J_ping", Click.attachedEvent = !0)
        }, Order.prototype = new Request, Order.prototype.deleteSeries = function() {}, Order.prototype.setPageParam = function() {}, Order.prototype.setParams = function() {}, AddCart.prototype = new Click, AddCart.prototype.addSeries = function() {}, AddCart.prototype.reportAsOrder = function(e, t) {
            if (e) {
                var r = new Order(e);
            ...
            getSeries: function() {
                ...
                isEmbedded() ? (r.pv_sid = e[0] + "", r.pv_seq = e[1] + "", r.pv_timestamp = (new Date).getTime() + "") : (r.mba_muid = getMuid(), r.mba_sid = e[0] + "");
                var o = getParameter("wjfrom") || "",
                    i = getParameter("wjwxpubid") || "",
                    a = getParameter("wjunionid") || "",
                    n = getParameter("wjopenid") || "";
                (o || i || a || n) && (r.wjfrom = o, r.wjwxpubid = i, r.wjunionid = a, r.wjopenid = n), r.std = lr.siteId;
                var d = getSeparatedUrl(lr.curUrl);
                return r.par = encodeURIComponent(d[1] || ""), r.event_id = lr.refCls, JSON.stringify(r)
            },
            ...
            wxappSeries: function() {
                var e = {},
                    t = getMSidSeq();
                return e.pv_sid = t[0] + "", e.pv_seq = t[1] + "", JSON.stringify(e)
            }
        },
        function() {
            var e, t, r, o, i = navigator.userAgent;
            if (hasTransmitFunc()) {
                var a = getPageParamFromSdk();
                if (a) {
                    lr.uid = a.uid || "";
                    var n = a.jdv || "",
                        d = (new Date).getTime();
                    if (n)(u = decodeURIComponent(n).split("|")).length > 5 && (r = lr.utm_source = u[1], lr.utm_campaign = u[2], lr.utm_medium = u[3], lr.utm_term = u[4], u[5] && (d = u[5].length < 13 ? 1e3 * u[5] : u[5])), r && setCookie(lr.ckJdv, [lr.hashDomain, lr.utm_source || "direct", lr.utm_campaign || "-", lr.utm_medium || "none", lr.utm_term || "-", d].join("|"), lr.ckDomain, lr.ckJdvEmbeddedExp);
                    a.std && (lr.pre_app = a.std), !lr.refUrl && a.ctp && (a.par ? lr.refUrl = a.ctp + "?" + a.par : lr.refUrl = a.ctp), a.event_id && (lr.refCls = a.event_id), a.debugId && (lr.debugId = a.debugId, lr.debugStd = a.debugSiteId, lr.debugReportDomain = a.debugReportDomain)
                }
            } else if (i && (isEmbedded() || i.indexOf("Android") >= 0 || i.indexOf("iPhone") >= 0)) {
                var l, c, s = function(e) {
                    var t = e + "/",
                        r = i.indexOf(t),
                        o = 0,
                        a = "";
                    return r >= 0 && (r += t.length) < (o = i.indexOf(";", r)) && (a = i.substring(r, o)), a
                };
                (i += ";").indexOf("psn/") >= 0 && (l = i.indexOf("psn/") + 4) <= (c = i.indexOf(";", l)) && (e = i.substring(l, c)), i.indexOf("psq/") >= 0 && (l = i.indexOf("psq/") + 4) <= (c = i.indexOf(";", l)) && (t = i.substring(l, c)), i.indexOf("ref/") >= 0 && (l = i.indexOf("ref/") + 4) <= (c = i.indexOf(";", l)) && (lr.refUrl = decodeURIComponent(i.substring(l, c))), i.indexOf("pap/") >= 0 && (l = i.indexOf("pap/") + 4) <= (c = i.indexOf(";", l)) && (lr.pre_app = i.substring(l, c));
                var u, p = !0;
                n = s("jdv"), d = (new Date).getTime();
                if (n)(u = decodeURIComponent(n).split("|")).length > 5 && (r = lr.utm_source = u[1], lr.utm_campaign = u[2], lr.utm_medium = u[3], lr.utm_term = u[4], u[5] && (d = u[5].length < 13 ? 1e3 * u[5] : u[5]), p = !1);
                if (p && i.indexOf("usc/") >= 0 && (l = i.indexOf("usc/") + 4) <= (c = i.indexOf(";", l)) && (r = lr.utm_source = i.substring(l, c)), p && i.indexOf("ucp/") >= 0 && (l = i.indexOf("ucp/") + 4) <= (c = i.indexOf(";", l)) && (lr.utm_campaign = i.substring(l, c)), p && i.indexOf("umd/") >= 0 && (l = i.indexOf("umd/") + 4) <= (c = i.indexOf(";", l)) && (lr.utm_medium = i.substring(l, c)), p && i.indexOf("utr/") >= 0 && (l = i.indexOf("utr/") + 4) <= (c = i.indexOf(";", l)) && (lr.utm_term = i.substring(l, c)), i.indexOf("adk/") >= 0 && (l = i.indexOf("adk/") + 4) <= (c = i.indexOf(";", l)) && (lr.adsCookieName = i.substring(l, c)), i.indexOf("ads/") >= 0 && (l = i.indexOf("ads/") + 4) <= (c = i.indexOf(";", l)) && (o = i.substring(l, c)), e && t ? (setCookie("pre_session", e, lr.ckDomain), setCookie("pre_seq", t, lr.ckDomain)) : (e = getCookie("pre_session") || "", t = getCookie("pre_seq") || ""), lr.preSession = e, lr.preSeqnum = t, r) {
                    var g = [lr.hashDomain, lr.utm_source || "direct", lr.utm_campaign || "-", lr.utm_medium || "none", lr.utm_term || "-", d].join("|");
                    setJdv(g = urlEncode(g, lr.hashDomain), lr.hashDomain)
                }
                o && (lr.ads = o, setCookie(lr.adsCookieName, lr.ads, lr.ckDomain, lr.mtSubsiteExp));
                var m = s("apprpd");
                m && (lr.rpd = m), lr.app_device = s("app_device");
                var _ = s("log-debug");
                _ && (_ = _.split("|")).length > 2 && (lr.debugId = _[0], lr.debugStd = _[1], lr.debugReportDomain = _[2]), lr.aid = s(";aid"), lr.oaid = s(";oaid"), lr.osv_int = s(";osVer")
            }
            lr.mta_data = getMtaData()
        }(), lr.clickCBF.push(function(e) {
            if (Click.attachedEvent) {
                for (var t, r = {}, o = e.srcElement || e.target, i = document.querySelector("body"); o !== i;) {
                    var a = o.className || "";
                    if (a && a.baseVal && (a = a.baseVal), a && a.indexOf(lr.cClass) > -1) {
                        t = o;
                        break
                    }
                    o = o.parentNode || i
                ...
                if (t) {
                    var n = t.getAttribute("href"),
                        d = t.getAttribute("report-eventid") || "",
                        l = t.getAttribute("report-eventlevel") || "",
                    ...
                    if (d) {
                        ...
                        r.logType = lr.logType.cl, r.clickType = lr.clickType.Jtag, r.event_id = d, r.event_level = l, r.page_name = c || p[0] || "", r.page_param = s || p[1] || "", r.event_param = u, r.tarUrl = n, updateMFLSeries(r), logCmd(r)
                    }
                    n && /^(http:\/\/|https:\/\/|\/\/).*/.exec(n) && "_blank" !== t.getAttribute("target") && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, setTimeout(function() {
            ...
            if (isWX()) {
                for (var t = {}, r = e.srcElement || e.target, o = "", i = ""; r && "BODY" != r.nodeName && r.getAttribute;) {
                    if (i = r.getAttribute("ptag") || r.getAttribute("PTAG")) {
                        o = "";
                        break
                    }
                    if ((o = r.getAttribute("data-url") || r.getAttribute("data-tourl") || r.getAttribute("data-href") || r.getAttribute("tourl") || r.getAttribute("target_href") || r.href) && (i = getUrlParam("ptag", o))) break;
                    r = r.parentNode
                }
                if (i) {
                    var a = "wq_" + i.replace(/\./g, "_"),
                        n = i;
                    if (a) {
                        var d = getSeparatedUrl(document.location.href);
                        t.logType = lr.logType.cl, t.clickType = lr.clickType.Jtag, t.event_id = a, t.event_level = "", t.page_name = d[0] || "", t.page_param = d[1] || "", t.event_param = n, t.tarUrl = o, updateMFLSeries(t), logCmd(t)
                    }
                    if (o && /^(http:\/\/|https:\/\/|\/\/).*/.exec(o) && r && "A" === r.nodeName && "_blank" !== r.getAttribute("target"))
                        for (var l = (new Date).getTime() + 100;
                            (new Date).getTime() < l;);
                }
            }
        });
    var getAbsoluteXPath = function(e) {
            for (var t = ""; e && 1 == e.nodeType; e = e.parentNode) {
                for (var r = e.parentNode.childNodes, o = "", i = 0, a = 0, n = r.length; i < n; i++) {
                    var d = r[i];
        ...
        isReportElement = function(e) {
            ...
            if (e && e.tagName) {
                ...
                t = !("html" === r || "body" === r || e.id && "tol_selected_xelemts_area" === e.id || e.parentElement.id && "tol_selected_xelemts_area" === e.parentElement.id) && (!!haveTag(e) || ("a" === r || isLeafElemt(e)))
            }
            return t
        },
        cltvalue = "";
    ...
    function haveTag(e) {
        for (cltvalue = e.getAttribute("clstag"); !cltvalue && (e = e.parentNode) && "BODY" != e.nodeName;) cltvalue = e.getAttribute("clstag");
        return !!cltvalue
    }

    function subUrl(e) {
        var t = 0;
        return e && e.length > 500 && (t = e.indexOf("?")) && (e = e.substring(0, t)), e
    }
    ...
    document.getElementsByClassName || (document.getElementsByClassName = function(e) {
        for (var t = document.getElementsByTagName("*"), r = [], o = 0; o < t.length; o++)
    ...
    var coordinateInfo = function(e) {
            var t = {};
            return t.scrollWidth = document.body.scrollWidth, t.scrollHeight = document.body.scrollHeight, t.offsetLeft = pageOffsetLeft(), t.x = parseInt(mouseX(e)), t.y = parseInt(mouseY(e)), t.offsetLeft > 0 && (t.x = parseInt(t.x - t.offsetLeft)), t
        },
        xpathReport = function(e) {
            try {
                var t = e.target || e.srcElement;
                if (isReportElement(t)) {
                    for (var r = coordinateInfo(e), o = t, i = t.tagName.toLowerCase(), a = getXPath(t) || "-", n = t.parentNode ? getXPath(t.parentNode) : "-", d = t.parentNode ? getAbsoluteXPath(t.parentNode) + "/" : "-", l = getAbsoluteXPath(t) || "-", c = l ? l.split("/").length : 1, s = document.body.clientWidth, u = s > 0 ? (r.x / s).toFixed(4) : 0, p = r.scrollHeight > 0 ? (r.y / r.scrollHeight).toFixed(4) : 0, g = o.tagName.toLowerCase();
                        "a" != g && (o = o.parentNode) && "BODY" != o.nodeName;) g = o.tagName.toLowerCase();
                    var m = "-",
                        _ = "-";
                    if (cltvalue) {
                    ...
                    var f = o && o.href ? subUrl(o.href) : "-",
                        M = t.innerText.substring(.2) || "-",
                        S = t.src ? subUrl(t.src) : "-";
                    "a" !== i || isLeafElemt(t) || (M = "-"), magictreelog("magictree", "Z", encodeURIComponent(a), encodeURIComponent(n), encodeURIComponent(d), c, r.x + "x" + r.y, r.scrollWidth + "x" + r.scrollHeight, r.offsetLeft, u, p, m, _, encodeURIComponent(f), encodeURIComponent(M), encodeURIComponent(S))
                }
            } catch (w) {
        ...
        loadJS = function(e) {
            ...
            t.type = "application/javascript", t.src = e, t.charset = "UTF-8", document.body ? document.body.appendChild(t) : document.getElementsByTagName("head")[0].appendChild(t)
        },
        loadCSS = function(e) {
    ...
    function magictreelog(e, t) {
        ...
        o = o && o.slice(2), r.pdsvj = {}, r.logType = lr.logType.magic, r.pdsvj.t1 = e, r.pdsvj.t2 = t, r.pdsvj.p0 = encodeURIComponent(joinArrayBySeparator(o)), logCmd(r)
    }
    var typepar = getParameter("typepar"),
        a1126, a1127;
    if (typepar && ("query" === typepar || "apply" === typepar)) try {
        loadCSS("//magicforest.jd.com/x.css"), loadJS("//magicforest.jd.com/tol2.min.js")
    } catch (e) {
    ...
    function logClstag(e, t, r) {
        if (e && t) {
            var o = {};
            o.logType = lr.logType.cl, o.clickType = lr.clickType.Clstag, o.cls = e + "|" + t, o.tarUrl = r || "", logCmd(o)
        }
    }
    ...
    function isDegrade(t, r, o, i) {
        var a = {
            ...
            d = new Date(2018, 5, 20).getTime(),
            l = (new Date).getTime();
        if (l < n || l > d) return !1;
        var c = a[t + "-" + r + "-" + o];
        return c === undefined && (c = a[t + "-" + r]), c === undefined && (c = a[t]),
            function(t) {
                try {
                    var r = i,
                        o = r.length;
    ...
    function log(e, t) {
        var r = {},
            o = Array.prototype.slice.call(arguments);
        o = o && o.slice(2), r.pdsvj = {}, r.logType = lr.logType.pd, r.pdsvj.t1 = e, r.pdsvj.t2 = t, r.pdsvj.p0 = encodeURIComponent(joinArrayBySeparator(o)), logCmd(r)
    }

    function logJSON(e, t, r) {
        var o = {};
        o.logType = lr.logType.pd, o.isByJson = !0, o.pdsvj = {
            t1: e,
            t2: t,
            p0: r
        }, o.toWarriors = !0, logCmd(o)
    }
    ...
    function expLogJSON(e, t, r) {
        var o = {};
        o.topic = "exp_log.100000", o.logType = lr.logType.pd, o.isByJson = !0, o.pdsvj = {
            t1: e,
            t2: t,
            p0: isObject(r) ? JSON.stringify(r) : r
        }, o.toWarriors = !0, logCmd(o)
    }
    window.initMagicModel = initMagicModel, document.location.href.indexOf("__clsData=") > -1 && (loadCSS("//magicforest.jd.com/cls.css"), loadJS("//magicforest.jd.com/cls.js")), quickClick(document, function(e) {
            var t, r = {},
            ...
            if (n.clientX || n.clientY || n.pageX || n.pageY) {
                ...
                for (; !a && "BODY" !== o.nodeName && "HTML" !== o.nodeName && (o = o.parentNode) && ("BODY" !== o.nodeName || "HTML" === o.nodeName);) a = o.getAttribute("clstag");
                var d;
                if (a) {
                    var l = a.split("|"),
                        c = l[1],
                    ...
                    if ("keycount" === c) {
                        ...
                        r.logType = lr.logType.cl, r.clickType = lr.clickType.Clstag, r.cls = d, r.tarUrl = p, logCmd(r), p && /^(http:\/\/|https:\/\/|\/\/).*/.exec(p) && "_blank" !== i.getAttribute("target") && !isMeta(e) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, setTimeout(function() {
                            window.location.href = p
                        }, 200))
                    }
                }
                var g = window.location.hostname.toLowerCase();
                if (lr.heatmapEnable || /(sale|mall|jmall|pop|bdp).(jd|360buy).com/.test(g)) {
                    var m = 0,
                        _ = 0;
                    e.pageX || e.pageY ? (m = e.pageX, _ = e.pageY) : (m = e.clientX + document.body.scrollLeft - document.body.clientLeft, _ = e.clientY + document.body.scrollTop - document.body.clientTop);
                    var h = window.screen.width >= 1210 ? 1210 : 990,
                        f = document.body.clientWidth > h ? Math.round((document.body.clientWidth - h) / 2) : 0;
                    r.logType = lr.logType.hm, r.cls = d || "-", r.x = m, r.y = _, r.offset_left = f, logCmd(r)
                }
        ...
        function() {
            ...
            function o(t) {
                for (var r, o = e ? "0123456789ABCDEF" : "0123456789abcdef", i = "", a = 0; a < t.length; a++) r = t.charCodeAt(a), i += o.charAt(r >>> 4 & 15) + o.charAt(15 & r);
                return i
            }

            function i(e) {
                for (var t, r, o = "", i = -1; ++i < e.length;) t = e.charCodeAt(i), r = i + 1 < e.length ? e.charCodeAt(i + 1) : 0, 55296 <= t && t <= 56319 && 56320 <= r && r <= 57343 && (t = 65536 + ((1023 & t) << 10) + (1023 & r), i++), t <= 127 ? o += String.fromCharCode(t) : t <= 2047 ? o += String.fromCharCode(192 | t >>> 6 & 31, 128 | 63 & t) : t <= 65535 ? o += String.fromCharCode(224 | t >>> 12 & 15, 128 | t >>> 6 & 63, 128 | 63 & t) : t <= 2097151 && (o += String.fromCharCode(240 | t >>> 18 & 7, 128 | t >>> 12 & 63, 128 | t >>> 6 & 63, 128 | 63 & t));
                return o
            }

            function a(e) {
                var t, r = Array(e.length >> 2);
        ...
        function() {
            ...
            if (e && t && r && i && a && n) {
                var c, s, u = -1,
                    ...
                    g = -1,
                    m = {};
                m.pdsvj = {}, "有货" === n ? (u = 1, p = 5, g = 33) : 0 === n.indexOf("有货") ? (u = 2, p = 5, g = 39) : n.indexOf("预定") > -1 ? (u = 3, p = 5, g = 36) : "无货" === n ? (u = 4, p = 5, g = 34) : n.indexOf("现货") > -1 ? (u = 7, p = 5, g = 33) : n.indexOf("暂不支持配送") > -1 && (u = 8, p = 6, g = 40), isNaN(a) && (a = -1), c = e + "_" + t + "_" + r + "_" + o, s = [i, a, u, p, g], d.area = c, d.sku = [s], l.t1 = "pv_stock", l.t2 = "sku", l.p0 = d, m.logType = lr.logType.pd, m.pdsvj = l, m.isByJson = !0, m.toWarriors = !0, logCmd(m)
            }
        }(), window.getUnionSeries = getUnionSeries, window.getAndroidUnionSeries = getAndroidUnionSeries, window.getUnionSeriesJsonObj = getUnionSeriesJsonObj, ("undefined" == typeof lr.autoLogPv || lr.autoLogPv) && (logPv(), lr.anchorpvflag && (window.history ? (a1126 = window.history, a1127 = a1126.pushState, a1126.pushState = function(e) {
            return "function" == typeof a1126.onpushstate && a1126.onpushstate({
                state: e
            }), a1127.apply(a1126, arguments)
        }, lr.account = "undefined" != typeof lr.account ? lr.account : getCookie("pin"), window.onpopstate = history.onpushstate = function(e) {
            setTimeout(function() {
                lr.refUrl = lr.curUrl, lr.curUrl = document.location.href, logPv()
            }, 0)
        ...
        }, window.log = log, window.logJSON = logJSON, window.nlog = nlog, window.expLogJSON = expLogJSON;
    try {
        setPageParamForSdk(MPing.EventSeries.getSeries())
    } catch (e) {}
    ...
    function setPPRD_PValue(e, t) {
        ...
        i.test(o) ? o = "EA" == e || "IA" == e || "CT" == e || "PD" == e ? o.replace(i, r + "$4") : o.replace(i, r + "$2") : o += 0 == o.length ? r : "-" + r, o = o.replace(/-?UUID\.-/g, "-").replace(/^-|-UUID\.$/g, "").replace(/-+/g, "-"), setCookie(lr.PPRD_PCCookieName, o, lr.ckDomain, 2592e5)
    }

    function setCookiePtag(e) {
        var t, r, o = "",
            i = /PTAG[=,](\d+)\.(\d+)\.(\d+)\D?/gim.exec(e && "ptag=" + e || location.href.toString());
    ...
    function getPPRD_PValue(e) {
        var t = {
            ...
            o = Array.isArray(e),
            i = {};
        return e = o ? e : [e], r && e.forEach(function(e) {
    ...
    var StorageBridge = {
        ...
        _init: function() {
            if (!StorageBridge._iframe && window.JSON && window.localStorage && window.postMessage && window.sessionStorage && document.body) {
                var e = document.createElement("iframe");
                e.style.cssText = "position:absolute;width:1px;height:1px;left:-9999px;", document.body.appendChild(e), window.addEventListener && (e.addEventListener("load", function() {
                    StorageBridge._iframe = e, StorageBridge._onIframeLoad()
                }, !1), window.addEventListener("message", StorageBridge._onMessage, !1)), e.src = this._bridgeDomain + "/storagebridge.html"
            }
        },
        _onMessage: function(e) {
            if (!(e.origin.indexOf(StorageBridge._bridgeDomain) < 0)) {
                ...
                r && r.callback && (delete StorageBridge._queries[t.id], r.callback && r.callback(t.value))
            }
        },
        ...
        _postMessage: function(t) {
            if (this._iframe) try {
                this._iframe.contentWindow.postMessage(JSON.stringify(t), this._bridgeDomain)
            } catch (e) {}
        },
        set: function(e, t, r) {
            var o = {
    ...
    isWX() && !isWxapp() && ("loading" === document.readyState ? document.addEventListener("DOMContentLoaded", function() {
        StorageBridge._init()
    }, !1) : StorageBridge._init()), StorageBridge.get("npr", function(e) {
        e && (StorageBridge.remove("npr"), "POST" == e.method ? logByPost(e.addr, e.data) : logByGet(e.addr, e.data))
    });
    var unifyRecoReport = function(_data) {
        var serverAddr = "//knicks.jd.com/log/server",
            data = extend({}, _data),
            vArray = [],
            sceneMap = {
                weixin: 0,
        ...
        if (data.impr || data.clk) {
            ...
            var content = data.impr ? data.impr : data.clk,
                extraVParamStr = vArray.join("$");
            if (-1 !== content.indexOf("mercury")) {
                extraVParamStr += "$";
                var contentArr = content.split("v=");
                contentArr.length > 1 && (content = contentArr[0] + "v=" + extraVParamStr + contentArr[1])
            } else extraVParamStr = "$" + extraVParamStr, content += extraVParamStr;
            ...
            extend(data, basicData), data.t = "0" == data.action ? "rec_common_exp" : "rec_common_clk", data.rm = (new Date).getTime(), data.pin || (data.pin = eval("'" + unescape(getCookie("jdpin") || "-") + "'")), data.uuid || (data.uuid = lr.uuid), data.sid || (data.sid = sid), data.type || (data.type = "rec." + (data.p || ""));
            for (var key in data) "t" !== key && vArray.push(key + "=" + data[key]);
            var url = serverAddr + "?t=" + data.t + "&v=" + vArray.join("$");

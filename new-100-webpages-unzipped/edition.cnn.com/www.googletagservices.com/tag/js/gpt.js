(function(E) {
    ...
    var Y = function() {
            ...
            this.o = new PerformanceObserver(Ed(640, function(b) {
                b = ba(b.getEntries());
                for (var c = b.next(); !c.done; c = b.next()) {
                    c = c.value;
                    if ("layout-shift" === c.entryType) {
                        var e = c;
                        e.hadRecentInput || (a.a += Number(e.value), Number(e.value) > a.c && (a.c = Number(e.value)))
                    }
                    "largest-contentful-paint" === c.entryType && (e = c, a.i = Math.floor(e.renderTime || e.loadTime));
    ...
    Y.prototype.g = function() {
        ...
        if (2 === ({
                ...
                preview: 4,
                unloaded: 5
            }[a.visibilityState || a.webkitVisibilityState || a.mozVisibilityState || ""] || 0) && !this.D) {
            this.D = !0;
            this.o.takeRecords();

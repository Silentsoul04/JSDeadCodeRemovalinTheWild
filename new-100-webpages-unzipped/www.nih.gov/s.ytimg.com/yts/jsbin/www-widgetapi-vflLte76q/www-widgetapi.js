(function() {
    ...
    var x = "closure_uid_" + (1E9 * Math.random() >>> 0),
        na = 0;
    ...
    function y(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? y = oa : y = pa;
    ...
    function La(a) {
        var b = new H(I, G instanceof F && G.constructor === F && G.a === Ia ? G.b : "type_error:Const", null);
        a.src = b.a ? b.a : (b instanceof H && b.constructor === H && b.b === Ja ? b.f : "type_error:TrustedResourceUrl").toString()
    };
    ...
    function Ma(a, b) {
        ...
        if (a && e.getElementsByClassName) {
            var f = e.getElementsByClassName(a);
            return f
        }
        ...
        if (a) {
            ...
            for (c = d = 0; e = f[c]; c++) {
                var h = e.className,
                    p;
                if (p = "function" == typeof h.split) p = 0 <= sa(h.split(/\s+/), a);
                p && (g[d++] = e)
            }
            g.length = d;
            return g
    ...
    function Qa() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == D.indexOf("Presto") && (a = function() {
            var e = M("IFRAME");
            ...
            e = f.document;
            e.open();
            e.write(L instanceof J && L.constructor === J && L.b === Ka ? L.a : "type_error:SafeHtml");
            e.close();
            var g = "callImmediate" + Math.random(),
                h = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host;
            e =
                y(function(p) {
                    if (("*" == h || p.origin == h) && p.data == g) this.port1.onmessage()
                }, this);
        ...
        if ("undefined" !== typeof a && -1 == D.indexOf("Trident") && -1 == D.indexOf("MSIE")) {
            var b = new a,
                c = {},
                d = c;
    ...
    function Va() {
        if (q.Promise && q.Promise.resolve) {
            ...
            var b = Ya,
                c;
            !(c = "function" != v(q.setImmediate)) && (c = q.Window && q.Window.prototype) && (c = -1 == D.indexOf("Edge") && q.Window.prototype.setImmediate == q.setImmediate);
            c ? (Pa || (Pa = Qa()), Pa(b)) : q.setImmediate(b)
        }
    }
    var Wa = !1,
        Xa = new Ra;
    ...
    k.B = function(a) {
        ...
        if (b) {
            var c = this.b[b];
            if (0 != this.i) this.h.push(a), this.a[a + 1] = ma;
            else {
                if (c) {
                    var d = sa(c, a);
        ...
        if (c) {
            ...
            if (this.o)
                for (e = 0; e < c.length; e++) {
                    var g = c[e];
                    ab(this.a[g + 1], this.a[g + 2], d)
                } else {
                    this.i++;
                    try {
                        for (e = 0, f = c.length; e < f; e++) g = c[e], this.a[g + 1].apply(this.a[g + 2], d)
                    } finally {
                        if (this.i--, 0 < this.h.length && 0 == this.i)
                            for (; c = this.h.pop();) this.B(c)
                    }
                }
            return 0 != e
        }
    ...
    k.clear = function(a) {
        if (a) {
            var b = this.b[a];
            b && (C(b, this.B, this), delete this.b[a])
    ...
    var fb = /#|$/;
    var R = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    z("yt.config_", R);

    function gb(a) {
        var b = arguments;
        1 < b.length ? R[b[0]] = b[1] : 1 === b.length && Object.assign(R, b[0])
    };
    ...
    function ib(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in R ? R.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), gb("ERRORS", c))
    };
    var jb = 0;
    z("ytDomDomGetNextId", t("ytDomDomGetNextId") || function() {
        return ++jb
    });
    var kb = {
    ...
    var E = t("ytEventsEventsListeners") || {};
    z("ytEventsEventsListeners", E);
    var lb = t("ytEventsEventsCounter") || {
        count: 0
    };
    z("ytEventsEventsCounter", lb);
    ...
    function mb(a, b, c, d) {
        ...
        return Ga(function(e) {
            ...
            return !!e.length && e[0] == a && e[1] == b && e[2] ==
                c && (f || g)
        })
    }
        ...
        a && ("string" == typeof a && (a = [a]), C(a, function(b) {
            if (b in E) {
                var c = E[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? ob() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete E[b]
            }
        }))
    }
    ...
    function pb(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new S(h);
                    if (!Na(h.relatedTarget, function(p) {
                            return p == a
                ...
                g = hb(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), ob() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                E[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function sb(a) {
        return rb[a] || (rb[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function ub() {
        var a = "undefined" != typeof Symbol && Symbol.iterator && l[Symbol.iterator];
        var b;
        a ? b = a.call(l) : b = {
            next: aa()
        };
    ...
    function vb(a, b) {
        b || (b = document);
        var c = va(b.getElementsByTagName("yt:" + a)),
            d = "yt-" + a,
            e = b || document;
        d = va(e.querySelectorAll && e.querySelector ? e.querySelectorAll("." + d) : Ma(d, b));
        return ua(c, d)
    }

    function U(a, b) {
        var c;
        "yt:" == a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[sb(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function wb(a, b) {
        Q.G.apply(Q, arguments)
    };
    ...
    xb.prototype.g = function(a) {
        if (a.origin == V(this, "host") || a.origin == V(this, "host").replace(/^http:/, "https:")) {
            ...
            if (a = W[b.id]) a.o = !0, a.o && (C(a.m, a.A, a), a.m.length = 0), a.H(b)
        }
    };
    var W = null;
    ...
    function X(a, b, c) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? cb(a.src) : "https://www.youtube.com"), this.b = new xb(b), c || (b = zb(this, a), this.i = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[x] || (a[x] = ++na), b.id = "widget" + a), T[this.a.id] = this, window.postMessage) {
                this.g = new P;
                Ab(this);
                b = V(this.b, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in tb) Bb(this, e)
            }
    }
    k = X.prototype;
    ...
    function zb(a, b) {
        for (var c = document.createElement("iframe"), d = b.attributes, e = 0, f = d.length; e < f; e++) {
            var g = d[e].value;
            null != g && "" != g && "null" != g && c.setAttribute(d[e].name, g)
        }
        ...
        window.location.host && (h.origin = window.location.protocol + "//" + window.location.host);
        h.widgetid = a.h;
        window.location.href && C(["debugjs", "debugcss"], function(p) {
            var u = window.location.href;
            var fa = u.search(fb);
            b: {
                var r = 0;
                for (var A = p.length; 0 <= (r = u.indexOf(p, r)) && r < fa;) {
                    var B = u.charCodeAt(r - 1);
                    if (38 == B || 63 == B)
                        if (B = u.charCodeAt(r + A), !B || 61 == B || 38 == B || 35 == B) break b;
                    r += A + 1
                }
                r = -1
            }
            if (0 > r) u = null;
                ...
                if (0 > A || A > fa) A = fa;
                r += p.length + 1;
                u = decodeURIComponent(u.substr(r, A - r).replace(/\+/g,
                    " "))
            }
            null !== u && (h[p] = u)
        });
        c.src = V(a.b, "host") + a.v() + "?" + eb(h);
        return c
    }
    k.F = function() {
        this.a && this.a.contentWindow ? this.A({
            event: "listening"
    ...
    function Ab(a) {
        yb(a.b, a, a.h);
        a.f = qb(y(a.F, a));
        pb(a.a, "load", y(function() {
            window.clearInterval(this.f);
            this.f = qb(y(this.F, this))
        }, a))
    }

    function Cb(a, b) {
        a.I[b] || (a.I[b] = !0, Db(a, "addEventListener", [b]))
    }
    k.A = function(a) {
        a.id = this.h;
        a.channel = "widget";
        ...
        if (this.a.contentWindow)
            for (c = 0; c < b.length; c++) try {
                ...
                if (d.name && "SyntaxError" == d.name) ib(d, "WARNING");
                else throw d;
    ...
    function Gb(a, b) {
        if (w(b))
            for (var c in b) a.l[c] = b[c]
    }

    function Hb(a, b) {
        C(b, function(c) {
            this[c] || ("getCurrentTime" == c ? this[c] = function() {
                var d = this.l.currentTime;
                if (1 == this.l.playerState) {
                    var e = (qa() / 1E3 - this.l.currentTimeLastUpdated_) * this.l.playbackRate;
                    0 < e && (d += Math.min(e, 1))
                }
                return d
            } : Eb(c) ? this[c] = function() {
                this.l = {};
                this.j = {};
                Db(this, c, arguments);
                return this
            } : Fb(c) ? this[c] = function() {
                var d = 0;
                0 == c.search("get") ? d = 3 : 0 == c.search("is") && (d = 2);
                return this.l[c.charAt(d).toLowerCase() + c.substr(d + 1)]
            } : this[c] = function() {
                Db(this, c, arguments);
                return this
            })
    ...
    k.getVideoEmbedCode = function() {
        ...
        var b = parseInt(V(this.b, "height"), 10),
            c = V(this.b, "host") + this.v();
        Da.test(c) && (-1 != c.indexOf("&") && (c = c.replace(xa, "&amp;")), -1 != c.indexOf("<") && (c = c.replace(ya, "&lt;")), -1 != c.indexOf(">") && (c = c.replace(za, "&gt;")), -1 != c.indexOf('"') && (c = c.replace(Aa, "&quot;")), -1 != c.indexOf("'") && (c = c.replace(Ba, "&#39;")), -1 != c.indexOf("\x00") && (c = c.replace(Ca, "&#0;")));
    ...
    k.getOption = function(a, b) {
        if (this.j.namespaces && a && b) return this.j[a][b]
    };
    ...
    Z.prototype.s = function(a, b) {
        X.prototype.s.call(this, a, b ? b.info : void 0)
    };
        ...
        if ("iframe" != a.tagName.toLowerCase()) {
            ...
            if (b) {
                b = {
                    ...
                    width: U(a, "width"),
                    height: U(a, "height"),
                    thumbWidth: U(a, "thumb-width"),
                    thumbHeight: U(a, "thumb-height"),
                    thumbAlign: U(a, "thumb-align")
                };
                var c = U(a, "onclick");
    ...
    z("YT.PlayerState.UNSTARTED", -1);
    z("YT.PlayerState.ENDED", 0);
    z("YT.PlayerState.PLAYING", 1);
    z("YT.PlayerState.PAUSED", 2);
    z("YT.PlayerState.BUFFERING", 3);
    z("YT.PlayerState.CUED", 5);
    z("YT.get", function(a) {
        return T[a]
    });
    z("YT.scan", ub);
    z("YT.subscribe", function(a, b, c) {
        Q.subscribe(a, b, c);
        tb[a] = !0;
        for (var d in T) Bb(T[d], a)
    });
    z("YT.unsubscribe", function(a, b, c) {
        $a(a, b, c)
    });
    z("YT.Player", Y);
    z("YT.Thumbnail", Z);
    ...
    X.prototype.getIframe = X.prototype.L;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || ub();
    var Kb = t("onYTReady");
    Kb && Kb();
    var Lb = t("onYouTubeIframeAPIReady");
    Lb && Lb();
    var Mb = t("onYouTubePlayerAPIReady");
    Mb && Mb();
}).call(this);
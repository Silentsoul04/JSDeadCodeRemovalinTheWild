/*1570706756,,JIT Construction: v1001278076,id_ID*/
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "FB",
                    "sdkurl": "https:\/\/connect.facebook.net\/id_ID\/sdk.js"
                });
                __d("JSSDKConfig", [], {
                    "features": {
                    ...
                    var m = b("Type").extend({
                        ...
                        n = {
                            ...
                            _createMobileLoader: function() {
                                var a;
                                b("sdk.UA").nativeApp() ? a = '<div class="dialog_header"></div>' : n.isTabletStyle() ? a = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + b("sdk.fbt")._("Batal") + "</a></div>" : a = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + b("sdk.fbt")._("Batal") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + b("sdk.fbt")._("Memuat...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                                return n.create({

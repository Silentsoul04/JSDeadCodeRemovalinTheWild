        ...
        _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(a, b, c) {
            var d, e, f, g, h, i, j, k, l, m = {
                ...
                Ba = function(a, b) {
                    ...
                    for (var c, d, e, f, g, h, i, j, k = ya(a, qa), l = ya(a.parentNode, ra), m = Aa(a, k, l, !1, !0);
                ...
                Ia = function(a) {
                    for (var b = a.split(","), c = (void 0 !== w.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel" : void 0 !== w.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : a).split(","), d = {}, e = 8; --e > -1;) d[b[e]] = c[e], d[c[e]] = b[e];
                    return d
                }("touchstart,touchmove,touchend,touchcancel"),
                Ja = function(a, b, c, d) {
                    a.addEventListener ? a.addEventListener(Ia[b] || b, c, d) : a.attachEvent && a.attachEvent("on" + b, c)
                },
                Ka = function(a, b, c) {
                    a.removeEventListener ? a.removeEventListener(Ia[b] || b, c) : a.detachEvent && a.detachEvent("on" + b, c)
                },
                La = function(a, b) {
                    ...
                    var h, i, j, k, l, r, s, v, w, y, E, H, P, S, U, V, Z, ba, da, ea, fa, ga, ha, la, ma, na, oa, pa, qa, ra, sa, ua, va, wa, xa = (g.type || (C ? "top,left" : "x,y")).toLowerCase(),
                        ...
                        eb = function(a, b) {
                            ...
                            a && f ? (a === !0 && (c = g.snap || g.liveSnap || {}, e = c instanceof Array || "function" == typeof c, a = {
                                ...
                                onComplete: cb,
                                onOverwrite: db,
                                onUpdate: g.fastMode ? ja : ab,
                                onUpdateParams: g.fastMode ? [Ma, "onthrowupdate", "onThrowUpdate"] : c && c.radius ? [!1, !0] : x
                            }, isNaN(g.maxDuration) ? 2 : g.maxDuration, isNaN(g.minDuration) ? 0 === j || "object" == typeof a && a.resistance > 1e3 ? 0 : .5 : g.minDuration, j), g.fastMode || (i && (i._suspendTransforms = !0), h.render(h.duration(), !0, !0), ab(!0, !0), Ma.endX = Ma.x, Ma.endY = Ma.y, za && (Ma.endRotation = Ma.x), h.play(0), ab(!0, !0), i && (i._suspendTransforms = !1))) : s && Ma.applyBounds()
                        },
                        fb = function(a) {
                        ...
                        gb = function() {
                            ...
                            fb(!1), ma && (j = Ma.pointerX * ma[0] + Ma.pointerY * ma[2] + ma[4], k = Ma.pointerX * ma[1] + Ma.pointerY * ma[3] + ma[5]), ba && (nb(Ma.pointerX, Ma.pointerY), _a(!0)), i ? (bb(), r = i.top(), l = i.left()) : (hb() ? (ab(!0, !0), bb()) : Ma.applyBounds(), za ? (Z = Ma.rotationOrigin = Ca(d, {
                                x: 0,
                                y: 0
                            }), ab(!0, !0), l = Ma.x, r = Ma.y = Math.atan2(Z.y - Ma.pointerY, Ma.pointerX - Z.x) * z) : (oa = d.parentNode ? d.parentNode.scrollTop || 0 : 0, pa = d.parentNode ? d.parentNode.scrollLeft || 0 : 0, r = ia(d, Da), l = ia(d, Aa))), s && a && (l > w ? l = w + (l - w) / a : y > l && (l = y - (y - l) / a), za || (r > E ? r = E + (r - E) / a : H > r && (r = H - (H - r) / a))), Ma.startX = l, Ma.startY = r
                        },
                        hb = function() {
                            return Ma.tween && Ma.tween.isActive()
                        },
                        ib = function() {
                            !D.parentNode || hb() || Ma.isDragging || D.parentNode.removeChild(D)
                        },
                        jb = function(a, b, c, d) {
                        ...
                        lb = function(a) {
                            var c;
                            if (!(!h || Ma.isPressed || !a || ("mousedown" === a.type || "pointerdown" === a.type) && B() - Za < 30 && Ia[Ma.pointerEvent.type])) {
                                if (na = hb(), Ma.pointerEvent = a, Ia[a.type] ? (la = -1 !== a.type.indexOf("touch") ? a.currentTarget || a.target : t, Ja(la, "touchend", ob), Ja(la, "touchmove", mb), Ja(la, "touchcancel", ob), Ja(t, "touchstart", Na)) : (la = null, Ja(t, "mousemove", mb)), sa = null, Ja(t, "mouseup", ob), a && a.target && Ja(a.target, "mouseup", ob), ha = Ya.call(Ma, a.target) && !g.dragClickables) return Ja(a.target, "change", ob), ja(Ma, "press", "onPress"), void Qa(Ra, !0);
                                if (ra = la && Ea !== Fa && Ma.vars.allowNativeTouchScrolling !== !1 ? Ea ? "y" : "x" : !1, C ? a = _(a, !0) : ra || Ma.allowEventDefault || (a.preventDefault(), a.preventManipulation && a.preventManipulation()), a.changedTouches ? (a = U = a.changedTouches[0], V = a.identifier) : a.pointerId ? V = a.pointerId : U = V = null, I++, Q(_a), k = Ma.pointerY = a.pageY, j = Ma.pointerX = a.pageX, (ra || Ma.autoScroll) && $(d.parentNode), d.parentNode && (i || Ma.autoScroll && !za && d.parentNode._gsMaxScrollX && !D.parentNode) && !d.getBBox && (D.style.width = d.parentNode.scrollWidth + "px", d.parentNode.appendChild(D)), gb(), Ma.tween && Ma.tween.kill(), Ma.isThrowing = !1, b.killTweensOf(i || d, !0, Ua), i && b.killTweensOf(d, !0, {
                                        scrollTo: 1
                                    ...
                                    for (c = Ra.length; --c > -1;) ca(Ra[c], "cursor", g.cursor || "move");
                                ja(Ma, "press", "onPress")
                            }
                        },
                        mb = function(a) {
                            ...
                            if (h && !e && Ma.isPressed && a) {
                                ...
                                if (C) a = _(a, !0);
                                    ...
                                    if (la && ra && !sa && (c = a.pageX, d = a.pageY, ma && (f = c * ma[0] + d * ma[2] + ma[4], d = c * ma[1] + d * ma[3] + ma[5], c = f), g = Math.abs(c - j), i = Math.abs(d - k), (g !== i && (g > Ga || i > Ga) || J && ra === sa) && (sa = g > i && Ea ? "x" : "y", Ma.vars.lockAxisOnTouchScroll !== !1 && (Ma.lockedAxis = "x" === sa ? "y" : "x", "function" == typeof Ma.vars.onLockAxis && Ma.vars.onLockAxis.call(Ma, l)), J && ra === sa))) return void ob(l);
                                    Ma.allowEventDefault || ra && (!sa || ra === sa) || l.cancelable === !1 || (l.preventDefault(), l.preventManipulation && l.preventManipulation())
                                }
                                Ma.autoScroll && (Wa = !0), nb(a.pageX, a.pageY)
                            }
                        },
                        nb = function(a, b) {
                        ...
                        ob = function(a, c) {
                            if (h && Ma.isPressed && (!a || null == V || c || !(a.pointerId && a.pointerId !== V || a.changedTouches && !La(a.changedTouches, V)))) {
                                ...
                                var e, f, i, j, k, l = a,
                                    m = Ma.isDragging,
                                    n = b.delayedCall(.001, ib);
                                if (la ? (Ka(la, "touchend", ob), Ka(la, "touchmove", mb), Ka(la, "touchcancel", ob), Ka(t, "touchstart", Na)) : Ka(t, "mousemove", mb), Ka(t, "mouseup", ob), a && a.target && Ka(a.target, "mouseup", ob), ba = !1, ha) return a && Ka(a.target, "change", ob), Qa(Ra, !1), ja(Ma, "release", "onRelease"), ja(Ma, "click", "onClick"), void(ha = !1);
                                if (R(_a), !za)
                                ...
                                return l && !m ? (na && (g.snap || g.bounds) && eb(g.throwProps), ja(Ma, "release", "onRelease"), J && "touchmove" === l.type || (ja(Ma, "click", "onClick"), j = l.target || l.srcElement || d, Za = B(), k = function() {
                                    Za !== va && Ma.enabled() && !Ma.isPressed && (j.click ? j.click() : t.createEvent && (i = t.createEvent("MouseEvents"), i.initMouseEvent("click", !0, !0, window, 1, Ma.pointerEvent.screenX, Ma.pointerEvent.screenY, Ma.pointerX, Ma.pointerY, !1, !1, !1, !1, 0, null), j.dispatchEvent(i)))
                                }, J || l.defaultPrevented || b.delayedCall(1e-5, k))) : (eb(g.throwProps), C || Ma.allowEventDefault || !l || !g.dragClickables && Ya.call(Ma, l.target) || !m || ra && (!sa || ra !== sa) || l.cancelable === !1 || (l.preventDefault(), l.preventManipulation && l.preventManipulation()), ja(Ma, "release", "onRelease")), hb() && n.duration(Ma.tween.duration()), m && ja(Ma, "dragend", "onDragEnd"), !0
                            }
                        },
                        pb = function(a) {
                            if (a && Ma.isDragging && !i) {
                                ...
                                (c || e) && (ma ? (j -= c * ma[0] + e * ma[2], k -= e * ma[3] + c * ma[1]) : (j -= c, k -= e), b._gsScrollX += c, b._gsScrollY += e, nb(Ma.pointerX, Ma.pointerY))
                            }
                        },
                        qb = function(a) {
                            var b = B(),
                            ...
                            return f && (e || d && Ma.vars.suppressClickOnDrag !== !1) && a.stopImmediatePropagation(), !c || Ma.pointerEvent && Ma.pointerEvent.defaultPrevented || e && i === h ? void((Ma.isPressed || d || c) && (f ? i && a.detail && c && !g || (a.preventDefault(), a.preventManipulation && a.preventManipulation()) : a.returnValue = !1)) : (i && e && (wa = Za), void(va = Za))
                        };
                    da = Ta.get(this.target), da && da.kill(), this.startDrag = function(a) {
                        lb(a), Ma.isDragging || (Ma.isDragging = !0, ja(Ma, "dragstart", "onDragStart"))
                    }, this.drag = mb, this.endDrag = function(a) {
                        ob(a, !0)
                        ...
                        var b, c, e, f, h, i;
                        if (a && g.bounds !== a) return g.bounds = a,
                            Ma.update(!0);
                        if (ab(!0), bb(), s) {
                            if (b = Ma.x, c = Ma.y, b > w ? b = w : y > b && (b = y), c > E ? c = E : H > c && (c = H), (Ma.x !== b || Ma.y !== c) && (e = !0, Ma.x = Ma.endX = b, za ? Ma.endRotation = b : Ma.y = Ma.endY = c, ba = !0, _a(!0), Ma.autoScroll && !Ma.isDragging))
                            ...
                            Ma.isThrowing && (e || Ma.endX > w || Ma.endX < y || Ma.endY > E || Ma.endY < H) && eb(g.throwProps, e)
                        }
                        return Ma
                    }, this.update = function(a, b, c) {
                        var e = Ma.x,
                            f = Ma.y;
                        return fb(!b), a ? Ma.applyBounds() : (ba && c && _a(!0), ab(!0)), b && (nb(Ma.pointerX, Ma.pointerY), ba && _a(!0)), Ma.isPressed && !b && (Ea && Math.abs(e - Ma.x) > .01 || Fa && Math.abs(f - Ma.y) > .01 && !za) && gb(), Ma.autoScroll && ($(d.parentNode), Wa = Ma.isDragging, _a(!0)), Ma.autoScroll && (X(d, pb), W(d, pb)), Ma
                    }, this.enable = function(a) {
                        var e, j, k;
                        if ("soft" !== a) {
                            for (j = Ra.length; --j > -1;) k = Ra[j], Ja(k, "mousedown", lb), Ja(k, "touchstart", lb), Ja(k, "click", qb, !0), za || ca(k, "cursor", g.cursor || "move"), ca(k, "touchCallout", "none"), ca(k, "touchAction", Ea === Fa ? "none" : Ea ? "pan-y" : "pan-x"), ta(k) && ca(k.ownerSVGElement || k, "touchAction", Ea === Fa ? "none" : Ea ? "pan-y" : "pan-x"), this.vars.allowContextMenu || Ja(k, "contextmenu", $a);
                            Qa(Ra, !1)
                        }
                        return W(d, pb), h = !0, f && "soft" !== a && f.track(i || d, ya ? "x,y" : za ? "rotation" : "top,left"), i && i.enable(), d._gsDragID = e = "d" + G++, F[e] = this, i && (i.element._gsDragID = e), b.set(d, {
                            x: "+=0",
                            overwrite: !1
                        }), qa = {
                            t: d,
                        ...
                        if ("soft" !== a) {
                            for (b = Ra.length; --b > -1;) c = Ra[b], ca(c, "touchCallout", null), ca(c, "touchAction", null), Ka(c, "mousedown", lb), Ka(c, "touchstart", lb), Ka(c, "click", qb), Ka(c, "contextmenu", $a);
                            Qa(Ra, !0), la && (Ka(la, "touchcancel", ob), Ka(la, "touchend", ob), Ka(la, "touchmove", mb)), Ka(t, "mouseup", ob), Ka(t, "mousemove", mb)
                        }
                        return X(d, pb), h = !1, f && "soft" !== a && f.untrack(i || d, ya ? "x,y" : za ? "rotation" : "top,left"), i && i.disable(), R(_a), Ma.isDragging = Ma.isPressed = ha = !1, e && ja(Ma, "dragend", "onDragEnd"), Ma
            ...
            Ua.constructor = Ta, Ua.pointerX = Ua.pointerY = Ua.startX = Ua.startY = Ua.deltaX = Ua.deltaY = 0, Ua.isDragging = Ua.isPressed = !1, Ta.version = "0.15.1", Ta.zIndex = 1e3, Ja(t, "touchcancel", function() {}), Ja(t, "contextmenu", function(a) {
                var b;

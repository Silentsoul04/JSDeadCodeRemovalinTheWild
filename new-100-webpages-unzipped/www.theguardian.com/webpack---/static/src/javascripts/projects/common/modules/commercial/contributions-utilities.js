...
import {
    isAbTestTargeted
} from 'common/modules/commercial/targeting-tool';
import {
    logView,
    viewsInPreviousDays,
...
import {
    epicButtonsTemplate
} from 'common/modules/commercial/templates/acquisitions-epic-buttons';
import {
    acquisitionsEpicControlTemplate
} from 'common/modules/commercial/templates/acquisitions-epic-control';
import {
...
import {
    getEpicTestData
} from 'common/modules/commercial/contributions-epic-test-data';
import {
...
import {
    initTicker
} from 'common/modules/commercial/ticker';
...
const shouldShowEpic = (test: EpicABTest): boolean => {
    ...
    return (!pageShouldHideReaderRevenue() &&
        onCompatiblePage &&
...
const buildEpicCopy = (
    ...
    return {
        heading: heading && countryName ?
            replaceCountryName(heading, countryName) :
            heading,
        paragraphs: paragraphs && countryName ?
...
export const buildConfiguredEpicTestFromJson = (test: Object): EpicABTest => {
    ...
    return makeEpicABTest({
        ...
        userCohort: test.userCohort && isValidCohort(test.userCohort) ?
            test.userCohort :
            'AllNonSupporters',
        ...(test.isLiveBlog ?
            {

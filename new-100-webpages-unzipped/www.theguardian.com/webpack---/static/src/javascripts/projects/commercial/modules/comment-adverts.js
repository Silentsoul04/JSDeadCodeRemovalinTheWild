...
import {
    addSlot
} from 'commercial/modules/dfp/add-slot';
import {
    adSizes
} from 'commercial/modules/ad-sizes';
import {
    isUserLoggedIn
...
import {
    createSlots
} from 'commercial/modules/dfp/create-slots';
import {
    getAdvertById
} from 'commercial/modules/dfp/get-advert-by-id';
import {
    refreshAdvert
} from 'commercial/modules/dfp/load-advert';

import type {
    Advert
} from 'commercial/modules/dfp/Advert';
...
const maybeUpgradeSlot = (ad: Advert, $adSlot: bonzo): Advert => {
    if (!containsDMPU(ad)) {
        ...
        ad.slot.defineSizeMapping([
            [
                [0, 0], ad.sizes.desktop
            ]
        ]);
        fastdom.write(() => {

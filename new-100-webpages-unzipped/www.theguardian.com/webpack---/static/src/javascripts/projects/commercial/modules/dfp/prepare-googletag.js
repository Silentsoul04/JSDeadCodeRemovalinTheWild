...
import {
    dfpEnv
} from 'commercial/modules/dfp/dfp-env';
import {
    fillAdvertSlots
...
import {
    onSlotLoad
} from 'commercial/modules/dfp/on-slot-load';
import {
    onSlotRender
} from 'commercial/modules/dfp/on-slot-render';
import {
    onSlotViewableFunction
} from 'commercial/modules/dfp/on-slot-viewable';
import {
    onSlotVisibilityChanged
} from 'commercial/modules/dfp/on-slot-visibility-changed';
import {
    refreshOnResize
} from 'commercial/modules/dfp/refresh-on-resize';
import {
    init as initMessenger
} from 'commercial/modules/messenger';
import {
    init as background
} from 'commercial/modules/messenger/background';
import {
    init as sendClick
} from 'commercial/modules/messenger/click';
import {
    init as disableRefresh
} from 'commercial/modules/messenger/disable-refresh';
import {
    init as initGetPageTargeting
} from 'commercial/modules/messenger/get-page-targeting';
import {
    init as getStyles
} from 'commercial/modules/messenger/get-stylesheet';
import {
    init as hide
} from 'commercial/modules/messenger/hide';
import {
    init as resize
} from 'commercial/modules/messenger/resize';
import {
    init as scroll
} from 'commercial/modules/messenger/scroll';
import {
    init as type
} from 'commercial/modules/messenger/type';
import {
    init as viewport
...
export const init = (): Promise < void > => {
    const setupAdvertising = (): Promise < void > => {
        ...
        return loadScript(config.get('libs.googletag'), {
            async: false
        });
    };

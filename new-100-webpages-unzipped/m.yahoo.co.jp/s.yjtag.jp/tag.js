...
function bt_meta(l, n) {
    for (var u, C = (n || document).getElementsByTagName("meta"), H = 0, J = C.length; H < J; H++)
        if (u = C[H], u.getAttribute("name") === l) return u.getAttribute("content");
    return ""
}
...
function bt_data(l, n) {
    var u = BrightTag.V2_RESPONSE ? BrightTag.configuredSites()[0] : BrightTag.instance;
    return u ? u.data(l, n) : ""
}
...
var bt_handle_exception = bt_log;
window.BrightTag = function(l) {
    ...
    function H(a, d) {
        for (var c = 0, b = this.length; c < b; c++) a.call(d, this[c], c, this)
    }

    function J(a, d, c) {
        for (var b in a) a.hasOwnProperty(b) && d.call(c, b, a[b], a)
    }
    ...
    function qa(a, d) {
        var c = Array.isArray(this) ? this.slice() : Array.from(this),
            b = [];
    ...
    function V(a) {
        return !p.isString(a) ? a : a.replace(/%/g, "%25").replace(/#/g, "%23").replace(/&/g, "%26").replace(/'/g, "%27").replace(/;/g, "%3B").replace(/</g, "%3C").replace(/>/g, "%3E")
    }

    function W(a) {
        for (var d = 5381, c = 0, b = a.length; c < b;) d = (d << 5) + d + a.charCodeAt(c++);
        return d.toString(36)
    }

    function Q(a) {
        if ("s.yjtag.jp" === a && "false" !== l.HTTP.Cookie(document).get("testyjproxy")) return "yjtag.yahoo.co.jp"
    }
    ...
    function X(a) {
        ...
        function k(b, h) {
            ...
            x.each(b.supported, function(a) {
                p.isString(a) && null != m[a] ? c[a] = m[a] : p.isObject(a) && null != m[a.option] && a.setter(c, m[a.option])
            });
            return c
        }
            ...
            return function() {
                try {
                    if (c("block:start", b), p.isString(b)) {
                        var m = x.trim(b).replace(/^\x3c!--/, "").replace(/--\x3e$/, "");
                        a.defaultView ? a.defaultView.eval.call(window, m) : a.parentWindow ? a.parentWindow.execScript(m) : c("block:error", e("wait",
                            "Could not evaluate wait block [" + m + "]"))
                    } else b()
                } catch (h) {
        ...
        var t = this,
            ...
            s = {
                iframe: {
                    ...
                    }, "frameborder", "id", "height", "scrolling", "width"]
                },
                image: {
                    tagName: "img",
                    defaults: {},
    ...
    function S(a) {
        function d(a) {
            ...
            g = {};
            a = 0;
            for (b = c.length; a < b; a++)(d = f.exec(c[a])) && (g[d[1]] = unescape(d[2]))
        }
        ...
        function c(b, c, k) {
            if (b) {
                k = k || {};
                b = [b + "=" + V(c || "")];
                if ((c = k.expires) || 0 === c) p.isNumber(c) && (c =
                    (new Date(c)).toGMTString()), b.push("expires=" + c);
        ...
        return {
            ...
            findEach: function(a, b) {
                for (var c in g) g.hasOwnProperty(c) &&
                    c.match(a) && b(c, g[c])
            },
            clear: function(a) {
                var c = s({}, g),
    ...
    function ba(a) {
        ...
        a.set = function(a, c, e) {
            ...
            0 === e.expires && (e.expires = +new Date("1/1/2038"));
            d(a, c, e)
        };
    ...
    function ca(a, d) {
        ...
        function f(a) {
            a = e(a);
            var b;
            return a && (a.hasOwnProperty("value") && a.hasOwnProperty("expires")) && !c(a) ? (b = a.value, delete a.value, [b, a]) : []
        }

        function k(a, b, c, d) {
            for (var k, e = 0, f = a.length; e < f; e++) k = a.key(e), !c[k] && (c[k] = k.match(b)) && d(k)
        }
        return {
            set: function(a, c, d) {
                a && null != c && (d = d || {}, (null != d.expires ? g : b)(a, c, d.expires))
            },
            get: function(b) {
            ...
            purge: function() {
                for (var a, b, k = d.length; k--;) a = d.key(k), (b = e(a)) && (b.hasOwnProperty("value") && b.hasOwnProperty("expires")) && c(b) && d.removeItem(a)
            }
        }
    }
    ...
    function M(a) {
        ...
        function c(a, b) {
            ...
            r(a, function(a) {
                ...
                a = null == a || "" === a ? b : a;
                (p.isString(a) || p.isNumber(a) || p.isBoolean(a)) &&
                c.push(a)
            });
            return c
        }
    ...
    function E(a) {
        ...
        var c = {},
            b, g, e, f, k, m, h, v, q, l, w = a.match(ua);
        a = w[1] || "";
        g = w[2] || "";
        e = (w[3] || "").substring(1);
        b = g + (e ? ":" + e : "");
    ...
    function da(a, d, c) {
        ...
        function g() {
            var a = c.createEventObject("Event");
            a.type = d;
            a.cancelable = !0;
            a.bubbleable = !1;
            return a
    ...
    function ea(a, d, c) {
        ...
        return {
            ...
            push: function(b) {
                ...
                if (v && b && !(-1 > b.tagId || -1 > b.pageId)) try {
    ...
    function fa(a, d) {
        return new function(a, b) {
            ...
            function e(a) {
                ...
                k = "var $ = BrightTag.$; ";
                l.jQuery ? b() : h.script(l.instance.baseUri() + "BrightTag.jquery-1.5.1.js").wait(b)
            }
            var f = {},
                k = "",
                m, h = l.Blab.group(b);
    ...
    function ga(a) {
        ...
        var b = this,
            ...
            e = a.parentReferrer,
            f = a.referrer,
            k = E(0 === a.host.length ? "" : (/^[a-z0-9+.-]+:\/\/.+/.test(a.host) ? "" : "//") + a.host + "/tag"),
        ...
        b.appendJs = function(a) {
            var d = c("client binding expression", a);
    ...
    function ha(a, d) {
        ...
        function b(a, b, c) {
            var d = l.instance.serverURL();
            r(a, function(a) {
                a.trigger(b, c, d)
            });
            d.hasConditions() && (d.appendParam("mode", "v1"), l.Blab.script(d.asString()))
        }
        ...
        function g(a, d, e) {
                    ...
                    try {
                        ...
                        if (!f) {
                            var h = l,
                                q = k.dbe,
                                w, p = k.dbe,
                                t = C("event-dbes/" + g + "-page-" + (B || "adhoc") + "-event-" + a);
                            w = m.functionWithAccess(["eventObject", "eventData"], "return " + p + ";" + t);
                            f = h[q] = w
                        }
            ...
            g.handler = function(c) {
                var d, e = k[a];
                e && 0 < e.length && (d = Array.prototype.slice.call(arguments, 1), f(c, d), b(e, c,
                    d))
            };
            return g
        }
        ...
        function e(a) {
            function b(a) {
                0 < h.length && (a.cf(h), r(l, function(b) {
                    a.appendData(b)
                }), r(y, function(b) {
                    a.appendJs(b)
                }))
            ...
            e.execute = function(b, d) {
                ...
                else if (p.isString(b)) a: {
                    try {
                        var f = C("events/" + a + "-tag-" + (k.tagId || "adhoc"));
            ...
            e.trigger = function(e, m, h) {
                var l = d("post-event conditional fire", f);
                if (!f || z(f, l)) {
                    try {
    ...
    function ia(a, d) {
        function c(a) {
            r(p.isArray(a) ? a : [a], function(a) {
                p.isFunction(a) ? a() : q.write('<script type="text/javascript" src="' + a + '">\x3c/script>')
            })
        }

        function b(a) {
            var b = w.group().options({
                tagId: -2
            });
            r(p.isArray(a) ? a : [a], function(a) {
        ...
        function m(b) {
            n.hasErrors() && (b.appendParam("errors", n.toJSON()), b.tooLong() && (b.deleteParam("errors"), n.tooManyErrors(), b.appendParam("errors", n.toJSON())));
            n.reset({
                site: a.site,
        ...
        h.site = a.site;
        h.host = a.host;
        h.loadOnly = !!a.loadOnly;
        n && w.addGlobalListener(new ka(n));
        w.run("serializer");
        h.load = function() {
            var a = Array.prototype.slice.call(arguments, 0);
            r(a, function(a) {
                p.isFunction(a) ? w.addToGroup("serializer", w.newEngine().wait(function() {
                    a(h)
                })) : p.isObject(a) && a.src ? h.library(a.src, a.options) : p.isString(a) && h.library(a)
            })
        };
        h.library =
            function(a, b) {
                w.addToGroup("serializer", w.newEngine().options(b || {}).script(a))
            };
        f(A(a.mode, "sync"));
        h.domReady = function() {
            A(a.mode, "sync") && f(!1);
        ...
        h.dbe = function(a, b, c) {
            ...
            null == v[a] && h.data(a, z(b, d, "page-dbes/" + a + "-page-" + (c && c.pageId || "adhoc")))
        };
        h.errors = function(a) {
            l.V2_RESPONSE = !1;
            n.configure(a)
        ...
        h.defaultBaseUri = function() {
            return ("https:" == q.location.protocol ? "https:" : "http:") + "//static-s.tgm.yahoo-net.jp/"
        };
        h.baseUri = function() {
            var a = /\btag(\.[^.]+|-n)?\.js(#.*)?$/;
        ...
        h.primary = function() {
            function a() {
                var b = h.serverURL();
                n && (n.processStoredErrors(),
                    m(b));
                return b.toString()
            }
            var b = [];
            K.JSON ? b.push(a()) : (b.push(h.baseUri() + "json2.js"), b.push(function() {
                h.writeScript(a())
            }));
            h.writeScript(b)
        };
        h.secondary = function(a) {
            var b = h.serverURL(),
                c = b.toString();
            a(b);
            b.toString() != c && (b.appendParam("mode", "v1"), n && m(b), b.isTooLarge() ? h.post(b) : h.writeScript(b.toString()))
        };
        h.post = function(a) {
    ...
    function ya(a) {
        ...
        return b = s({
            ...
            evaluate: function(d) {
                var f = c("return " + d);
                e = f ? function(b, c, d, e) {
                    return f.call(c.target,
                        c, d, e, a.data)
                } : function() {
                    return !1
                };
    ...
    function ja(a) {
        function d(a, b) {
            a.src ? b.preemptScript(a.src, a.innerHTML) : a.innerHTML && b.preemptWait(a.innerHTML)
        }

        function c(a, b) {
            for (var f = a.childNodes || [], k = 0, m = f.length; k < m; k++) {
                var h = f[k];
        ...
        return {
            process: function(g, e) {
                if (0 !== e.length) {
                    b.innerHTML = "<br/>" + e;
                    for (var f = b.childNodes || [], k = 1, m = f.length; k < m; k++) {
                        var h =
                            f[k];
    ...
    function ka(a) {
        return {
            ...
            "block:error": function(d, c) {
                var b, g, e;
                c && (b = c.type, g = c.exception || c, e = d.option("tagId") || -1, a.push({
                    type: b,
                    message: g.toString(),
                    tagId: e
                }))
    ...
    function Ea(a) {
        function d() {
            ...
            f && (c.host = f);
            d && r((new M(d)).params(), function(a, b) {
    ...
    function T(a) {
        ...
        return c = {
            ...
            appendData: function(b) {
                var d = a.data(b);
                g["_cb_bt_data('" + b + "')"] = p.isArray(d) || p.isObject(d) ? JSON.stringify(d) : d;
                return c
            },
            appendJs: function(a) {
                g["_cb_" + a] = z(a);
            ...
            when: function(b) {
                var d;
                try {
                    return d = new Function(["bt_data"], "return " + l.trim(b)), d(a.data) ? c : la()
                } catch (k) {
                    bt_log("conditional evaluation error: [" + k.toString() + "] while evaluating [" + b + "]")
                }
                return la()
            },
            hasConditions: function() {
                return 0 < b.length || d(g, function(a, b) {
                    return null !=
                        b
                })
            }
    ...
    function Ga(a, d, c, b, g, e) {
        ...
        function k(a) {
            if (null == a || a.hasConditions()) b.reset({
                site: n.site,
        ...
        function m(a) {
            var c = E("//" + r + "/tag").appendParams({
                site: n.site,
                mode: n.mode,
                H: n.H,
                referrer: n.referrer,
                docReferrer: n.docReferrer
            }).appendParam("mode", "v2").alwaysAppendParams(a);
            (a = I.get("X-BT-InspectSession")) && c.appendParam("inspect-session", a);
            g.findEach(RegExp("^btp(s|db)\\." +
                n.site + "\\..+"), function(a, b) {
                c.appendParam(a, b)
            });
        ...
        function p(a) {
            var b = h(a);
            b ? (k(a), b.tooLong() ? u.ensure("jQuery", function() {
                l.jQuery.ajax({
                    url: b.origin + b.path,
                    type: "POST",
                    data: b.queryString(),
        ...
        return q = x.extend({
            ...
            data: a.data,
            dataref: function(a) {
                return null == a ? "" : 'BrightTag.site("' + n.site + '").data("' + a.replace(/"/g, "\\x22") + '")'
            },
            store: function(a) {
                x.each(a, function(a) {
                    if (a.name) {
    ...
    function Ka(a) {
        var d, c, b, g, e, f, k, m;
        if ((k = a.site) && !N[k]) return d = wa(a.data), c = new aa(document), m = ja(document), b = Ja(c, m, a), e = Aa(d, Ia(a)), f = ea(G ? L(G, I) : I, "__bterr_" + k, {
            site: k,
            referrer: a.referrer,
            enabled: !1
        }), g = ka(f), d.on("error", g.dbe), e.on("error", g.events), c.addGlobalListener(g), l.Events.onDOMReady(function() {
    ...
    function ma(a, d, c) {
        try {
            ...
            if (!(l.instance && l.instance.site === e.site)) {
                var f = e.referrer || d.location.href,
                    k = s({
                ...
                b = Ka(k);
                if (e.site && !l.instance && !na && !A(e.mode, "v2") && !A(e.mode, "v2b")) {
                    var m = a.script,
                        h = oa();
    ...
    function Ma(a) {
        if (!na && !A(a.config.mode, "v2") && !A(a.config.mode, "v2b")) l.Events.onDOMReady(function(d) {
            a.domready()
        });
        else a.config.loadOnly || (l.Events.onDOMReady(function(d) {
            a.domready()
        }), a.primary())
    }
    ...
    function oa() {
        var a, d = ba(document),
            ...
            b = d;
        try {
            window.localStorage && window.sessionStorage && (a =
                ca(sessionStorage, localStorage), a.purge(), c = L(d, a), b = L(a, d))
        } catch (g) {
    ...
    var p = {
        ...
        ta = function() {
            ...
            function d(a,
                ...
                try {
                    ...
                    bt_log("warning: could not assign value to 'document." + b + "': " + d)
                }
            }
            var c, b = [],
                g = function(a) {
        ...
        Ha = function() {
            ...
            a.prototype = {
                    ...
                    if (g) {
                        ...
                        f ? b() : this.tagMgrRouter.script(E(this.config.staticHost +
                            g.path)).wait(b)
                    }
                }
            };
        ...
        G, I = ba(document);
    try {
        window.localStorage && window.sessionStorage && (G = ca(sessionStorage, localStorage), G.purge())
    } catch (Oa) {
    ...
    l.Escaper = {
        ...
        javascript: function(a) {
            return !p.isString(a) ? a : a.replace(/\\/g, "\\\\").replace(/'/g, "\\x27").replace(/"/g, "\\x22").replace(/\n/g, "\\n").replace(/\r/g, "\\r")
        }
    };
    l.Random = {
        integer: function(a) {
    ...
    l.pushIfDefined = function(a, d, c) {
        a && (a.constructor ==
            Array && null != d) && a.push(c || d)
    };
    l.ServerURL = ga;
    l.Main = function(a) {
        function d(b) {
            (b = b.fragment()) && r((new M(b)).params(), function(b, c) {
                a[b] = c[0]
            })
        }
        ...
        e && (g = new E(e.src), a.host = a.host || Q(g.host), d(g), c(e.innerHTML));
        if (null !=
            a.site) {
            l.Events.enablePageReadyOverrides();
            try {
                b = new ia(a, e), l.Events.onDOMReady(b.domReady), b.loadOnly || b.primary()
            } catch (f) {
    ...
    l.Events = new function(a, d) {
        ...
        var h = this,
            ...
            t = n ? "" : "on",
            x = d.documentElement.doScroll || function() {
                throw "No doScroll";
            };
        h.listen = b;
        h.unlisten = g;
        h.onDOMReady = function(c) {
            e() ? c.call(this) : d.addEventListener ? (b(d, p, c), b(d, p, function() {
                g(a, r, c)
            }), b(a, r, c)) : f(e, c, 1)
        };
...
(function(l) {
    ...
    null == l.instance && setTimeout(function() {
        null == l.instance && l.configureNewSites(window, l.initializeSite)
    }, 0)
})(BrightTag);
var _bt_url_prefix, _bt_referrer, _bt_site, _bt_mode;

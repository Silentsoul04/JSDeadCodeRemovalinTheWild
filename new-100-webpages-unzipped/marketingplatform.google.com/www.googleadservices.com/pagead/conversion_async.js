(function() {
    ...
    function G(a, b, d) {
        for (var c = a.search(E), e = 0, f, g = []; 0 <= (f = D(a, e, b, c));) g.push(a.substring(e, f)), e = Math.min(a.indexOf("&", f) + 1 || c, c);
        g.push(a.substr(e));
    ...
    function Ga(a, b) {
        var d = "query";
        if ("protocol" === d || "port" === d) a.protocol = Ha(a.protocol) || Ha(M.location.protocol);
    ...
    function Ja(a, b, d) {
        ...
        document.cookie = a;
        a = document.cookie;
        return c != a || void 0 != d && 0 <= Ia(b, a).indexOf(d)
    }
    var Ka = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/,
        La = /(^|\.)doubleclick\.net$/i;

    function Ma(a, b) {
        return La.test(document.location.hostname) || "/" === b && Ka.test(a)
    };
    var Na = {};
    var Oa = /^\w+$/,
        Pa = /^[\w-]+$/,
    ...
    function Va(a) {
        return a && "string" == typeof a && a.match(Oa) ? a : "_gcl"
    }
    ...
    function Wa(a, b, d) {
        ...
        var e = {};
        if (void 0 !== a && a.match(Pa)) switch (b) {
            case void 0:
                c(a, "aw");
                break;
            case "aw.ds":
            ...
            case "ds":
                ...
                break;
            case "3p.ds":
                (void 0 == Na.gtm_3pds ? 0 : Na.gtm_3pds) && c(a, "dc");
                break;
            case "gf":
                c(a, "gf");
                break;
    ...
    function Xa(a, b) {
                    ...
                    for (r in m)
                        if (m.hasOwnProperty(r)) {
                            ...
                            if (null != z) switch (r) {
                                ...
                                default:
                                    "path" ==
                                    r && (ha = z), "expires" == r && z instanceof Date && (z = z.toUTCString()), v += "; " + r + "=" + z
                            }
                        }
                    if ("auto" === p) {
                        b: {
                            var r = [];m = document.location.hostname.split(".");
                            if (4 === m.length && (p = m[m.length - 1], parseInt(p, 10).toString() === p)) {
                                r = ["none"];
                                break b
                            }
                            for (p = m.length - 2; 0 <= p; p--) r.push(m.slice(p).join("."));m = document.location.hostname;La.test(m) || Ka.test(m) || r.push("none")
                        }
                        for (m = 0; m < r.length; ++m)
                            if (p = "none" != r[m] ? r[m] : void 0, !Ma(p, ha) && Ja(v + (p ? "; domain=" + p : ""), q, y)) break a
                    }
                    else p && "none" != p && (v += "; domain=" + p),
                    !Ma(p,
                        ha) && Ja(v, q, y)
                }
            }
        ...
        var f = Va(e.prefix),
            g = e.domain || "auto",
            k = e.path || "/",
            l = void 0 == e.g ? 7776E3 : e.g;
        b = b || (new Date).getTime();
        var n = 0 == l ? void 0 : new Date(b + 1E3 * l),
            B = Math.round(b / 1E3);
    ...
    function Ya() {
        for (var a = ["aw"], b = Va(void 0), d = {}, c = 0; c < a.length; c++) Ra[a[c]] && (d[a[c]] = Ra[a[c]]);
        Ea(d, function(e, f) {
            f = Ia(b + f, Ba.cookie);
            if (f.length) {
                f = f[0];
    ...
    function db(a, b) {
        ...
        } else if (a = Sa(a, (b || "_gcl") + "_aw"), 0 < a.length) return a.join(".");
        return ""
    }

    function eb(a) {
        if (0 === Sa(document, "_gcl_aw").length && (!a || 0 === Sa(document, a + "_aw").length)) {
            ...
            d = Ga(c, "gclsrc");
            b = Ga(c, "dclid");
            a && d || (c = c.hash.replace("#", ""), a = a || Fa(c, "gclid"), d = d || Fa(c, "gclsrc"));
            a = Wa(a, d, b);
            Xa(a);
            Ya()
        }
    ...
    function ob(a) {
        ...
        void 0 === a && (a = 0);
        if (!R)
            for (R = {}, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""), c = ["+/=", "+/", "-_=", "-_.", "-_"], e = 0; 5 > e; e++) {
    ...
    function V(a, b, d, c, e, f) {
        ...
        a = [T("cv", c.google_conversion_js_version),
            ...
            Fb(d), c.google_remarketing_only || !c.google_additional_conversion_params ? "" : Ib(c.google_additional_conversion_params)
        ].join("");
        b = ya();
    ...
    function Mb(a) {
        for (var b = C("IFRAME"), d = [], c = [], e = 0; e < a.google_conversion_items.length; e++) {
    ...
    function Ob(a, b) {
        J && "376635471" == K(2) && ("complete" === b.readyState ? Kb(b) : a.addEventListener ? a.addEventListener("load", function() {
            Kb(b)
    ...
    function Sb(a, b, d, c) {
        L() && (hb(2), c.google_gtm && jb(P.a(), a));
        var e = !1;
        if (!c || 3 != c.google_conversion_format) return !1;
        try {
            Pb(c) && (c.google_remarketing_only && c.google_enable_display_cookie_match && !qb && J && I(["376635470", "376635471"], ea, 2), c.google_remarketing_only && !c.google_conversion_domain && J && I(["759238990", "759238991"], ja, 13), !c.google_remarketing_only || c.google_conversion_domain || J && ("759248991" == K(14) || "759248990" == K(14)) || J && I(["759248990", "759248991"], ia, 14), !1 === c.google_conversion_linker || c.google_gtm ||
                eb(c.google_gcl_cookie_prefix), J && I(["910057690", "910057691"], ka, 17), 1 == c.google_remarketing_only && null != c.google_gtag_event_data && null != c.google_gtag_event_data.items && c.google_gtag_event_data.items.constructor === Array && 0 < c.google_gtag_event_data.items.length ? Tb(a, b, d, c) : c.google_remarketing_only || /googleadservices\.com/.test("www.googleadservices.com") || !J || "910057691" != K(17) ? W(a, d, c, V(a, b, d, c, c.google_remarketing_only ? 2 : 0)) : (c.onload_callback && "function" == typeof c.onload_callback.call ? c.onload_callback =
                    tb(2, c.onload_callback) : c.onload_callback = function() {}, W(a, d, c, V(a, b, d, c, 1)), W(a, d, c, V(a, b, d, c, 3))), c.google_remarketing_only && c.google_enable_display_cookie_match && Ob(a, d), e = !0), Jb(c) && (Nb(a, c, d), e = !0)
        } catch (f) {}
        return e
    }
    ...
    function Ub(a, b, d) {
        ...
        if (2 == d.length) {
            var g = d[0],
                k = d[1];
            0 <= D(g, 0, "rmt_tld", g.search(E)) && 0 <= D(g, 0, "ipr", g.search(E)) && !k.match(ra)[6] && (k += sa(g), d[1] = G(k, "rmt_tld", "1"))
        }

...
(function() {
    ...
    var tc = sc,
        ...
        vc = null,
        wc = null,
        xc = "//www.googletagmanager.com/a?id=" + oc.m + "&cv=9",
        yc = {},
        zc = {},
        Ac = function() {
            var a = pc.sequence || 0;
    ...
    var yi = function(a, b, c) {
        ...
        return {
            Ib: function(h, k, l) {
                var m = a(),
                    n = m.Id,
                    p = void 0 !== l ? Math.round(l) : void 0 !== k ? Math.round(m.Id * k) : Math.round(m.Jf),
                    t = void 0 !== k ? Math.round(100 * k) : 0 >= n ? 0 : Math.round(p / n * 100),
                    q = D.hidden ? !1 : .5 <= qi(c);
                d();
                var r = sg(c, "gtm.video", [b]);
    ...
    Z.a.sdl = ["google"],
        function() {
            ...
            function b(x) {
                for (var A = [], z = x.split(","), B = 0; B < z.length; B++) {
                    var E = Number(z[B]);
                    if (isNaN(E)) return [];
                    n.test(z[B]) || A.push(E)
                }
            ...
            function c() {
                ...
                return function() {
                    var z = pi(),
                        B = z.height;
                    x = Math.max(v.scrollLeft + z.width, x);
            ...
            function g() {
                ...
                e(A, "horiz.pix",
                    p.xb, t.xd);
                e(B, "horiz.pct", p.wb, t.xd);
                e(z, "vert.pix", p.xb, t.Cd);
                e(E, "vert.pct", p.wb, t.Cd);
                ug("sdl", "pending", !1)
            }
            ...
            function h() {
                var x = 250,
                    A = !1;
                r.scrollingElement && r.documentElement && q.addEventListener && (x = 50, A = !0);
                var z = 0,
                    B = !1,
                    E = function() {
                        B ? z = Ai(E, x) : (z = 0, g(), Ni("sdl") && !a() && (Qb(q, "scroll", F), Qb(q, "resize", F), ug("sdl", "init", !1)));
                        B = !1
                    },
                    F = function() {
                        A && y();
                        z ? B = !0 : (z = Ai(E, x), ug("sdl", "pending", !0))
                    };
                return F
            }
            ...
            function m(x) {
                ...
                Ni("sdl") ? wg("sdl", "pending") || (w || (d(), w = !0), G(function() {
                    return g()
                })) : (d(), w = !0, v && (Oi("sdl"), ug("sdl", "pending", !0), G(function() {
                    g();
                    if (a()) {
                        var N = h();
                        Pb(q, "scroll", N);
            ...
            (function(x) {
                ...
                x.vtp_triggerStartOption ? m(x) : Kf(function() {
                    m(x)
                })
            })
        }();
    ...
    Z.a.sp = ["google"],
        function() {
            (function(a) {
                ...
                var b = void 0,
                    c = "//www.googleadservices.com/pagead/conversion_async.js"; - 1 != navigator.userAgent.toLowerCase().indexOf("firefox") && (0 == Yi() ? (b = {
                    cjs: "0"
                }, c = "https://www.googleadservices.com/pagead/conversion_async.js?cjs=0") : (b = {
                    cjs: "1"
                }, c = "https://google.com/pagead/conversion_async.js?cjs=1"));
                ...
                c = function(d) {
                    ...
                    if (ja(t)) {
                        ...
                        if ("TRACK_EVENT" == d.vtp_trackType) {
                            ...
                            var V = Fi("gtm.element", 1);
                            V && t(function() {
                                var S = de(),
                                    O = S && S.getByName && S.getByName(r),
                                    oa = Zi(W("gaplugins").Linker, O);
                                V && V.href && (V.href = oa.decorate(V.href, d.vtp_useHashDecorateLink), G(d.vtp_gtmOnSuccess))
                            });
    ...
    Z.a.ytl = ["google"],
        function() {
            ...
            function e(w, y) {
                if (!w.getAttribute("data-gtm-yt-inspected-" + y.Xc) && (w.setAttribute("data-gtm-yt-inspected-" + y.Xc, "true"), d(w, y.Md))) {
                    w.id || (w.id = a());
                    var x = W("YT"),
                        A = x.get(w.id);
                    A || (A = new x.Player(w.id));
                    var z = h(A, y),
                        B = {},
                        E;
                    for (E in z) B.Ha = E, z.hasOwnProperty(B.Ha) && A.addEventListener(B.Ha, function(F) {
                        return function(M) {
                            return z[F.Ha](M.data)
                        }
                    }(B)), B = {
                        Ha: B.Ha
                    }
            ...
            function g(w) {
                G(function() {
                    function y() {
                        for (var A = x.getElementsByTagName("iframe"), z = A.length, B = 0; B < z; B++) e(A[B], w)
                    }
                    var x = W("document");
                    y();
                    Yh(y)
            ...
            function h(w, y) {
                ...
                function B(S) {
                    switch (S) {
                        case q.PLAYING:
                            ...
                            Q = w.getVideoUrl();
                            if (w.getVideoData) {
                                var O = w.getVideoData();
                                V = O ? O.title : ""
                            }
                            Y = w.getPlaybackRate();
                            y.Cf ? P.Ib("start") : P.kc();
                            L = m(y.yg, y.xg, w.getDuration());
                            return E(S);
                        default:
                            return B
                    }
                ...
                function F(S) {
                    ...
                    switch (S) {
                        ...
                        case q.PAUSED:
                            O = "pause";
                        case q.BUFFERING:
                            var oa = w.getCurrentTime() - da;
                            O = 1 < Math.abs(((new Date).getTime() - ea) / 1E3 * Y - oa) ? "seek" : O || "buffering";
                            w.getCurrentTime() && (y.Bf ? P.Ib(O) : P.kc());
                            T();
                            return M;
                        case q.UNSTARTED:
                            return z(S);
                ...
                function N() {
                    ...
                    y.Af && P.Ib("complete", 1);
                    return z(q.UNSTARTED)
                }
                ...
                function R() {
                    if (L.length && 0 !== Y) {
                        ...
                        do {
                            O = L[0];
                            if (O.ma > w.getDuration()) return;
                            S = (O.ma - w.getCurrentTime()) / Y;
                            if (0 > S && (L.shift(), 0 === L.length)) return
                        } while (0 > S);
                        x = function() {
                            A = 0;
                            x = U;
                            0 < L.length && L[0].ma === O.ma && (L.shift(), P.Ib("progress", O.ce, O.ke));
                            R()
                        };
                        A = Ai(x, 1E3 * S)
                    }
                ...
                var P, L = [],
                    I, Q, V, Y, da, ea, Ba = z(q.UNSTARTED);
                A = 0;
                x = U;
                return {
                    ...
                    onPlaybackRateChange: function(S) {
                        da = w.getCurrentTime();
                        ea = (new Date).getTime();
                        P.kc();
                        Y = S;
            ...
            function k(w) {
                for (var y = w.split(","), x = y.length, A = [], z = 0; z < x; z++) {
                    var B = parseInt(y[z], 10);
                    isNaN(B) || 100 < B || 0 > B || A.push(B / 100)
                }
                A.sort(function(E, F) {
                    return E - F
                });
            ...
            function n(w) {
                w.vtp_triggerStartOption ? p(w) : Qd(function() {
                    p(w)
                })
            }
            ...
            function p(w) {
                var y = !!w.vtp_captureStart,
                    ...
                    A = !!w.vtp_capturePause,
                    z = k(w.vtp_progressThresholdsPercent + ""),
                    B = l(w.vtp_progressThresholdsTimeInSeconds + ""),
                    E = !!w.vtp_fixMissingApi;
                if (y || x || A || z.length || B.length) {
                    var F = {
                            Cf: y,
                            Af: x,
                            Bf: A,
                            ...
                            yg: B,
                            Md: E,
                            Xc: void 0 === w.vtp_uniqueTriggerId ? "" : w.vtp_uniqueTriggerId
                        },
                        M = W("YT"),
                        N = function() {
                            g(F)
                    ...
                    if (M) M.ready && M.ready(N);
                    else {
                        var U = W("onYouTubeIframeAPIReady");
                        Hi("onYouTubeIframeAPIReady", function() {
                            U && U();
                            N()
                        });
                        G(function() {
                            for (var T = W("document"), R = T.getElementsByTagName("script"), P = R.length, L = 0; L < P; L++) {
                                var I = R[L].getAttribute("src");
                                if (b(I, "iframe_api") || b(I, "player_api")) return
                            }
                            for (var Q = T.getElementsByTagName("iframe"), V = Q.length, Y = 0; Y < V; Y++)
                                if (!v && d(Q[Y], F.Md)) {
                                    K("https://www.youtube.com/iframe_api");
                                    v = !0;
                                    break
                                }
                        })
            ...
            var a = !1,
                ...
                h = function(k) {
                    ...
                    var p = function(v, w) {
                        ...
                        q = "//www.googleadservices.com/pagead/conversion_async.js"; - 1 != navigator.userAgent.toLowerCase().indexOf("firefox") && (0 == Yi() ? (p("cjs", "0"), q = "https://www.googleadservices.com/pagead/conversion_async.js?cjs=0") : (p("cjs", "1"), q = "https://google.com/pagead/conversion_async.js?cjs=1"));

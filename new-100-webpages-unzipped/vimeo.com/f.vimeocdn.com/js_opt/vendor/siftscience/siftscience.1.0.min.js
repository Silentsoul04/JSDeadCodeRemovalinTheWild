...
function __siftFlashCB(s) {
    _sift.push(["_setFlash", s])
}
window.__siftFlashCB = __siftFlashCB;
var Sift = Sift || function() {
    function s(b, m) {
        for (var l = p(b), k = b.length; 0 < l.length && l.length > m;) k = Math.floor(k / 2), l = p(b.substring(0, k));
        return l
    }
    ...
    function E(b) {
        ...
        for (k in b)
            if (b.hasOwnProperty(k)) {
                var h = b[k];
                h && ("undefined" != h && "null" != h) && (0 < l && (m += "&"), m += k + "=" + h, l++)
            }
        return m
    }
    ...
    function L(b) {
        ...
        var l = "http:" == t.location.protocol ? "http://" : "https://";
        if (x === F) m.src = l + x + "/i.gif?" + b;
        else {
            var k = Math.ceil(1e6 * Math.random()).toString();
            m.src = l + x + "/images/" + k + ".gif?" + b
        }
    }

    function q(b, m, l) {
        var k = PluginDetect.getVersion(l);
        k ? b[m] = k : -.25 <= PluginDetect.isMinVersion(l, 0) && (b[m] = "unk")
    }
    ...
    function M(b, m) {
        function l() {
            var h = (new Date).getTime(),
                j = !1;
            do {
                if (k < b.length) b[k](), k += 1;
                else {
                    j = !0;
                    break
                }
            } while (100 > (new Date).getTime() - h);
            j || setTimeout(l, m)
        }
        var k = 0;
        setTimeout(l, m)
        ...
        M([function() {
            ...
            a: {
                ...
                var h = H + "=",
                    j = k.indexOf("; " + h);
                if (-1 == j) {
                    if (j = k.indexOf(h), 0 !== j) {
                        k = void 0;
                        break a
                    }
                } else j += 2;
                var n = k.indexOf(";", j); - 1 == n && (n = k.length);k = P(k.substring(j + h.length, n))
            }
            if (!k || 15 > k.length || "undefined" === k || "null" === k) {
                h = k = void 0;
                for (h = k = ""; 36 > k++; h += 51 * k & 52 ? (k ^ 15 ? 8 ^ Math.random() * (k ^ 20 ? 16 : 4) : 4).toString(16) : "-");
                k = h;
                var n = new Date(2030, 1, 1),
                    h = H,
                    j = p(k),
                    n = n.toGMTString(),
                    a = void 0 === z ? K() : z;
                document.cookie = h + "=" + j + (n ? ";expires=" + n : "") + ";path=/" + (a ? ";domain=." + a : "")
            }
            b.userUuid_ = k
        }, function() {
            var k;
            k = "";
            try {
                k = r.top.document.referrer
            } catch (h) {
                if (r.parent) try {
                    k = r.parent.document.referrer
                } catch (j) {
                    k = ""
                }
            }
            "" === k && (k = t.referrer);
            "" !== k && (b.referrer_ = s(k, 200))
        }, function() {
            t && (b.title_ = s(t.title, Q), b.characterSet_ = p(t.characterSet || t.charset))
        }, function() {
            r && (b.url_ = s(r.location.href, 200), b.hostName_ = s(r.location.hostname, 200))
        }, function() {
            y && (b.screenHeight_ = y.height, b.screenWidth_ = y.width, b.colorDepth_ = y.colorDepth)
        }, function() {
            u && (b.platform_ = p(u.platform), b.language_ = p(u.language || u.browserLanguage), b.userAgent_ = s(u.userAgent, 200))
        }, function() {
            var k = new Date;
            b.timezoneOffset_ = k.getTimezoneOffset();
            k.setDate(1);
            k.setMonth(6);
            var h = k.getTimezoneOffset();
            k.setMonth(12);
            k = k.getTimezoneOffset();
            b.dstOffset_ = Math.abs(Math.abs(k) - Math.abs(h))
        }, function() {
            A && (b.userId_ = p(A))
        }, function() {
            B ? b.sessionId_ = v.MD5(B.toString()) : b.userUuid_ && (b.sessionId_ = v.MD5(b.userUuid_))
        }, function() {
            C && (b.partnerUserId_ = p(C))
        }, function() {
            for (var k = u.mimeTypes, h = k ? k.length : 0, j = "", n = 0; n < h; n++) j += k[n].type;
            b.numMimeTypes_ = h;
            b.mimeTypesHash_ = v.MD5(j)
        }, function() {
            for (var k = u.plugins, h = k ? k.length : 0, j = "", n = 0; n < h; n++) var a = k[n],
                j = j + (a.name + a.description + a.filename + a.length);
            b.numPlugins_ = h;
            b.pluginsHash_ = v.MD5(j)
        }, function() {
            ...
            q(m, "w", "windowsmediaplayer")
        }, function() {
            q(m, "sl", "silverlight")
        }, function() {
            (void 0 === I || 8 > I) && q(m, "vl", "vlc")
        }, function() {
            q(m, "pd", "adobereader")
        }, function() {
            q(m, "rp", "realplayer")
            ...
            if (!l) {
                ...
                if (null != w && "object" == typeof w) {
                    for (var k in w) b[k] = w[k];
                    if (w.flash_fontsArray_) {
                        var h = (k = w.flash_fontsArray_) ? k.length : 0;
                        b.numFonts_ = h;
                        for (var j = "", n = 0; n < h; n++) j += k[n];
                        b.fontsHash_ = v.MD5(j)
                    }
                }
                ...
                (h = E(m)) && (k += "&" + h);
                k += "&z=z";
                (h = t.getElementById("plugindetect")) && h.parentNode.removeChild(h);
                L(k)
            }
        }], S)
    }
    ...
    function J() {
        var b, m, l;
        for (b = 0; b < arguments.length; b += 1) l = arguments[b], m = l.shift(), "string" === typeof m || m instanceof String ? D[m].apply(D, l) : m.apply(D, l)
    }
    var v = {};
    (function() {
        var b = v = {},
            m = b.util = {
                ...
                endian: function(b) {
                    if (b.constructor == Number) return m.rotl(b, 8) & 16711935 | m.rotl(b, 24) & 4278255360;
                    for (var h = 0; h < b.length; h++) b[h] = m.endian(b[h]);
                    return b
                },
                ...
                bytesToWords: function(b) {
                    for (var h = [], j = 0, n = 0; j < b.length; j++, n += 8) h[n >>> 5] |= (b[j] & 255) << 24 - n % 32;
                    return h
                },
                wordsToBytes: function(b) {
                    for (var h = [], j = 0; j < 32 * b.length; j += 8) h.push(b[j >>> 5] >>> 24 - j % 32 & 255);
                    return h
                },
                bytesToHex: function(b) {
                    for (var h = [], j = 0; j < b.length; j++) h.push((b[j] >>> 4).toString(16)), h.push((b[j] & 15).toString(16));
                    return h.join("")
                },
                hexToBytes: function(b) {
                    for (var h = [], j = 0; j < b.length; j += 2) h.push(parseInt(b.substr(j, 2), 16));
                    return h
                },
                bytesToBase64: function(b) {
                    if ("function" == typeof btoa) return btoa(l.bytesToString(b));
                    for (var h = [], j = 0; j < b.length; j += 3)
                        for (var n = b[j] << 16 | b[j + 1] << 8 | b[j + 2], a = 0; 4 > a; a++) 8 * j + 6 * a <= 8 * b.length ? h.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n >>> 6 * (3 - a) & 63)) : h.push("=");
                    return h.join("")
                },
                base64ToBytes: function(b) {
                    if ("function" == typeof atob) return l.stringToBytes(atob(b));
                    for (var b = b.replace(/[^A-Z0-9+\/]/gi, ""), h = [], j = 0, n = 0; j < b.length; n = ++j % 4) 0 != n && h.push(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(j - 1)) & Math.pow(2, -2 * n + 8) - 1) << 2 * n | "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(j)) >>> 6 - 2 * n);
                    return h
                }
            },
            b = b.charenc = {};
        b.UTF8 = {
            stringToBytes: function(b) {
                return l.stringToBytes(unescape(encodeURIComponent(b)))
            },
            bytesToString: function(b) {
                return decodeURIComponent(escape(l.bytesToString(b)))
            }
        };
        var l = b.Binary = {
            stringToBytes: function(b) {
                for (var h = [], j = 0; j < b.length; j++) h.push(b.charCodeAt(j) & 255);
                return h
            },
            bytesToString: function(b) {
                for (var h = [], j = 0; j < b.length; j++) h.push(String.fromCharCode(b[j]));
                return h.join("")
            }
        }
    })();
    (function() {
        var b = v,
            ...
            k = l.UTF8,
            h = l.Binary,
            j = b.MD5 = function(b, a) {
                var c = m.wordsToBytes(j._md5(b));
                return a && a.asBytes ? c : a && a.asString ? h.bytesToString(c) : m.bytesToHex(c)
            };
        j._md5 = function(b) {
            b.constructor == String && (b = k.stringToBytes(b));
            for (var a = m.bytesToWords(b), c = 8 * b.length, b = 1732584193, d = -271733879, e = -1732584194, f = 271733878, g = 0; g < a.length; g++) a[g] = (a[g] << 8 | a[g] >>> 24) & 16711935 | (a[g] << 24 | a[g] >>> 8) & 4278255360;
            a[c >>> 5] |= 128 << c % 32;
            a[(c + 64 >>> 9 << 4) + 14] = c;
            for (var c = j._ff, h = j._gg, o = j._hh, l = j._ii, g = 0; g < a.length; g += 16) var T = b,
                U = d,
                p = e,
                q = f,
                ...
                b = l(b, d, e, f, a[g + 0], 6, -198630844),
                f = l(f, b, d, e, a[g + 7], 10, 1126891415),
                e = l(e, f, b, d, a[g + 14], 15, -1416354905),
                d = l(d, e, f, b, a[g + 5], 21, -57434055),
                b = l(b, d, e, f, a[g + 12], 6, 1700485571),
                f = l(f, b, d, e, a[g + 3], 10, -1894986606),
                e = l(e, f, b, d, a[g + 10], 15, -1051523),
                d = l(d, e, f, b, a[g + 1], 21, -2054922799),
                b = l(b, d, e, f, a[g + 8], 6, 1873313359),
                f = l(f, b, d, e, a[g + 15], 10, -30611744),
                e = l(e, f, b, d, a[g + 6], 15, -1560198380),
                d = l(d, e, f, b, a[g + 13], 21, 1309151649),
                b = l(b, d, e, f, a[g + 4], 6, -145523070),
                f = l(f, b, d, e, a[g + 11], 10, -1120210379),
                e = l(e, f, b, d, a[g + 2], 15, 718787259),
                d = l(d, e, f, b, a[g + 9], 21, -343485551),
                b = b + T >>> 0,
                d = d + U >>> 0,
                e = e + p >>> 0,
                f = f + q >>> 0;
            return m.endian([b, d, e, f])
        };
        j._ff = function(b, a, c, d, e, f, g) {
            b = b + (a & c | ~a & d) + (e >>> 0) + g;
            return (b << f | b >>> 32 - f) + a
        };
        j._gg = function(b, a, c, d, e, f, g) {
            b = b + (a & d | c & ~d) + (e >>> 0) + g;
            return (b << f | b >>> 32 - f) + a
        };
        j._hh = function(b, a, c, d, e, f, g) {
            b = b + (a ^ c ^ d) + (e >>> 0) + g;
            return (b << f | b >>> 32 - f) + a
        };
        j._ii = function(b, a, c, d, e, f, g) {
            b = b + (c ^ (a | ~d)) + (e >>> 0) + g;
            return (b << f | b >>> 32 - f) + a
        };
        j._blocksize = 16;
    ...
    (function() {
        var b = {
            ...
            getPluginFileVersion: function(a, c, d, e) {
                ...
                for (e = 0; e < a.length; e++)
                    if (-1 < g && e > g && "0" != a[e] || d[e] != a[e] && (-1 == g && (g = e), "0" != a[e])) return c;
                return f
            },
            AXO: function() {
                var a;
            ...
            browser: {
                ...
                detectIE: function() {
                    ...
                    this.isIE = (this.isIE = this.ActiveXEnabled) || b.isNum(a.documentMode) || !1;
                    try {
                        a.documentMode = c;
            ...
            ev: {
                ...
                call0: function(a) {
                    ...
                    if (0 < c && b.isFunc(a[0])) a[0](b, 1 < c ? a[1] : 0, 2 < c ? a[2] : 0, 3 < c ? a[3] : 0);
                    else b.isFunc(a) && a(b)
                },
                ...
                ifDetectDoneCallHndlrs: function() {
                    ...
                    if (this.allDoneHndlrs.length && (!b.win || b.win.loaded && !b.win.loadPrvtHndlrs.length && !b.win.loadPblcHndlrs.length)) {
                        if (b.Plugins)
                            for (a in b.Plugins)
                                if (b.hasOwn(b.Plugins, a) && (c = b.Plugins[a]) && b.isFunc(c.getVersion) && (3 == c.OTF || c.DoneHndlrs && c.DoneHndlrs.length || c.BIHndlrs && c.BIHndlrs.length)) return;
            ...
            isMinVersion: function(a, c, d, e) {
                ...
                null !== f.installed && (a = .5 >= f.installed ? f.installed : .7 == f.installed ? 1 : null === f.version ? 0 : 0 <= b.compareNums(f.version, c, f) ? 1 : -.1);
                return a
            },
            ...
            onDetectionDone: function(a, c, d, e) {
                ...
                if (-.5 != f.installed && .5 != f.installed) return b.ev.call(c), 1;
                ...
                search: function(a, c) {
                    ...
                    if (!c || d.isActiveXObject(a, b.formatNum(a.DIGITMIN.join(",")))) {
                        ...
                        for (f = 0; f < m.length; f++) {
                            ...
                            j = l.join(",");
                            k = l.slice(0, f).concat([99999999, 99999999, 99999999, 99999999]).slice(0, l.length).join(",");
                            for (g = 0; g < h.length; g++) b.isArray(h[g]) && (h[g].push(0), h[g][f] > m[f] && (0 <= b.compareNums(k, a.Lower[g]) && 0 > b.compareNums(j, a.Upper[g])) && (m[f] = Math.floor(h[g][f])));
                            for (g = 0; 30 > g; g++) {
                                if (16 >= m[f] - l[f]) {
                ...
                convert: function(a, c, d) {
                    ...
                    if (c)
                        for (e = 0; e < a.Lower.length; e++)
                            if ((g = this.convert_(a, e, a.Lower[e])) && 0 <= b.compareNums(c, d ? g : a.Lower[e]) && (!e || 0 > b.compareNums(c, d ? this.convert_(a, e, a.Upper[e]) : a.Upper[e]))) {
            ...
            DOM: {
                ...
                getTagStatus: function(a, c, d, e, f, g, h) {
                    ...
                    h && (!a.pi && b.isDefined(k) && b.browser.isIE && a.tagName == d.tagName && a.time <= d.time && f === e && 0 === j && 0 !== m) && (a.pi = 1);
                    return e < l || !a.loaded || !c.loaded || !d.loaded ? a.pi ? -.1 : 0 : f != l && g && f == this.pluginSize && g && (!b.isNum(j) || 4 === j) ? 1 : a.pi ? -.5 : -1
                },
                ...
                insertDivInBody: function(a, c) {
                    ...
                    if (!f) try {
                        e.write('<div id="pd33993399">.' + b.openTag + "/div>"), d = e.getElementById("pd33993399")
                    } catch (g) {}
                ...
                insert: function(a, c, d, e, f, g, h) {
                    ...
                    h && (/div/i.test(h.tagName) && (j = h.ownerDocument), /iframe/i.test(h.tagName) && (j = this.iframe.doc(h)));
                    if (!j || !j.createElement) j = document;
                    b.isDefined(e) || (e = "");
                    if (b.isString(a) && /[^\s]/.test(a)) {
                        for (var a = a.toLowerCase().replace(/\s/g, ""), f = b.openTag + a + " ", f = f + ('style="' + this.getStyle.plugin(g) + '" '), k = 1, l = 1, g = 0; g < c.length; g += 2) /[^\s]/.test(c[g + 1]) && (f += c[g] + '="' + c[g + 1] + '" '), /width/i.test(c[g]) && (k = 0), /height/i.test(c[g]) && (l = 0);
                        f += (k ? 'width="' + this.pluginSize + '" ' : "") + (l ? 'height="' + this.pluginSize + '" ' : "");
                        if ("embed" == a || "img" == a) f += " />";
                        else {
                            f += ">";
                    ...
                    if (h && h.parentNode)
                        if (/iframe/i.test(h.tagName)) this.iframe.addHandler(h, [this.onLoadHdlr, a]), a.loaded = 0, a.spanId = b.name + "Span" + this.HTML.length, j = '<span id="' + a.spanId + '" style="' + this.getStyle.span(1) + '">' + f + "</span>", a.time = (new Date).getTime(), h = this.iframe.write(h, j), 0 <= h && (a.insertDomDelay = h);
                        else if (/div/i.test(h.tagName)) {
                        j = j.createElement("span");
                        this.setStyle(j, this.getStyle.span());
                        h.appendChild(j);
                        try {
                            a.time = (new Date).getTime(), j.innerHTML = f, a.insertDomDelay = (new Date).getTime() - a.time
                        } catch (m) {}
                        a.spanObj = j
                    }
                    this.HTML.push(a);
        ...
        var m = {
            setPluginStatus: function(a, c, d) {
                this.installed = (this.version = c ? b.formatNum(c, 3) : null) ? 1 : d ? 0 < d ? .7 : -.1 : a ? 0 : -1;
                this.getVersionDone = .7 == this.installed || -.1 == this.installed || 0 === this.nav.done ? 0 : 1
            },
                    ...
                    for (c = 0; c < this.progID.length; c++)
                        if (a = b.getAXO(this.progID[c]))
                            if (this.installed = 1, (a = b.pd.getPROP(a, "QuickTimeVersion")) && a.toString)
                                if (a = a.toString(16), this.version = parseInt(a.charAt(0) || "0", 16) + "." + parseInt(a.charAt(1) || "0", 16) + "." + parseInt(a.charAt(2) || "0", 16), !b.dbug) break;
                    return this
                }
            }
        };
        b.addPlugin("quicktime", m);
        var l = {
                ...
                query: function() {
                    ...
                    for (c = 0; 10 > c; c++)
                        if (d = b.getAXO(this.progID + (c ? "." + c : ""))) {
                            ...
                            if (a && (this.version = a, this.precision = l.getPrecision(a), !b.dbug)) break
                        }
                    return this
                }
            },
        ...
        b.addPlugin("windowsmediaplayer", k);
        ...
        var h = {
            compareNums: function(a, c) {
                ...
                for (f = 0; f < Math.min(d.length, e.length); f++) {
                    ...
                    if (2 == f && j != k) return j > k ? 1 : -1
                }
                return 0
            },
            setPluginStatus: function(a, c, d) {
                this.installed = c ? 1 : d ? 0 < d ? .7 : -.1 : a ? 0 : -1;
            ...
            instance: {
                ...
                isDisabled: function() {
                    var a = 1;
                    this.hasRun || (b.dbug ? a = 0 : h.nav.installed && b.hasMimeType(this.mimeType) && (a = 0));
                    return a
                },
                query: function() {
                    var a = b.DOM.altHTML,
                    ...
                    this.hasRun = 1;
                    if (d) return this;
                    this.HTML = b.DOM.insert("object", ["type", this.mimeType], "autoplay no loop no volume 0".split(" "), a, h);
                    if (d = this.HTML.obj()) {
                        try {
        ...
        var j = {
            ...
            setPluginStatus: function() {
                ...
                this.precision = c;
                c = -1;
                if (3 == a) c = this.version ? .5 : -.5;
                else if (d) c = 1;
                else if (e) c = 0;
                else if (-.5 == f || -.5 == j) c = -.15;
                else if (b.browser.isIE && (!b.browser.ActiveXEnabled || b.browser.ActiveXFilteringEnabled)) c = -1.5;
                this.installed = c;
                1 != this.getVersionDone && (a = 1, this.verify && this.verify.isEnabled() || .5 == this.installed || -.5 == this.installed ? a = 0 : 1 == this.doc2.isDisabled() && (a = 0), this.getVersionDone = a)
            },
            getVersion: function(a, c) {
                var d = 0,
                    e = this.verify;
            ...
            nav: {
                ...
                query: function() {
                    ...
                    a && (c = b.getNum(a.description) || b.getNum(a.name), (c = b.getPluginFileVersion(a, c)) || (c = this.attempt3()), c && (this.version = c, this.precision = j.getPrecision(c)));
                    return this
                },
                attempt3: function() {
                    var a = null;
            ...
            activexQuery: function(a) {
                ...
                if (c && b.isString(c) && (a = /\=\s*[\d\.]+/g, e = c.match(a))) {
                    ...
                    f.precision = j.getPrecision(c, "\\=\\s*")
                }
                return f
            },
            axo: {
                ...
                query: function() {
                    ...
                    for (f = 0; f < this.progID.length; f++)
                        ...
                        } else g && (b.errObj && g !== b.errObj && g.message !== b.errObj.message) && (this.detected = -.5);
                    d && (this.version = d);
                    e && (this.precision = e);
                    return this
                }
            ...
            doc: {
                ...
                query: function() {
                    ...
                    a = d.version;
                    d = d.precision;
                    this.detected = 0 < c || a ? 1 : -.1 == c || -.5 == c ? -.5 : -1;
                    a && (this.version = a);
                    d && (this.precision = d);
                    return this
                }
    ...
    var R = (new Date).getTime(),
        ...
        y = screen,
        r = window,
        p = r.encodeURIComponent,
        P = r.decodeURIComponent,
        F = "b.siftscience.com",
        x = F,
        w, S = 0,
        H = "__ssid",
        ...
        Q = 100,
        I = function() {
            for (var b = 3, m = document.createElement("b"), l = m.all || []; m.innerHTML = "\x3c!--[if gt IE " + ++b + "]><i><![endif]--\x3e", l[0];);
    ...
    for (i = 0; i < _sift.length; i++) J(_sift[i]);
    _sift = {
        push: J
    }
}();
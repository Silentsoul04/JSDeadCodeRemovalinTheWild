    ...
    return function a(b, c, d) {
        ...
        4: [function(a, b, c) {
            (function(c) {
                ...
                function e() {
                    this.a = !("object" != typeof JSON || !JSON.stringify), this.b = !f(D), this.c = null, this.d = null, this.e = null, this.f = null, this.g = null, this.h = {}, this.i = {
                        logger: "javascript",
                        ignoreErrors: [],
                        ignoreUrls: [],
                        whitelistUrls: [],
                        ...
                        stackTraceLimit: 50,
                        autoBreadcrumbs: !0
                    }, this.j = 0, this.k = !1, this.l = Error.stackTraceLimit, this.m = C.console || {}, this.n = {}, this.o = [], this.p = d(), this.q = [], this.r = [], this.s = null, this.t = C.location, this.u = this.t && this.t.href;
                ...
                e.prototype = {
                    ...
                    config: function(a, b) {
                        var c = this;
                        if (c.e) return this.v("error", "Error: Raven has already been configured"), c;
                        if (!a) return c;
                        var d = c.i;
                        b && l(b, function(a, b) {
                            "tags" === a || "extra" === a || "user" === a ? c.h[a] = b : d[a] = b
                    ...
                    install: function() {
                        var a = this;
                        return a.isSetup() && !a.k && (w.report.subscribe(function() {
                            a.w.apply(a, arguments)
                        }), a.x(), a.i.autoBreadcrumbs && a.y(), a.z(), a.k = !0), Error.stackTraceLimit = a.i.stackTraceLimit, this
                    },
                    setDSN: function(a) {
                        var b = this,
                            c = b.A(a),
                            ...
                            e = c.path.substr(1, d);
                        b.B = a, b.f = c.user, b.C = c.pass && c.pass.substr(1), b.g = c.path.substr(d + 1), b.e = b.D(c), b.E = b.e + "/" + e + "api/" + b.g + "/store/"
                    },
                    ...
                    wrap: function(a, b, c) {
                        function d() {
                            ...
                            try {
                                ...
                                throw e.F(), e.captureException(i, a), i
                            }
                        }
                        var e = this;
                        if (f(b) && !g(a)) return a;
                    ...
                    uninstall: function() {
                        return w.report.uninstall(), this.J(), Error.stackTraceLimit = this.l, this.k = !1, this
                    },
                    ...
                    captureMessage: function(a, b) {
                        if (!this.i.ignoreErrors.test || !this.i.ignoreErrors.test(a)) {
                            b = b || {};
                            var c = m({
                                message: a + ""
                            }, b);
                            if (this.i.stacktrace || b && b.stacktrace) {
                                var d;
                                try {
                                    throw new Error(a)
                                } catch (e) {
                    ...
                    captureBreadcrumb: function(a) {
                        ...
                        if (g(this.i.breadcrumbCallback)) {
                            var c = this.i.breadcrumbCallback(b);
                            if (i(c) && !j(c)) b = c;
                            else if (c === !1) return this
                        }
                        return this.r.push(b), this.r.length > this.i.maxBreadcrumbs && this.r.shift(), this
                    },
                    ...
                    setExtraContext: function(a) {
                        return this.N("extra", a), this
                    },
                    setTagsContext: function(a) {
                        return this.N("tags", a), this
                    },
                    clearContext: function() {
                        return this.h = {}, this
                    },
                    getContext: function() {
                        return JSON.parse(y(this.h))
                    },
                    ...
                    setDataCallback: function(a) {
                        ...
                        return this.i.dataCallback = g(a) ? function(c) {
                            return a(c, b)
                        } : a, this
                    },
                    setBreadcrumbCallback: function(a) {
                        var b = this.i.breadcrumbCallback;
                        return this.i.breadcrumbCallback = g(a) ? function(c) {
                            return a(c, b)
                        } : a, this
                    },
                    setShouldSendCallback: function(a) {
                        var b = this.i.shouldSendCallback;
                        return this.i.shouldSendCallback = g(a) ? function(c) {
                            return a(c, b)
                        } : a, this
                    },
                    ...
                    isSetup: function() {
                        return !!this.a && (!!this.e || (this.ravenNotConfiguredError || (this.ravenNotConfiguredError = !0, this.v("error", "Error: Raven has not been configured.")), !1))
                    },
                    afterLoad: function() {
                        var a = C.RavenConfig;
                    ...
                    R: function() {
                        ...
                        return function(c) {
                            ...
                            if (e && ("INPUT" === e || "TEXTAREA" === e || d.isContentEditable)) {
                                var f = a.Q;
                                f || a.P("input")(c), clearTimeout(f), a.Q = setTimeout(function() {
                                    a.Q = null
                                }, b)
                            }
                        }
                    ...
                    S: function(a, b) {
                        var c = r(this.t.href),
                            d = r(b),
                            e = r(a);
                        this.u = b, c.protocol === d.protocol && c.host === d.host && (b = d.relative), c.protocol === e.protocol && c.host === e.host && (a = e.relative), this.captureBreadcrumb({
                            category: "navigation",
                            data: {
                                to: b,
                                from: a
                        ...
                        function b(a) {
                            ...
                            b && b.hasOwnProperty && b.hasOwnProperty("addEventListener") && (v(b, "addEventListener", function(b) {
                                return function(d, f, g, h) {
                                    ...
                                    var j, k, l;
                                    return e && e.dom && ("EventTarget" === a || "Node" === a) && (k = c.P("click"), l = c.R(), j = function(a) {
                    ...
                    y: function() {
                        ...
                        var b = this,
                            c = this.i.autoBreadcrumbs,
                            d = b.q;
                        if (c.xhr && "XMLHttpRequest" in C) {
                            var e = XMLHttpRequest.prototype;
                            v(e, "open", function(a) {
                                return function(c, d) {
                                    return h(d) && d.indexOf(b.f) === -1 && (this.T = {
                                        method: c,
                                        url: d,
                                        status_code: null
                                ...
                                return function(d) {
                                    function e() {
                                        if (f.T && (1 === f.readyState || 4 === f.readyState)) {
                                            try {
                                                f.T.status_code = f.status
                                            } catch (a) {}
                                            b.captureBreadcrumb({
                                                type: "http",
                                                category: "xhr",
                        ...
                        }, d), c.dom && this.b && (D.addEventListener ? (D.addEventListener("click", b.P("click"), !1), D.addEventListener("keypress", b.R(), !1)) : (D.attachEvent("onclick", b.P("click")), D.attachEvent("onkeypress", b.R())));
                        var f = C.chrome,
                        ...
                        if (c.location && j) {
                            ...
                            C.onpopstate = function() {
                                var a = b.t.href;
                                if (b.S(b.u, a), k) return k.apply(this, arguments)
                            }, v(history, "pushState", function(a) {
                                return function() {
                                    var c = arguments.length > 2 ? arguments[2] : void 0;
                                    return c && b.S(b.u, c + ""), a.apply(this, arguments)
                                }
                            }, d)
                        }
                    ...
                    A: function(a) {
                        ...
                        if (c.pass && !this.i.allowSecretKey) throw new x("Do not specify your secret key in the DSN. See: http://bit.ly/raven-secret-key");
                        return c
                    },
                    D: function(a) {
                    ...
                    K: function(a, b) {
                        ...
                        this.O("handle", {
                            stackInfo: a,
                            options: b
                        }), this.U(a.name, a.message, a.url, a.lineno, c, b)
                    },
                    L: function(a, b) {
                        var c = this,
                            d = [];
                        ...
                        return d = d.slice(0, this.i.stackTraceLimit)
                    },
                    V: function(a) {
                        if (a.url) {
                            var b = {
                    ...
                    X: function() {
                        if (this.b && D.location && D.location.href) {
                            var a = {
                                headers: {
                    ...
                    M: function(a) {
                        var b = this.i,
                            ...
                            e = this.X();
                        e && (c.request = e), a.trimHeadFrames && delete a.trimHeadFrames, a = m(c, a), a.tags = m(m({}, this.h.tags), a.tags), a.extra = m(m({}, this.h.extra), a.extra), a.extra["session:duration"] = d() - this.p, this.r && this.r.length > 0 && (a.breadcrumbs = {
                            values: [].slice.call(this.r, 0)
                        }), j(a.tags) && delete a.tags, this.h.user && (a.user = this.h.user), b.environment && (a.environment = b.environment), b.release && (a.release = b.release), b.serverName && (a.server_name = b.serverName), g(b.dataCallback) && (a = b.dataCallback(a) || a), a && !j(a) && (g(b.shouldSendCallback) && !b.shouldSendCallback(a) || this.Y(a))
                    },
                    Z: function() {
                        return s()
                    },
                    Y: function(a, b) {
                        var c = this,
                            d = this.i;
                        if (this.d = a.event_id || (a.event_id = this.Z()), a = this.W(a), this.v("debug", "Raven about to send:", a), this.isSetup()) {
                            var e = {
                                sentry_version: "7",
                                sentry_client: "raven-js/" + this.VERSION,
                                sentry_key: this.f
                            };
                            this.C && (e.sentry_secret = this.C);
                    ...
                    N: function(a, b) {
                        f(b) ? delete this.h[a] : this.h[a] = m(this.h[a] || {}, b)
                    }
                };
...
(function() {
    if (!window.vimeo || !window.vimeo.config || !window.vimeo.config.sentry_url) {
        return
    }
    var sentryOptions = window.vimeo.config.sentry_options || {};
    var sentryLimit = .1;
    if (typeof window.vimeo.config.sentry_limit == "number") {
        sentryLimit = window.vimeo.config.sentry_limit
    }
    var loadSentry = Math.random() < sentryLimit;
    if (window.Raven && loadSentry) {
        window.Raven.config(window.vimeo.config.sentry_url, sentryOptions).install();
        if (window.ablincoln_config && window.ablincoln_config.user && window.ablincoln_config.user.vuid) {
            window.Raven.setUserContext({
                id: window.ablincoln_config.user.vuid
            })
        }
    }
})();
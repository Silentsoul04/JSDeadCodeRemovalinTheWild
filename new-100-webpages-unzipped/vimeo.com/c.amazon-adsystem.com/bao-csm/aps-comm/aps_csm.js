    ...
    function() {
        ...
        amzn_aps_csm.loadModules([{
            ...
            if (amzn_aps_csm.log("parent received message!: ", a.data), amzn_aps_csm.log(a.origin), /pixelId/.test(a.data)) {
                ...
                for (e = {}, null != apstag && null != apstag.debug("getState") && apstag.debug("getState").AAXReqs[0].bidConfig.slots.forEach(function(a) {
                        e[a.slotID] = a.slotName
                    }), f = "", g = document.getElementsByTagName("iframe"), h = 0; h < g.length; h++)

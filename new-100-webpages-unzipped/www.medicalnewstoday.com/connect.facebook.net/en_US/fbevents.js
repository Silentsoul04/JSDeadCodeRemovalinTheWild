...
(function(a, b, c, d) {
    ...
    (function() {
                ...
                (function() {
                    ...
                    b = function() {
                        function b(e) {
                            ...
                            this._startOffset = this._pageStartTime - g.performance.timing.navigationStart;
                            if (e.execStart != null) this._execStart = e.execStart - this._startOffset;
                            else throw new Error("fbq.execStart must be set in the base code.");
                            i.listen(function() {
                                return h.execEnd()
                            });
                            c.listen(function() {
                        ...
                        h(b, [{
                            ...
                            value: function() {
                                ...
                                return {
                                    ...
                                    ttse: this._execEnd != null ? this._execEnd.toString() : null
                                }
                            }
                        }]);
                        return b
                    }();
                    b.supported = g.performance && g.performance.now && !!g.performance.timing;
                    e.exports = b
                })();
                return e.exports
            }(a, b, c, d)
        ...
        f.registerPlugin && f.registerPlugin("fbevents.plugins.performance", e.exports);

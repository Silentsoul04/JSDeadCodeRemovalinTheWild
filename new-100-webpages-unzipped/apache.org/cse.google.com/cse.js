(function(opts_) {
    ...
    var u = function(a, b) {
        ...
        if (d && "undefined" != typeof d[b] && (!a || !(a instanceof d[b]) && (a instanceof d.Location || a instanceof d.Element))) {
            d = typeof a;
            if ("object" == d && null != a || "function" == d) try {
                var g = a.constructor.displayName || a.constructor.name || Object.prototype.toString.call(a)
            } catch (r) {
                g = "<object could not be stringified>"
            } else g = void 0 === a ? "undefined" : null === a ? "null" :
                typeof a;
            t("Argument is not a %s (or a non-Element, non-Location mock); got: %s", b, g)
        }
    };
    var x = function(a, b) {
        this.i = a === v && b || "";
    ...
    var y = function(a) {
            if (a instanceof x && a.constructor === x && a.l === w) return a.i;
            t("expected object of type Const, got '" + a + "'");
    ...
    var C = function(a) {
            if (a instanceof B && a.constructor === B && a.m === A) return a.b;
            t("expected object of type TrustedResourceUrl, got '" + a + "' of type " + l(a));
            return "type_error:TrustedResourceUrl"
        },
        E = function(a, b) {
            var c = y(a);
            if (!aa.test(c)) throw Error("Invalid TrustedResourceUrl format: " + c);
            a = c.replace(ba, function(e, d) {
                ...
                e = b[d];
                return e instanceof
                x ? y(e) : encodeURIComponent(String(e))
            });
            return D(a)
        },
        ba = /%{(\w+)}/g,
        aa = /^((https:)?\/\/[0-9a-z.:[\]-]+\/|\/[^/\\]|[^:/\\%]+\/|[^:/\\%]*[?#]|about:blank#)/i,
        ca = /^([^?#]*)(\?[^#]*)?(#[\s\S]*)?/,
        G = function(a) {
            var b = da;
            a = E(ea, a);
            ...
            a = ca.exec(a);
            var c = a[3] || "";
            return D(a[1] + F("?", a[2] || "", b) + F("#", c, void 0))
        },
        A = {},
        D = function(a) {
            var b = new B;
        ...
        F = function(a, b, c) {
            ...
            for (var e in c) {
                ...
                for (var g = 0; g < d.length; g++) {
                    var r = d[g];
                    null != r && (b || (b = a), b += (b.length > a.length ? "&" : "") + encodeURIComponent(e) + "=" + encodeURIComponent(String(r)))
                }
            }
            return b
        };
    ...
    (new J).a("<!DOCTYPE html>");
    (new J).a("");
    (new J).a("<br>");
    var fa = new x(v, "https://www.google.com/cse/static/style/look/%{versionDir}%{versionSlash}%{theme}.css"),
        K = new x(v, "https://www.google.com/cse/static/element/%{versionDir}%{versionSlash}default%{experiment}+%{lang}.css"),
        ea = new x(v, "https://www.google.com/cse/static/element/%{versionDir}%{versionSlash}cse_element__%{lang}.js"),
        L = new x(v, "/");
    ...
    window.__gcse.scb = function() {
        ...
        var b = ha(a.initializationCallback || a.callback);
        google.search.cse.element.init(opts_) && ("explicit" !== a.parsetags ? "complete" === document.readyState || "interactive" === document.readyState ? (google.search.cse.element.go(), b && b()) : google.setOnLoadCallback(function() {
    ...
    function N(a) {
        ...
        u(b, "HTMLLinkElement");
        b.rel = "stylesheet";
        q(a instanceof B, 'URL must be TrustedResourceUrl because "rel" contains "stylesheet"');
        b.href = a.j ? a.j : C(a).toString();
        return b
    };
    var O, da = opts_.usqp ? {
            usqp: opts_.usqp
    ...
    u(R, "HTMLScriptElement");
    R.src = C(O);
    var S;
    if (null === k) a: {
        var T = f.document,
            U = T.querySelector && T.querySelector("script[nonce]");
        if (U) {
            var V = U.nonce || U.getAttribute("nonce");
            if (V && h.test(V)) {
                k = V;
                break a
            }
    ...
    if (M()) {
        document.getElementsByTagName("head")[0].appendChild(N(opts_.cselibVersion ? E(K, {
            versionDir: opts_.cselibVersion,
            versionSlash: L,
            experiment: opts_.uiOptions.imageLayoutRedesign ? "_v2" : "",
            lang: opts_.language
        }) : E(K, {
            versionDir: "",
            versionSlash: "",
    ...
    "cx": "005703438322411770421:5mgshgrgx2u",
    "language": "en",
    "theme": "V2_DEFAULT",
    "uiOptions": {
        "resultsUrl": "",

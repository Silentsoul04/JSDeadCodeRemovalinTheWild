! function() {
  ...
  class u extends r {
    constructor(e) {
      super(e), this.data.longTasks = [], this._longTaskFields = ["duration", "name", "startTime"], this._observer = new PerformanceObserver(null);
      try {
  ...
  class p {
    ...
    _resetState(e) {
      this._beaconData = {}, this._viewTimings = {}, this._scrollTime = void 0, this._shouldSendBeacon = !0, this._timeOutVal && (clearTimeout(this._timeOutVal), this._timeOutVal = void 0), e && this._config.plugins.map(null)
    }
    ...
    _collectPluginData() {
      ...
      }), this._pushCurrentBeaconData(), e ? this._sendAllData() : setTimeout(null, this._config["async-plugins-timeout"]), this._resetState(!0))
    }
    _markAllAsyncPluginCompletenull
    _doesNotHaveLazyImageClassnull
    _doesElementOverlapWithViewportnull
    _getImgResourceEntriesnull
    ...
    _getRenderingModenull
    _doesRenderErrorCodeBlockExistsnull
    ...
    _getBeaconAndPluginData() {
      if (this._readPageKey(), this._readSinglePageAppData(), this._readRenderTimingEntries(), this._readIsSSL(), this._config["app-version"] && (this._beaconData.appVersion = this._config["app-version"]), this._config.plugins.map(null), "navigationStart" in this._beaconData && this._shouldSendBeacon) {
    ...
    ! function(e) {
            ...
            var n = "undefined" != typeof window && window && "node" !== window.appEnvironment,
              ...
              a = {
                ...
                addToQueue: function(e) {
                  ...
                  if (!this.timeoutId) {
                    var t = this;
                    i && !this.paused ? this.timeoutId = this.idleFlush(this.queueTimeout) : this.timeoutId = setTimeout(null, this.queueTimeout)
                  }
                },
                validateEvent: null,
      ...
      var T = 10,
        ...
        P = function() {
          ...
          return t.prototype._handleDocumentClicks = null, t.prototype._handleWindowBeforeUnload = null, t.prototype._handleDocumentVisibilityChange = null, t.prototype.saveStateForPageDeparture = null, t.prototype.fireControlInteractionEvent = null, t.prototype.fireNavigationEvent = function(t, n, i) {
            void 0 === i && (i = {});
          ...
          }, t.prototype.fireExternalNavigationEvent = null, t.prototype.firePageViewEvent = null, t.prototype.fireAnchorPageViewEvent = null, t.prototype.firePageVisibilityChangeEvent = null, t.prototype.fireTrackingEvent = function(e, t, n, i) {
            ...
            this.config.validationMode ? r.validateEvent(d, c, null) : (r.sendEvent(d, c), i && r.flush())
          }, t.prototype.destroy = null, t.createFromPageKey = function(e, n) {
            return e.initialPageInstance = w(n), new t(e)
          }, t
        }();
      e.AppTrackingInstance = P, e.clearNavStorage = null, e.derivePageInstanceFromString = y, e.derivePageKeyFromUrn = _, e.generateControlUrn = v, e.generatePageInstance = w, e.generatePageUrn = m, e.generateTrackingId = p, e.getReferrer = E, e.getTrackingCode = b, e.stringifyPageInstance = null, e.uuid = g, e.webTrackingTransport = r
    }(t)
  }(v = {
    exports: {}
  }, v.exports), v.exports);
  ...
  var T = Object.assign || null;

  function I(e) {
    "complete" === document.readyState ? e() : window.addEventListener("load", null)
  }
  ...
  class z {
    constructornull
    _getPageLoadTimenull
    fireIngraphsRequestnull
  }
  const x = "[data-impression-id]",
    V = "data-impression-id",
    F = {
      observeComponents: null,
      unobserveComponents: null,
      handleDynamicElements: null
    };
  class K {
    constructor(e, t) {
    ...
    observeComponents() {
      ...
      this.intersectionObserverInstance && e.forEach(null)
    }
    unobserveComponents() {
      (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : []).forEach(null)
    }
    _returnImpressionMetaDatanull
    _isNodeVisible(e) {
      return e.intersectionRatio >= this.threshold
    }
    _handleObservedNodes(e) {
      if (this.intersectionObserverInstance) {
        const t = e.filter(null).map(null),
  ...
  function Y() {
    var e;
    e = navigator.userAgent, Q.test(e) && S(document.querySelectorAll(".app-store-link")).forEach(null)
  }

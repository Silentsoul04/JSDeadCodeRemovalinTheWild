...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        if (window.ue_ihb === 1) {
            ...
            (function(d) {
                var e = d.ue = d.ue || {},
                    f = Date.now || function() {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[292:356]", functionData => eval(functionData))};
                e.d = function(b) {
            ...
            (function(d, e) {
                function h(f, b) {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[1554:2231]", functionData => eval(functionData))}

                function l(a, b, c, e, g) {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[2275:2755]", functionData => eval(functionData))}
                var k = "FATAL",
                    m = "ERROR",
                    n = "WARN",
                    p = "DOWNGRADED",
                    a = {
                        ...
                        startTimer: function() {
                            a.ts++;
                            setInterval(function() {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[3279:3424]", functionData => eval(functionData))}, 1E4)
                        }
                    };
                l.skipTrace = 1;
                h.skipTrace = 1;
            ...
            (function(d, k, J) {
                ...
                function E(a) {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[6013:6225]", functionData => eval(functionData))}

                function K(p, b) {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[6260:6685]", functionData => eval(functionData))}
                ...
                function W() {
                    function a() {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[16232:16288]", functionData => eval(functionData))}
                ...
                d.uex = P;
                a.reset = K;
                a.pause = function(d) {lacuna_lazy_load("lacuna_cache/exported_vnh0f4.js[19040:19092]", functionData => eval(functionData))};
                W()

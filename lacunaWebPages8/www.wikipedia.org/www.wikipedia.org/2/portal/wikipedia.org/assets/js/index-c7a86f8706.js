...
window.JSON || (window.JSON = {
    ...
    }(), document.querySelector || (document.querySelector = function(e) {}), Function.prototype.bind || (Function.prototype.bind = function(e) {}), Object.defineProperty && Object.getOwnPropertyDescriptor && Object.getOwnPropertyDescriptor(Element.prototype, "textContent") && !Object.getOwnPropertyDescriptor(Element.prototype, "textContent").get && ! function() {}(), window.Element && !Element.prototype.matches && (Element.prototype.matches = function e(t) {}), window.attachedEvents = [], window.onunload = function() {};
var _ = _ || {};
_.now = Date.now || function() {}, _.throttle = function(e, t, n) {}, _.debounce = function(e, t, n) {
...
mw.html = function() {
    ...
    function() {
        ...
        e = window.eventLoggingLite = {
            ...
            sendBeacon: /1|yes/.test(navigator.doNotTrack) || !r ? t.noop : navigator.sendBeacon ? function(e) {} : function(e) {},
    ...
    function(e, t) {
        ...
        return f || (f = document.createElement("div"), f.id = p, v.appendChild(f)), window.callbackStack = {
            ...
            setIndex: function(e) {},
            clear: function() {}
        }, window.portalOpensearchCallback = function(e) {}, addEvent(w, "keydown", l), addEvent(w, "blur", function(e) {}), {
            typeAheadEl: f,
            query: a
        }
    },
    function(e, t) {
        ...
        n = "oninput" in document ? "input" : "propertychange", addEvent(r, n, _.debounce(function() {}, 100))
    }(wmTest, WMTypeAhead),
    function(e, t) {
        function n(e) {
            var t;
        ...
        function s(t, r) {
            ...
            s.open("GET", encodeURI("portal/wikipedia.org/assets/l10n/" + r + "-" + translationsHash + ".json"), !0), s.onload = function() {}, s.send()
        }
    ...
    function(e, t, n, r) {
        ...
        if (u = a(), d = u ? o(n.storage.get("storedTranslations")) || {} : {}, d[h]) {
            ...
            l(h), c(m)
        } else g = new XMLHttpRequest, g.open("GET", encodeURI("portal/wikipedia.org/assets/l10n/" + h + "-" + t + ".json"), !0), g.onreadystatechange = function() {}, g.send()
    ...
    function(e) {
        var t = document.cookie.match(/GeoIP=.[^:]/),
            ...
            u = c.querySelector("a"),
            d = "banner-visible";
        addEvent(l, "click", function() {}), u.href = "https://donate.wikimedia.org/?utm_medium=portal&utm_campaign=portalBanner", u.href += "&uselang=fr&country=FR", u.href += "&utm_source=" + c.id, u.target = "_blank", !i && n && r.indexOf(n) > -1 && a[0] === o && c.classList.add(d)
    }(wmTest);
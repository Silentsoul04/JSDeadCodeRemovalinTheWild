            ...
            var lazyContentLoader = function() {
                ...
                var init = function() {
                    (function() {
                        ...
                        var _removeEventHandlers = function() {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[1240:1399]", functionData => eval(functionData))};

                        var _clearWillChange = function(e) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[1461:1548]", functionData => eval(functionData))};
                        ...
                        var _stringToFunctionPath = function(functionString) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[1953:2818]", functionData => eval(functionData))};

                        var _callCallback = function(callback, callbackAfter) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[2899:3933]", functionData => eval(functionData))};

                        var _lazyLoadImageLoadHandler = function(lazyItem, callback, callbackAfter) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[4036:5495]", functionData => eval(functionData))}
                        ...
                        var _parseImgSettings = function(lazyItem) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[6462:7048]", functionData => eval(functionData))}

                        var _loadAnimation = function(anim) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[7110:8298]", functionData => eval(functionData))};
                        ...
                        var _loadBgImage = function(lazyItem) {
                            if (lazyItem.hasAttribute(LAZY_IMAGE_ATTRIBUTE_NAME)) { // older method, set inline style
                                ...
                                if (source) {
                                    ...
                                    function imageLoadHandler() {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[8818:9261]", functionData => eval(functionData))}
                        ...
                        var _loadImage = function(lazyItem) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[9829:10756]", functionData => eval(functionData))}

                        var _loadVideo = function(lazyItem) {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[10818:12072]", functionData => eval(functionData))};
                        ...
                        /* Public Methods */
                        lazyContent.check = function() {lacuna_lazy_load("lacuna_cache/exported_gtvokv.js[14560:14633]", functionData => eval(functionData))};
                    })();
                }

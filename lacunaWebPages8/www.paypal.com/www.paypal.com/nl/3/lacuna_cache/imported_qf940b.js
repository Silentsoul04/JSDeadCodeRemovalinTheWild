/*@ 2019 PayPal (v1.3.26) */ ! function() {
  ...
  String.prototype.trim || (String.prototype.trim = null), Array.prototype.indexOf || (Array.prototype.indexOf = null), Array.prototype.forEach || (Array.prototype.forEach = null), window.document.querySelectorAll || (document.querySelectorAll = null);
  var u = {},
    f = {},
    i = -1;
  ...
  }, u.publishSync = null, u.subscribe = function(t, e) {
    if ("function" != typeof e) return !1;
    f.hasOwnProperty(t) || (f[t] = {});
    var n = "uid_" + String(++i);
    return f[t][n] = e, n
  }, u.subscribeOnce = null, u.clearAllSubscriptions = null, u.clearSubscriptions = null, u.unsubscribe = null;
  var C = {
    click: {
  ...
  function _t() {
    K() && W(I.URL_PPOBJ + "/pa/mi/miconfig.js", null)
  }
  ...
  function zt(e, t) {
    J("scroll", window, Kt), Ht = [], Vt = D({}, Jt), Yt = t && t.Analytics ? t.Analytics.prototype : null, "object" === d(e) && Object.keys(e).forEach(null);
    var n = l();
  ...
  $t.Analytics = function(t) {
    ...
    _recordEvent: null,
    _createBeacon: null,
    _generateBeaconUrl: null,
    _generateLogBeaconUrl: null,
    getTimeNow: ft,
    _getGmtOffset: null,
    ...
    _getLastFormFocusedValue: null,
    _getLastInputFocusedValue: null,
    ...
    recordImpression: function(o, t) {
      ...
      }(), "mo" !== $t.settings && (c[s.plugins] = S()), o.data.view ? a._recordEvent(c, o) : (P && (o.data.view = o.data.view || {}, o.data.view._t11s = P.now()), wt(null))
    },
    recordClick: null,
    recordFormAbandonment: null,
    trackFormFocus: null,
    ...
    recordAjaxStartTime: null,
    logActivity: null,
    logPerf: null,
    recordAjaxPerformanceData: null,
    recordError: null,
    recordScroll: null,
    record: null
    ...
    removeCookie: h,
    wrapSelectors: G
  }, $t.logPerformance = null, $t.logActivity = null, $t.Analytics.prototype.resetScroll = null, $t.setup = function(t) {
    ! function e() {
      "3p" !== $t.settings && _t()
  ...
  }, $t.setup3p = null, $t.setupMobile = null, $t.reSetup = null, $t.setup.init = function(t) {
    t = Y(t || {}, {
      trackImpression: !0,
      trackPPClicks: !0,
      trackPPExitClicks: !0,
    ...
    return "object" === d(r.customClicks) && l.trackClicks({
      ...
      request: f
    }), r.trackScroll && zt(r.scroll, $t), M(document.body, "click", null), $t.instance = l
  };
  ...
  $t.resumeCPLTracking = null, $t.beaconTrackingData = {}, $t.addCPLData = null, $t.setCPLData = null, $t.startCPLTracking = null, $t.endCPLTracking = null, $t.resourceCPL = null;
  var ae = !($t.autoCPLTracking = null);
  ...
  ! function we(t) {
    ...
    t.setState = null, t.listen = null, t.transitionTo = null, t.pushState = null, t.go = null, M(window, "hashchange", ce), u.subscribe(I.E.BEACON, null)
  }();
  var se = !1;
  $t.startClientErrorTracking = function(a) {
    if (a = a || {}, !se) {
      ...
      var c, s = a.maxErrors || 5,
        u = 0,
        o = window.onerror;
      M(window, "unhandledrejection", null), M(window, "error", null), window.onerror = null
    }

    
  }, $t.logJSError = null, PAYPAL.trackJSError = null, u.subscribe(I.E.INIT, function() {
    ! function t() {

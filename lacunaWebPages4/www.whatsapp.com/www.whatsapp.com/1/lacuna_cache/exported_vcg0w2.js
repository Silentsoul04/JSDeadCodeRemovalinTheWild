        ...
        require("TimeSlice").guard((function() {___jdce_logger("lacuna_cache/exported_vcg0w2.js", 37, 9816);
            bigPipe.onPageletArrive({
                resource_map: {
                    FEt5G: {
                        type: "js",
                        src: "https://static.whatsapp.net/rsrc.php/v3/yL/r/rsk-4_J6Np9.js?_nc_x=Ij3Wp8lg5Kz"
                    },
                    "3ChAt": {
                        type: "js",
                        src: "https://static.whatsapp.net/rsrc.php/v3/yB/r/LT-1HjtH4sU.js?_nc_x=Ij3Wp8lg5Kz"
                    },
                    NwL3C: {
                        type: "js",
                        src: "https://static.whatsapp.net/rsrc.php/v3/yN/r/k87fq4HF9ML.js?_nc_x=Ij3Wp8lg5Kz"
                    }
                },
                gkxData: {
                    "1148668": {
                        result: false,
                        hash: "AT4yNkdcdBDhFQyN"
                    }
                },
                allResources: ["w0wbZ", "7Og4B", "+eNMI", "LSWUO", "hcWQ1", "SAUyn", "50B9A", "TMKon", "prOs4", "iiRTm", "Qx/wH", "SbYVn", "FEt5G", "iA96j", "3ChAt", "NwL3C"],
                displayResources: ["w0wbZ", "LSWUO", "50B9A", "TMKon", "prOs4"],
                onafterload: ["CavalryLogger.getInstance(\"6746135357502255335-0\").collectBrowserTiming(window)", "window.CavalryLogger&&CavalryLogger.getInstance().setTimeStamp(\"t_paint\");", "if (window.ExitTime){CavalryLogger.getInstance(\"6746135357502255335-0\").setValue(\"t_exit\", window.ExitTime);};"],
                id: "last_response",
                phase: 1,
                jsmods: {
                    require: [
                        ...
                        ["NavigationMetrics", "setPage", [],
                            [{
                                page: "WAXWhatsAppRootController",
                                page_type: "normal",
                                page_uri: "https://www.whatsapp.com/",
                                serverLID: "6746135357502255335-0"
                            }]
                        ],
                        ["Chromedome", "start", [],
                            [
                        ...
                        ["HighContrastMode", "init", [],
                            [{
                                isHCM: false,
                                spacerImage: "https://static.whatsapp.net/rsrc.php/v3/y4/r/-PAXP-deijE.gif"
                            }]
                        ],
                        ["ClickRefLogger"],
                    ...
                    define: [
                        ...
                        ["cr:844180", ["TimeSpentImmediateActiveSecondsLoggerBlue"], {
                            __rc: ["TimeSpentImmediateActiveSecondsLoggerBlue", "Aa3O24fCqad5QsnY5m2z0N3PJRehtFgV7AT-LSw5cQ2NQavZrNcBseWa8UICydfcLN63OMMg-4t8eIps8hdrt5g"]
                        }, -1],
                        ...
                        ["TrackingConfig", [], {
                            domain: "https://pixel.whatsapp.com"
                        }, 325],

...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        (function() {
            ...
            if (hasPromise()) {
                define('idcta/es6-promise', function() {lacuna_lazy_load("lacuna_cache/exported_jt32bs.js[1330:1392]", functionData => eval(functionData))});
            ...
            define('idcta/config', ['idcta-v2/config'], function(data) {lacuna_lazy_load("lacuna_cache/exported_jt32bs.js[2641:2685]", functionData => eval(functionData))});
            define('idcta/translations', ['idcta-v2/translations'], function(data) {lacuna_lazy_load("lacuna_cache/exported_jt32bs.js[2771:2815]", functionData => eval(functionData))});
        })();

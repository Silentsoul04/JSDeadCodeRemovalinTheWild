            ...
            var AdSlot4 = function() {
                ...
                return function() {
                    ...
                    function A(o) {
                        "art, oak" !== o && "art,oak" !== o || (o = "art"), B.cmd.push(function() {
                            B.events.subscribe({
                                name: "AdDefined",
                                scope: "all",
                                callback: function(n) {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[1112:2694]", functionData => eval(functionData))}
                            })
                        })
                    }
                    return B.loadScripts = function(n) {
                        ...
                        x || (!("1" === z("nyt-gdpr") || (i = document.referrer || "", (t = /([a-zA-Z0-9_\-.]+)(@|%40)([a-zA-Z0-9_\-.]+).([a-zA-Z]{2,5})/).test(i) || t.test(window.location.href)) || "s" === z("nyt-purr").substring(1, 2)) && (!r || window.advBidxc && window.advBidxc.isLoaded || (d = g, a = "8CU2553YN", window.innerWidth < 740 && (a = "8CULO58R6"), b("https://contextual.media.net/bidexchange.js?cid=".concat(a, "&dn=").concat("www.nytimes.com", "&https=1"), function() {
                        ...
                        }, function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[4129:4518]", functionData => eval(functionData))}), window.advBidxc = window.advBidxc || {}, window.advBidxc.renderAd = function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[4600:4602]", functionData => eval(functionData))}, window.advBidxc.startTime = (new Date).getTime(), window.advBidxc.customerId = {
                            mediaNetCID: a
                            ...
                            o[t] || (o[t] = {
                                ...
                                fetchBids: function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[5320:5409]", functionData => eval(functionData))},
                                setDisplayBids: function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[5470:5472]", functionData => eval(functionData))},
                                targetingKeys: function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[5532:5613]", functionData => eval(functionData))},
                                _Q: []
                            })
                        }("apstag", window), b("//c.amazon-adsystem.com/aax2/apstag.js", function() {
                            window.apstag || console.warn("A9 not loading properly")
                        }, function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[5910:6297]", functionData => eval(functionData))}), window.apstag.init({
                            pubID: "3030",
                            adServer: "googletag",
                            params: {
                                si_section: o
                            }
                        }), A(e))), l && b("https://nytimes.com/ads/google/adsbygoogle.js", function() {}, function() {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[6647:7037]", functionData => eval(functionData))}), x = !0)
                    }, window.AdSlot4 = B
                }()
            }();
            AdSlot4.loadScripts({
            ...
            (function() {
                var _f = function(e) {
                    ...
                    function n(e) {
                        ...
                        return u ? (r = e, d = (n = u) && n.emailSubscriptions, (a = n && n.bundleSubscriptions) && r && (r.sub = "reg", d && d.length && (r.em = d.toString().toLowerCase()), n.wat && (r.wat = n.wat.toLowerCase()), a && a.length && a[0].bundle && (i = a[0], r.sub = i.bundle.toLowerCase(), i.source && (r.subsrc = i.source.toLowerCase()), i.promotion && (r.subprm = i.promotion), i.in_grace && (r.grace = i.in_grace.toString()))), e = r) : e.sub = "anon", o() ? (e.prop = "mnyt", e.plat = "mweb", e.ver = "mvi") : (e.prop = "nyt", e.plat = "web", e.ver = "vi"), "/es/" === window.location.pathname.substring(0, 4) && (e.prop = "esnyt", e.edn = "es", o() && (e.prop = "mesnyt")), "hp" === e.typ && (document.referrer && (e.topref = document.referrer), t && (e.refresh = "manual")), e.abra_dfp = (p = document.documentElement.getAttribute("data-nyt-ab")) ? p.split(" ").reduce(function(e, t) {lacuna_lazy_load("lacuna_cache/exported_o1m0bh.js[9095:9384]", functionData => eval(functionData))}, []) : "", e.page_view_id = window.NYTD.PageViewId && window.NYTD.PageViewId.current, e
                    }
                    var r = e || {},
                        i = r.adTargeting || {},

...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        if (window.csa) {
            ...
            function m(n) {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[2203:2255]", functionData => eval(functionData))}
            ...
            function D() {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[2999:3041]", functionData => eval(functionData))}
        ...
        csa.plugin(function(a) {
            ...
            function s() {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[5716:5799]", functionData => eval(functionData))}
        ...
        csa.plugin(function(t) {
            ...
            function k(c) {
                ...
                }, this.setEntity = function(n) {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[8029:8094]", functionData => eval(functionData))}
            }
            t.on("$pageTransition", function() {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[8156:8194]", functionData => eval(functionData))}), t.register("Events", {
        ...
        csa.plugin(function(o) {
            ...
            function S() {
                p.forEach(function(t) {
                    ...
                    v.forEach(function(e) {
                        ...
                        }, function(e, t, n) {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[10281:10710]", functionData => eval(functionData))}].some(function(e) {
                            try {
                                return e(t, n, r)
                            } catch (e) {}
                        })
            ...
            }), o.on("$afterPageTransition", function() {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[11554:11591]", functionData => eval(functionData))})
        });
        csa.plugin(function(n) {
            ...
            i && i[1] && (t = "https://" + i[1] + "/ping"), n("Transport")("register", {
                ...
                preflight: function() {lacuna_lazy_load("lacuna_cache/exported_c3h9w5.js[12258:12359]", functionData => eval(functionData))},
                accepts: function() {
                    return 1
                }
            })

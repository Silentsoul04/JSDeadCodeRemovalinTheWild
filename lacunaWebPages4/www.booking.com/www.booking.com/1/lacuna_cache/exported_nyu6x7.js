        ...
        return response.text();
                    ...
                    (function() {
                        ...
                        if (typeof window.CustomEvent !== 'function') {
                            ...
                            var CustomEvent = function(event, params) {lacuna_lazy_load("lacuna_cache/exported_nyu6x7.js[648:1819]", functionData => eval(functionData))};
                        ...
                        if (!Element.prototype.closest) {
                            Element.prototype.closest = function(s) {lacuna_lazy_load("lacuna_cache/exported_nyu6x7.js[2534:3001]", functionData => eval(functionData))};
                        }
                    }());
                    (function() {
                        ...
                        function showChildrenAges() {lacuna_lazy_load("lacuna_cache/exported_nyu6x7.js[3648:3810]", functionData => eval(functionData))}

                        function hideChildrenAges() {lacuna_lazy_load("lacuna_cache/exported_nyu6x7.js[3864:4024]", functionData => eval(functionData))}

                        function onGroupChildenChange(e) {lacuna_lazy_load("lacuna_cache/exported_nyu6x7.js[4083:5409]", functionData => eval(functionData))}
                        if (groupChildren) {

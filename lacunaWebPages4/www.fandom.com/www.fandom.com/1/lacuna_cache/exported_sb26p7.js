...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        location.search.replace(/InstantGlobals\.(\w+)=(\d)/g, function(a, b, c) {lacuna_lazy_load("lacuna_cache/exported_sb26p7.js[3729:3785]", functionData => eval(functionData))});
        location.search.replace(/InstantGlobals\.(\w+)=\[(.*?)]/g, function(a, b, c) {lacuna_lazy_load("lacuna_cache/exported_sb26p7.js[3873:3936]", functionData => eval(functionData))});

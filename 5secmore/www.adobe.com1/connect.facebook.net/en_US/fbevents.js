                    ...
                    d = function() {
                        ...
                        i(d, [{
                            ...
                            value: function(a, b) {
                                ...
                                if (typeof b !== "string" || !z(b)) throw new Error('Invalid Argument: "' + b + '" is not a valid opt-in feature');
                                z(b) && (this.optIns.optIn(a, b, d), q([b].concat(k(x[b] || [])), function(a) {
                                    y[a] && q(y[a], function(a) {
                            ...
                            value: function(a, b, c, d, e) {
                                ...
                                if (!Object.prototype.hasOwnProperty.call(this.pixelsByID, a)) {
                                    ...
                                    e == null ? v(f) : u(new Error(f.type + " " + f.pixelID));
                                    return this
                                }
                            ...
                            value: function(a) {
                                ...
                                (!this.fbq.pendingConfigs || t(this.fbq.pendingConfigs, function(b) {
                                    return b === a
                                }) === !1) && A(a, this.VERSION, this.RELEASE_SEGMENT != null ? this.RELEASE_SEGMENT : "stable")
                            }
                        }, {
                            key: "configLoaded",
                            value: function(a) {
                ...
                (function() {
                    ...
                    c = function c() {
                        ...
                        this.sendGET = function(b, c, d) {
                            ...
                            if (g.length < 2048) {
                                ...
                                if (d != null) {
                                    ...
                                    h.onerror = function() {
                                        a.setShouldProxy(!0), i || f.sendGET(b, c, d)
                                    }
                                }
                                h.src = g;
                                return !0
                        ...
                        this.sendPOST = function(a, c, d) {
                            ...
                            if (e) {
                                a.append("exp", e.code);
                                if (e.isInExperimentGroup) return f._sendXHRPost(a, c, d)
                            }
                        ...
                        this._sendXHRPost = function(b, c, d) {
                            ...
                            var e = new XMLHttpRequest(),
                                g = function() {
                                    if (d != null) {
                                        var e = a.getShouldProxy();
                                        a.setShouldProxy(!0);
                                        e || f.sendPOST(b, c, d)
                                    }
                                };
                            if ("withCredentials" in e) e.withCredentials = !0, e.open("POST", c, !1), e.onreadystatechange = function() {
                                if (e.readyState !== i.DONE) return;
                                e.status !== 200 && g()
                            };
                        ...
                        this._sendFormPOST = function(c, i, j) {
                            ...
                            if (j != null) {
                                var p = a.getShouldProxy();
                                o.onerror = function() {
                                    a.setShouldProxy(!0), p || f.sendPOST(c, i, j)
                                }
                            }
                            h.body != null && h.body.appendChild(m);
                            return !0
                        ...
                        this.sendBeacon = function(b, c, d) {
                            b.append("rqm", "SB");
                            if (g.navigator && g.navigator.sendBeacon) {
                                var h = g.navigator.sendBeacon(e(c, d), b.toFormData());
                                if (d != null && !h) {
                                    h = a.getShouldProxy();
                                    a.setShouldProxy(!0);
                                    h || f.sendBeacon(b, c, d)
                                }
                                return !0
                            }
                            return !1
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(g, h, i, l) {
                ...
                (function() {
                    ...
                    m = y.execEnd;
                    var E = y.fired,
                        F = y.getCustomParameters,
                        aa = y.iwlBootstrap,
                        ba = y.piiInvalidated,
                        ca = y.setIWLExtractors,
                        da = n.logError,
                        G = n.logUserError,
                        H = r.global,
                        I = -1,
                    ...
                    function U(c) {
                        ...
                        switch (c) {
                            ...
                            case "firstPartyCookies":
                                ...
                                if (typeof p === "string") R.callMethod([r, p, "FirstPartyCookies"]);
                            ...
                            case "mobileBridge":
                                var x = f[0],
                                    y = f[1];
                                if (typeof x !== "string") throw new Error("Invalid pixelID supplied to set call.");
                                if (typeof y !== "string") throw new Error("Invalid appID supplied to set call.");
                            ...
                            default:
                                ...
                                if (typeof E !== "string") throw new Error("The metadata value must be a string.");
                                if (typeof F !== "string") throw new Error("Invalid pixelID supplied to set call.");
                                ga(c, E, F);
                                break
                        }
                    }
                    ...
                    function V(a, b, c) {
                        ...
                        if (a == null) return;
                        if (J.call(O, a)) {
                            b && B(O[a].userData) ? (O[a].userData = b, S.loadPlugin("identity")) : G({
                                pixelID: a,
                    ...
                    function ha(a, b, c) {
                        b = b || {}, o.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), X.call(this, a, b, c)
                    }

                    function X(a, b, c) {
                        for (var d = 0, e = N.length; d < e; d++) {
                            var f = N[d];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(Q, a) && Q[a].has(f.id)) continue;
                            $({
                                customData: b,
                                eventData: c,
                                eventName: a,
                    ...
                    E.listenOnce(function() {
                        ka()
                    });

                    function la(b) {
                        a._initHandlers.push(b), W()
                    }
                    ...
                    function na(a) {
                        a.instance = R, a.callMethod = T, a._initHandlers = [], a._initsDone = {}, a.send = Y, a.getEventCustomParameters = Z, a.addInitHandler = la, a.getState = ma, a.init = V, a.set = U, a.loadPlugin = function(a) {

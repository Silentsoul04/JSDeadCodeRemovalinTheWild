...
Array.prototype.every || (Array.prototype.every = function(e, t) {
    ...
    function(w) {
        w.adobeid = function(e) {
            ...
            var I = "adobeid_ims_access_token",
                b = "/",
                T = "from_ims",
                S = T + "=true",
                E = "rctx",
                ...
                var i = this,
                    e = function() {
                        var t = k.cloneObject(i._accessTokensInfos || {}),
                            n = function() {
                                if (i.isMandatorySignIn() && !i.isSignedInUser() && i.signIn(), i._callCallbacksToUpdateUI(), y() && !i.isSignedInUser())
                        ...
                        if (i.isSingleLogOutEnabled() || !i.isSignedInUser()) i.signInBasedOnSingleSignOnSSO(function(e) {
                            ...
                            delete t[i.getKeyForAccessToken(e)], i.testAccessTokenIsStillValid(e, function() {
                                i.getAccessToken() && !i.getUserProfile() ? j(i, n) : k.callIfFunction(n, i)
                            })
                        }
                    };
                y() && (this.loadFromStorage(), k.isEmptyObject(this._profile) || this._callCallbacksToUpdateUI()), this._signInWhenRedirectedBackFromIMS(function() {
            ...
            return D = k.merge({
                    ...
                    reAuthenticate: function(e, t) {
                        var n = k.merge({
                            reauth: "check",
                            idp_flow: this._profile && "type2" === this._profile.account_type ? "login_t2" : void 0,
                    ...
                    getAccessTokenSessionStorageKey: function(e, t, n) {
                        return [I, t || this.getClientID(), !!e, n || this.getScope()].join(b)
                    },
                    ...
                    testAccessTokenIsStillValid: function(t, n) {
                        ...
                        o && this.isKnownClientID(o.client_id) ? a.validateToken(o, function(e) {
                            e.token && i.shouldAcceptTheToken(t, e.token.client_id, e.token.scope, e.token.user_id, e.valid, o.isReAuthentication) ? n() : r(e)
                        }, r) : r()
                    },
                    ...
                    _clearCredentials: function(e) {
                        ...
                        if (e && e.access_token) t = this.getKeyForAccessToken(e.access_token), v.remove(t, !1), v.remove(t, !0), delete this._accessTokensInfos[t];
                            ...
                            for (t in this._accessTokensInfos) t.startsWith(I) && v.remove(t, this._accessTokensInfos[t].isReAuthentication);
                ...
                cors: function(e) {
                    switch ((e = u.merge({
                        ...
                        case f.GET:
                            ...
                            break;
                        case f.POST:
                            t = e.url, n = e.headers, o = e.onLoad, r = e.onError, (i = e.data).client_id && (t += d.buildQueryString({
                                client_id: i.client_id
                            }, t), delete i.client_id), n = n || {}, i && (i = d.uriEncodeData(i), n["Content-Type"] = "application/x-www-form-urlencoded"), h(f.POST, t, i, n, o, r);
                            break;
                        default:
            ...
            function f(e, t, n) {
                ...
                n = n || _, p.corsSupported ? (l = t, d = n, u = {}, (f = h.cloneObject((c = e).params) || {}).client_id || (f.client_id = v(c.api)), c.bearerToken && (u[g.AUTHORIZATION] = "Bearer " + c.bearerToken), p.cors({
                    data: f,
                    headers: u,
                    method: c.method,
        ...
        }, w.tokenStorage = function(t, n) {
            "use strict";

            function i(e) {
                return e || "local" === n ? t.local : t.session
            }
            return {
                get: function(e, t) {
            ...
            var e = w.build,
                ...
                v = w.profileStorage(u, c.preferred_storage),
                k = w.tokenStorage(u, c.preferred_storage),
                y = w.eventDispatcher(c, t, l, i, r, f),
                I = w.http(i, m, f),
                b = w.imsApis(c, _, g, y, I, i, m, f),
                T = w.client(g, b, i, f),
                S = w.tokenManagement(T, g, i);
            window.adobeIMS = w.adobeIMS(c, h, p, T, g, t, l, y, I, b, n, i, v, r, u, s, S, k, f, a), window.adobeIMS.version = e.version;

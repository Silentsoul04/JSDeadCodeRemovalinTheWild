(function() {
    var ccJs = function(options) {
        ...
        client = bcpClient = 10816;
        var firstPartyHost = "cc.bbc.com";
        var actualClient = {
            id: 10816,
            useFirstPartyDomain: "never",
            domainPrefix: "cc",
            cookieDomain: "bbc.com",
            cookieDomainIDN: "bbc.com"
        };
        ...
        function executeOptimus() {
            ...
            addTrigger({
                ...
                location: "\\://([^/]*)/([a-zA-Z0-9_-]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)",
                element: "{{html}}",
                event: "",
                opr: 77496
            });
            addTrigger({
                ...
                location: "\\://([^/]*)/([a-zA-Z0-9_-]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)/([a-zA-Z_-]+)",
                element: "{{html}}",
                event: "",
                opr: 77497
            });
            addTrigger({
                "med": ['$1 : Article Section : {{meta[property*\x3d"article:section"]}}.content'],
                location: "\\://([^/]*)",
                element: '{{meta[property*\x3d"article:section"]}}',
                event: "",
                opr: 80847
            });
            addTrigger({
                "med": ['$1 : Title: {{meta[property*\x3d"og:title"]}}.content'],
                location: "\\://([^/]*)",
                element: '{{meta[property*\x3d"og:title"]}}',
                event: "",
                opr: 80848
            });
            addTrigger({
                "med": ['$1 : META Section : {{meta[name*\x3d"Section"]}}.content'],
                location: "\\://([^/]*)",
                element: '{{meta[name*\x3d"Section"]}}',
                event: "",
                opr: 80852
            });
            addTrigger({
            ...
            if (namespace.dropSyncPixels)
                if (useFPC) {
                    ...
                    try {
                        ...
                        tempIFrame.setAttribute("id",
                            "LOTCCFrame_" + (new Date).getTime());

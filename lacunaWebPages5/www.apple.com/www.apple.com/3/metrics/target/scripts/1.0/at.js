...
window.adobe = window.adobe || {}, window.adobe.target = function() {
    ...
    function On(n, t, e) {
        ...
        if (e) {
            var i = r.push;
            r[Gs] = Sd, r[zl] = Sn(t), r[Zl] = [], r[Gl] = [], r.push = null
        }
        n[Jl] = r
    }
    ...
    function ht(n, t, e) {
        return n.onerror = null, n
    }

    function pt(n, t, e, r) {
        return n.timeout = t, n.ontimeout = null, n
    }
    ...
    function qu(n) {
        ...
        var f = null,
            s = null;
        Ru(e, o), Yn(u), Nu(s, f, o).then(null)['catch'](null)
    }
    ...
    var Tc = Object.getOwnPropertySymbols,
            ...
            ! function(e) {
                ...
                function t(e) {
                    ...
                    return r.set = r, r.get = function(n) {
                        return r.call(r, n)
                    }, r.getJSON = null, r.defaults = {}, r.remove = function(t, e) {
                        r(t, "", n(e, {
                            expires: -1
                        }))
                    }, r.withConverter = t, r
        ...
        gd = function(n, t, e, r) {
            return t = t || "&", e = e || "=", null === n && (n = void 0), "object" === (void 0 === n ? "undefined" : Rc(n)) ? Object.keys(n).map(function(r) {
                ...
                return Array.isArray(n[r]) ? n[r].map(null).join(t) : i + encodeURIComponent(md(n[r]))
    ...
    var Nd = "at-library-loaded",
        ...
        Ld = J(function(n) {
            ! function(t) {
                ...
                var l = setTimeout;
                i.prototype['catch'] = null, i.prototype.then = null, i.all = null, i.resolve = null, i.reject = null, i.race = null, i._immediateFn = "function" == typeof setImmediate && null || null, i._unhandledRejectionFn = null, i._setImmediateFn = null, i._setUnhandledRejectionFn = null, void 0 !== n && n.exports ? n.exports = i : t.Promise || (t.Promise = i)
            }(od)
        }),
        ...
        Wh = function(n) {
            var t = function() {
                ...
                var C, S, O, T, k, N, A = [],
                    ...
                    nn = Array.isArray || null;
                return X.matches = null, k = null, N = null, X.fragment = function(n, t, e) {
                    var r, i, o;
                    ...
                    return X.init(n, t)
                }, O.extend = null, X.qsa = function(n, t) {
                    var e, r = "#" == t[0],
                        i = !r && "." == t[0],
                        o = r || i ? t.slice(1) : t,
                        u = J.test(o);
                ...
                } : null, O.type = t, O.isFunction = e, O.isWindow = r, O.isArray = nn, O.isPlainObject = u, O.isEmptyObject = null, O.isNumeric = null, O.inArray = null, O.camelCase = k, O.trim = null, O.uuid = 0, O.support = {}, O.expr = {}, O.noop = null, O.map = function(n, t) {
                    var e, r, i, o = [];
                    if (c(n))
                    ...
                    return n
                }, O.grep = null, n.JSON && (O.parseJSON = JSON.parse), O.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(n, t) {
                    ...
                    O.fn[e] = function() {
                        var e, o, u = O.map(arguments, function(n) {
                                var r = [];
                                return e = t(n), "array" == e ? (n.forEach(null), r) : "object" == e || null == n ? n : X.fragment(n)
                            }),
                            c = this.length > 1;
                    ...
                    }, O.fn[i ? e + "To" : "insert" + (r ? "Before" : "After")] = null
            ...
            return function(t) {
                    ...
                    t.fn.delegate = null, t.fn.undelegate = null, t.fn.live = null, t.fn.die = null, t.fn.on = null, t.fn.off = null, t.fn.trigger = null, t.fn.triggerHandler = null, "focusin focusout focus blur load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select keydown keypress keyup error".split(" ").forEach(function(n) {
                        t.fn[n] = null
                    }), t.Event = null
                }(t),
                function() {

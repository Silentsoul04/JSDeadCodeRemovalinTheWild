...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_ignoreCase": true,
                "vtp_map": ["list", ["map", "key", "marketingplatform\\.google\\.com\\\/about\\\/partner.*", "value", "gmp partners"],
                    ["map", "key", "marketingplatform\\.google\\.com\\\/about.*", "value", "gmp"],
                    ["map", "key", "admanager\\.google\\.com.*", "value", "gam"],
                    ["map", "key", "measurementpartners\\.google\\.com.*", "value", "mm partners"]
                ]
            }, {
                "function": "__v",
                ...
                "vtp_input": ["macro", 14],
                "vtp_defaultValue": ["macro", 16],
                "vtp_map": ["list", ["map", "key", "gam", "value", ["macro", 17]],
                    ["map", "key", "gmp partners", "value", ["macro", 18]],
                    ["map", "key", "gmp", "value", ["macro", 18]]
                ]
            }, {
                "function": "__u",
                "vtp_component": "QUERY",
                ...
                "vtp_replaceAfterMatch": true,
                "vtp_ignoreCase": true,
                "vtp_map": ["list", ["map", "key", ".+utm\\_source.+", "value", "utms"],
                    ["map", "key", ".+utm\\_medium.+", "value", "utms"],
                    ["map", "key", ".+gclid\\=.+", "value", "autotag"],
                    ["map", "key", ".+dclid\\=.+", "value", "autotag"]
                ]
            }, {
                "function": "__u",
                "convert_case_to": 1,
                ...
                "vtp_ignoreCase": true,
                "vtp_map": ["list", ["map", "key", "gmp(.partners)?", "value", "UA-38676921-23"],
                    ["map", "key", "gam", "value", "UA-118666886-2"],
                    ["map", "key", "mm partners", "value", "UA-118666886-5"]
                ]
            }, {
                "function": "__gas",
                ...
                "vtp_fieldsToSet": ["list", ["map", "fieldName", "allowLinker", "value", "true"],
                    ...
                    ["map", "fieldName", "location", "value", ["macro", 13]],
                    ["map", "fieldName", "referrer", "value", ["macro", 19]],
                    ["map", "fieldName", "campaignSource", "value", ["macro", 20]],
                    ["map", "fieldName", "campaignMedium", "value", ["macro", 21]],
                    ["map", "fieldName", "campaignContent", "value", ["macro", 22]],
                    ["map", "fieldName", "campaignName", "value", ["macro", 23]],
                    ["map", "fieldName", "campaignKeyword", "value", ["macro", 24]],
                    ["map", "fieldName", "alwaysSendReferrer", "value", "true"],
                ...
                "vtp_dimension": ["list", ["map", "index", "1", "dimension", ["macro", 25]],
                    ["map", "index", "2", "dimension", ["macro", 26]],
                    ["map", "index", "3", "dimension", ["macro", 27]],
                    ["map", "index", "6", "dimension", ["macro", 19]],
                    ["map", "index", "8", "dimension", ["macro", 29]],
                    ["map", "index", "29", "dimension", ["macro", 30]],
                    ["map", "index", "30", "dimension", ["macro", 31]],
                    ["map", "index", "4", "dimension", ["macro", 3]],
                    ["map", "index", "5", "dimension", ["macro", 32]],
                    ["map", "index", "34", "dimension", ["macro", 33]]
                ],
    ...
    var sc = rc,
        ...
        uc = null,
        vc = null,
        wc = "//www.googletagmanager.com/a?id=" + nc.m + "&cv=9",
        xc = {},
        yc = {},
        zc = function() {
            var a = oc.sequence || 0;
    ...
    var Bd = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        Cd = {
            cl: ["ecl"],
    ...
    function Od() {
        if (!Kd && 140 > Ld) {
            Ld++;
            try {
                D.documentElement.doScroll("left"), Nd()
            } catch (a) {
                C.setTimeout(Od, 50)
            }
        }
    ...
    var ke = /:[0-9]+$/,
        ...
        oe = function(a, b, c, d, e) {
            ...
            "port" === b ? a.port = String(Number(a.hostname ? a.port : C.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === b &&
                (a.hostname = (a.hostname || C.location.hostname).replace(ke, "").toLowerCase());
            var g = b,
                h, k = me(a.protocol);
    ...
    Ne.prototype.push = function(a, b, c, d) {
        ...
        if (c) {
            ...
            if (h && (Ue(this, c).status = 2, this.push("require", [], g.containerId), Re[g.containerId] = wa(), !ld())) {
                ...
                Kb(("http:" != C.location.protocol ? "https:" :
    ...
    Ne.prototype.flush = function(a) {
        for (var b = this; this.Ya.length;) {
            var c = this.Ya[0];
            if (c.defer) c.defer = !1, this.Ya.push(c);
            else switch (c.type) {
                case "require":
                    if (3 !== Ue(this, c.O).status && !a) return;
                    break;
                case "set":
                    ra(c.Db[0], function(l, m) {
                        b.Qd[l] = m
                    });
                    break;
                case "config":
    ...
    var sf = {
            ...
            set: function(a) {
                var b;
                2 == a.length && Ha(a[1]) ? b = v(a[1]) : 3 == a.length && ja(a[1]) && (b = {}, Ha(a[2]) || la(a[2]) ? b[a[1]] = v(a[2]) : b[a[1]] = a[2]);
                if (b) {
                    b._clear = !0;
                    return b
                }
    ...
    pg.prototype.valueOf = pg.prototype.toString;
    og.$e = pg;
    og.kc = {};
    og.Kf = function(a) {
        return new pg(a)
    ...
    function Ig() {
        for (var a = Jg, b = {}, c = 0; c < a.length; ++c) b[a[c]] = c;
        return b
    }
    ...
    var Ug = /(.*?)\*(.*?)\*(.*)/,
        ...
        Zg = function(a, b) {
            ...
            Og = d;
            for (var l = 4294967295, m = 0; m < c.length; m++) l = l >>> 8 ^ Og[(l ^ c.charCodeAt(m)) & 255];
            ...
            try {
                if (a) {
                    ...
                    if (h && "1" === h[1]) {
                        ...
                        if (l) {
                            for (var p = {}, t = k ? k.split("*") : [], q = 0; q < t.length; q += 2) p[t[q]] = Ng(t[q + 1]);
                            return p
                        }
                    }
                }
    ...
    function eh(a, b, c) {
        for (var d = {}, e = {}, g = Sg().decorators, h = 0; h < g.length; ++h) {
            var k = g[h];
            (!c || k.forms) && Pg(k.domains, b) && (k.fragment ? za(e, k.callback()) : za(d, k.callback()))
        }
        if (Ca(d)) {
            var l = $g(d);
            if (c) {
                ...
                if (void 0 !== nh[l]) {
                    ...
                    if (n) {
                        var p = Math.min(uh(n), wa()),
                            t;
                        b: {
                            for (var q = p, r = We(m, D.cookie), u = 0; u < r.length; ++u)
                                if (uh(r[u]) > q) {
                                    t = !0;
                                    break b
                                }
    ...
    var xh = function(a, b, c, d, e) {
        ...
        zh = function(a) {
            for (var b = ["aw", "dc"], c = oh(a && a.prefix), d = {}, e = 0; e < b.length; e++) nh[b[e]] && (d[b[e]] = nh[b[e]]);
            ra(d, function(g, h) {
    ...
    var Nh = ["input", "select", "textarea"],
        Ph = ["button", "hidden", "image", "reset", "submit"],
        Qh = function(a) {
            var b = a.tagName.toLowerCase();
            return !ma(Nh, function(c) {
                return c === b
            }) || "input" === b && ma(Ph, function(c) {
        ...
        Xh = function(a) {
            if (!Wh) {
                var b = function() {
                    var c = D.body;
                    if (c)
                        if (Vh)(new MutationObserver(function() {
    ...
    var oi = function() {
            ...
            if (D.compatMode && "BackCompat" !== D.compatMode) c = b ? b.clientHeight : 0, d = b ? b.clientWidth : 0;
                ...
                var e = function(g, h) {
                    return g && h ? Math.min(g, h) : Math.max(g, h)
                };
                Bc("GTM", 7);
        ...
        pi = function(a) {
            var b = oi(),
                ...
                g = e.bottom - e.top,
                h = e.right - e.left;
            return g && h ? (1 - Math.min((Math.max(0 - e.left,
                0) + Math.max(e.right - d, 0)) / h, 1)) * (1 - Math.min((Math.max(0 - e.top, 0) + Math.max(e.bottom - c, 0)) / g, 1)) : 0
        },
        qi = function(a) {
    ...
    var xi = function(a, b, c) {
        ...
        return {
            Jb: function(h, k, l) {
                var m = a(),
                    n = m.Jd,
                    p = void 0 !== l ? Math.round(l) : void 0 !== k ? Math.round(m.Jd * k) : Math.round(m.Lf),
                    t = void 0 !== k ? Math.round(100 * k) : 0 >= n ? 0 : Math.round(p / n * 100),
                    q = D.hidden ? !1 : .5 <= pi(c);
                d();
                var r = rg(c, "gtm.video", [b]);
                r["gtm.videoProvider"] = "youtube";
                r["gtm.videoStatus"] = h;
                r["gtm.videoUrl"] = m.url;
                r["gtm.videoTitle"] = m.title;
                r["gtm.videoDuration"] = Math.round(n);
                r["gtm.videoCurrentTime"] =
                    Math.round(p);
                r["gtm.videoElapsedTime"] = Math.round(g);
                r["gtm.videoPercent"] = t;
                r["gtm.videoVisible"] = q;
                Mf(r)
            },
            Lg: function() {
                e = wa()
    ...
    var vk = window,
        ...
        xk = function(a) {
            ...
            for (var d = We("AMP_TOKEN", wk.cookie, !0), e = 0; e < d.length; e++)
    ...
    Z.a.sdl = ["google"],
        function() {
            ...
            function b(x) {
                for (var z = [], A = x.split(","), B = 0; B < A.length; B++) {
                    var E = Number(A[B]);
                    if (isNaN(E)) return [];
                    n.test(A[B]) || z.push(E)
                }
            ...
            function c() {
                ...
                return function() {
                    var A = oi(),
                        B = A.height;
                    x = Math.max(u.scrollLeft + A.width, x);
                    z = Math.max(u.scrollTop + B, z);
                    return {
                        Nf: x,
                        Of: z
                    }
            ...
            function d() {
                q = W("self");
                r = q.document;
                u = r.scrollingElement || r.body && r.body.parentNode;
                y = c()
            }
            ...
            function g() {
                var x = y(),
                    z = x.Nf,
                    A = x.Of,
                    B = z / u.scrollWidth * 100,
                    E = A / u.scrollHeight * 100;
                e(z, "horiz.pix",
                    p.yb, t.yd);
                e(B, "horiz.pct", p.xb, t.yd);
                e(A, "vert.pix", p.yb, t.Dd);
                e(E, "vert.pct", p.xb, t.Dd);
                tg("sdl", "pending", !1)
            }
            ...
            function h() {
                var x = 250,
                    z = !1;
                r.scrollingElement && r.documentElement && q.addEventListener && (x = 50, z = !0);
                var A = 0,
                    B = !1,
                    E = function() {
                        B ? A = zi(E, x) : (A = 0, g(), Mi("sdl") && !a() && (Pb(q, "scroll", F), Pb(q, "resize", F), tg("sdl", "init", !1)));
                        B = !1
                    },
                    F = function() {
                        z && y();
                        A ? B = !0 : (A = zi(E, x), tg("sdl", "pending", !0))
                    };
                return F
            }
            ...
            function m(x) {
                G(x.vtp_gtmOnSuccess);
                var z = x.vtp_uniqueTriggerId,
                    A = x.vtp_horizontalThresholdsPixels,
                    B = x.vtp_horizontalThresholdsPercent,
                    E = x.vtp_verticalThresholdUnits,
                    F = x.vtp_verticalThresholdsPixels,
                    J = x.vtp_verticalThresholdsPercent;
                ...
                Mi("sdl") ? vg("sdl", "pending") || (w || (d(), w = !0), G(function() {
                    return g()
                })) : (d(), w = !0, u && (Ni("sdl"), tg("sdl", "pending", !0), G(function() {
                    g();
                    if (a()) {
                        var N = h();
                        Ob(q, "scroll", N);
            ...
            (function(x) {
                ...
                x.vtp_triggerStartOption ? m(x) : Jf(function() {
                    m(x)
                })
            })
        }();
        ...
        function() {
            (function(a) {
                ...
                M(c, function() {
                    ...
                    if (ia(e)) {
                        var g = {};
                        "DATA_LAYER" == a.vtp_customParamsFormat ? g = a.vtp_dataLayerVariable : "USER_SPECIFIED" == a.vtp_customParamsFormat && (g = cj(a.vtp_customParams, "key", "value"));
                        var h = {};
    ...
    Z.a.f = ["google"],
        function() {
            (function(a) {
                ...
                var b = Ei("gtm.referrer", 1) || D.referrer;
                return b ? a.vtp_component && "URL" != a.vtp_component ? oe(pe(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : Ci(String(b)) : String(b)
            })
        }();
    ...
    Z.a.u = ["google"],
        function() {
            ...
            (function(b) {
                ...
                var c;
                c = (c = b.vtp_customUrlSource ? b.vtp_customUrlSource : Ei("gtm.url", 1)) || Ai();
                var d = b[a("vtp_component")];
                if (!d || "URL" == d) return Ci(String(c));
                var e = pe(String(c)),
                    g;
                if ("QUERY" === d) a: {
                    var h = b[a("vtp_multiQueryKeys").toString()],
                        ...
                        m;m = h ? la(k) ? k : String(k).replace(/\s+/g,
                        "").split(",") : [String(k)];
                    for (var n = 0; n < m.length; n++) {
                        var p = oe(e, "QUERY", void 0, void 0, m[n]);
                        if (void 0 != p && (!l || "" !== p)) {
                            g = p;
                            break a
                        }
                ...
                else g = oe(e, d, "HOST" == d ? b[a("vtp_stripWww")] : void 0, "PATH" == d ? b[a("vtp_defaultPages")] : void 0, void 0);
                return g
            })
        }();
    Z.a.v = ["google"],
            ...
            var a, b = {},
                c = function(d) {
                    ...
                    if (d.vtp_gaSettings) {
                        ...
                        v(cj(n.vtp_fieldsToSet, "fieldName", "value"), g);
                        v(cj(n.vtp_contentGroup, "index", "group"), h);
                        v(cj(n.vtp_dimension, "index", "dimension"), k);
                        v(cj(n.vtp_metric, "index", "metric"), l);
                    ...
                    v(cj(d.vtp_fieldsToSet, "fieldName", "value"), g);
                    v(cj(d.vtp_contentGroup,
                        "index", "group"), h);
                    v(cj(d.vtp_dimension, "index", "dimension"), k);
                    v(cj(d.vtp_metric, "index", "metric"), l);
                    var t = ee(d.vtp_functionName);
                    if (ia(t)) {
                        var q = "",
                            r = "";
                        d.vtp_setTrackerName && "string" == typeof d.vtp_trackerName ? "" !== d.vtp_trackerName && (r = d.vtp_trackerName, q = r + ".") : (r = "gtm" + zc(), q = r + ".");
                        var u = {
                                name: !0,
                                clientId: !0,
                                sampleRate: !0,
                            ...
                            x = function(T, P) {
                                return void 0 === P ? P : T(P)
                            },
                            z = function(T, P) {
                                if (P)
                                    for (var pa in P) P.hasOwnProperty(pa) && y("set", T + pa, P[pa])
                            },
                            A = function() {},
                            B = function(T, P, pa) {
                                var Ta = 0;
                                if (T)
                                    for (var Aa in T)
                                        if (T.hasOwnProperty(Aa) && (pa && u[Aa] || !pa && void 0 === u[Aa])) {
                                            var Ua = w[Aa] ? ta(T[Aa]) : T[Aa];
                                            "anonymizeIp" != Aa || Ua || (Ua = void 0);
                                            P[Aa] = Ua;
                                            Ta++
                                        }
                                return Ta
                        ...
                        if ("TRACK_EVENT" == d.vtp_trackType) {
                            ...
                            var U = Ei("gtm.element", 1);
                            U && t(function() {
                                var T = ce(),
                                    P = T && T.getByName && T.getByName(r),
                                    pa = Yi(W("gaplugins").Linker, P);
                                U && U.href && (U.href = pa.decorate(U.href, d.vtp_useHashDecorateLink), G(d.vtp_gtmOnSuccess))
                            });
                        } else if ("DECORATE_FORM" == d.vtp_trackType) {} else if ("TRACK_DATA" == d.vtp_trackType) {} else {
                            d.vtp_enableEcommerce && (y("require", "ec", "ec.js"), A());
                            ...
                            J ? y("send", "pageview", J) : y("send", "pageview");
                        }
                        if (!a) {
                            ...
                            a = !0;
                            var Ba = L("https:", "http:", "//www.google-analytics.com/" + ea, g && g.forceSSL);
                            M(Ba, function() {
                                var T = ce();
                                T && T.loaded || d.vtp_gtmOnFailure();
                            }, d.vtp_gtmOnFailure)
                        }
    ...
    Z.a.ytl = ["google"],
        function() {
            function a() {
                var w = Math.round(1E9 * Math.random()) + "";
                return D.getElementById(w) ? a() : w
            }

            function b(w, y) {
                if (!w) return !1;
                for (var x = 0; x < t.length; x++)
                    if (0 <= w.indexOf("//" + t[x] + "/" + y)) return !0;
                return !1
            }

            function c(w) {
                var y = -1 !== w.indexOf("?") ? "&" : "?";
                if (-1 < w.indexOf("origin=")) return w + y + "enablejsapi=1";
                if (!r) {
                    var x = W("document");
                    r = x.location.protocol + "//" + x.location.hostname;
                    x.location.port && (r += ":" + x.location.port)
                }
                return w + y + "enablejsapi=1&origin=" + encodeURIComponent(r)
            }

            function d(w,
                y) {
                var x = w.getAttribute("src");
                if (b(x, "embed/")) {
                    if (0 < x.indexOf("enablejsapi=1")) return !0;
                    if (y) return w.setAttribute("src", c(x)), !0
                }
                return !1
            }

            function e(w, y) {
                if (!w.getAttribute("data-gtm-yt-inspected-" + y.Yc) && (w.setAttribute("data-gtm-yt-inspected-" + y.Yc, "true"), d(w, y.Nd))) {
                    w.id || (w.id = a());
                    var x = W("YT"),
                        z = x.get(w.id);
                    z || (z = new x.Player(w.id));
                    var A = h(z, y),
                        B = {},
                        E;
                    for (E in A) B.Ha = E, A.hasOwnProperty(B.Ha) && z.addEventListener(B.Ha, function(F) {
                        return function(J) {
                            return A[F.Ha](J.data)
                        }
                    }(B)), B = {
                        Ha: B.Ha
                    }
            ...
            function g(w) {
                G(function() {
                    function y() {
                        for (var z = x.getElementsByTagName("iframe"), A = z.length, B = 0; B < A; B++) e(z[B], w)
                    }
                    var x = W("document");
                    y();
                    Xh(y)
            ...
            function h(w, y) {
                ...
                function B(T) {
                    switch (T) {
                        case q.PLAYING:
                            I = Math.round(w.getDuration());
                            R = w.getVideoUrl();
                            if (w.getVideoData) {
                                var P = w.getVideoData();
                                U = P ? P.title : ""
                            }
                            Y = w.getPlaybackRate();
                            y.Ef ? O.Jb("start") : O.mc();
                            K = m(y.Ag, y.zg, w.getDuration());
                            return E(T);
                        default:
                            return B
                    }
                ...
                function F(T) {
                    ...
                    switch (T) {
                        ...
                        case q.PAUSED:
                            P = "pause";
                        case q.BUFFERING:
                            var pa = w.getCurrentTime() - da;
                            P = 1 < Math.abs(((new Date).getTime() - ea) / 1E3 * Y - pa) ? "seek" : P || "buffering";
                            w.getCurrentTime() && (y.Df ? O.Jb(P) : O.mc());
                            S();
                            return J;
                        case q.UNSTARTED:
                            return A(T);
                ...
                function N() {
                    ...
                    y.Cf && O.Jb("complete", 1);
                    return A(q.UNSTARTED)
                }
                ...
                function Q() {
                    if (K.length && 0 !== Y) {
                        ...
                        do {
                            P = K[0];
                            if (P.ma > w.getDuration()) return;
                            T = (P.ma - w.getCurrentTime()) / Y;
                            if (0 > T && (K.shift(), 0 === K.length)) return
                        } while (0 > T);
                        x = function() {
                            z = 0;
                            x = V;
                            0 < K.length && K[0].ma === P.ma && (K.shift(), O.Jb("progress", P.de, P.me));
                            Q()
                        };
                        z = zi(x, 1E3 * T)
                    }
                ...
                var O, K = [],
                    I, R, U, Y, da, ea, Ba = A(q.UNSTARTED);
                z = 0;
                x = V;
                return {
            ...
            function k(w) {
                for (var y = w.split(","), x = y.length, z = [], A = 0; A < x; A++) {
                    var B = parseInt(y[A], 10);
                    isNaN(B) || 100 < B || 0 > B || z.push(B / 100)
                }
                z.sort(function(E, F) {
                    return E - F
                });
            ...
            function n(w) {
                w.vtp_triggerStartOption ? p(w) : Pd(function() {
                    p(w)
                })
            }

            function p(w) {
                var y = !!w.vtp_captureStart,
                    x = !!w.vtp_captureComplete,
                    z = !!w.vtp_capturePause,
                    A = k(w.vtp_progressThresholdsPercent + ""),
                    B = l(w.vtp_progressThresholdsTimeInSeconds + ""),
                    E = !!w.vtp_fixMissingApi;
                if (y || x || z || A.length || B.length) {
                    var F = {
                            Ef: y,
                            Cf: x,
                            Df: z,
                            ...
                            Ag: B,
                            Nd: E,
                            Yc: void 0 === w.vtp_uniqueTriggerId ? "" : w.vtp_uniqueTriggerId
                        },
                        J = W("YT"),
                        N = function() {
                            g(F)
                    ...
                    if (J) J.ready && J.ready(N);
                    else {
                        var V = W("onYouTubeIframeAPIReady");
                        Gi("onYouTubeIframeAPIReady", function() {
                            V && V();
                            N()
                        });
                        G(function() {
                            for (var S = W("document"), Q = S.getElementsByTagName("script"), O = Q.length, K = 0; K < O; K++) {
                                var I = Q[K].getAttribute("src");
                                if (b(I, "iframe_api") || b(I, "player_api")) return
                            }
                            for (var R = S.getElementsByTagName("iframe"), U = R.length, Y = 0; Y < U; Y++)
                                if (!u && d(R[Y], F.Nd)) {
                                    M("https://www.youtube.com/iframe_api");
                                    u = !0;
                                    break
                                }
                        })
                    }
                } else G(w.vtp_gtmOnSuccess)
            }
            var t = ["www.youtube.com", "www.youtube-nocookie.com"],
                q = {
                    UNSTARTED: -1,
                    ENDED: 0,
                    PLAYING: 1,
        ...
        function() {
            ...
            function b(q, r, u, w) {
                ...
                if (n.hasOwnProperty(y)) x = n[y];
                    ...
                    var z = a(q, w);
                    if (z && (x = u(z), n[y] = x, p.push(y), 35 < p.length)) {
                        var A = p.shift();
                        delete n[A]
                    }
                }
            ...
            function d(q, r) {
                if (!q) return !1;
                var u = e(Ai());
                la(r) || (r = String(r || "").replace(/\s+/g, "").split(","));
                for (var w = [u], y = 0; y < r.length; y++)
            ...
            function e(q) {
                m.test(q) || (q = "http://" + q);
                return oe(pe(q), "HOST", !0)
            }

            function g(q, r, u) {
                switch (q) {
                    case "SUBMIT_TEXT":
                        return b(r, "FORM." + q, h, "formSubmitElement") || u;
                    case "LENGTH":
                        var w = b(r, "FORM." + q, k);
                        return void 0 === w ? u : w;
            ...
            function k(q) {
                if ("form" === q.tagName.toLowerCase() && q.elements) {
                    for (var r = 0, u = 0; u < q.elements.length; u++) Qh(q.elements[u]) && r++;
                    return r
                }
            }
                ...
                switch (w) {
                        ...
                        a: {
                            ...
                            switch (B) {
                                case "URL":
                                    ...
                                    break a;
                                case "IS_OUTBOUND":
                                    x = d(z, q.vtp_affiliatedDomains);
                                    break a;
                                default:
                                    x = oe(A, B, q.vtp_stripWww, q.vtp_defaultPages, q.vtp_queryKey)
                            }
                        }
                        return x;
                    case "ATTRIBUTE":
                        var E;
                        if (void 0 === q.vtp_attribute) E = c(r, w, u);
                        else {
                    ...
                    case "MD":
                        ...
                        return N && V ? ni(V, N) ||
                            u : V || u;
                    case "FORM":
                        return g(String(q.vtp_component || "SUBMIT_TEXT"), r, u);
                    default:
                        return c(r, w, u)
                }
            })
            ...
            var a = !1,
                ...
                h = function(k) {
                    ...
                    k.vtp_enableProductReporting && (n = m(k.vtp_productReportingDataSource), n("google_conversion_merchant_id", "vtp_awMerchantId", "aw_merchant_id"), n("google_basket_feed_country",
                        "vtp_awFeedCountry", "aw_feed_country"), n("google_basket_feed_language", "vtp_awFeedLanguage", "aw_feed_language"), n("google_basket_discount", "vtp_discount", "discount"), n("google_conversion_items", "vtp_items", "items"), l.google_conversion_items = l.google_conversion_items.map(function(u) {
                        return {
                            value: u.price,
                            quantity: u.quantity,
                            item_id: u.id
                    ...
                    var p = function(u, w) {
                            (l.google_additional_conversion_params = l.google_additional_conversion_params || {})[u] = w
                        },
                        t = function(u) {
                            return function(w, y, x, z) {
                                var A = "DATA_LAYER" ==
                                    u ? Ei(x) : k[y];
                                z(A) && p(w, A)
                            }
                    ...
                    k.vtp_enableNewCustomerReporting && (n = t(k.vtp_newCustomerReportingDataSource), n("vdnc",
                        "vtp_awNewCustomer", "new_customer",
                        function(u) {
                            return void 0 != u && "" !== u
                        }), n("vdltv", "vtp_awCustomerLTV", "customer_lifetime_value", function(u) {
                        return void 0 != u && "" !== u
                    }));
                    ...
                    e = function(g) {
                        ...
                        if (h && 3 !== g.which && (!g.timeStamp || g.timeStamp !== d)) {
                            ...
                            var k = g.defaultPrevented || !1 === g.returnValue,
                                l = vg("lcl", k ? "nv.mwt" : "mwt", 0),
                                m;
                            m = k ? vg("lcl", "nv.ids", []) : vg("lcl", "ids", []);
                            if (m.length) {
                                var n = rg(h, "gtm.linkClick", m);
                                if (b(g, h, c) && !k && l && h.href) {
                                    var p = W((Pi(h, "target") || "_self").substring(1)),
                                        t = !0;
                                    if (Fi(n, Nf(function() {
                                            t && p && (p.location.href = Pi(h,
                                                "href"))
                                        }), l)) t = !1;
                                    else return g.preventDefault && g.preventDefault(), g.returnValue = !1
                                } else Fi(n, function() {}, l || 2E3);
                                return !0
                            }
                        }
                    };
    ...
    }, Qk.onHtmlSuccess = og.Id(!0), Qk.onHtmlFailure = og.Id(!1);
    Qk.dataLayer = cd;
    Qk.callback = function(a) {
    ...
    Qk.hg = function() {
        ...
        if (oc[nc.m]) {
            ...
            for (var b = data.resource || {}, c = b.macros || [], d = 0; d < c.length; d++) gb.push(c[d]);
            for (var e = b.tags || [], g = 0; g < e.length; g++) kb.push(e[g]);
            for (var h = b.predicates || [],
                    k = 0; k < h.length; k++) jb.push(h[k]);
            ...
            Gf = !1;
            "complete" === D.readyState ? If() :
                Ob(C, "load", If);
            a: {
                if (!Sc) break a;C.setInterval(Tc, 864E5);
            }
            uc = (new Date).getTime();
        }
    };

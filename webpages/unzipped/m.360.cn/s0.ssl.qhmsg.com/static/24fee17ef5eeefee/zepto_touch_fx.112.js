var Zepto = function() {
    ...
    var S, x, T, N, C = [],
        ...
        D = /^\s*<(\w+|!)[^>]*>/,
        P = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        H = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
        B = /^(?:body|html)$/i,
        j = /([A-Z])/g,
    ...
    return K.matches = function(e, t) {
        ...
        if (typeof e == "string") {
            e = e.trim();
            if (e[0] == "<" && D.test(e)) r = K.fragment(e, RegExp.$1, n), e = null;
            else {
            ...
            else if (D.test(e)) r = K.fragment(e.trim(), RegExp.$1, n), e = null;
            else {
                if (n !== S) return T(n).find(e);
                r = K.qsa(A, e)
            }
        ...
        css: function(t, n) {
            ...
            if (e(t) == "string") !n && n !== 0 ? this.each(function() {
                ...
                for (x in t) !t[x] && t[x] !== 0 ? this.each(function() {
...
window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto),
    ...
    function(e) {
        ...
        function r() {
            c = null, o.last && (o.el.trigger("longTap"), o = {})
        }
        ...
        function s() {
            u && clearTimeout(u), a && clearTimeout(a), f && clearTimeout(f), c && clearTimeout(c), u = a = f = c = null, o = {}
        }
        var o = {},
            u, a, f, l = 750,
            c;
        e(document).ready(function() {
            ...
            e(document.body).bind("touchstart", function(n) {
                h = Date.now(), p = h - (o.last || h), o.el = e(t(n.touches[0].target)), u && clearTimeout(u), o.x1 = n.touches[0].pageX, o.y1 = n.touches[0].pageY, p > 0 && p <= 250 && (o.isDoubleTap = !0), o.last = h, c = setTimeout(r, l)
            }).bind("touchmove", function(e) {
                i(), o.x2 = e.touches[0].pageX, o.y2 = e.touches[0].pageY, Math.abs(o.x1 - o.x2) > 10 && e.preventDefault()
            }).bind("touchend", function(t) {
                i(), o.x2 && Math.abs(o.x1 - o.x2) > 30 || o.y2 && Math.abs(o.y1 - o.y2) > 30 ? f = setTimeout(function() {
                    o.el.trigger("swipe"), o.el.trigger("swipe" + n(o.x1, o.x2, o.y1, o.y2)), o = {}
                }, 0) : "last" in o && (a = setTimeout(function() {
                    var t = e.Event("tap");
                    t.cancelTouch = s, o.el.trigger(t), o.isDoubleTap ? (o.el.trigger("doubleTap"), o = {}) : u = setTimeout(function() {
                        u = null, o.el.trigger("singleTap"), o = {}
                    }, 250)
                }, 0))
            }).bind("touchcancel", s), e(window).bind("scroll", s)
    ...
    function(e, t) {
        ...
        e.each(a, function(e, n) {
            if (l.style[e + "TransitionProperty"] !== t) return i = "-" + e.toLowerCase() + "-", s = n, !1
        }), h = i + "transform", E[p = i + "transition-property"] = E[d = i + "transition-duration"] = E[m = i + "transition-delay"] = E[v = i + "transition-timing-function"] = E[g = i + "animation-name"] = E[y = i + "animation-duration"] = E[w = i + "animation-delay"] = E[b = i + "animation-timing-function"] = "", e.fx = {
            off: s === t && l.style.transitionProperty === t,
            speeds: {
                _default: 400,
                fast: 200,
                slow: 600
        ...
        }, e.fn.anim = function(r, i, s, o, u) {
            var a, f = {},
                l, S = "",
                x = this,
                T, N = e.fx.transitionEnd,
                C = !1;
            i === t && (i = e.fx.speeds._default / 1e3), u === t && (u = 0), e.fx.off && (i = 0);
            if (typeof r == "string") f[g] = r, f[y] = i + "s", f[w] = u + "s", f[b] = s || "linear", N = e.fx.animationEnd;
            else {
                l = [];
                for (a in r) c.test(a) ? S += a + "(" + r[a] + ") " : (f[a] = r[a], l.push(n(a)));
                S && (f[h] = S, l.push(h)), i > 0 && typeof r == "object" && (f[p] = l.join(", "), f[d] = i + "s", f[m] = u + "s", f[v] = s || "linear")
            }
            return T = function(t) {
                ...
                C = !0, e(this).css(E), o && o.call(this)
            }, i > 0 && (this.bind(N, T), setTimeout(function() {
                if (C) return;
                T.call(x)
            }, i * 1e3 + 25)), this.size() && this.get(0).clientLeft, this.css(f), i <= 0 && setTimeout(function() {
                x.each(function() {
                    T.call(this)
                })
            }, 0), this

...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        require(['mybbc/notifications/NotificationsMain', 'idcta/idcta-1'], function(NotificationsMain, idcta) {
            ...
            var loadNotifications = function(isUK) {lacuna_lazy_load("lacuna_cache/exported_vy9fr6.js[427:747]", functionData => eval(functionData))};
            ...
            if (window.bbcuser && window.bbcuser.isUKCombined && typeof(window.bbcuser.isUKCombined) === 'function') {
                ...
                window.bbcuser.isUKCombined().then(function(isUK) {lacuna_lazy_load("lacuna_cache/exported_vy9fr6.js[990:1054]", functionData => eval(functionData))});
            } else {

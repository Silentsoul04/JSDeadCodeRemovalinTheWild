...
! function(global, setTimeout) {
  ...
  function commentReplace(e, t) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[983:1007]", functionData => eval(functionData))}
  ...
  function defaultOnError(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[2123:2140]", functionData => eval(functionData))}

  function getGlobal(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[2166:2282]", functionData => eval(functionData))}

  function makeError(e, t, i, r) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[2317:2479]", functionData => eval(functionData))}
  if (void 0 === define) {
    if (void 0 !== requirejs) {
    ...
    void 0 === require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function(e, t, i, r) {
      ...
      setTimeout(e, 4)
    } : function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[3196:3213]", functionData => eval(functionData))}, require = require || req, req.version = version, req.jsExtRegExp = /^\/|:|\?|\.js$/, req.isBrowser = isBrowser, s = req.s = {
      contexts: contexts,
      ...
      if (isWebWorker) try {
        setTimeout(function() {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[4851:4853]", functionData => eval(functionData))}, 0), importScripts(r), t.completeLoad(i)
      } catch (e) {
  ...
  function newContext(u) {
    ...
    function E(t) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[7911:8130]", functionData => eval(functionData))}

    function w(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[8150:8332]", functionData => eval(functionData))}
    ...
    function S(e, t, i, r) {
      var n, o, a, s, u = null,
        ...
        p = !0,
        f = "";
      return e || (p = !1, e = "_@r" + (x += 1)), u = (s = y(e))[0], e = s[1], u && (u = q(u, c, r), o = getOwn(m, u)), e && (u ? f = o && o.normalize ? o.normalize(e, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[8811:8846]", functionData => eval(functionData))}) : -1 === e.indexOf("!") ? q(e, c, r) : e : (u = (s = y(f = q(e, c, r)))[0], f = s[1], i = !0, n = l.nameToUrl(f))), {
        prefix: u,
        name: f,
        parentMap: t,
    ...
    function O(i, e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[9579:9810]", functionData => eval(functionData))}
    ...
    return c = {
      ...
      exports: function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[12197:12329]", functionData => eval(functionData))},
      module: function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[12357:12621]", functionData => eval(functionData))}
    }, (e = function(e) {
      ...
      init: function(e, t, i, r) {
        r = r || {}, this.inited || (this.factory = t, i ? this.on("error", i) : this.events.error && (i = bind(this, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[13028:13071]", functionData => eval(functionData))})), this.depMaps = e && e.slice(0), this.errback = i, this.inited = !0, this.ignore = r.ignore, r.enabled || this.enabled ? this.enable() : this.check())
      },
            ...
            if (this.error) this.emit("error", this.error);
              ...
              if (this.defining = !0, this.depCount < 1 && !this.defined) {
                ...
                if (this.exports = n, this.map.isDefine && !this.ignore && (m[i] = n, req.onResourceLoad)) {
                  var a = [];
                  each(this.depMaps, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[15171:15241]", functionData => eval(functionData))}), req.onResourceLoad(l, this.map, a)
                }
                P(i), this.defined = !0
              }
      ...
      callPlugin: function() {
        ...
        this.depMaps.push(e), M(e, "defined", bind(this, function(e) {
          ...
          return this.map.unnormalized ? (e.normalize && (n = e.normalize(n, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[16124:16168]", functionData => eval(functionData))}) || ""), M(t = S(u.prefix + "!" + n, this.map.parentMap), "defined", bind(this, function(e) {
          ...
          })), void((i = getOwn(p, t.id)) && (this.depMaps.push(t), this.events.error && i.on("error", bind(this, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[16569:16616]", functionData => eval(functionData))})), i.enable()))) : r ? (this.map.url = l.nameToUrl(r), void this.load()) : ((o = bind(this, function(e) {
            this.init([], function() {
              return e
            }, null, {
              enabled: !0
            })
          })).error = bind(this, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[16894:17096]", functionData => eval(functionData))}), o.fromText = bind(this, function(e, t) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[17138:17627]", functionData => eval(functionData))}), void e.load(u.name, s, o, g))
      ...
      enable: function() {
        (f[this.map.id] = this).enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(e, t) {
          ...
          if ("string" == typeof e) {
            ...
            })), this.errback ? M(e, "error", bind(this, this.errback)) : this.events.error && M(e, "error", bind(this, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[18381:18432]", functionData => eval(functionData))}))
          }
      ...
      configure: function(e) {
        if (e.baseUrl && "/" !== e.baseUrl.charAt(e.baseUrl.length - 1) && (e.baseUrl += "/"), "string" == typeof e.urlArgs) {
          var i = e.urlArgs;
          e.urlArgs = function(e, t) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[19461:19533]", functionData => eval(functionData))}
        }
        var r = g.shim,
          n = {
            paths: !0,
        ...
        }), e.bundles && eachProp(e.bundles, function(e, t) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[19860:19950]", functionData => eval(functionData))}), e.shim && (eachProp(e.shim, function(e, t) {
          isArray(e) && (e = {
            deps: e
          }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = l.makeShimExports(e)), r[t] = e
        }), g.shim = r), e.packages && each(e.packages, function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[20218:20475]", functionData => eval(functionData))}), eachProp(p, function(e, t) {
          e.inited || e.map.unnormalized || (e.map = S(t, null, !0))
        }), (e.deps || e.callback) && l.require(e.deps || [], e.callback)
      },
      makeShimExports: function(t) {
        return function() {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[20722:20855]", functionData => eval(functionData))}
      },
      makeRequire: function(o, a) {
        ...
        return a = a || {}, mixin(s, {
          isBrowser: isBrowser,
          toUrl: function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[21665:21923]", functionData => eval(functionData))},
          defined: function(e) {
            return hasProp(m, S(e, o, !1, !0).id)
          },
          specified: function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[22054:22141]", functionData => eval(functionData))}
        }), o || (s.undef = function(i) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[22182:22507]", functionData => eval(functionData))}), s
      },
      enable: function(e) {
      ...
      onScriptError: function(e) {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[24332:24737]", functionData => eval(functionData))}
    }).require = l.makeRequire(), l
  }

  function getInteractiveScript() {lacuna_lazy_load("lacuna_cache/imported_nu52mp.js[24813:25034]", functionData => eval(functionData))}

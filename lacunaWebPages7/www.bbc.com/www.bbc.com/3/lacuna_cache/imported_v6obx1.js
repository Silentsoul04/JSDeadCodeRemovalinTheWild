...
! function(e, t, n) {
  ...
  function p(t, r) {
    ...
    if ("CSSSupportsRule" in e) {
      ...
      return i = i.join(" or "), u("@supports (" + i + ") { #modernizr { position: absolute; } }", null)
    }
    return n
  }
  ...
  ! function() {
    ...
    x = r(e, "undefined") || r(e.call, "undefined") ? null : null
  }(), S._l = {}, S.on = null, S._trigger = null, Modernizr._q.push(function() {
    S.addTest = s
  });
  _ || ! function(e, t) {
    ...
    ! function() {
      try {
        ...
        e.innerHTML = "<xyz></xyz>", u = "hidden" in e, c = 1 == e.childNodes.length || null()
      } catch (n) {
        u = !0, c = !0
      }
    }();
  ...
  var N = (S.testProp = null, "Moz O ms Webkit"),

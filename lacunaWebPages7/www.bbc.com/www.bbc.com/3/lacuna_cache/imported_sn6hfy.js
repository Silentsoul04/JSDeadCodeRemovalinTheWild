! function n(o, s, u) {
  ...
  5: [function(e, r, t) {
    ...
    var u = "bbc_website",
      ...
      }), s(a, "_isCustomVariable", null), s(a, "_setCustomVariable", function(e, r, t) {
        if (t) {
  ...
  6: [function(e, r, t) {
    ...
    var a = function() {
      ...
      return r = e, (t = [{
        ...
        value: function() {
          var r = this;
          return this.isReady() ? new Promise(null) : (this.echoDeviceId = this._readCookie(this.echoDeviceIdCookie), this._loadATI().then(function() {

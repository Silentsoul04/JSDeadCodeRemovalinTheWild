...
! function(global, setTimeout) {
  ...
  if (void 0 === define) {
    ...
    void 0 === require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function(e, t, i, r) {
      ...
      setTimeout(e, 4)
    } : null, require = require || req, req.version = version, req.jsExtRegExp = /^\/|:|\?|\.js$/, req.isBrowser = isBrowser, s = req.s = {
      contexts: contexts,
      ...
      if (isWebWorker) try {
        setTimeout(null, 0), importScripts(r), t.completeLoad(i)
      } catch (e) {
  ...
  function newContext(u) {
    ...
    function S(e, t, i, r) {
      var n, o, a, s, u = null,
        ...
        p = !0,
        f = "";
      return e || (p = !1, e = "_@r" + (x += 1)), u = (s = y(e))[0], e = s[1], u && (u = q(u, c, r), o = getOwn(m, u)), e && (u ? f = o && o.normalize ? o.normalize(e, null) : -1 === e.indexOf("!") ? q(e, c, r) : e : (u = (s = y(f = q(e, c, r)))[0], f = s[1], i = !0, n = l.nameToUrl(f))), {
        prefix: u,
        name: f,
        parentMap: t,
    ...
    return c = {
      ...
      init: function(e, t, i, r) {
        r = r || {}, this.inited || (this.factory = t, i ? this.on("error", i) : this.events.error && (i = bind(this, null)), this.depMaps = e && e.slice(0), this.errback = i, this.inited = !0, this.ignore = r.ignore, r.enabled || this.enabled ? this.enable() : this.check())
      },
            ...
            if (this.error) this.emit("error", this.error);
              ...
              if (this.defining = !0, this.depCount < 1 && !this.defined) {
                ...
                if (this.exports = n, this.map.isDefine && !this.ignore && (m[i] = n, req.onResourceLoad)) {
                  var a = [];
                  each(this.depMaps, null), req.onResourceLoad(l, this.map, a)
                }
                P(i), this.defined = !0
              }
      ...
      callPlugin: function() {
        ...
        this.depMaps.push(e), M(e, "defined", bind(this, function(e) {
          ...
          return this.map.unnormalized ? (e.normalize && (n = e.normalize(n, null) || ""), M(t = S(u.prefix + "!" + n, this.map.parentMap), "defined", bind(this, function(e) {
          ...
          })), void((i = getOwn(p, t.id)) && (this.depMaps.push(t), this.events.error && i.on("error", bind(this, null)), i.enable()))) : r ? (this.map.url = l.nameToUrl(r), void this.load()) : ((o = bind(this, function(e) {
            this.init([], function() {
              return e
            }, null, {
              enabled: !0
            })
          })).error = bind(this, null), o.fromText = bind(this, null), void e.load(u.name, s, o, g))
      ...
      enable: function() {
        (f[this.map.id] = this).enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(e, t) {
          ...
          if ("string" == typeof e) {
            ...
            })), this.errback ? M(e, "error", bind(this, this.errback)) : this.events.error && M(e, "error", bind(this, null))
          }
      ...
      configure: function(e) {
        ...
        }), e.bundles && eachProp(e.bundles, null), e.shim && (eachProp(e.shim, function(e, t) {
          isArray(e) && (e = {
            deps: e
          }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = l.makeShimExports(e)), r[t] = e
        }), g.shim = r), e.packages && each(e.packages, null), eachProp(p, function(e, t) {

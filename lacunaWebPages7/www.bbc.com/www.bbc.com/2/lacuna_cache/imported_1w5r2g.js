...
window.orb.fig = function() {
  ...
  return i.load = function(e, n) {
  ...
  }, i.setData = function(e) {}, i.figSuccess = function(e) {}, i.figError = function() {}, i.figFailed = function() {
    return t
  }, i.isOverridden = function() {}, i.isCached = function() {}, i.isStale = function() {
    return a
  }, i.init = function() {
    ...
    if (e) {
      var o = {};
      return e.replace(/([a-z]{2}):([0-9]+)/g, function(e, n, t) {}), f = o, i.redirect(), u = !0, i
    }
    u = !1;
    var n = h(s);
    if (n) try {

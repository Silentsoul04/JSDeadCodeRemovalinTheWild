  ...
  function newContext(u) {
    ...
    function S(e, t, i, r) {
      var n, o, a, s, u = null,
        ...
        p = !0,
        f = "";
      return e || (p = !1, e = "_@r" + (x += 1)), u = (s = y(e))[0], e = s[1], u && (u = q(u, c, r), o = getOwn(m, u)), e && (u ? f = o && o.normalize ? o.normalize(e, function(e) {
        return q(e, c, r)
      ...
      callPlugin: function() {
        ...
        this.depMaps.push(e), M(e, "defined", bind(this, function(e) {
          ...
          return this.map.unnormalized ? (e.normalize && (n = e.normalize(n, function(e) {
            return q(e, a, !0)
          }) || ""), M(t = S(u.prefix + "!" + n, this.map.parentMap), "defined", bind(this, function(e) {

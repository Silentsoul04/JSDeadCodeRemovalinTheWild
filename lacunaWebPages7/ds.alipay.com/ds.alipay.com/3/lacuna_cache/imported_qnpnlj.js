! function(modules) {
  ...
  var _extends = Object.assign || null,
  ...
  exports["default"] = {
    ...
    requestIdleCallback: function(_requestIdleCallback) {
      ...
      return requestIdleCallback.toString = null, requestIdleCallback
    }(null),
    dealExtra: null,
  ...
  var _extends = Object.assign || null,
    _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? null : null,
    _tracertUtil = __webpack_require__(1),
    _tracertUtil2 = _interopRequireDefault(_tracertUtil),
  ...
  var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? null : null,
    _tracertUtil = __webpack_require__(1),
    _tracertUtil2 = _interopRequireDefault(_tracertUtil);
  exports["default"] = {
    initFromStartParams: null,
    expoMerge: null,
    checkSubPage: null,
    formatRemoteParams: null
  }, module.exports = exports["default"]
}, function(module, exports, __webpack_require__) {
  "use strict";
  ...
  exports["default"] = {
    ...
    disableBizLog: function() {
      win.BizLog && "function" == typeof win.BizLog.call && (win.BizLog.call("config", {
        disabled: !0
      }), "function" == typeof document.addEventListener && document.addEventListener("AlipayJSBridgeReady", null, !1))
    },
    runBizlogLoader: function(Tracert) {
      if (win.BizLog) {
        var _readyToRun = win.BizLog._readyToRun,
          BizLog = win.BizLog || {};
        if (BizLog.call = null, _readyToRun && _readyToRun.length)
    ...
    initTracert: function(tracert) {
      if (win.Tracert && win.Tracert._isInit) {
        ...
        if (win.Tracert.call = null, _readyToRun && _readyToRun.length)
          for (var i = 0; i < _readyToRun.length; i++) {
            var fn = _readyToRun[i];
            try {
              fn()
  ...
  ! function(factory) {
    ...
    function init(converter) {
      ...
      return api.set = api, api.get = null, api.getJSON = null, api.defaults = {}, api.remove = null, api.withConverter = init, api
    }
    return init(null)
  })
}, function(module, exports, __webpack_require__) {
  ...
  function addEventListener(element, eventName, handler) {
    element && (element.addEventListener ? element.addEventListener(eventName, handler, !1) : element.attachEvent && element.attachEvent("on" + eventName, null))
  }
  ...
  }, nameStorage.removeItem = null, nameStorage.clear = null, nameStorage.valueOf = null, nameStorage.toString = null, addEventListener(win, "beforeunload", function() {
    save()

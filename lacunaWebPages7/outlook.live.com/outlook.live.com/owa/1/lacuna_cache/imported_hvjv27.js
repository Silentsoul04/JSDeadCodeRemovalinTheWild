...
! function() {
  ...
  var t = {
    ...
    n = {
      ...
      unregister: function(e, i, r) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[958:1173]", functionData => eval(functionData))},
      process: function() {
      ...
      processInView: function(e, t) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[2085:3196]", functionData => eval(functionData))}
    },
    i = {
      lastStartEvent: 0,
      timeoutHandle: null,
  ...
  $.extend($.event.special, {
    onscreen: {
      ...
      remove: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[4543:4599]", functionData => eval(functionData))}
    },
    inview: {
      noBubble: !0,
      add: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[4664:4716]", functionData => eval(functionData))},
      remove: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[4744:4798]", functionData => eval(functionData))}
    }
  }), $.extend($.fn, {
    onscreen: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[4854:4923]", functionData => eval(functionData))},
    inview: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[4949:5016]", functionData => eval(functionData))}
  });
  var r = {
      locks: [],
      lock: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[5076:5126]", functionData => eval(functionData))},
      unlock: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[5154:5399]", functionData => eval(functionData))},
      isLocked: function(e) {
    ...
    o = {
      ...
      config: function(e) {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[5706:5770]", functionData => eval(functionData))}
    };
  $.inview = $.onscreen = function() {lacuna_lazy_load("lacuna_cache/imported_hvjv27.js[5815:5834]", functionData => eval(functionData))}, $.extend($.inview, r, o);
  var s = {
      $el: $(window),
      height: null,
      width: null,

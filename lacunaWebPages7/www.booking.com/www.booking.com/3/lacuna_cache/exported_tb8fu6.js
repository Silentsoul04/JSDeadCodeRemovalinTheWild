        ...
        ImageLazyLoader.prototype = {
            ...
            init: function() {
                ...
                if (!this.supportsIntersectionObserver) {
                    var updateViewportHeight = null.bind(this);
            ...
            enableHighResImagesLoading: null,
            loadLazyImage: null,
            ...
            parseDataSrc: null,
            loadImageAndInsert: null,
            listenMutationEvents: null,
            getWatcher: function() {
                if (this.supportsIntersectionObserver) {
        ...
        ImageLazyLoader.prototype.enableHighResImagesLoading = function() {
            ...
            this.highResQueue.forEach(null.bind(this));
            this.highResQueue = []
        };

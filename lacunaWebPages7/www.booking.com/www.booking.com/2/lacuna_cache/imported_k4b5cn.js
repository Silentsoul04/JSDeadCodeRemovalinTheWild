! function() {
  ...
  ! function(p) {
    ...
    d = function(e, t) {
      var n, r, i = u(e),
        o = i[0];
      return e = i[1], o && (n = E(o = a(o, t))), o ? e = n && n.normalize ? n.normalize(e, (r = t, function(e) {})) : a(e, t) : (o = (i = u(e = a(e, t)))[0], e = i[1], o && (n = E(o))), {
        f: o ? o + "!" + e : e,
        n: e,
        pr: o,
        p: n
    ...
    }, s.config = function(e) {}, e._defined = g, (i = function(e, t, n) {
...
}(), B.define("env", function(e, t, n) {}), B.define("server-data", function(e, t, n) {
    return B.env
  }),
  function(e, t) {
    ...
    N.fn = N.prototype = {
      ...
      proxy: function(e, t) {
        var n, r, i;
        return "string" == typeof t && (n = e[t], t = e, e = n), N.isFunction(e) ? (r = c.call(arguments, 2), (i = function() {}).guid = e.guid = e.guid || N.guid++, i) : void 0
      },
      now: Date.now,
      support: v
    ...
    var p = function(n) {
      ...
      for (e in h = re.support = {}, i = re.isXML = function(e) {
          ...
          }), h.getById ? (b.find.ID = function(e, t) {}, b.filter.ID = function(e) {}) : (delete b.find.ID, b.filter.ID = function(e) {}), b.find.TAG = h.getElementsByTagName ? function(e, t) {} : function(e, t) {}, b.find.CLASS = h.getElementsByClassName && function(e, t) {}, a = [], m = [], (h.qsa = Y.test(C.querySelectorAll)) && (se(function(e) {
          ...
          } : function(e, t) {}, j = t ? function(e, t) {} : function(e, t) {}), C
        ...
        }, re.error = function(e) {}, re.uniqueSort = function(e) {}, o = re.getText = function(e) {}, (b = re.selectors = {
          cacheLength: 50,
          createPseudo: oe,
          match: V,
          attrHandle: {},
          ...
          filter: {
            ...
            PSEUDO: function(e, o) {
              ...
              return s[N] ? s(o) : 1 < s.length ? (t = [e, e, "", o], b.setFilters.hasOwnProperty(e.toLowerCase()) ? oe(function(e, t) {}) : function(e) {}) : s
            }
          },
          pseudos: {
            not: oe(function(e) {}),
      ...
      function xe(e) {
        for (var i, t, n, r = e.length, o = b.relative[e[0].type], s = o || b.relative[" "], a = o ? 1 : 0, u = ge(function(e) {}, s, !0), l = ge(function(e) {}, s, !0), c = [function(e, t, n) {
      ...
      }) || ae("type|href|height|width", function(e, t, n) {}), h.attributes && se(function(e) {
        return e.innerHTML = "<input/>", e.firstChild.setAttribute("value", ""), "" === e.firstChild.getAttribute("value")
      }) || ae("value", function(e, t, n) {}), se(function(e) {
        return null == e.getAttribute("disabled")
      }) || ae(H, function(e, t, n) {}), re
    }(C);
      ...
      Deferred: function(e) {
        ...
        return s.pipe = s.then, N.each(o, function(e, t) {
          ...
          s[t[1]] = n.add, r && n.add(function() {
            i = r
          }, o[1 ^ e][2].disable, o[2][2].lock), a[t[0]] = function() {}, a[t[0] + "With"] = n.fireWith
    ...
    var q = function(e, t, n, r, i, o, s) {
        ...
        else if (void 0 !== r && (i = !0, N.isFunction(r) || (s = !0), l && (s ? (t.call(e, r), t = null) : (l = t, t = function(e, t, n) {})), t))
    ...
    N.extend({
      ...
      data: function(r, e) {
        ...
        return "object" == typeof r ? this.each(function() {}) : q(this, function(t) {
          var e, n;
          if (o && void 0 === t) {
    ...
    function ue(e, t, n, r, i, o) {
      ...
      return 1 === o && (s = i, (i = function(e) {}).guid = s.guid || (s.guid = N.guid++)), e.each(function() {
    ...
    }, N.removeEvent = function(e, t, n) {}, N.Event = function(e, t) {
    ...
    N.extend({
      ...
      N.cssHooks[s] = {
        get: function(e, t, n) {
          return t ? _e.test(N.css(e, "display")) && 0 === e.offsetWidth ? Se(e, Le, function() {}) : Fe(e, s, n) : void 0
        },
        set: function(e, t, n) {}
      }
    }), N.cssHooks.marginLeft = De(v.reliableMarginLeft, function(e, t) {}), N.cssHooks.marginRight = De(v.reliableMarginRight, function(e, t) {}), N.each({
      margin: "",
      padding: "",
      border: "Width"
    }, function(i, o) {
    ...
    N.Animation = N.extend(Je, {
      ...
      return r.duration = N.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in N.fx.speeds ? N.fx.speeds[r.duration] : N.fx.speeds._default, null != r.queue && !0 !== r.queue || (r.queue = "fx"), r.old = r.complete, r.complete = function() {}, r
    }, N.fn.extend({
    ...
    }), N.timers = [], N.fx.tick = function() {}, N.fx.timer = function(e) {}, N.fx.interval = 13, N.fx.start = function() {}, N.fx.stop = function() {}, N.fx.speeds = {
      slow: 600,
      fast: 200,
      _default: 400
    }, N.fn.delay = function(r, e) {}, Xe = E.createElement("input"), ze = E.createElement("select"), Ue = ze.appendChild(E.createElement("option")), Xe.type = "checkbox", v.checkOn = "" !== Xe.value, v.optSelected = Ue.selected, ze.disabled = !0, v.optDisabled = !Ue.disabled, (Xe = E.createElement("input")).value = "t", Xe.type = "radio", v.radioValue = "t" === Xe.value;
    ...
    var ut = C.location,
      lt = N.now(),
      ct = /\?/;
    N.parseJSON = function(e) {}, N.parseXML = function(e) {};
    var ft = /#.*$/,
      pt = /([?&])_=[^&]*/,
      dt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
      ht = /^(?:GET|HEAD)$/,
    ...
    xt.href = ut.href, N.extend({
      ...
      ajax: function(e, t) {
        ...
        if (c = wt(mt, g, t, T)) {
          ...
          g.async && 0 < g.timeout && (d = C.setTimeout(function() {}, g.timeout));
          try {
            w = 1, c.send(o, u)
          } catch (e) {
            if (!(w < 2)) throw e;
    ...
    }), N._evalUrl = function(e) {}, N.fn.extend({
      wrapAll: function(t) {},
      wrapInner: function(n) {},
      wrap: function(t) {},
      unwrap: function() {}
    }), N.expr.filters.hidden = function(e) {}, N.expr.filters.visible = function(e) {
    ...
    v.cors = !!Dt && "withCredentials" in Dt, v.ajax = Dt = !!Dt, N.ajaxTransport(function(i) {
      ...
      return v.cors || Dt && !i.crossDomain ? {
        send: function(e, t) {
          ...
          }, r.onload = o(), s = r.onerror = o("error"), void 0 !== r.onabort ? r.onabort = s : r.onreadystatechange = function() {}, o = o("abort");
          try {
    ...
    }), N.ajaxPrefilter("script", function(e) {}), N.ajaxTransport("script", function(n) {});
    var _t = [],
      Lt = /(=)\?(?=&|$)|\?\?/;
    N.ajaxSetup({
      jsonp: "callback",
      ...
      return s || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = N.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Lt, "$1" + r) : !1 !== e.jsonp && (e.url += (ct.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {}, e.dataTypes[0] = "json", i = C[r], C[r] = function() {}, n.always(function() {}), "script") : void 0
    ...
    N.fn.load = function(e, t, n) {
      ...
      return -1 < a && (r = N.trim(e.slice(a)), e = e.slice(0, a)), N.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 0 < s.length && N.ajax({
        ...
        dataType: "html",
        data: t
      }).done(function(e) {}).always(n && function(e, t) {}), this
    }, N.each(["ajaxStart", "ajaxStop", "ajaxComplete", "ajaxError", "ajaxSuccess", "ajaxSend"], function(e, t) {
      N.fn[t] = function(e) {}
    }), N.expr.filters.animated = function(t) {}, N.offset = {
    ...
    var Ht = C.jQuery,
      It = C.$;
    return N.noConflict = function(e) {}, e || (C.jQuery = C.$ = N), N
  }), B.define("jquery", function() {
    return jQuery
  }), "function" != typeof Object.assign && (Object.assign = function(e) {}), Object.defineProperties && function(i, r) {
    var o = {
      pageX: function(e) {},
      pageY: function(e) {},

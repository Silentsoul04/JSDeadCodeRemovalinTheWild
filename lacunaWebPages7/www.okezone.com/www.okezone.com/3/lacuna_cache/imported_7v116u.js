function _typeof(e) {
  ...
  window.RFP = RFP, RFP.Common = void 0 === window.RFP.Common ? {} : window.RFP.Common, RFP.Common.Util = function() {
    ...
    Util.forEach = function(e, t, n) {
      ...
      return i
    }, Util.objectSeal = null, Util.jsonParse = function(json_str) {
      return window.JSON ? window.JSON.parse(json_str) : eval("(" + json_str + ")")
    }, Util.waitDomReady = null, Util.extend = function(e, t) {
    ...
    }, Util.isFunction = null, Util.isArray = function(e) {
      return "[object Array]" === Object.prototype.toString.call(e)
    }, Util.isSmartPhone = null, Util.throttle = function(e, t) {
      var n = this;
      t = +t || 0;
      var o = Date.now();
      return function() {
    ...
    var handlers = {},
      signals = {};
    Util.on = null, Util.one = null, Util.emit = null, Util.inView = null;
    var InViewObserver = {
      elements: []
    };
    return InViewObserver.addElement = null, InViewObserver.removeElement = null, InViewObserver.observe = function(e, t) {
      e = +e || 0, t = +t || 1;
      var n = [],
        o = function() {
          InViewObserver.elements.forEach(null)
        };
  ...
  RFP.Common = RFP.Common || {}, RFP.Common.NetworkBase = function() {
    ...
    return e.makeCacheBuster = function() {
    ...
    }, e.sendRequest = null, e.sendBeaconRequest = null, e.callJsonAPI = function(t, n, o) {
      ...
      o.onload = function() {
        ...
        n(null, e)
      }, o.onerror = null, o.ontimeout = null, o.onprogress = function() {}, o.open("GET", t), o.withCredentials = !0, o.send()
    }, e.sendJSONPRequest = null, e._supportXHR2 = function() {
    ...
    }, e._buildJSONPCallbackName = null, e._buildScriptElement = null, e._appendScriptElement = null, e._buildJSONPCallback = null, e
  }();
  var RFP = window.RFP = window.RFP || {};
  RFP.Common = RFP.Common || {}, RFP.Common.NetworkAd = function() {
    ...
    return e.callSyncURLs = function(e) {
      if (e.hasOwnProperty("sync_urls") && 0 !== e.sync_urls.length) {
        var t = this;
        RFP.Common.Util.forEach(e.sync_urls, null)
      }
    }, e.buildAdRequestUrl = function(e) {
      var t = RFP.Common.Config;
      return t.protocol + "//" + t.host.ad + "/ad?" + e.join("&")
    }, e.buildImpRequestUrl = null, e.buildClickRequestUrl = null, e
  }();
  var RFP = window.RFP = window.RFP || {};
  RFP.Common = RFP.Common || {}, RFP.Common.AdInfoModelBase = function() {
    ...
    return e.prototype.store = null, e
  }();
  var RFP = void 0 === window.RFP ? {} : window.RFP;
  window.RFP = RFP, RFP.InFeed = void 0 === window.RFP.InFeed ? {} : window.RFP.InFeed, RFP.InFeed.Template = function() {
    ...
    var t = ["main_image_url", "displayed_advertiser", "tp_imp_urls", "vast_xml"],
      ...
      o = RFP.Common.Util;
    return o.inherits(e, RFP.Common.AdInfoModelBase), e.prototype.storeExtended = null, e.prototype.toObject = null, e.prototype.toObjectWithPublicParams = null, e
    ...
    }, e.prototype.toObject = null, e
  }(), RFP.InFeed.AdView = function() {
    
    var t = RFP.Common.Util;
    return e.prototype.show = null, e.prototype.buildHtmlDomList = null, e.prototype.swapTagToAd = null, e
    ...
    }, e.prototype.notifyImp = null, e.prototype.getLoadedAds = function() {
      return n.map(this.loaded_ads, null)
    }, e.prototype.getPlacementInfo = null, e.prototype.getRawRes = function() {
      return this.raw_res
    }, e.prototype.showAd = null, e
      ...
      if (v.length > 0) {
        ...
        for (n = 0; n < v.length && n < e.length; n++) {
          ...
          if (w && P) {
            ...
            C.addEventListener("ended", null), C.rfpAdView = s, m.InViewObserver.addElement(C)
          }
          s.showed && (d(I), p.options.viewable_impression ? (I.rfpNotifyImpression = null(o), m.InViewObserver.addElement(I)) : u.notifyImp(o))
        }
      } else {
        var A = u.getRawRes();
    ...
    return p._makeCallbackOfBeforeRender = null, p.run = function() {

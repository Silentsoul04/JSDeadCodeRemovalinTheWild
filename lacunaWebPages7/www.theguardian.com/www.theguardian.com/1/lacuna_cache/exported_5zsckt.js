    ...
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        (function(window) {
            ...
            if (!window.requestAnimationFrame) {
                ...
                window.requestAnimationFrame = function(callback, element) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[969:1359]", functionData => eval(functionData))}
            }
            if (!window.cancelAnimationFrame) window.cancelAnimationFrame = function(id) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[1463:1511]", functionData => eval(functionData))}
        })(window);
        (function(window, document) {
            ...
            function bindEvents() {
                ...
                document.addEventListener("keypress", function(event) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[2388:2604]", functionData => eval(functionData))}, true)
            }
        ...
        (function(documentElement, window, navigator) {
            ...
            function shimCSSSupports() {
                ...
                function cssToDOM(name) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[146544:146655]", functionData => eval(functionData))}

                function cssToDOMReplacer(str, m1, m2) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[146712:146780]", functionData => eval(functionData))}
                return function(prop, value) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[146826:147338]", functionData => eval(functionData))}
            }
        ...
        (function(window, document) {
            ...
            function loadFontsAsynchronously() {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[156009:156658]", functionData => eval(functionData))}

            function fontSmoothingEnabled() {
                try {
                    var saveFontSmoothing = function(state) {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[156788:157027]", functionData => eval(functionData))};
            ...
            function disableFonts() {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[158810:158909]", functionData => eval(functionData))}

            function enableFonts() {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[158946:159053]", functionData => eval(functionData))}
        ...
        function guardianPolyfilled() {
            ...
            function stateChange() {lacuna_lazy_load("lacuna_cache/exported_5zsckt.js[161622:161983]", functionData => eval(functionData))}

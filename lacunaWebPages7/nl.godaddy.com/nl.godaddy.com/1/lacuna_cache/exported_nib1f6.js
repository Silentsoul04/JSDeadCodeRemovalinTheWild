...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        return response.text();
            ...
            window.ux.fns = [];
            window.ux.ready = function uxReadyPreScriptsLoaded(fn) {lacuna_lazy_load("lacuna_cache/exported_nib1f6.js[200:255]", functionData => eval(functionData))};
            ...
            window.ux.eldorado.shopperData = function shopperDataPreQueue(fn) {lacuna_lazy_load("lacuna_cache/exported_nib1f6.js[534:738]", functionData => eval(functionData))};
            ...
            window.addEventListener('load', function loadDeferredScripts() {
                ...
                function handleLoadError() {lacuna_lazy_load("lacuna_cache/exported_nib1f6.js[1796:2579]", functionData => eval(functionData))}

...
function ensightenInit() {
  ...
  window[ensightenOptions.ns] || (window[ensightenOptions.registryNs] || (window[ensightenOptions.registryNs] = {}), window[ensightenOptions.registryNs][ensightenOptions.ns] = window[ensightenOptions.ns] = function(c) {
    ...
    l.ensightenOptions = ensightenOptions, l.scDataObj = {}, u.version = "1.26.0", u.nexus = c.nexus || "nexus.ensighten.com", u.rand = -1, u.currSec = (new Date).getSeconds(), u.options = {
    ...
    }, (e.prototype = new Error) || (e.prototype = {}), e.prototype.constructor = e, u.DependencyNotAvailableException = e, (t.prototype = new Error) || (t.prototype = {}), t.prototype.constructor = t, u.BeaconException = t, u.checkForInvalidDependencies = null, l.currentRuleId = -1, l.currentDeploymentId = -1, l.reportedErrors = [], l.reportedAlerts = [], l.AF = [], l._serverTime = "", l._clientIP = "", l.sampleBeacon = null, l.getServerComponent = function(e) {
      ...
      l.ensightenOptions.xhrJsonServerComponentRequest ? l.sendXhrRequest(t, null) : l.insertScript(t)
    }, l.setVariable = null, l.getVariable = null, l.testAll = function() {
    ...
    }, l.reportException = null, l.Rule = function(e) {
      ...
      return !1
    }, l.getAllDeploymentIds = null, l.getRunDeploymentIds = null, l.hasRuleRun = null, u.toTwoChar = null, l.Alert = null, l.generateAlert = null, l.imageRequest = null, l.addServerComponentData = function(e, t, n, o) {
      if (t) {
      ...
      _utf8_encode: null,
      _utf8_decode: null
    }, l.insertScriptEncoded = null, l.insertScript = null, l.loadScriptCallbackEncoded = null, l.loadScriptCallback = null, l.unobtrusiveAddEvent = null, l.anonymous = null, l.setCurrentRuleId = null, l.setCurrentDeploymentId = null, l.bindImmediate = function(e, t, n) {
      var i;
      ...
      l.registerRule(i)
    }, l.bindDOMLoaded = null, l.bindPageSpecificCompletion = null, l.bindOnGetServerComponent = null, l.bindDataDefinitionComplete = null, l.checkHasRun = null, l.bindDependencyImmediate = null, l.bindDependencyDOMLoaded = null, l.bindDependencyDOMParsed = null, l.bindDependencyPageSpecificCompletion = null, l.bindDependencyOnGetServerComponent = null, l.bindDependencyPageSpecificCompletion = null, l.dataDefintionIds = [], l.dataDefinitions = [], l.pageSpecificDataDefinitionsSet = !1, l.setPageSpecificDataDefinitionIds = null, l.DataDefinition = function(e, t) {
    ...
    }, l.callOnDataDefintionComplete = null, l.callOnDOMParsed = function() {
    ...
    }, l.callOnPageSpecificCompletion = null, l.callOnGetServerComponent = function() {
      window[ensightenOptions.ns].executionState.readyForServerComponent = !0, window[ensightenOptions.ns].testAll()
    }, l.hasDOMParsed = null, l.hasDOMLoaded = null, l.hasPageSpecificCompletion = null, l.sendXhrRequest = function(e, t, n) {
      var r = [function() {
    ...
    return l.new_fArray = null, u.timer = null,
      function() {
      ...
      }, 50) : document.addEventListener("DOMContentLoaded", l.callOnDOMParsed, !1), window.addEventListener("load", l.callOnDOMLoaded, !1)) : (setTimeout(null, 1), window.attachEvent("onload", null)), "true" === u.options.enableTagAuditBeacon && l.sampleBeacon() && window.setTimeout(null, 3e3), window.setInterval(l.testAll, u.options.interval), l
  }(ensightenOptions), "true" === ensightenOptions.enablePagePerfBeacon && window[ensightenOptions.ns] && window[ensightenOptions.ns].sampleBeacon() && window[ensightenOptions.ns].bindDOMParsed(null), window[ensightenOptions.ns].data || (window.JSON && "object" == typeof JSON || (window[ensightenOptions.ns].JSON = {}), function() {
    "use strict";
    ...
    "function" != typeof JSON.stringify && (JSON.stringify = null), "function" != typeof JSON.parse && (JSON.parse = null)
    ...
    return h.defer = function() {
      ...
      return (e = {
        ...
        }, e.reject = e.resolver.reject = null, e.notify = e.resolver.notify = null
      }), e
    }, h.resolve = s, h.reject = null, h.join = null, h.all = n, h.map = d, h.reduce = function(e, r) {
    ...
    }, h.any = null, h.some = c, h.isPromise = null, a.prototype = {
      otherwise: null,
      ensure: null,
      yield: null,
      spread: null,
      ...
      w(e, 0)
    }, m = (e = Function.prototype).call, g = e.bind ? m.bind(m) : null, f = (y = []).slice, p = y.reduce || null, h
  }(), function() {
    var o, r;
    ...
    o = window[ensightenOptions.ns].when, r = [].slice, o.apply = a, o.call = null, o.lift = e, o.bind = e, o.compose = null
    ...
    if (DataDefinitionException.prototype = new Error, DataDefinitionException.prototype || (DataDefinitionException.prototype = {}), DataDefinitionException.prototype.constructor = DataDefinitionException, _private.DataDefinitionException = DataDefinitionException, _private.checkForInvalidDataDefinitions = null, _private.collectAvailableDataDefinitions = null, _private.getSync = null, _private.dataDefinitions = {}, _private.dataDefinitionsBySourceCollName = {}, _public.defineEngine = function(e, t) {
      ...
      }, _public.all = null, _public.get = null, _private.getWait = null, _private.getWaitForKey = null, _public.set = null, _public.remove = null, _public.clear = null, _public.define = function(o, e) {
      ...
      }, _public.checkConditions = null, _public.triggerPromise = null, _public.timeoutPromise = null, _public.delayTrigger = null, _public.delayUntilTrigger = null, _private.applyTrigger = function(e) {
      ...
      }, _public.afterEnsightenCompleteTrigger = null, _public.afterElementsDownloadedTrigger = null, _public.getAllDataDefinitionsOnCurrentPage = null, _public.getAllDataDefinitionsOnCurrentPage_S_C_N = null, _public.getDataDefinitionById = null, _public.getDataDefinitionBySourceCollectionName = null, _public.getDataDefinitionByPercentSyntax = null, _public.resolve = null, _public.extract = null, void 0 === module) var module = {
        exports: {}
      },
    ...
    var r, a = {},
      ...
      s = "localStorage",
      n = "globalStorage",
      c = Array.isArray || null;
    a.set = null, a.get = null, a.remove = null, a.clear = null;
    try {
      if (s in e && e[s]) r = e[s], a.set = function(e, t) {
        ...
        return r.getItem(e)
      }, a.remove = null, a.clear = null, a.all = null;
      else if (n in e && e[n]) r = e[n][e.location.hostname], a.set = null, a.get = null, a.remove = null, a.clear = null, a.all = null;
        ...
        a.set = u(null), a.get = u(null), a.remove = u(null), a.clear = u(null), a.all = u(null)
      }
    } catch (e) {}
    var p, f = {};
    for (p in a) f[p] = a[p];
    return f.testStorage = null, a.utils = f, window[ensightenOptions.ns].data.local = a
  }()), window[ensightenOptions.ns].data.defineEngine("cookie", (vo = document, xo = null, yo = xo.utils = {
    isArray: Array.isArray || null,
    isPlainObject: window[ensightenOptions.ns].data.utils.isPlainObject,
    toArray: null,
    getKeys: Object.keys || null,
    escape: function(e) {
      return String(e).replace(/[,;"\\=\s%]/g, null)
    },
  ...
  }, xo.set = null, xo.remove = null, xo.clear = null, xo.get = null, xo.all = null, xo.utils = yo, window[ensightenOptions.ns].data.cookie = xo))), window[ensightenOptions.ns].ensEvent || (window[ensightenOptions.ns].ensEvent = (lp = window, op = {
    queue: {},
    pollQueue: {},
    pushTrigger: null,
    callTrigger: null,
    ...
    var V, G = "compareDocumentPosition" in n ? null : "contains" in n ? null : null,
      $ = ((V = s.createElement("p")).innerHTML = '<a href="#x">x</a>') && "#x" != V.firstChild.getAttribute("href") ? null : null,
      X = !!s[c],
    ...
    return Q({
      useNativeQSA: !0
    }), F.configure = Q, F.uniq = M, F.is = null, F.pseudos = {}, F
  }(), function() {
    var s, d = 0,
      i = 0,
      p = {},
    ...
    v.prototype.on = null, v.prototype.off = null, v.cancel = null, v.addEvent = null, v.matchesEvent = null, v.load = null, window[ensightenOptions.ns].Delegate = v
  }(), cv = window[ensightenOptions.ns].Delegate, dv = cv.addEvent, cv.addEvent = null, cv.cancel = null, window[ensightenOptions.ns].on = window[ensightenOptions.ns].Delegate), Bootstrapper.dataDefinitionIds = [45161, 44907, 44908, 44909, 19470, 44911, 52335, 44912, 19472, 44913, 11505, 11506, 45724], Bootstrapper.bindImmediate(function() {
    ...
    t.Cookies = {
      ...
      watchers: []
    }).options = {}, i.options.interval = i.options.interval || 50, i.Watcher = null, i.doChecks = function() {
    ...
    var t = window.Bootstrapper;
    t.ensightenOptions;
    t.ensEvent.overrides = t.ensEvent.overrides || {}, t.ensEvent.overrides.evt_queue = {}, t.ensEvent.overrides.sitvs = {}, t.ensEvent.overrides.evt_processor = null, t.ensEvent.overrides.custom_delegator = null

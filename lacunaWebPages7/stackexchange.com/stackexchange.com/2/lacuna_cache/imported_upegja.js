/*! jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license */ ! function(a, b) {
  ...
  var t = function(a) {
    ...
    }, fa.matches = function(a, b) {}, fa.matchesSelector = function(a, b) {}, fa.contains = function(a, b) {}, fa.attr = function(a, b) {}, fa.error = function(a) {}, fa.uniqueSort = function(a) {}, e = fa.getText = function(a) {}, d = fa.selectors = {
      cacheLength: 50,
      createPseudo: ha,
      match: W,
      attrHandle: {},
  ...
  n.extend({
    ...
    ajax: function(b, c) {
      ...
      if (j = Ub(Pb, l, c, w)) {
        ...
        l.async && l.timeout > 0 && (h = a.setTimeout(function() {}, l.timeout));
        try {
          u = 1, j.send(s, y)
        } catch (x) {
          if (!(2 > u)) throw x;

...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        return response.text();
                        ...
                        (function() {
                            function a(d, e) {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[84:500]", functionData => eval(functionData))}

                            function c(d, e) {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[547:969]", functionData => eval(functionData))}
                            var b = function() {
                                (function() {
                                    (function(j, n) {
                                        j.sfLogErrors = j.sfLogErrors || false;
                                        var p = p || function(t, s) {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[1267:2501]", functionData => eval(functionData))};
                                        ...
                                        var f = function() {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[3345:3487]", functionData => eval(functionData))};
                                        throttle = function(t, v, z) {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[3558:5997]", functionData => eval(functionData))};
                                        ...
                                        try {
                                            ...
                                            if (j.apeViewableLatencyTrackers[i].valid && !j.apeViewableLatencyTrackers[i].viewed) {
                                                j.apeViewableLatencyTrackers[i].tracker = throttle(function() {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[10515:10633]", functionData => eval(functionData))}, 20);
                                        ...
                                        try {
                                            ...
                                            if (m) {
                                                ...
                                                o.onerror = function() {lacuna_lazy_load("lacuna_cache/exported_x9f3s3.js[12400:12541]", functionData => eval(functionData))};

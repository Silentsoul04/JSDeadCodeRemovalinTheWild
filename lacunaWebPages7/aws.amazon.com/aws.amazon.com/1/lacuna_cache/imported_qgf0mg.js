...
(function() {
  ...
  if (typeof window === "object" && typeof window.document === "object") {
    if (!window.console) {
      console = {
        log: function() {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[6392:6394]", functionData => eval(functionData))}
      }
    }
  }
  var Logger = function() {
...
(function() {
  ...
  DA._DA = {
    debounceWindowEvent: function(func, eventName, timeout, context) {
      ...
      var count = 0;
      $(window).on(eventName, function() {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[8822:8986]", functionData => eval(functionData))})
    },
...
(function() {
  ...
  DA.ElementUtils = {
    ...
    isReportableLink: function(url) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[11511:11693]", functionData => eval(functionData))},
...
(function() {
  ...
  DA.EventUtils = {
    ...
    isRightClick: function(e) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[15045:15126]", functionData => eval(functionData))}
  };
...
(function() {
  ...
  (function() {
    ...
    DA.Decorators.noRepeatData = function(event, $elem, logger) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[15353:16260]", functionData => eval(functionData))}
  })();
  DA.Decorators.inViewport = function(event, $elem, logger, options) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[16338:17511]", functionData => eval(functionData))};
...
(function() {
  ...
  DA.Validator = {
    ...
    isValidSetterKey: function(str) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[17932:17988]", functionData => eval(functionData))},
    ...
    validateSetters: function(setters, ruleSetName) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[18242:18506]", functionData => eval(functionData))},
    validateSetter: function(setter, ruleSetName) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[18558:19080]", functionData => eval(functionData))}
  };
...
(function() {
  ...
  DA.Controller = {
    ...
    updateLogic: function(logic) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[20556:20673]", functionData => eval(functionData))},
    ...
    listenToViewportTriggerEvents: function() {
      ...
      this.logic.viewportTriggerEvents.forEach(function(eventName) {
        $(document).on(eventName, function() {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[21359:21478]", functionData => eval(functionData))})
      })
    },
    ...
    resolveCSSAspect: function(aspect) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[22678:22977]", functionData => eval(functionData))},
      ...
      for (var i = 0, len = elems.length; i < len; i++) {
        (function(i) {
          ...
          if (!AWS.DA.EventUtils.setElementEventRelationship($elem, event)) {
            ...
            var cb = function() {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[26422:26480]", functionData => eval(functionData))};
    ...
    setupCustomEvent: function(event) {
      ...
      if (!AWS.DA.EventUtils.setElementEventRelationship($("body"), event)) {
        $(document).on(event.customEventName, function(e) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[28374:29040]", functionData => eval(functionData))})
      }
    },
    runConditionChain: function(event, $elem, cb) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[29107:30086]", functionData => eval(functionData))},
    createCustomFunction: function(fct) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[30128:30902]", functionData => eval(functionData))},
    setClickHandler: function($elem, notSelector, explicitUrlAttr, cb) {
      var that = this;
      var isClickHandled = false;
      var processClick = function($closestLink, attrName) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[31092:31674]", functionData => eval(functionData))};
      $elem.on("click.aws-da, mouseup.aws-da", function(e) {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[31735:32661]", functionData => eval(functionData))})
    },
    ...
    watchScroll: function() {
      ...
      AWS.DA._DA.debounceWindowEvent(function() {lacuna_lazy_load("lacuna_cache/imported_qgf0mg.js[40888:40933]", functionData => eval(functionData))}, "scroll", 40, this)
    },

/*! adobe-globalnav - v1.0.34 - 09-16-2019, 1:44:24 AM
    ...
    ! function(t, n) {
        ...
        function(e, t, n) {
            ...
            i = function() {
                ...
                return a.dispatchEvent = function(e) {
                ...
                }, a.bypassConsent = function() {
                    var t = window.location.search.indexOf(e.strings.bypassConsent) > -1,
                        n = ".adobe.com",
                        i = new Date;
                    t && "undefined" == typeof o.getValue(e.privacy.cookieName) && (i.setMonth(i.getMonth() + e.privacy.cookieTime), o.setValue(e.privacy.cookieName, (new Date).toISOString(), {
                        expiration: i,
                        domain: n,
                        path: "/"
                    }, !0))
                    ...
                    var o, r, l, c = e.privacy.id,
                        u = e.privacy.country;
                    a.bypassConsent(), a.overrideEndpointsConfig(t), o = e.privacy.cdn, r = o + e.privacy.notice, window.evidon = window.evidon || {}, window.evidon.id = c, window.evidon.test = window.location.search.indexOf(e.strings.testNotice) > -1, s.log("test notice", window.evidon.test), window.evidon.priorConsentCallback = function() {
        ...
        function(e, t) {
            ...
            return s.isConfigurationReady = function() {
                ...
                var t = ["onReady", "onError", "openExistingChat", "closeExistingChat", "chatState", "getContext"];
                ...
                o = n.getParamValuesFromCookie({
                    ...
                    callbacks: {
                        ...
                        chatStateCallback: function(e) {
                            i.isFunction(s.config.chatState) && s.config.chatState.apply(null, [e])
                        },
                        getContextCallback: function() {
                            if (i.isFunction(s.config.getContext)) return s.config.getContext.apply(null, [])
                        }
                    }
            ...
            return I.getAuthoredContent = function(e, t) {
                ...
                t = document.querySelector(o.primaryNavigation.navigation), t instanceof HTMLElement && (n = parseInt(window.getComputedStyle(t).getPropertyValue("max-width")), n && t.scrollWidth > n && t.classList.add(o.modifiers.isLarge), I.setKeyboard(), I.setSearch(e.locale), i = a.mergeObjects(e.theme, I.globalnavTheme), I.setTheme(i), I.flags.initProfile && (l.theme = I.getProfileTheme(e), l.localMenu = a.getPropertySafely(e, "profile.localMenu"), s = e.signIn, I.initProfile(l, s)), I.flags.initPrompt && I.initPrompt(), u.init({
                    ...
                    onInstantDownScroll: function() {
                        r = document.querySelector(o.primaryNavigation.sticky), r instanceof HTMLElement && ((1 === r.children.length && window.pageYOffset > r.offsetHeight || r.children.length > 1) && r.classList.add(o.modifiers.isRetracted), r.classList.add(o.modifiers.isScrolled)), I.keyboard.index >= 0 && (I.keyboard.closePopups(),

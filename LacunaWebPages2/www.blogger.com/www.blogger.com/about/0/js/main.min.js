...
window.onYouTubeIframeAPIReady = function() {
    ...
    event.initEvent("TCYoutubeReady", true, false);
...
(function() {
    ...
    var v = Array.prototype.indexOf ? function(a, b, c) {
        ...
        w = Array.prototype.forEach ? function(a, b, c) {
            ...
            for (var d = a.length, f = n(a) ? a.split("") : a, e = 0; e < d; e++) e in f && b.call(c, f[e], e, a)
        },
    ...
    (function() {
        ...
        G.Fa = function(a, c, d) {
            for (var b = Array(arguments.length - 2), e = 2; e < arguments.length; e++) b[e - 2] = arguments[e];
    ...
    G.prototype.a = function(a, b) {
        ...
        null === d ? (this.offsetX = B || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = B || void 0 !== a.offsetY ? a.offsetY : a.layerY, this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX,
    ...
    G.prototype.preventDefault = function() {
        ...
        else if (a.returnValue = !1, wa) try {
    ...
    H.prototype.add = function(a, b, c, d, f) {
        ...
        a = this.b[e];
        a || (a = this.b[e] = [], this.K++);
        var g = Ba(a, b, d, f); - 1 < g ? (b = a[g], c || (b.M = !1)) : (b = new za(b, this.src, e, !!d, f), b.M = c, a.push(b));
        return b
    };
    ...
    function Ca(a, b) {
        ...
        if (c in a.b) {
            ...
            e && (Aa(b), 0 == a.b[c].length && (delete a.b[c], a.K--))
        }
    }
    H.prototype.hasListener = function(a, b) {
        ...
        return ma(this.b, function(a) {
            for (var e = 0; e < a.length; ++e)
                if (!(c && a[e].type != d || f && a[e].F != b)) return !0;
            return !1
        })
    };
    ...
    function Ba(a, b, c, d) {
        for (var f = 0; f < a.length; ++f) {
            var e = a[f];
            if (!e.w && e.listener == b && e.F == !!c && e.P == d) return f
        }
        return -1
    };
    ...
    function I(a, b, c, d, f) {
        if ("array" == m(b))
            for (var e = 0; e < b.length; e++) I(a, b[e], c, d, f);
        else if (c = Ga(c), a && a[xa]) a.ta.add(String(b), c, !1, d, f);
        else {
            ...
            if (!c.I) {
                ...
                d.src = a;
                d.listener = c;
                if (a.addEventListener) a.addEventListener(b.toString(), d, e);
                else if (a.attachEvent) a.attachEvent(Ja(b.toString()), d);
    ...
    function Ma(a, b) {
        ...
        if (a.M && !p(a) && a && !a.w) {
            ...
            if (f && f[xa]) Ca(f.ta, a);
                ...
                Fa--;
                (e = Ha(f)) ? (Ca(e, a), 0 == e.K && (e.src = null, f[Da] = null)) : Aa(a)
            }
        }
        return c.call(d, b)
    }
        ...
        if (!va) {
            ...
            if (!(0 > f.keyCode || void 0 != f.returnValue)) {
                a: {
                    ...
                    if (e || void 0 == f.returnValue) f.returnValue = !0
                }
                f = [];
                for (e = c.currentTarget; e; e = e.parentNode) f.push(e);
                for (var e = a.type, g = f.length - 1; !c.X && 0 <= g; g--) {
                    c.currentTarget = f[g];
                    var k = La(f[g], e, !0, c),
                        d = d && k
                }
                for (g = 0; !c.X && g < f.length; g++) c.currentTarget =
                    f[g],
                k = La(f[g], e, !1, c),
                d = d && k
            }
    ...
    h.translate = function(a, b) {
        a instanceof K ? (this.x += a.x, this.y += a.y) : (this.x += Number(a), p(b) && (this.y += b));
        return this
    };
    ...
    function Oa(a, b, c) {
        ...
        if (c.querySelectorAll && c.querySelector && (f || b)) return c.querySelectorAll(f + (b ? "." + b : ""));
        if (b && c.getElementsByClassName) {
            a = c.getElementsByClassName(b);
            if (f) {
                c = {};
                for (var e = d = 0, g; g = a[e]; e++) f == g.nodeName && (c[d++] = g);
                c.length = d;
                return c
            }
            return a
        ...
        if (b) {
            ...
            for (e = d = 0; g = a[e]; e++) {
                var f = g.className,
                    k;
                if (k = "function" == typeof f.split) k = 0 <= v(f.split(/\s+/), b);
                k && (c[d++] = g)
            }
            c.length = d;
            return c
    ...
    function Ua(a, b, c, d) {
        if (null != a)
            for (a = a.firstChild; a;) {
                if (b(a) && (c.push(a), d) || Ua(a, b, c, d)) return !0;
                a = a.nextSibling
            }
        return !1
    }
    ...
    function Wa(a, b) {
        var c;
        a.classList ? c = a.classList.contains(b) : (c = Va(a), c = 0 <= v(c, b));
        return c
    }
    ...
    function Za(a) {
        var b = a.offsetWidth,
            c = a.offsetHeight,
            d = B && !b && !c;
        return (void 0 === b || d) && a.getBoundingClientRect ? (a = Xa(a), new L(a.right - a.left, a.bottom - a.top)) : new L(b, c)
    };
    var $a = !z;
    ...
    S.prototype.m = function() {
        this.B && this.B && (l.clearTimeout(this.B), this.B = null);
    ...
    V.prototype.f = function(a) {
        ...
        b = b.replace(c, "");
        c = document;
        if (b = n(b) ? c.getElementById(b) : b) a.preventDefault(), c = O(b), a = new K(0, 0), d = c ? O(c) : document, d = !z || 9 <= Number(ua) || "CSS1Compat" == (d ? new P(O(d)) : t || (t = new P)).u.compatMode ? d.documentElement : d.body, b != d && (b = Xa(b), c = Qa((c ? new P(O(c)) : t || (t = new P)).u), a.x = b.left + c.x, a.y = b.top + c.y), ab(this.ka, null, a.y - this.ea, this.Ea,
            null), this.ka.play()
    };
    ...
    function eb(a) {
        a.l && a.c >= a.A || !a.l && a.c <= a.A || (a.c >= a.A ? a.l || (a.l = !0, Q(a.da, "header--sticky")) : a.l && (a.l = !1, R(a.da, "header--sticky")))
    }
    ...
    gb.prototype.a = function() {
        ...
        if (!this.o) return console.log("Error: No hero themes found");
        for (var a = 0, b = 0, c = this.o.length; b < c; b++) Wa(this.o[b], "active") && (a = b);
        this.h();
        hb(this, a)
    };
    ...
    function kb(a) {
        return Ta(a.g, function(a) {
            if ("OPTION" === a.nodeName) return !!a.selected
        })
    }
    ...
    Y.prototype.sa = function(a) {
        ...
        a && (b && this.Y("Language Toggler: Navigating to: " + b), a.target.value && J(function() {
    ...
    mb.prototype.a = function() {
        ...
        this.xa.a();
        var a = N("header");
        a && (this.oa = new X(a, 64), this.oa.a());
        N("hero") && (this.ga = new gb, this.ga.a());
        this.ma = new fb;
        this.ma.a();
        N("js-language-switch") && (this.ha = new Y, this.ha.a())
    };
    (new mb).a();
}());
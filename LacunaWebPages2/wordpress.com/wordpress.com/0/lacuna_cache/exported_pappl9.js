        ...
        (function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 10, 5283);
            'use strict';

            var html = document.documentElement;

            var extend = function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 125, 699);
                var args = [].slice.call(arguments);

                var obj0 = args.slice(0, 1)[0] || {};
                obj0 = 'object' === typeof obj0 ? obj0 : {};

                args.slice(1).forEach(function(_obj) {___jdce_logger("lacuna_cache/exported_pappl9.js", 346, 653);
            ...
            window.a8cGAOptimize = window.a8cGAOptimize || {
                ...
                push: function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 1371, 1462);
                    a8cGAOptimize.dataLayer.push(arguments);
                },

                isEnabled: function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 1492, 1610);
                    return !!(a8cGAOptimize.config.id && a8cGAOptimize.config.enabled);
                },

                startAsyncDim: function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 1644, 2595);
                    ...
                    a8cGAOptimize.refs.asyncDimInterval = setInterval(function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 2307, 2570);
                ...
                endAsyncDim: function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 2627, 3214);
                    ...
                    setTimeout(function() {___jdce_logger("lacuna_cache/exported_pappl9.js", 3071, 3191);
                        html.className = html.className.replace(/\s?async-dim/g, '');
                    }, 0);
                },

                a8cAnalyticsSetup: function(kit, config) {___jdce_logger("lacuna_cache/exported_pappl9.js", 3252, 3889);
                ...
                a8cAnalyticsExpStart: function(variationId, experimentId) {___jdce_logger("lacuna_cache/exported_pappl9.js", 3930, 5150);

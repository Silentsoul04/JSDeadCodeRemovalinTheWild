            ...
            (function($) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 14, 19636);
                'use strict';
                if (!$) return; // No jQuery.

                var $document = $(window.document);

                function getWPCOMAnalyticsDefaultConfig() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 174, 707);
                    return {
                ...
                $document.on('a8c-analytics:loaded', function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 762, 19620);
                    ...
                    function fireTracks() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 1492, 1934);
                    ...
                    function fireAffiliateReferrals() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 1956, 2179);
                    ...
                    function loadGoogleAdsGtag() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 2201, 2307);
                        kit.loadGtag('AW-946162814');
                    }

                    function fireGoogleAnalytics() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 2329, 3321);
                        ...
                        ga(function(tracker) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 2867, 3043);
                    ...
                    function fireFacebook() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 3343, 3540);
                        kit.loadFacebook();
                        fbq('init', '823166884443641');
                        fbq('track', 'PageView');
                    }

                    function fireQuantcast() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 3562, 4444);
                        // P-Code: p-3Ma3jHaQMB_bS
                        // Label: _fp.event.Default
                        window._qevents = window._qevents || [];
                        (function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 3782, 4297);
                    ...
                    function fireOutbrain() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 4466, 5685);
                        ! function(_window, _document) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 4518, 5591);
                            var OB_ADV_ID = '00f0f5287433c2851cc0cb917c7ff0465e';
                            if (_window.obApi) {
                                return;
                            }
                            var api = _window.obApi = function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 4804, 4957);
                    ...
                    function fireYahooGeminiOath() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 5707, 6062);
                    ...
                    function fireBing() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 6084, 7044);
                        (function(w, d, t, r, u) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 6131, 6900);
                            var f, n, i;
                            w[u] = w[u] || [], f = function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 6249, 6503);
                                var o = {
                                    ti: "4074038"
                                };
                                o.q = w[u], w[u] = new UET(o), w[u].push("pageLoad")
                            }, n = d.createElement(t), n.src = r, n.async = 1, n.onload = n.onreadystatechange = function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 6587, 6807);
                    ...
                    function fireAdRoll() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 7066, 7501);
                    ...
                    function fireTwitter() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 7523, 7708);
                        kit.loadTwitter();
                        twq('init', 'nvzbs');
                        twq('track', 'PageView');
                    }

                    function fireLinkedIn() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 7730, 8319);
                        window._linkedin_data_partner_id = "195308";
                        (function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 7850, 8293);
                    ...
                    function fireDCMFloodlight() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 8341, 8691);
                    ...
                    function fireDCMFloodlightEvents(tracksAnonId) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 8713, 9949);
                    ...
                    function fireDCMFloodlightEventsGTM(tracksAnonId) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 9971, 10262);
                        window.dataLayer.push({
                    ...
                    function fireExperianAddressableTV() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 10284, 10710);
                        (function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 10348, 10684);
                    ...
                    function fireIconMedia() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 10732, 11099);
                    ...
                    function firePinterest() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 11121, 11329);
                        kit.loadPinterest();
                        window.pintrk('load', '2613194105266', {});
                        window.pintrk('page');
                    }

                    function fireClickCease() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 11351, 12280);
                    ...
                    function setupTracksClickTracking() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 12302, 15456);
                        $('body').on('click', 'a, .click-tracking-enable', function(event) {___jdce_logger("lacuna_cache/exported_48n9vw.js", 12415, 15432);
                            ...
                            if (props.is_in_header_nav || props.is_cta || props.is_button) {
                                if (props.href && 0 !== props.href.indexOf('#') && -1 !== ['', '_top', '_self'].indexOf(props.target)) {
                                    ...
                                    setTimeout(function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 15213, 15335);
                    ...
                    function applyLinkers() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 15478, 16551);
                        kit.linkQueryVars([{
                                includeRegExps: [
                    ...
                    $document.on('a8c-analytics:fire-sensitive-pixels', function() {___jdce_logger("lacuna_cache/exported_48n9vw.js", 17189, 19601);

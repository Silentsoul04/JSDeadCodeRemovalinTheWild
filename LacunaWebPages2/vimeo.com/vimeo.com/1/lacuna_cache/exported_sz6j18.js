                ...
                function completeUserLogin(response) {___jdce_logger("lacuna_cache/exported_sz6j18.js", 117, 301);
                    if (response && !response.signup) {
                        window.location.reload();
                    }
                }

                function handleUploadButtonClick(event) {___jdce_logger("lacuna_cache/exported_sz6j18.js", 319, 932);

...
(function(window, document){___jdce_logger("lacuna_cache/exported_bcjv4b.js", 2, 8567);
    ...
    desktop.addEventListener('touchstart', function(e){___jdce_logger("lacuna_cache/exported_bcjv4b.js", 405, 707);
    ...
    desktop.addEventListener(listen, function(e){___jdce_logger("lacuna_cache/exported_bcjv4b.js", 931, 1146);
    ...
    Vimeo.desktop_shared._upload = function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 1247, 2114);
        ...
        if (/iPad|iPhone|iPod/.test(navigator.userAgent)){
            ...
            // Callbacks
            webkitHiddenCallback = function() {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 1610, 1812);
            ...
            hitCallback = function() {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 1882, 2006);
...
// ===================================================================
    ...
    Vimeo.desktop_shared._s2ds = function() {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 2322, 2479);
        document.cookie='opt_out_mobile=1;expires=Fri, 31 Dec 9999 23:59:59 GMT;domain=' + vimeo.domain;
        window.location.reload();
    };

    // Switch to language
    Vimeo.desktop_shared._s2l = function(sel) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 2540, 3035);
        var lang = sel.value,
        ...
        xhr.onload = function post() {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 2907, 3028);
            if (xhr.status === 200) {
                window.location.reload();
            }
        };
    ...
    function checkForMobileMenuExperiment() {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 3118, 3796);
    ...
    if (mobileMenuEle) {
        mobileMenuEle.addEventListener('click', function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 3952, 5670);
            ...
            mobile_header_close.addEventListener('click', function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 4511, 4668);
                e.stopPropagation();
                e.preventDefault();
            ...
            topnav2015_mobile_header_settings.addEventListener('click', function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 4986, 5657);
                e.stopPropagation();
                e.preventDefault();
                ...
                topnav2015_mobile_header_settings_close.addEventListener('click', function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 5402, 5641);
                    e.stopPropagation();
                    e.preventDefault();
    ...
    if (mobileAlbumsEle) {
        mobileAlbumsEle.addEventListener('click', function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 5850, 6502);
            e.stopPropagation();
            e.preventDefault();
            ...
            if (mobile_albums_close) {
                mobile_albums_close.addEventListener('click', function(e) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 6299, 6476);
                    e.stopPropagation();
                    e.preventDefault();
...
// ===================================================================
    ...
    // items on the page.
    setTimeout(function(){___jdce_logger("lacuna_cache/exported_bcjv4b.js", 6927, 8557);
         // DOM Elements
        ...
        avatar.addEventListener('mouseover', function() {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 7665, 7956);
            if (on_hover) return;
        ...
        function store_user_message_settings(value) {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 8059, 8549);
            ...
            xhr.onload = function () {___jdce_logger("lacuna_cache/exported_bcjv4b.js", 8524, 8538);};
        };

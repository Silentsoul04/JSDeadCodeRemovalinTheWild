        ...
        (function() {___jdce_logger("lacuna_cache/exported_19gvxy.js", 10, 4196);

            if (document.cookie.match(/^(.*;)?\s*vimeo_gdpr_optin\s*=\s*[^;]+(.*)?$/)) {
                return;
            }

            var handleGDPR = function() {___jdce_logger("lacuna_cache/exported_19gvxy.js", 181, 3964);
                ...
                var _log = function(args) {___jdce_logger("lacuna_cache/exported_19gvxy.js", 2702, 3318);
                    var parts = [],
                        url = '/ablincoln/fatal_attraction?';
                    Object.keys(args).forEach(function(key) {___jdce_logger("lacuna_cache/exported_19gvxy.js", 2863, 2999);
                ...
                var gdprOptIn = function(event) {___jdce_logger("lacuna_cache/exported_19gvxy.js", 3352, 3854);

this.workbox = this.workbox || {}, this.workbox.precaching = function(e, t, n, r, s) {
    "use strict";
    try {
    ...
    class i {
        ...
        i(e) {
            ...
            if ("cache" in Request.prototype) n.cache = "reload";
                ...
                e.search += (e.search ? "&" : "") + n("_workbox-cache-bust") + "=" + n(this.n), t = e.toString()
            }
    ...
    class a {
        constructor(t) {
            ...
            this.c = new e.DBWrapper(n, 2, {
                onupgradeneeded: this.o
            })
        }
        o(e) {
            const t = e.target.result;
            e.oldVersion < 2 && (t.objectStoreNames.contains("workbox-precaching") && t.deleteObjectStore("workbox-precaching"), t.objectStoreNames.contains(l) && t.deleteObjectStore(l)), t.createObjectStore(l)
        }
        l(e, t) {
            var n = this;
            return babelHelpers.asyncToGenerator(function*() {
                return (yield n.a(t.t)) === t.n && !!(yield(yield caches.open(e)).match(t.r))
            })()
        }
        u() {
            var e = this;
            return babelHelpers.asyncToGenerator(function*() {
                return yield e.c.getAllMatching(l, {
                    includeKeys: !0
                })
            })()
        }
    ...
    const u = (d = babelHelpers.asyncToGenerator(function*(e) {
        const t = e.clone(),
    ...
    class h {
        ...
        b(e) {
            ...
            if (t) {
                if (t.n !== e.n) throw new n.WorkboxError("add-to-cache-list-conflicting-entries", {
                    firstEntry: t.e,
                    secondEntry: e.e
                })
        ...
        install({
            suppressWarnings: e = !1,
            event: t,
            plugins: n
        } = {}) {
            var r = this;
            return babelHelpers.asyncToGenerator(function*() {
                const e = yield caches.open(r.g()), s = yield e.keys();
                yield Promise.all(s.map(function(t) {
                    return e.delete(t)
                }));
                const i = [],
                    c = [];
                for (const e of r.f.values())(yield r.y.l(r.p, e)) ? c.push(e) : i.push(e);
                return yield Promise.all(i.map(function(e) {
                    return r.m({
                        event: t,
                        plugins: n,
                        precacheEntry: e
        ...
        activate(e = {}) {
            var t = this;
            return babelHelpers.asyncToGenerator(function*() {
                const n = yield caches.open(t.g()), r = yield n.keys();
                for (const i of r) {
        ...
        m({
            ...
            return babelHelpers.asyncToGenerator(function*() {
                ...
                return c.redirected && (c = yield u(c)), yield s.cacheWrapper.put({
                    cacheName: i.g(),
                    request: e.r,
                    response: c,
                    event: t,
        ...
        R() {
            ...
            return babelHelpers.asyncToGenerator(function*() {
                ...
                return {
                    deletedCacheRequests: n,
                    deletedRevisionDetails: r
                }
            })()
        }
        _(e) {
            ...
            return babelHelpers.asyncToGenerator(function*() {
                ...
                const n = yield caches.open(t.p), r = (yield n.keys()).filter(function(t) {
                    return !e.includes(new URL(t.url, location).toString())
                });
                return yield Promise.all(r.map(function(e) {
                    return n.delete(e)
                })), r.map(function(e) {
                    return e.url
                })
        ...
        U(e) {
            ...
            return babelHelpers.asyncToGenerator(function*() {
                ...
                return yield Promise.all(n.map(function(e) {
    ...
    const g = t.cacheNames.getPrecacheName(),
        ...
        m = (e, {
            ...
            for (const e of o)
                if (-1 !== l.indexOf(e.href)) return e.href;
            return null
        },
        R = {
            precache: e => {
                v.addToCacheList(e), f || e.length <= 0 || (f = !0, self.addEventListener("install", e => {
                    e.waitUntil(v.install({
                        event: e,
                        plugins: w,
                        suppressWarnings: b
                    }))
                }), self.addEventListener("activate", e => {
                    e.waitUntil(v.activate({
                        event: e,
                        plugins: w
                    }))
                }))
            ...
            addRoute: e => {
                y || (y = !0, self.addEventListener("fetch", t => {

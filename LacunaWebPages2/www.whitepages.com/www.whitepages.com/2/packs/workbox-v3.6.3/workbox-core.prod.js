self.babelHelpers = {
    ...
    const n = e => r <= e,
        ...
        l = function(r, o, i) {
            ...
            const s = ["%cworkbox", `background: ${i}; color: white; padding: 2px 0.5em; ` + "border-radius: 0.5em;"];
            console[r](...s, ...o)
        },
        s = () => {
    ...
    var f, d;
    Object.keys(a).forEach(e => (e = e, d = a[e], u[e] = ((...t) => l(e, t, d)), void(u.unprefixed[e] = ((...t) => l(e, t)))));
    const h = (e, ...t) => {
        let r = e;
    ...
    class v {
        ...
        open() {
            ...
            return babelHelpers.asyncToGenerator(function*() {
                if (!e.o) return e.o = yield new Promise(function(t, r) {
                    let n = !1;
                    setTimeout(function() {
        ...
        deleteDatabase() {
            var e = this;
            return babelHelpers.asyncToGenerator(function*() {
                e.close(), e.o = null, yield new Promise(function(t, r) {
        ...
        getAll(e, t, r) {
            var n = this;
            return babelHelpers.asyncToGenerator(function*() {
                return "getAll" in IDBObjectStore.prototype ? yield n.i("getAll", e, "readonly", t, r): yield n.getAllMatching(e, {
                    query: t,
                    count: r
                })
            })()
                ...
                return yield r.transaction([e], "readonly", function(r, n) {
                    ...
                    i.openCursor(l, s).onsuccess = function(e) {
                        ...
                        if (r) {
                            ...
                            c.push(t.includeKeys ? {
                                primaryKey: e,
                                key: o,
                                value: i
                            } : i), t.count && c.length >= t.count ? n(c) : r.continue()
                        } else n(c)
                    }
                })
            })()
        ...
        transaction(e, t, r) {
            var n = this;
            return babelHelpers.asyncToGenerator(function*() {
                return yield n.open(), yield new Promise(function(o, i) {
    ...
    const k = e => {
        ...
        D = (() => {
            var e = babelHelpers.asyncToGenerator(function*({
                ...
                if (!r) throw new p("cache-put-with-no-response", {
                    url: k(t.url)
                });
                let i = yield P({
                    request: t,
                ...
                if (!i) return;
                const c = yield caches.open(e), l = O(o, E);
                let s = l.length > 0 ? yield R({
                    cacheName: e,
                    request: t
                }): null;
                try {
                ...
                for (let r of l) yield r[E].call(r, {
                    cacheName: e,
                    request: t,
                    event: n,
                    oldResponse: s,
        ...
        R = (A = babelHelpers.asyncToGenerator(function*({
            ...
            for (let c of o) x in c && (i = yield c[x].call(c, {
                cacheName: e,
                request: t,
                event: r,
                matchOptions: n,
    ...
    const P = (W = babelHelpers.asyncToGenerator(function*({
        ...
        let o = t,
            i = !1;
        for (let t of n)
            if (L in t && (i = !0, !(o = yield t[L].call(t, {
                    request: e,
                    response: o,
                    event: r
                })))) break;
        ...
        _ = {
            fetch: (() => {
                var e = babelHelpers.asyncToGenerator(function*({
                    ...
                    try {
                        for (let t of n) N in t && (e = yield t[N].call(t, {
                            request: e.clone(),
                            event: r
                        }))
                    } catch (e) {
                    ...
                    try {
                        ...
                        for (let t of o) yield t[H].call(t, {
                            error: e,
                            event: r,
    ...
    var B = new class {
        ...
        setLogLevel(t) {
            if (t > e.silent || t < e.debug) throw new p("invalid-value", {
                paramName: "logLevel",

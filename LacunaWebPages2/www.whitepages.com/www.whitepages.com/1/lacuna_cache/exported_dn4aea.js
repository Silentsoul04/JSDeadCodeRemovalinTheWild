        ...
        //<![CDATA[
        $(function() {___jdce_logger("lacuna_cache/exported_dn4aea.js", 31, 2237);
            if (dfpAdSlots.length > 0) {
                googletag.cmd.push(function() {___jdce_logger("lacuna_cache/exported_dn4aea.js", 120, 1902);
                    ...
                    dfpAdSlots.forEach(function(slot) {___jdce_logger("lacuna_cache/exported_dn4aea.js", 1788, 1882);
                ...
                apstag.fetchBids({
                    slots: dfpAdSlots
                }, function(bids) {___jdce_logger("lacuna_cache/exported_dn4aea.js", 1998, 2211);
                    googletag.cmd.push(function() {___jdce_logger("lacuna_cache/exported_dn4aea.js", 2054, 2191);

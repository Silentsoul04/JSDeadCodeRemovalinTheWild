...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        ue_csm.ue.exec(function(b, e) {
            function q() {lacuna_lazy_load("lacuna_cache/exported_12z3xy.js[66:415]", functionData => eval(functionData))}

            function t() {lacuna_lazy_load("lacuna_cache/exported_12z3xy.js[442:481]", functionData => eval(functionData))}
            ...
            function E() {
                d.trigger && d.trigger.isStub &&
                    d.trigger.replay(function(a) {lacuna_lazy_load("lacuna_cache/exported_12z3xy.js[1660:1724]", functionData => eval(functionData))})
            }

            function y() {lacuna_lazy_load("lacuna_cache/exported_12z3xy.js[1766:1829]", functionData => eval(functionData))}
            var s = ":1234",
                ...
                B = function() {
                    return {
                        send: function(a) {lacuna_lazy_load("lacuna_cache/exported_12z3xy.js[2544:2810]", functionData => eval(functionData))}
                    }
                }(),
                u = function() {
                    return {
                        send: function(a) {lacuna_lazy_load("lacuna_cache/exported_12z3xy.js[2958:3033]", functionData => eval(functionData))}
                    }
                }();

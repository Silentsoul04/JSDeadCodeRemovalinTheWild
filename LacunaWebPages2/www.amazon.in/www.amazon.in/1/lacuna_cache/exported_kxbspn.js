    ...
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        if (window.ue_ihe === 1) {
            ...
            (function(l, d) {
                ...
                function p() {lacuna_lazy_load("lacuna_cache/exported_kxbspn.js[3886:3931]", functionData => eval(functionData))}
            ...
            (function(a) {
                var b = a.alert;
                window.alert = function() {lacuna_lazy_load("lacuna_cache/exported_kxbspn.js[4723:5033]", functionData => eval(functionData))}
            })(window);

            (function(k, l, g) {
                function m(a) {lacuna_lazy_load("lacuna_cache/exported_kxbspn.js[5122:5448]", functionData => eval(functionData))}

                function r() {lacuna_lazy_load("lacuna_cache/exported_kxbspn.js[5479:5586]", functionData => eval(functionData))}

...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        P.when('secondary-scroll-depth')
            .execute(function(secondaryScrollDepth) {lacuna_lazy_load("lacuna_cache/exported_ag3iuc.js[399:454]", functionData => eval(functionData))});
        P.when('jQuery', 'card-loader', 'merch-data-store')
            .execute(function($, cardLoader, merchDataStore) {lacuna_lazy_load("lacuna_cache/exported_ag3iuc.js[578:637]", functionData => eval(functionData))});

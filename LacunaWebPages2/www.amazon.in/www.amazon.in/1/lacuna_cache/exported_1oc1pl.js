...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        (function(f, b) {
            function g() {
                try {
                    b.PerformanceObserver && "function" === typeof b.PerformanceObserver && (a = new b.PerformanceObserver(function(b) {lacuna_lazy_load("lacuna_cache/exported_1oc1pl.js[211:276]", functionData => eval(functionData))}), a.observe(d))
                } catch (h) {
                    k()
                }
            }

        ...
        NYTD.Abra = function(t) {
                ...
                var r,o={};return t.dataLayer=t.dataLayer||[],e.init=function(e){var a,o,i,c,u,h,l,s,f,p,d=[],v=[],m=(t.document.cookie.match(/ ( ? : ^ | ;) * nyt - a = ([ ^ ;] * ) / ) || [])[1], b = (t.document.cookie.match(/(?:^|;) *ab7=([^;]*)/) || [])[1], g = (t.location.search.match(/(?:^\?|&)abra=([^&]*)/) || [])[1];
                    ...
                    (function() {
                        ...
                        function setupPageViewId() {
                            NYTD.PageViewId = {}, NYTD.PageViewId.update = null
                        }
                        var _f = function(e) {
                            try {
                    ...
                    (function() {
                        var _f = function(e) {
                            ...
                            window.userXhrObject = r(), window.userXhrRefresh = null
                        };;
                        _f.apply(null, [{
                    ...
                    (function() {
                        ...
                        window.registerInteractive = null, window.getInteractiveBridge = null;
                    })();;
                    100 * Math.random() <= vi.env.SENTRY_SAMPLE_RATE ? (window.INSTALL_RAVEN = !0, window.nyt_errors = {
                        ravenInstalled: !1,
                        list: [],
                        tags: []
                    }, window.onerror = null) : window.INSTALL_RAVEN = !1;;
                    (function() {
                            ...
                            var a = window,
                                ...
                                c = function(e, n) {
                                    ...
                                    A || (A = function() {
                                        ...
                                        return t.load().catch(null), "loading" == t.status || "loaded" == t.status
                                    }() ? "woff2" : "woff");
                    ...
                    (function() {
                        ...
                        function loginWithGoogle() {
                            return "undefined" != typeof window && (-1 === document.cookie.indexOf("NYT-S") && (!0 !== checkSwgOptOut() && (!!window.SWG && ((window.SWG = window.SWG || []).push(function(e) {
                                return e.init(vi.env.SWG_PUBLICATION_ID), e.getEntitlements().then(null).catch(function() {
                                    return !1
                                }), !0
                            }), !0))))
                        }

            ...
            var AdSlot4 = function() {
                ...
                return function() {
                    ...
                    function A(o) {
                        "art, oak" !== o && "art,oak" !== o || (o = "art"), B.cmd.push(function() {
                            B.events.subscribe({
                                name: "AdDefined",
                                scope: "all",
                                callback: function(n) {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[1112:2694]", functionData => eval(functionData))}
                            })
                        })
                    }
                    return B.loadScripts = function(n) {
                        ...
                        x || (!("1" === z("nyt-gdpr") || (i = document.referrer || "", (t = /([a-zA-Z0-9_\-.]+)(@|%40)([a-zA-Z0-9_\-.]+).([a-zA-Z]{2,5})/).test(i) || t.test(window.location.href)) || "s" === z("nyt-purr").substring(1, 2)) && (!r || window.advBidxc && window.advBidxc.isLoaded || (d = g, a = "8CU2553YN", window.innerWidth < 740 && (a = "8CULO58R6"), b("https://contextual.media.net/bidexchange.js?cid=".concat(a, "&dn=").concat("www.nytimes.com", "&https=1"), function() {
                        ...
                        }, function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[4129:4518]", functionData => eval(functionData))}), window.advBidxc = window.advBidxc || {}, window.advBidxc.renderAd = function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[4600:4602]", functionData => eval(functionData))}, window.advBidxc.startTime = (new Date).getTime(), window.advBidxc.customerId = {
                            mediaNetCID: a
                            ...
                            o[t] || (o[t] = {
                                ...
                                fetchBids: function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[5320:5409]", functionData => eval(functionData))},
                                setDisplayBids: function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[5470:5472]", functionData => eval(functionData))},
                                targetingKeys: function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[5532:5613]", functionData => eval(functionData))},
                                _Q: []
                            })
                        }("apstag", window), b("//c.amazon-adsystem.com/aax2/apstag.js", function() {
                            window.apstag || console.warn("A9 not loading properly")
                        }, function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[5910:6297]", functionData => eval(functionData))}), window.apstag.init({
                            pubID: "3030",
                            adServer: "googletag",
                            params: {
                                si_section: o
                            }
                        }), A(e))), l && b("https://nytimes.com/ads/google/adsbygoogle.js", function() {}, function() {lacuna_lazy_load("lacuna_cache/exported_qw6gfg.js[6647:7037]", functionData => eval(functionData))}), x = !0)
                    }, window.AdSlot4 = B
                }()
            }();
            AdSlot4.loadScripts({

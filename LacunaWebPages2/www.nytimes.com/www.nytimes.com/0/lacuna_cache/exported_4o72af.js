            ...
            var AdSlot4 = function() {
                ...
                return function() {
                            ...
                            B.events.subscribe({
                                ...
                                callback: function(n) {
                                    ...
                                    n.sizes.forEach(function(n) {
                                        n[0] < window.innerWidth && n[0] > i[0] && (i = []).push(n)
                    ...
                    return B.loadScripts = function(n) {
                        ...
                        }), A(e))), l && b("https://nytimes.com/ads/google/adsbygoogle.js", function() {}, function() {
                            B.cmd.push(function() {
                                B.events.publish({
                                    name: "AdEmpty",
                                    value: {

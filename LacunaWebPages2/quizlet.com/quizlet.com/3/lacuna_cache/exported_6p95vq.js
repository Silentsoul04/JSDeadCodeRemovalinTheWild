        ...
        _rollbarConfig.transform = function xformPayload(payload) {___jdce_logger("lacuna_cache/exported_6p95vq.js", 1577, 1800);
            if (typeof payload.data === "undefined") payload.data = {};
            if (window.FS) payload.fullstoryUrl = FS.getCurrentSessionURL(true);
            return payload;
        };
        _rollbarConfig.checkIgnore = function shouldIgnore(isUncaught, args, payload) {___jdce_logger("lacuna_cache/exported_6p95vq.js", 1839, 2387);

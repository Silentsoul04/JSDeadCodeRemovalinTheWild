        ...
        (function(g, b) {___jdce_logger("lacuna_cache/exported_e81zjg.js", 10, 2965);
            b.getCsToken = function() {___jdce_logger("lacuna_cache/exported_e81zjg.js", 54, 295);
                var a;
                a = g.cookie.match("(?:^|;)\\s*" + b.cstokenName.replace(/[\-\[\]{}()*+?.,\\^$|#\s]/g, "$&") + "=([^;]*)");
                return null !== a ? decodeURIComponent(a[1]) : null
            };
            b.appendCstokenToForm = function(a) {___jdce_logger("lacuna_cache/exported_e81zjg.js", 333, 529);
                var d = b.getCsToken();
                d ? (b.setHiddenFormElement(a, "cstoken", d), b.addCsTokenDebugging(a)) : Rollbar.warning("csrf_cookie_missing")
            };
            b.setHiddenFormElement = function(a, b, e) {___jdce_logger("lacuna_cache/exported_e81zjg.js", 568, 1013);
                var c = !1;
            ...
            b.addCsTokenDebugging = function(a) {___jdce_logger("lacuna_cache/exported_e81zjg.js", 1051, 1321);
            ...
            b.getCsTokenV2 = function() {___jdce_logger("lacuna_cache/exported_e81zjg.js", 1352, 1707);
            ...
            b.getFormFieldCount = function(a, b) {___jdce_logger("lacuna_cache/exported_e81zjg.js", 1743, 1933);
                for (var e = 0, c = 0; c < a.elements.length; c++) "hidden" === a.elements[c].type && a.elements[c].name === b && e++;
                return e
            };
            var k = function(a) {___jdce_logger("lacuna_cache/exported_e81zjg.js", 1955, 2183);
            ...
            b.willHaveMootools && QWait("mootools", function() {___jdce_logger("lacuna_cache/exported_e81zjg.js", 2360, 2954);
                var a = function() {___jdce_logger("lacuna_cache/exported_e81zjg.js", 2397, 2882);
                    var a =
                        b.getCsToken();

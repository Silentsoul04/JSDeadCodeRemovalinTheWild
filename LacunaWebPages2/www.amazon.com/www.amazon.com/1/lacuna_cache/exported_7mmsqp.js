...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        (function(l) {
            ...
            c.guardFatal ? c.guardFatal(l)(c, window) : c.execute(function() {lacuna_lazy_load("lacuna_cache/exported_7mmsqp.js[262:306]", functionData => eval(functionData))})
        })(function(l, m, p) {
            (function(c) {
                function k(a) {
                    if (a && !e[a] && (e[a] = !0, d[a])) {
                ...
                c.gm = {
                    ...
                    wil: function(a, b) {
                        if (b)
                            if (a && 0 !== a.length)
                                for (var c = 0, d = [], e = function(e) {lacuna_lazy_load("lacuna_cache/exported_7mmsqp.js[2490:2755]", functionData => eval(functionData))}, n = 0; n < a.length; ++n) {
                                    var q = a[n];
                                    f(q, e(q)) && d.push(q)
                                } else b([])
                    },
                    ...
                    onImageLoad: function(k, f) {
                        ...
                        if (!gm.r("hfa")) {
                            ...
                            if (d.length && -1 == d[0].className.indexOf("hidden") && d[0].getBoundingClientRect().top + c.pageYOffset < c.innerHeight) {
                                ...
                                if (gm.r("taw")) return;
                                gm.s("taw", 1);
                                l.when("A").execute(function(a) {lacuna_lazy_load("lacuna_cache/exported_7mmsqp.js[6105:6915]", functionData => eval(functionData))})
                            }

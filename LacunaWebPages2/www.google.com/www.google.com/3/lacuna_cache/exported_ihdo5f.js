        ...
        (nullg, b)
                ...
                _.za = Array.prototype.filter ? function(b, c, d) {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 10988, 11089);
                    return Array.prototype.filter.call(b, c, d)
                } : function(b, c, d) {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 11092, 11449);
                ...
                _.Aa = Array.prototype.map ? function(b, c, d) {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 11496, 11594);
                    return Array.prototype.map.call(b, c, d)
                } : function(b, c, d) {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 11597, 11826);
                    for (var e = b.length, f = Array(e), g = "string" === typeof b ? b.split("") : b, h = 0; h < e; h++) h in g && (f[h] = c.call(d, g[h], h, b));
                    return f
                };
                _.w = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 11850, 11957);
                    this.ua = this.ua;
                    this.wa = this.wa
                };
                _.w.prototype.ua = !1;
                _.w.prototype.U = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 12032, 12118);
                    this.ua || (this.ua = !0, this.v())
                };
                _.w.prototype.v = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 12154, 12283);
                    if (this.wa)
                        for (; this.wa.length;) this.wa.shift()()
                };
                var Ba = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 12310, 12484);
                    _.w.call(this);
                    this.b = this.a = null;
                    this.f = 0;
                    this.c = {}
                ...
                _.n(Ba, _.w);
                Ba.prototype.g = function(b, c) {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 12549, 12726);
                    this.a = c;
                    this.b = b;
                    c.preventDefault ? c.preventDefault() : c.returnValue = !1
                };
                _.Ca = new Ba;
                _.Da = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 12782, 12877);
                    this.a = {};
                    this.b = {}
                };
                _.sa(_.Da);
                _.Fa = function(b, c) {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 12930, 13348);
                    var d = _.Da.za();
                    if (b in d.a) {
                ...
                _.Ga = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 13373, 13438);
                    _.v.call(this)
                };
                _.t(_.Ga, _.v);
                var Ea = function() {___jdce_logger("lacuna_cache/exported_ihdo5f.js", 13497, 13562);
                    _.v.call(this)
                };
                _.t(Ea, _.Ga);
                _.Fa("eq", _.Ca);

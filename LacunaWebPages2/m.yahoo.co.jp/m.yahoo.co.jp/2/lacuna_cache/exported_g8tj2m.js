                        ...
                        ! function() {
                            ...
                            t && (r(), window.addEventListener("resize", r)), window.YAHOO = window.YAHOO || {}, YAHOO.JP = YAHOO.JP || {}, YAHOO.JP.rma = YAHOO.JP.rma || {}, YAHOO.JP.rma.smp = YAHOO.JP.rma.smp || {}, YAHOO.JP.rma.smp.addAdEventListener && (YAHOO.JP.rma.smp.addAdEventListener("load", function(e) {
                                o && ("noad" === e && (t.style.display = "none"), YAHOO.JP.rma.smp.insert("STW"))
                            }, "STW"), YAHOO.JP.rma.smp.addAdEventListener("append", function() {
                                t.style.height = "auto", window.removeEventListener("resize", r)
                            }, "STW")), YAHOO.JP.mtop = YAHOO.JP.mtop || {}, YAHOO.JP.mtop.isAutoplay = function() {
                                try {
                            ...
                            }, YAHOO.JP.mtop.isCovered = function() {
                                var e = "0";
                                if ("0" === e) return !1;
                                try {

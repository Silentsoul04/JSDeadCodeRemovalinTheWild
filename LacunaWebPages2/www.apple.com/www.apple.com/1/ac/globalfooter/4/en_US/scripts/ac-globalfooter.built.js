...
! function() {
    ...
    3: [function(t, e, i) {
        ...
        var s = r.prototype;
        s.update = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[3601:3704]", functionData => eval(functionData))}, s.isOpen = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[3728:3774]", functionData => eval(functionData))}, s.toggle = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[3798:3864]", functionData => eval(functionData))}, s.open = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[3886:3966]", functionData => eval(functionData))}, s.close = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[3989:4069]", functionData => eval(functionData))}, s._anchorOpenClick = function(t) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[4104:4185]", functionData => eval(functionData))}, s._anchorCloseClick = function(t) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[4221:4302]", functionData => eval(functionData))}, e.exports = r
    }, {}],
    4: [function(t, e, i) {
        "use strict";
        var r = function() {
    ...
    7: [function(t, e, i) {
        ...
        var r = t("./getStyleProperty"),
            ...
            a = /(\([^\)]+\))/gi,
            l = /([^ ,;\(]+(\([^\)]+\))?)/gi;
        e.exports = function(t, e) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[7330:8013]", functionData => eval(functionData))}
    }, {
        "./getStyleProperty": 6,
        "./shared/prefixHelper": 9,
        "./shared/stylePropertyCache": 10,
    ...
    8: [function(t, e, i) {
        ...
        }, e.exports.resetElement = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[8442:8474]", functionData => eval(functionData))}
    }, {}],
    9: [function(t, e, i) {
        "use strict";
        var r = ["-webkit-", "-moz-", "-ms-"],
        ...
        }, c.reduce = function(t) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[8915:9052]", functionData => eval(functionData))}, e.exports = new o
    }, {}],
    10: [function(t, e, i) {
        "use strict";
        e.exports = {}
    ...
    11: [function(t, e, i) {
        ...
        var r, s, n = t("./stylePropertyCache"),
            ...
            c = !1,
            a = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[9361:9700]", functionData => eval(functionData))};
        e.exports = function(t, e) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[9737:10053]", functionData => eval(functionData))}, e.exports.resetFlags = function() {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[10089:10119]", functionData => eval(functionData))}
    }, {
    ...
    15: [function(t, e, i) {
        ...
        }, a._onChatLinkClick = function(t) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[12575:12683]", functionData => eval(functionData))}, a._makeBlockLink = function(t) {lacuna_lazy_load("/ac/globalfooter/4/en_US/scripts/ac-globalfooter.built.js[12716:13191]", functionData => eval(functionData))}, e.exports = o
    }, {

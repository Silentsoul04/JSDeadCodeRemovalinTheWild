        ...
        ! function(a, b) {
            ...
            function g(b) {
                var c = l("disableLog"),
                    d = a.console;
                void 0 === d || void 0 === d.log || c || d.log("[Bugsnag] " + b)
            }

            function h(b, c, d) {
                var e = l("maxDepth", B);
                if (d >= e) return encodeURIComponent(c) + "=[RECURSIVE]";
                d = d + 1 || 1;
                try {
                    if (a.Node && b instanceof a.Node) return encodeURIComponent(c) + "=" + encodeURIComponent(r(b));
                    var f = [];
                    for (var g in b)
                        if (b.hasOwnProperty(g) && null != g && null != b[g]) {
                            var i = c ? c + "[" + g + "]" : g,
                                j = b[g];
                            f.push("object" == typeof j ? h(j, i, d) : encodeURIComponent(i) + "=" + encodeURIComponent(j))
                        }
                    return f.join("&")
                } catch (k) {
                    return encodeURIComponent(c) + "=" + encodeURIComponent("" + k)
                }
            }

            function i(a, b, c) {
                if (null == b) return a;
                if (c >= l("maxDepth", B)) return "[RECURSIVE]";
                a = a || {};
                for (var d in b)
                    if (b.hasOwnProperty(d)) try {
                        a[d] = b[d].constructor === Object ? i(a[d], b[d], c + 1 || 1) : b[d]
                    } catch (e) {
                        a[d] = b[d]
                    }
                return a
            ...
            function l(a, b) {
                D = D || k(K);
                var c = void 0 !== x[a] ? x[a] : D[a.toLowerCase()];
                return "false" === c && (c = !1), void 0 !== c ? c : b
            }

            function m(a) {
                return a && a.match(E) ? !0 : (g("Invalid API key '" + a + "'"), !1)
            }
            ...
            function n(b, c) {
                ...
                if (m(d) && A) {
                    A -= 1;
                    var e = l("releaseStage", "production"),
                        f = l("notifyReleaseStages");
                    if (f) {
                    ...
                    if (n !== w) {
                        ...
                        return 0 === o.lineNumber && /Script error\.?/.test(o.message) ? g("Ignoring cross-domain script error. See https://bugsnag.com/docs/notifiers/js/cors") : void j(l("endpoint") || H, o)
                    }
                }
            }
                ...
                if (!b) {
                    ...
                    try {
                        for (var h = arguments.callee.caller.caller; h && f.length < c;) {
                            var i = F.test(h.toString()) ? RegExp.$1 || d : d;
                            f.push(i), h = h.caller
                        }
                    } catch (j) {
                        g(j)
            ...
            function r(a) {
                if (a) {
                    var b = a.attributes;
                    if (b) {
                        for (var c = "<" + a.nodeName.toLowerCase(), d = 0; d < b.length; d++) b[d].value && "null" !== b[d].value.toString() && (c += " " + b[d].name + '="' + b[d].value + '"');
                        return c + ">"
                    }
                    return a.nodeName
                }
            ...
            x.noConflict = function() {
                return a.Bugsnag = b, "undefined" == typeof b && delete a.Bugsnag, x
            }, x.refresh = function() {
                A = 10
            }, x.notifyException = function(a, b, c, d) {
                a && (b && "string" != typeof b && (c = b, b = void 0), c || (c = {}), f(c), n({
                    name: b || a.name,
            ...
            var C = "complete" !== document.readyState;
            ...
            if (l("autoNotify", !0)) {
                ...
                t(a, "setTimeout", M), t(a, "setInterval", M), a.requestAnimationFrame && t(a, "requestAnimationFrame", function(a) {
                    return function(b) {
                        return a(c(b))
                    }
                    ...
                    d && d.hasOwnProperty && d.hasOwnProperty("addEventListener") && (t(d, "addEventListener", function(a) {
                        return function(b, d, e, f) {
                            try {
                                d && d.handleEvent && (d.handleEvent = c(d.handleEvent, {
                                    eventHandler: !0
                                }))
                            } catch (h) {
                                g(h)

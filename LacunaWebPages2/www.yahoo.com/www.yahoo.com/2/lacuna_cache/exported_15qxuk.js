                        ...
                        if (window.wafer) {
                            ...
                            window.wafer.on("error", function waferErrHandler(wferror) {
                                ...
                                if (wferror) {
                                    ...
                                    // beacon error
                                    var beaconUrl = "/p.gif?err=" + wferror.name + "&beaconType=wafer_err&info=" + escape(JSON.stringify(wferror.meta)) + "&stack=" + errorMessage + "&rid=9sm8t6hepu37t" + "&bucket=MFPTOAST02,FPRIVEN02" + "&apptype=default" + "&connection=" + escape(JSON.stringify(connectionMeta));
                            ...
                            window.wafer.on("log", function waferLogHandler(wfData) {
                                if (wfData) {
                                    ...
                                    // beacon log
                                    var beaconUrl = "/p.gif?for=" + name + "&beaconType=wafer_log&info=" + escape(JSON.stringify(wfData.meta)) + "&rid=9sm8t6hepu37t" + "&bucket=MFPTOAST02,FPRIVEN02" + "&apptype=default";
                        ...
                        if (!storedCookieValue || (storedBCookieValue && bCookieValue && storedBCookieValue !== bCookieValue)) {
                            if (typeof window.localStorage === 'object') {
                                ...
                                if (storedBCookieValue && storedBCookieValue !== bCookieValue) {
                                    ...
                                    var beaconUrl =  '/p.gif?beaconType=bCookieChurn&newBCookieValue=' + bCookieValue + '&oldBCookieValue=' + storedBCookieValue + '&secElapsed=' + timeElapsed + "&rid=9sm8t6hepu37t" + "&bucket=MFPTOAST02,FPRIVEN02";

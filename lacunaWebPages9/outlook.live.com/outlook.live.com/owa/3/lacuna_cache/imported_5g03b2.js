jQuery(document).ready(function(e) {
  ...
  var c;
  e("[name='a-simple-experience']").find(".buttons-captions").attr("data-current", "1"), e("[name='a-simple-experience']").find(".buttons-track li:nth-of-type(1)").addClass("current"), e("[name='a-simple-experience'] .buttons-track li").on("focus mouseover", null), a("iOS" == l | "Android" == l ? 55 : 90), e('[name="productivity-apps"] header span').on("onscreen", function(t, a) {
  ...
  var d = (new LazyLoad({
    ...
    l = getOS();
  "iOS" !== l && "Android" !== l || e("[data-task='signin']").click(null), e(u).on("keydown", null), e("#mobile-speedbump .mobile-speedbump-close").click(null)
});
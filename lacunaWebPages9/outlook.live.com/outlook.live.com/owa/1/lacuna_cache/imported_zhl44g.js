...
! function(e, t) {
  ...
  function t(e, t) {lacuna_lazy_load("lacuna_cache/imported_zhl44g.js[778:850]", functionData => eval(functionData))}
  return function(n) {
    n = "string" == typeof n ? n : "vh-offset";
    var o = e();
    return !!o && (t(n, o), window.addEventListener("orientationchange", function() {lacuna_lazy_load("lacuna_cache/imported_zhl44g.js[1023:1063]", functionData => eval(functionData))}, !1), !0)
  }
});
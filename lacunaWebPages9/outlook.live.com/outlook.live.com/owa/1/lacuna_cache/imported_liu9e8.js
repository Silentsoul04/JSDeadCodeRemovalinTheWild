...
jQuery(document).ready(function(e) {
  ...
  function i() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[697:828]", functionData => eval(functionData))}

  function o() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[845:989]", functionData => eval(functionData))}

  function s() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[1006:1377]", functionData => eval(functionData))}

  function r() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[1394:1632]", functionData => eval(functionData))}
  ...
  var c;
  e("[name='a-simple-experience']").find(".buttons-captions").attr("data-current", "1"), e("[name='a-simple-experience']").find(".buttons-track li:nth-of-type(1)").addClass("current"), e("[name='a-simple-experience'] .buttons-track li").on("focus mouseover", function() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[2655:2987]", functionData => eval(functionData))}), a("iOS" == l | "Android" == l ? 55 : 90), e('[name="productivity-apps"] header span').on("onscreen", function(t, a) {
  ...
  var d = (new LazyLoad({
    ...
    l = getOS();
  "iOS" !== l && "Android" !== l || e("[data-task='signin']").click(function() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[4344:4395]", functionData => eval(functionData))}), e(u).on("keydown", function(e) {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[4429:4640]", functionData => eval(functionData))}), e("#mobile-speedbump .mobile-speedbump-close").click(function() {lacuna_lazy_load("lacuna_cache/imported_liu9e8.js[4707:4720]", functionData => eval(functionData))})
});
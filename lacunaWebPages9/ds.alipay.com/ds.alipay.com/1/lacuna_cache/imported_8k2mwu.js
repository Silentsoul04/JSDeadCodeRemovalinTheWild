...
(function() {
  ...
  var t = false;
  window.addEventListener("deviceorientation", function(e) {lacuna_lazy_load("lacuna_cache/imported_8k2mwu.js[3659:3847]", functionData => eval(functionData))}, false);
  ...
  function a(e) {
    if (e.data.length == 0) {
      ...
      e.avg = e.data.reduce(function(e, n) {lacuna_lazy_load("lacuna_cache/imported_8k2mwu.js[3995:4025]", functionData => eval(functionData))}) / e.data.length;
      e.dev = e.data.map(function(n) {lacuna_lazy_load("lacuna_cache/imported_8k2mwu.js[4081:4131]", functionData => eval(functionData))}).reduce(function(e, n) {lacuna_lazy_load("lacuna_cache/imported_8k2mwu.js[4155:4185]", functionData => eval(functionData))}) / e.data.length
    }
    delete e.data
  }
  setTimeout(function() {

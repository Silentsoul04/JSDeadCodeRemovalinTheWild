! function() {
  ...
  class p {
    ...
    _collectPluginData() {
      ...
      }), this._pushCurrentBeaconData(), e ? this._sendAllData() : setTimeout(() => {}, this._config["async-plugins-timeout"]), this._resetState(!0))
    }
    ...
    _getBeaconAndPluginData() {
      if (this._readPageKey(), this._readSinglePageAppData(), this._readRenderTimingEntries(), this._readIsSSL(), this._config["app-version"] && (this._beaconData.appVersion = this._config["app-version"]), this._config.plugins.map(e => {}), "navigationStart" in this._beaconData && this._shouldSendBeacon) {
    ...
    ! function(e) {
            ...
            var n = "undefined" != typeof window && window && "node" !== window.appEnvironment,
              ...
              a = {
                ...
                addToQueue: function(e) {
                  ...
                  if (!this.timeoutId) {
                    var t = this;
                    i && !this.paused ? this.timeoutId = this.idleFlush(this.queueTimeout) : this.timeoutId = setTimeout(function() {}, this.queueTimeout)
                  }
                },
      ...
      var T = 10,
        ...
        P = function() {
          ...
          return t.prototype._handleDocumentClicks = function(e) {}, t.prototype._handleWindowBeforeUnload = function(e) {}, t.prototype._handleDocumentVisibilityChange = function() {}, t.prototype.saveStateForPageDeparture = function(e) {}, t.prototype.fireControlInteractionEvent = function(t, n, i) {}, t.prototype.fireNavigationEvent = function(t, n, i) {
            void 0 === i && (i = {});
          ...
          }, t.prototype.fireExternalNavigationEvent = function(t, n) {}, t.prototype.firePageViewEvent = function(t, n) {}, t.prototype.fireAnchorPageViewEvent = function(e, t, n) {}, t.prototype.firePageVisibilityChangeEvent = function(t, n) {}, t.prototype.fireTrackingEvent = function(e, t, n, i) {
            ...
            this.config.validationMode ? r.validateEvent(d, c, function(t) {}) : (r.sendEvent(d, c), i && r.flush())
          }, t.prototype.destroy = function() {}, t.createFromPageKey = function(e, n) {
            return e.initialPageInstance = w(n), new t(e)
          }, t
        }();
      e.AppTrackingInstance = P, e.clearNavStorage = function() {}, e.derivePageInstanceFromString = y, e.derivePageKeyFromUrn = _, e.generateControlUrn = v, e.generatePageInstance = w, e.generatePageUrn = m, e.generateTrackingId = p, e.getReferrer = E, e.getTrackingCode = b, e.stringifyPageInstance = function(e) {}, e.uuid = g, e.webTrackingTransport = r
    }(t)
  }(v = {
    exports: {}
  }, v.exports), v.exports);

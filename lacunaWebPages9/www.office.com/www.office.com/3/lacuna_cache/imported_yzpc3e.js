var __awaiter = this && this.__awaiter || function(e, t, n, a) {
    return new(n || (n = Promise))(function(r, i) {
      ...
      function c(e) {
        e.done ? r(e.value) : new n(null).then(o, s)
      }
  ...
  __generator = this && this.__generator || function(e, t) {
    ...
    return s = {
      ...
      throw: n(1),
      return: n(2)
    }, "function" == typeof Symbol && (s[Symbol.iterator] = null), s
  },
  HomePage;
! function(e) {
  function t() {
  ...
  var p = function() {
      ...
      return e.prototype.setupFade = function() {
        ...
        this.$document.find("#scroll-button").click(null)
      }, e.prototype.connectFreeAccountButton = function() {
        this.$document.find("#hero-banner-free-account-link").click(null)
      }, e
    }(),
    m = function() {
      function e(e) {
      ...
      return e.prototype.ForgetAccountClick = null, e.prototype.SendAADForget = null, e.prototype.SwitchAccount = null, e.prototype.SignInWithNewEmail = null, e.prototype.CloseNewEmail = null, e.prototype.updateQueryStringParameter = null, e
    }();
  e.init = t
}(HomePage || (HomePage = {}));
var awa = awa || {},
...
awa.actionType = {
    ...
    return {
      ...
      readExpIdFromCoreData: null,
      getImpressionGuid: a,
      getPageViewImpressionGuid: r,
      getGroups: i,
      setDeviceClass: d,
      getDeviceClass: g,
      setExpIdCookieName: null,
      getExpIdCookieName: null
    }
  ...
  function() {
    ...
    awa.experimentIdTag = "expId", awa.isAvailable = !0, awa.getRequestBody = null, awa.getQueryStringParameters = null, Object.freeze && Object.freeze(awa.verbosityLevels), awa.capabilitiesCheck();
    ...
    for (awa.init = function(e) {
      ...
      }, awa.sendEventThroughIframe = null, awa._validateAndTranslateEvent = function(e) {
        function t(e, t, n) {
          b[e] = t, O(e, t, n)
        }
      ...
      }, awa.console = window.console || {}, awa.console.fallback = awa.console.log || null, o = ["log", "info", "warn", "error", "trace"], s = 0; s < o.length; s++) c = o[s], awa.console[c] || (awa.console[c] = awa.console.fallback);
    awa.extendCoreData = null
    ...
    function e(e) {
      var n, a, r, i;
      awa.isAvailable && (K = e, Q = K.autoCapture, se = !0 === K.useShortNameForContentBlob ? oe.shortNames : oe.longNames, Q.pageView && (!0 === K.isLoggedIn && !0 === K.shareAuthStatus ? t(null) : p({
        isAuto: !0
      })), Q.click && (window.addEventListener ? (n = -1 !== navigator.appVersion.indexOf("MSIE") ? "click" : "mousedown", window.addEventListener(n, l, !1), window.addEventListener("keyup", l, !1)) : document.attachEvent && (document.attachEvent("onclick", l), document.attachEvent("keyup", l))), Q.jsError && Y.init(), Q.scroll && (a = g(null, null, K.debounceMs.scroll), window.addEventListener ? window.addEventListener("scroll", a) : window.attachEvent && window.attachEvent("onscroll", a)), Q.resize && (r = g(null, null, K.debounceMs.resize), window.addEventListener ? window.addEventListener("resize", r) : window.attachEvent && window.attachEvent("onresize", r)), Q.onUnload && (i = null, window.addEventListener ? window.addEventListener("scroll", i) : window.attachEvent && window.attachEvent("onscroll", i), awa.timespanHandler.recordTimeSpan("dwellTime", !1), window.addEventListener ? (window.addEventListener("beforeunload", y), window.addEventListener("unload", y)) : window.attachEvent && (window.attachEvent("onbeforeunload", y), window.attachEvent("onunload", y))), t(awa.ct.domReadyTasksWrapper))
    }
    ...
    return {
      ...
      del: null,
      patch: null,
      doNotChangeSupportCors: null,
      alwaysAddCvToRequestHeader: null,
...
! function(e) {
  var t = function() {
    ...
    return e.signIn = null, e.startDefaultSignIn = null, e.handleSignInResult = null, e.updateQueryStringParameter = null, e
  }();

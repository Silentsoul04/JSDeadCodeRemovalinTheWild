...
Mzp.Modal = function(t) {
  ...
  function() {
    ...
    ! function s() {
      ...
      i && (t = document.getElementById("newsletter-submit"), e = document.getElementById("newsletter-details"), n = document.querySelector(".mzp-js-email-field"), o = "none" !== window.getComputedStyle(e).display, n.addEventListener("focus", null), t.addEventListener("click", null), i.addEventListener("submit", null))
    }()
  ...
  function() {
    ...
    }, o.loadAllFallback = null, o.onImageLoad = function(t) {
  ...
  function() {
    ...
    var n = 0,
      r = {};
    e.prototype.queueTrigger = null, e.prototype.trigger = null, e.prototype.destroy = null, e.prototype.disable = null, e.prototype.enable = null, e.prototype.next = null, e.prototype.previous = null, e.invokeAll = null, e.destroyAll = null, e.disableAll = null, e.enableAll = null, e.refreshAll = null, e.viewportHeight = function() {
  ...
  function() {
    ...
    }, n.prototype.checkEmpty = null, n.prototype.createThrottledResizeHandler = function() {
      
      var e = this;
      this.adapter.on("resize.waypoints", null)
    }, n.prototype.createThrottledScrollHandler = function() {
      
      var e = this;
      this.adapter.on("scroll.waypoints", null)
    }, n.prototype.handleResize = null, n.prototype.handleScroll = function() {
      var t = {},
        e = {
          horizontal: {
    ...
    }, n.prototype.remove = null, n.prototype.innerWidth = function() {
      return this.element == this.element.window ? y.viewportWidth() : this.adapter.innerWidth()
    }, n.prototype.destroy = null, n.prototype.refresh = function() {
  ...
  function() {
    ...
    }, e.prototype.flushTriggers = null, e.prototype.next = null, e.prototype.previous = null, e.prototype.queueTrigger = null, e.prototype.remove = null, e.prototype.first = null, e.prototype.last = null, e.findOrCreate = function(t) {
  ...
  function() {
    ...
    if (h) {
      ...
      h.addEventListener("submit", null, !1)
    }
  ...
  function(o, i) {
    ...
    r.attr("aria-hidden", "true"), s ? Mozilla.Cookies.getItem("sticky-home-cta-dismissed") ? r.remove() : function a() {
      ...
      o('<button type="button" class="sticky-dismiss">').text("Dismiss this prompt.").appendTo(e), o(".sticky-dismiss").on("click", null)
    }() : r.remove()

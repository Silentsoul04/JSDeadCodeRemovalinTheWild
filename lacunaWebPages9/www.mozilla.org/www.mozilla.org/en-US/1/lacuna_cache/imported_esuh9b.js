...
! function() {
  ...
  window.site = {
    ...
    setItem: function(e, t, o, i, n, a) {lacuna_lazy_load("lacuna_cache/imported_esuh9b.js[3942:4550]", functionData => eval(functionData))},
    removeItem: function(e, t, o) {lacuna_lazy_load("lacuna_cache/imported_esuh9b.js[4586:4794]", functionData => eval(functionData))},
    hasItem: function(e) {
      "use strict";
      return !!e && new RegExp("(?:^|;\\s*)" + encodeURIComponent(e).replace(/[\-\.\+\*]/g, "\\$&") + "\\s*\\=").test(document.cookie)
    },
    keys: function() {lacuna_lazy_load("lacuna_cache/imported_esuh9b.js[5006:5250]", functionData => eval(functionData))},
    enabled: function() {
      "use strict";
      try {

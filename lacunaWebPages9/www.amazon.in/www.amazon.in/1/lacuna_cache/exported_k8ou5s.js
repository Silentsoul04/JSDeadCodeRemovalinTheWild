...
function lacuna_lazy_load(id, callback){
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        if (window.ue_ihb === 1) {
            var ue_hob = +new Date();
            var ue_id = 'VS5H3DHG80YPHS4W1AQD',
                ue_csm = window,
                ue_err_chan = 'jserr-rw',
                ue = {};
            (function(d) {
                var e = d.ue = d.ue || {},
                    f = Date.now || function() {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[406:470]", functionData => eval(functionData))};
                e.d = function(b) {
            ...
            (function(d, e) {
                function h(f, b) {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[1731:2408]", functionData => eval(functionData))}
                ...
                var k = "FATAL",
                    ...
                    a = {
                        ...
                        startTimer: function() {
                            a.ts++;
                            setInterval(function() {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[3456:3601]", functionData => eval(functionData))}, 1E4)
                        }
                    };
                l.skipTrace = 1;
                h.skipTrace = 1;
            ...
            var ue_url = '/uedata/unsticky/260-2259749-2497118/NoPageType/ntpoffrw',
                ue_sid = '260-2259749-2497118',
                ...
                ue_fcsn = 1,
                ue_isrw = true,
                ue_fpf = '//fls-eu.amazon.in/1/batch/1/OP/A21TJRUUN4KGV:260-2259749-2497118:VS5H3DHG80YPHS4W1AQD$uedata=s:',
                ue_qsl = 2000,
                ue_rpl_ns = 0,
                ue_orct = 1,
                ue_int = 0,
            ...
            (function(d, k, J) {
                ...
                function E(a) {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[6684:6896]", functionData => eval(functionData))}

                function K(p, b) {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[6931:7356]", functionData => eval(functionData))}
                ...
                function W() {
                    function a() {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[16903:16959]", functionData => eval(functionData))}
                ...
                d.uex = P;
                a.reset = K;
                a.pause = function(d) {lacuna_lazy_load("lacuna_cache/exported_k8ou5s.js[19711:19763]", functionData => eval(functionData))};
                W()

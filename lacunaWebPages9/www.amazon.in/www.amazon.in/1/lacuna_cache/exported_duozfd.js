    ...
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        (function(f, h, R, A) {
            ...
            function ea(a, b) {
                function c(c, e) {
                    function g() {
                        va(b, c, h, function(b) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[2028:2352]", functionData => eval(functionData))}, e)
                    }
                    if (fa[c]) return !1;
                    fa[c] = !0;
                    v("resource_count");
                ...
                if (b) {
                    var e = 0,
                        g = 0;
                    c.andConfirm = function(a, b) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[2713:2903]", functionData => eval(functionData))};
                    c.confirm = function() {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[2948:2999]", functionData => eval(functionData))};
                    c.getCsriCounters = function() {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[3052:3207]", functionData => eval(functionData))}
                }
                return c
            }
            ...
            function wa(a, b, c) {
                for (var e = {
                        ...
                        logError: function(c,
                            d, e) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[3571:3649]", functionData => eval(functionData))}
            ...
            "use strict";
            var O = R.now = R.now || function() {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[8766:8819]", functionData => eval(functionData))},
                D = function(a) {
            ...
            var da = {},
                ...
                fa = {},
                I = !1;
            y(f, "beforeunload", function() {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[9829:9959]", functionData => eval(functionData))});
            var ga = /^prv:/,
                W = {},
                J = {},
                V = {},
            ...
            K.prototype = {
                logError: function(a, b, c, e) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[10938:11354]", functionData => eval(functionData))},
                error: function(a, b, c, e) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[11400:11561]", functionData => eval(functionData))},
                guardError: X(),
                guardFatal: X("FATAL"),
                ...
                log: function(a, b, c) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[11849:11924]", functionData => eval(functionData))},
                declare: C([], !0, !0, !0),
                register: C([], !0),
                execute: C([]),
                ...
                trigger: function(a, b, c) {
                    ...
                    c && c.instrument && F.when("prv:a-logTrigger").execute(function(b) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[12517:12569]", functionData => eval(functionData))})
                },
                handleTriggers: function() {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[12633:12710]", functionData => eval(functionData))},
                attributeErrors: function(a) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[12757:12812]", functionData => eval(functionData))},
            ...
            var M = !0,
                ...
                N = 4;
            L();
            y(f, "resize", function() {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[19102:19194]", functionData => eval(functionData))});
            var ta = {
                getItem: function(a) {
                    try {
            ...
            w && (y(w, "message", function(a) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[20731:20799]", functionData => eval(functionData))}), w.controller && w.controller.postMessage("MSG-RDY"));
            var na = [],
                l = {
                    reg: {},
                    unreg: {}
            ...
            l.reg.browser = {
                action: function(a, b) {
                    w.register("/service-worker.js").then(function() {
                        v(a + "success")
                    }).catch(function(c) {lacuna_lazy_load("lacuna_cache/exported_duozfd.js[21205:21357]", functionData => eval(functionData))})
                }
            };
            (function(a) {
                var b = a.reg,

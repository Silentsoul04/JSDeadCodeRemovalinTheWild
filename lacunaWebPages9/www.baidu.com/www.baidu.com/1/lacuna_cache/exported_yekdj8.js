    ...
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        ! function() {
            ...
            a.init = function() {
                var v = !1,
                    h = [];
                return a._fireInit = function() {lacuna_lazy_load("lacuna_cache/exported_yekdj8.js[626:686]", functionData => eval(functionData))},
                    function(c) {
                        v ? c() : h.push(c)
                    }
            }(), a.load = function() {
        ...
        ! function() {
            ...
            c.asynJs = [], c.asynLoad = function(a) {lacuna_lazy_load("lacuna_cache/exported_yekdj8.js[2540:2612]", functionData => eval(functionData))}
        }();;
        ! function() {

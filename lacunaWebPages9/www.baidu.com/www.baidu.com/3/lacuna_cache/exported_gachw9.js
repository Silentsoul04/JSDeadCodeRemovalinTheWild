                ...
                h.prototype = {
                    ...
                    jsonpRequest: function(a) {
                        ...
                        if (C && (C = "&sid=" + C), h.chgVersion) {
                            ...
                            }, c.onerror = null, c.src && document.body.appendChild(c), c.scId = setTimeout(null, 3e4)
                    ...
                    redirectURL: null,
                    clearLocal: null,
                    urlParamsUpdate: null
                }, v.localStore = function(a) {
                    var p = a || {};
                    p.type = p.type ? p.type : "index";
                    var c = new h(p);
                    return v.getCode = null, c.jsonpRequest(), c
                }, window.B = v
            }();;
            ! function() {
                function a() {
                ...
                if (w) {
                    ...
                    b.getAttribute("data-pagetimer") && (y.speed.loading = (new Date).getTime(), y.speed.cacheStatus = 0), b.setAttribute("data-query", encodeURIComponent(w)), setTimeout(null, 0)

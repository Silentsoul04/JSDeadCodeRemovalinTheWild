...
(function(N, p) {
  ...
  function za(a, b, d) {
    ...
    Array.isArray(a) ? X(a, f, d, function(a) {}) : null != a && (T(a) && (a = va(a, c + (!a.key || b && b.key === a.key ? "" : ("" + a.key).replace(ma, "$&/") + "/") +
      d)), f.push(a))
  }
  ...
  if ("undefined" !== typeof window && window._schedMock) {
    ...
    window.addEventListener("message", function(a) {}, !1);
    var ba = function(a) {};
    E = function(a, b) {};
    P = function() {}
  }
...
(function(Y, cb) {
  ...
  var Cc = void 0,
    Wf = function(a) {
      return "undefined" !== typeof MSApp && MSApp.execUnsafeLocalFunction ? function(b, c, d, e) {} : a
    }(function(a, b) {}),
    xb = function(a, b) {},
    lb = {
  ...
  var Bg = {
    ...
    __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: {
      Events: [de, ua, Kc, Ud.injectEventPluginsByName, Fc, Ga, function(a) {}, pe, qe, Xb, Jc]
    },

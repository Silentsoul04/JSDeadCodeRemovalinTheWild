...
var b = window.b || {};
b.map = b.map || {}, B.define("component/dropdown", function(e, t, i) {}), $(function() {
    if (_i_("b71:52718e00"), "city" != b.env.b_action || $(".lp_sb_trigger").is("[data-tab-target]")) return _r_();
    $(".lp_sb_trigger").on("click", function(e) {}), _r_()
  }),
  function(a) {
    "use strict";
    _i_("b71:0c71c0ed"), B.define("component/seo/more_relevant_nearby_cities", function(e, t, i) {}), _r_()
  }(B.require("jquery")),
  function() {
    "use strict";
    _i_("b71:2f679b1d"), B.define("component/seo/top-accommodations", function(e, t, i) {}), B.define("component/seo/top-accommodations-snap", function(e, t, i) {}), _r_()
  }(),
  function() {
    "use strict";
    _i_("b71:192b450b"), B.define("component/seo/tabs-navigation", function(e, t, i) {}), _r_()
  }(),
  function() {
    "use strict";
    _i_("b71:6996a028"), B.define("component/seo/target-click", function(e, t, i) {}), _r_()
  }(), _i_("b71:9603028c"), B.define("component/multiple-states", function(e, t, i) {}), B.when({
    events: "ready"
  }).run(function(e) {
    _i_("b71:1731f73f");
    var t = e("jquery");
    t(".js-click-search").on("click", function() {}), _r_()
  }), _r_(), $(document).on("click", ".js-toggle-long-text__content", function() {}), B.when({
    events: "click .lp-usp-banner__close"
  }).run(function(e) {}), _i_("b71:95cf2ddf"), B.when({
    action: ["index"]
  }).run(function(e) {
    _i_("b71:b147e0e2");
    var t = e("event-bus");
    ...
    if (!t) return _r_(!1);
    var i = function(e) {};
    $(".dualcal").each(function() {}), t.on(t.EVENTS.CALENDAR_UPDATE, function(e, t) {}), _r_()
  }), _r_(), b.require("jquery")(function(r) {
    if (_i_("b71:d7b1fbb6"), "index" != b.env.b_action) return _r_();
    r("#top-destinations_postcard").on("click", "a.city_link", function(e) {}), _r_()
  ...
  }), B.define("component/tabs", function(e, t, i) {}), B.when({
    action: "index",
    events: "ready"
  }).run(function(e) {
    _i_("b71:01f2d0fa");
    var i = e("jquery");
    i(".js--how-works-cta").on("click", function() {}), _r_()
    ...
    })(n) || i.fadeIn(500), t(".ugc-pending-modal__close").on("click", function() {}), _r_()
  }), B.define("component/dismissible-item/cookie-block", function(e, t, i) {}), B.define("component/async-carousel", function(e, t, i) {}), B.define("watcher", function(e, t, i) {}), B.define("component/bh/exposure-counter", function(e, t, i) {}), B.when({
    action: ["index", "searchresults", "hotel"],
    events: "load",
    condition: function(e) {
      return _i_("b71:dd433292"), _r_(!!e.bhaw_display_survey)
    }
  }).run(function(e) {}), booking.jstmpl("m_booking_home_selected_properties_card", function() {
    _i_("b71:782d4d48");
  ...
  }()), B.define("component/bh/async-carousel", function(e, t, i) {}), B.define("component/surveygizmo_survey", function(e, t, i) {}), booking.jstmpl("surveygizmo_survey_invite", function() {
    _i_("b71:787c85e0");
  ...
  }()), B.define("referral/raf-goal", function(e, t, i) {}), B.define("referral/rap-goal", function(e, t, i) {}),
  function(b) {
    _i_("b71:a6bb0ba0");

    function h(e) {}
    b.define("component/referral/copy-input", function(e, t, i) {}), _r_()
  }(window.B), B.define("referral/clipboard", function(e, t, i) {}), B.define("component/referral/share-buttons", function(e, t, i) {}), B.define("component/referral/web-virality/ga", function(e, t, i) {}), booking.lightbox = function() {
    _i_("b71:47a1a86e");
  ...
  }(), B.define("lightbox", booking.lightbox), B.define("dismiss-item", function(e, t, i) {}), B.when({
    action: "index",
    ...
    0 < t(".ccp__acb__reminding_banner.ccp__acb__reminding_banner_header").length && i.click(function() {}), _r_()
  }), B.when({
      ...
      run: function() {
        ...
        if (e && (window.b_survey_url = e, booking.env.survey_key = $("#survey").attr("surveykey"), booking.env.surveytracklink = "/outgoinglink/survey/" + booking.env.survey_key), void 0 !== window.b_survey_url && window.b_survey_url) {
          var i = $("#conf_survey,#survey,#conf_survey_bottom"),
            n = function() {},
            t = function(e) {};
          booking.env.showRevdSurvey2016Q1 ? (booking.events.on("REVIEWS:fetched", function() {}), i.find("button").on("click", t)) : (i.fadeIn("normal", n), i.find("button").click(t))
        }
        _r_()
      },
      init: function() {
  ...
  }()), B.define("component/landpages/budget-themes", function(e, t, i) {}), B.when({
    events: "ready"
  }).run(function(e) {
    _i_("b71:5fa3c614");
    var i = e("jquery"),
    ...
    if (void 0 !== a && i("<input />").attr("type", "hidden").attr("name", "lpsr").attr("value", "1").appendTo("#form_search_location"), t.length && n.length && void 0 !== a) {
      t.click(function() {}), n.click(function() {})
    }

    function o(e, t) {}
    r.length && t.length && n.length && r.click(function(e) {}), _r_()
  }), B.when({
    events: "ready"
  }).run(function(e) {
    _i_("b71:2ce9b458");
    ...
    function n(e) {}
    i.length && i.click(function(e) {}), _r_()
  }), B.define("component/landing_pages/beach/lp-accordion-switch", function(e, t, i) {}), B.define("component/company/dom-utils/scroll", function(e, t, i) {}), B.define("component/trip-types/show-more", function(e, t, i) {}), B.when({
    action: ["city", "region"],
    events: "ready",
    condition: function(e) {
  ...
  function(r) {
    function o(e, t) {}
    _i_("b71:da8ddea9"), r.define("component/feedback-base", function(a, e, t) {}), o.prototype.getStorage = function(e) {}, o.prototype.saveData = function() {}, o.prototype.loadData = function() {}, o.prototype.removeExpired = function() {}, o.prototype.isExpired = function(e, t) {}, o.prototype.remove = function(e) {}, o.prototype.set = function(e, t, i) {}, o.prototype.get = function(e) {}, _r_()
  }(window.booking),
  function(c) {
    _i_("b71:6bfd22f0"), c.define("component/feedback-inline", function(_, e, t) {}), _r_()
    ...
    _i_("b71:6fcc3aa3"), e("#yielding_free_cancellation_addon_banner").on("click", ".bui-banner__close", function() {}), _r_()
  }), B.define("component/fragment/joinapp-retargeting", function(e, t, i) {}), B.define("component/sp-banner/floating", function(e, t, i) {}), B.when({
    events: "ready",
    condition: B.env.fe_track_ski_discovery
  }).run(function(e) {}), b.env.scripts_tracking.lp.run = 1;
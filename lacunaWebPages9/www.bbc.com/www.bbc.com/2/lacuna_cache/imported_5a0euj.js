! function() {
  ...
  p.cookieOvenRequest = function(e, o, t) {}, p.cookieOvenClient = function(e, o, t, n) {}, p.set = function(e, o, t, n) {
      var i, r, c;
      if (void 0 !== o) {
        r = m(i = u(e), o, t);
      ...
      var o = d();
      return e ? o[e] : o
    }, p.analyticsPolicyString = function() {}, p.get = function(e) {
    ...
    }, p.isCookiePolicySet = function() {}, p.setDefaultCookiesSingleDomain = function() {}, p.setDefaultCookiesCrossDomain = function() {}, p.copyPolicyCookiesCrossDomain = function(e) {}, p.setCookiePolicyCrossDomain = function(e) {}, p._setPolicy = function(e, o, t, n) {}, p.cookiesEnabled = function() {
    ...
    }, p._getCurrentDomain = function() {}, p._getPolicy = p.readPolicy, String.prototype.trim || (e = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, String.prototype.trim = function() {}),
    function(o, t) {
      var n = !1,
        e = !0,
        i = o.document,
      ...
      p._crunch()
    }), window.addEventListener ? window.addEventListener("beforeunload", function() {}, !1) : window.attachEvent ? window.attachEvent("onbeforeunload", function() {}) : window.onbeforeunload = function() {}, "object" == typeof window.bbccookies && "function" == typeof window.bbccookies._getCookieName || (window.bbccookies = p, "function" == typeof define && define.amd && define("orb/cookies", function() {
      return p
    }))
}();
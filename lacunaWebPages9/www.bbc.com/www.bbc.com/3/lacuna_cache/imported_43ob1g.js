! function(e) {
  ...
  n.m = e, n.c = o, n.d = null, n.r = null, n.t = null, n.n = null, n.o = null, n.p = "", n(n.s = 0)
}([function(e, o, n) {
  e.exports = n(1)
}, function(e, o, n) {
  "use strict";
  ...
  t = function() {
    var e = 1,
      o = {
        ...
        jsonp: function(n, t, i) {
          var r, c, a, s = !1;
          r = (i = i || {}).callbackName ? i.callbackName : "jsonpcb" + e++, i.timeout && (a = setTimeout(null, i.timeout));
    ...
    return {
      ...
      copyPolicyCookiesCrossDomain: null,
      setDefaultCookiesSingleDomain: null,
      setDefaultCookiesCrossDomain: null,
      optInToAllCookiesCrossDomain: null,
      isCookiePolicySet: null
    }
    ...
    (function(e, o) {
      ...
      function l() {
        ...
        document.getElementById("bbcprivacy-continue-button").addEventListener("click", null), document.getElementById("bbccookies-continue-button").addEventListener("click", null);
        var a, l = document.getElementById("bbccookies-settings").getElementsByTagName("a")[0];
        l.addEventListener("click", (a = !1, null));
        var d, m, f = o.get(t) === c;
      ...
      Promise.all([window.bbcuser.isUKCombined(), window.bbcuser.getCountry(), window.bbcpage.getLanguage()]).then(null).catch(function() {
        d("en", l, "gb")
      })
    }).apply(null, [t, c])
  }).catch(n.oe)
  ...
  ! function() {
     ...
     *
     */
    i.cookieOvenRequest = null, i.cookieOvenClient = null, i.set = function(e, o, n, t) {
        var r, c;
        if (void 0 !== o) {
          c = k(r = y(e), o, n);
        ...
        var o = b();
        return e ? o[e] : o
      }, i.analyticsPolicyString = null, i.get = function(e) {
      ...
      }, i.isCookiePolicySet = null, i.setDefaultCookiesSingleDomain = null, i.setDefaultCookiesCrossDomain = null, i.copyPolicyCookiesCrossDomain = null, i.setCookiePolicyCrossDomain = null, i._setPolicy = null, i.cookiesEnabled = null, i.delete = null, i.del = i.delete, i._crunch = function() {
        f("");
      ...
      }, i._getPolicy = i.readPolicy, String.prototype.trim || (r = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, String.prototype.trim = null),
      function(e, o) {
        var n = !1,
          t = !0,
          i = e.document,
        ...
        i._crunch()
      }), window.addEventListener ? window.addEventListener("beforeunload", null, !1) : window.attachEvent ? window.attachEvent("onbeforeunload", null) : window.onbeforeunload = null, "object" == typeof window.bbccookies && "function" == typeof window.bbccookies._getCookieName || (window.bbccookies = i, void 0 === (t = function() {
        return i

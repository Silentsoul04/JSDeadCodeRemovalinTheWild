...
window.bbcpage.isModal() && (dependencies = removeElement(dependencies, "orb/features/masthead/_layoutprimarynav")), require(dependencies, function() {
    ...
    return e.animate = r ? null : null, e
    ...
    } : o.addEvent = null, o.mixin = function(t) {
  ...
  function(d) {
    ...
    }((v = document, n = "getElementsByClassName", m = "length", o = null, function(e, t) {
    ...
    }, u.addCSS = null, u.addHTML = null, u
    ...
    }, e.prototype.getPanel = null, e.prototype.resize = null, e.prototype.showPanel = null, e.prototype.hidePanel = null, e.prototype.activate = null, e.prototype.deactivate = null, e.prototype.getCurrentPanel = function() {
      return this._currentPanel
    }, e.Panel = function(e, t, n) {
      this.name = e, t && (this.control = t.control, this.content = t.content), this.publishState = null, "function" == typeof n && (this.stateChangeCallback = n), r.mixin(this)
    }, e
    ...
    function T() {
      ...
      function s() {
        var e = {
          ...
          a = (l(".orb-nav-id")[0], 0);
        a = l.config.rtl ? l.client.ie6 || l.client.ie7 ? null : null : function() {
      ...
      function e(e) {
        ...
        }), s(), a(), l.addClass(b, g), l.removeClass(b, y), r(), o(), h = !0, d(T), u(), l.config.fixed || (l.addEvent(window, "resize", i()), l.addEvent(window, "orientationchange", null))
      }
      T.recalculateLayout = null, n.load(e, e)
    }
    return e.mixin(T), T
    ...
    }).prototype.removeLink = null, t.prototype.showAll = function() {
    ...
    }, t.prototype.applyMaximum = null, t.prototype.hasVisible = function() {
    ...
    function r(e) {
      var i, a = null,
        t = window.getComputedStyle ? null : null;

      function n() {
        var e = o.getCurrentPanel();
        null !== e && null(e)
      }
      r.initPanelDom = null, s.ready(function() {
        ! function() {
          var e = s("#orb-panel-template")[0];
          e && (i = e.innerHTML, e.parentNode.removeChild(e))
        }(), (l.drawer = o).event("onActivate").add(null), o.event("onDeactivate").add(null), o.event("onSwapContents").add(null), n(), s.addEvent(l, "mousemove", null), s.addEvent(l, "mousedown", null), s.addEvent(l, "keydown", null), e.event("afterLayout").add(n)
      }), r.refreshNav = null
    }
    return r.addPanelEvents = function(n) {
      var r = n.name;
      s.addEvent(n.control, "click", null), s.addEvent(l, "keydown", null)

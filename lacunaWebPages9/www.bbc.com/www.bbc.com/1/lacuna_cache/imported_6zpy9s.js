...
function removeElement(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[121:158]", functionData => eval(functionData))}
window.bbcpage.isModal() && (dependencies = removeElement(dependencies, "orb/features/masthead/_layoutprimarynav")), require(dependencies, function() {
    ...
    return e.animate = r ? function(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[779:869]", functionData => eval(functionData))} : function(n, e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[887:1421]", functionData => eval(functionData))}, e
    ...
    } : o.addEvent = function(t, e, n) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[3429:3754]", functionData => eval(functionData))}, o.mixin = function(t) {
  ...
  function(d) {
    ...
    function e(e, t, n) {
      ...
      o.rel = "stylesheet", o.href = e, o.media = "only x",
        function e(t) {
          if (a.body) return t();
          setTimeout(function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[4601:4631]", functionData => eval(functionData))})
        }(function() {
    ...
    }((v = document, n = "getElementsByClassName", m = "length", o = function(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[5736:5980]", functionData => eval(functionData))}, function(e, t) {
    ...
    return u.isReady = !1,
      function(t, n) {
        var e = !0,
          ...
          d = function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[7660:7830]", functionData => eval(functionData))};
    ...
    "use strict";
    return {
      htmlEntities: function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[8381:8498]", functionData => eval(functionData))},
      trimHtml: function(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[8531:9096]", functionData => eval(functionData))}
    }
  }), define("orb/lib/_template", function() {
    "use strict";
    var a = {};
    return function e(t, n) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[9212:9822]", functionData => eval(functionData))}
    ...
    }, u.addCSS = function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[10788:11138]", functionData => eval(functionData))}, u.addHTML = function(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[11167:11244]", functionData => eval(functionData))}, u
    ...
    }, e.prototype.getPanel = function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[11639:11699]", functionData => eval(functionData))}, e.prototype.resize = function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[11734:11919]", functionData => eval(functionData))}, e.prototype.showPanel = function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[11957:12428]", functionData => eval(functionData))}, e.prototype.hidePanel = function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[12465:12640]", functionData => eval(functionData))}, e.prototype.activate = function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[12676:12751]", functionData => eval(functionData))}, e.prototype.deactivate = function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[12789:12819]", functionData => eval(functionData))}, e.prototype.getCurrentPanel = function() {
      return this._currentPanel
    }, e.Panel = function(e, t, n) {
      this.name = e, t && (this.control = t.control, this.content = t.content), this.publishState = function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[13045:13150]", functionData => eval(functionData))}, "function" == typeof n && (this.stateChangeCallback = n), r.mixin(this)
    }, e
    ...
    function T() {
      ...
      function i() {
        var e, t = 0;
        return function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[14986:15181]", functionData => eval(functionData))}
      }
      ...
      function s() {
        var e = {
          ...
          a = (l(".orb-nav-id")[0], 0);
        a = l.config.rtl ? l.client.ie6 || l.client.ie7 ? function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[15560:15620]", functionData => eval(functionData))} : function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[15634:15708]", functionData => eval(functionData))} : function() {
      ...
      function e(e) {
        ...
        }), s(), a(), l.addClass(b, g), l.removeClass(b, y), r(), o(), h = !0, d(T), u(), l.config.fixed || (l.addEvent(window, "resize", i()), l.addEvent(window, "orientationchange", function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[17181:17223]", functionData => eval(functionData))}))
      }
      T.recalculateLayout = function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[17273:17344]", functionData => eval(functionData))}, n.load(e, e)
    }
    return e.mixin(T), T
    ...
    }).prototype.removeLink = function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[17989:18048]", functionData => eval(functionData))}, t.prototype.showAll = function() {
    ...
    }, t.prototype.applyMaximum = function(n) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[18435:18641]", functionData => eval(functionData))}, t.prototype.hasVisible = function() {
    ...
    function a(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[20566:20832]", functionData => eval(functionData))}

    function r(e) {
      var i, a = null,
        t = window.getComputedStyle ? function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[20927:21033]", functionData => eval(functionData))} : function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[21048:21310]", functionData => eval(functionData))};

      function n() {
        var e = o.getCurrentPanel();
        null !== e && function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[21405:21526]", functionData => eval(functionData))}(e)
      }
      r.initPanelDom = function(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[21576:22364]", functionData => eval(functionData))}, s.ready(function() {
        ! function() {
          var e = s("#orb-panel-template")[0];
          e && (i = e.innerHTML, e.parentNode.removeChild(e))
        }(), (l.drawer = o).event("onActivate").add(function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[22582:23324]", functionData => eval(functionData))}), o.event("onDeactivate").add(function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[23366:23940]", functionData => eval(functionData))}), o.event("onSwapContents").add(function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[23984:24597]", functionData => eval(functionData))}), n(), s.addEvent(l, "mousemove", function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[24644:24685]", functionData => eval(functionData))}), s.addEvent(l, "mousedown", function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[24727:24768]", functionData => eval(functionData))}), s.addEvent(l, "keydown", function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[24808:24852]", functionData => eval(functionData))}), e.event("afterLayout").add(n)
      }), r.refreshNav = function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[24921:24960]", functionData => eval(functionData))}
    }
    return r.addPanelEvents = function(n) {
      var r = n.name;
      s.addEvent(n.control, "click", function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[25082:25241]", functionData => eval(functionData))}), s.addEvent(l, "keydown", function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[25281:25529]", functionData => eval(functionData))})
    ...
    return function() {
      r.ready(function() {
        ...
        r.addEvent(e, "click", function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[25820:26043]", functionData => eval(functionData))})
      })
    }
  }), define("orb/nav", ["orb/lib/_$", "orb/features/_drawerManager", "orb/features/masthead/_drawer"], function(o, i, s) {
    "use strict";
    return {
      loadCss: function(e, t) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[26245:26334]", functionData => eval(functionData))},
      loadJs: function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[26362:26538]", functionData => eval(functionData))},
      ...
      getDrawerState: function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[26821:26949]", functionData => eval(functionData))},
      updateDrawerHeight: function(e) {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[26989:27038]", functionData => eval(functionData))},
      getMastheadDrawer: function() {
        return i.getMastheadDrawer()
      },
      refresh: function() {lacuna_lazy_load("lacuna_cache/imported_6zpy9s.js[27150:27198]", functionData => eval(functionData))}
    }
  });

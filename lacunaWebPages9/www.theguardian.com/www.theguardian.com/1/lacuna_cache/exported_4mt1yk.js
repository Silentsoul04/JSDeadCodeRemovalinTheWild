    ...
    fetch("http://127.0.0.1:8125/lazyload/", {
        ...
        try {
            (function(isVeryModern, document, window) {
                if (isVeryModern) {
                    var decodeBase64 = function(str) {lacuna_lazy_load("lacuna_cache/exported_4mt1yk.js[160:304]", functionData => eval(functionData))};
            ...
            (function(document, window) {
                ...
                window.requestAnimationFrame(function() {
                    ...
                    window.requestAnimationFrame(function() {
                        ...
                        adBlockers.onDetect = {
                            push: function() {lacuna_lazy_load("lacuna_cache/exported_4mt1yk.js[2808:2980]", functionData => eval(functionData))}
                        };
        ...
        try {
            (function(isVeryModern, document, window) {
                ...
                if (isVeryModern && user) window.requestAnimationFrame(function() {lacuna_lazy_load("lacuna_cache/exported_4mt1yk.js[3588:4721]", functionData => eval(functionData))})
        ...
        try {
            (function(document, window) {
                if (!window.__cmp) window.__cmp = function() {
                    ...
                    addLocatorFrame();
                    var commandQueue = [];
                    var cmp = function(command, parameter, callback) {lacuna_lazy_load("lacuna_cache/exported_4mt1yk.js[5903:6468]", functionData => eval(functionData))};
                    cmp.commandQueue = commandQueue;
                    cmp.receiveMessage = function(event) {lacuna_lazy_load("lacuna_cache/exported_4mt1yk.js[6580:6960]", functionData => eval(functionData))};
                    cmp.config = {

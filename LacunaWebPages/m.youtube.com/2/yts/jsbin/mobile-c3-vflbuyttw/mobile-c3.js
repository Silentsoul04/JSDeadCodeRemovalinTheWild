(function() {
    ...
    */
    ...
    function ok(a) {
        ...
        null == r("_lact", window) && (b = parseInt(x("LACT"), 10), b = isFinite(b) ? Sa() - Math.max(b, 0) : -1, p("_lact", b, window), p("_fact", b, window), -1 == b && pk(), kk(document, "keydown", function(e) {}), kk(document, "keyup", function(e) {}), kk(document, "mousedown", function(e) {}), kk(document, "mouseup", function(e) {}), a && (c ? kk(window, "touchmove", function(e) {}, {
            passive: !0
        }) : (kk(window, "resize", function(e) {}), kk(window, "scroll", function(e) {}))), new mk(function() {
            qk("mouse", 100)
    ...
    function CE() {
        x("MWEB_BLAZERPLAYER", !1) ? window.addEventListener("playback-end", function(a) {}) : window.addEventListener("player-state-change", AE)
    };

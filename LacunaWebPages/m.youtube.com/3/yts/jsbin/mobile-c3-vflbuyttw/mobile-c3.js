(function() {
    ...
    var Wa = Array.prototype.indexOf ? null : null,
        ...
        $a = Array.prototype.reduce ? null : null,
    ...
    */
    ...
    function ok(a) {
        ...
        null == r("_lact", window) && (b = parseInt(x("LACT"), 10), b = isFinite(b) ? Sa() - Math.max(b, 0) : -1, p("_lact", b, window), p("_fact", b, window), -1 == b && pk(), kk(document, "keydown", null), kk(document, "keyup", null), kk(document, "mousedown", null), kk(document, "mouseup", null), a && (c ? kk(window, "touchmove", null, {
            passive: !0
    ...
    function CE() {
        x("MWEB_BLAZERPLAYER", !1) ? window.addEventListener("playback-end", null) : window.addEventListener("player-state-change", AE)
    };
    ...
    var BF = np("ytm-input-with-counter", null);
    var CF = W({
            buttonRenderer: Z,
            compactLinkRenderer: bu,
            dropdownRenderer: Qq
    ...
    var LF = np("ytm-create-playlist-content-component", null),
        MF = np("ytm-create-playlist-buttons-component", null);
    ...
    var sH = G.ja,
        ...
        wH = to(v("dropdown")),
        xH = np("ytm-playlist-settings-editor-renderer", null);
    var yH = W({
    ...
    var gJ = np("ytm-comment-section-renderer", null);
    var hJ = W({
        buttonRenderer: Z
    });
    ...
    var mJ = G.Oa,
        nJ = G.Ba,
        oJ = np("ytm-donation-shelf-renderer-outer", null);
    var pJ = W({
        buttonRenderer: Z
    });
    ...
    ;
    var yJ = np("ytm-redeem-code-renderer", null);
    var zJ = W({
        dropdownRenderer: Qq,
        buttonRenderer: Z
    });
    ...
    var uK = G.Oa,
        ...
        xK = np("ytm-universal-watch-card-renderer", null);
    var yK = W({
        buttonRenderer: Z
    });
    ...
    var RK = G.Oa,
        ...
        UK = np("ytm-ypc-offers-list-renderer", null);

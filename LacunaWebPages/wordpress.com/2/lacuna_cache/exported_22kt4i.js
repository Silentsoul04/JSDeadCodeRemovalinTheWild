	...
	( function( $ ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 4, 14729);
		'use strict';
		if ( ! $ ) return; // No jQuery.

		var $document = $( window.document );

		function getWPCOMAnalyticsDefaultConfig() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 115, 440);
			return {
		...
		$document.on( 'a8c-analytics:loaded', function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 482, 14723);
			...
			function fireTracks() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 1090, 1394);
			...
			function fireAffiliateReferrals() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 1399, 1587);
			...
			function loadGoogleAdsGtag() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 1592, 1663);
				kit.loadGtag( 'AW-946162814' );
			}

			function fireGoogleAnalytics() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 1668, 2545);
				...
				ga( function( tracker ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 2063, 2177);
			...
			function resetGAOptimizeExperiment( experimentDotVar ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 2550, 3523);
				...
				var prefix = _gaexp.split( '.' ).slice( 0, 2 ).join( '.' ) || '';
								...
								experiments.forEach( function( experiment ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 3017, 3334);
			...
			function fireGAOptimizeCallback( variationId, experimentId ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 3528, 4189);
			...
			function fireFacebook() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 4194, 4318);
				kit.loadFacebook();
				fbq( 'init', '823166884443641' );
				fbq( 'track', 'PageView' );
			}

			function fireQuantcast() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 4323, 4880);
				// P-Code: p-3Ma3jHaQMB_bS
				// Label: _fp.event.Default
				window._qevents = window._qevents || [];
				(function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 4463, 4820);
			...
			function fireOutbrain() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 4885, 5649);
				!function( _window, _document ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 4916, 5588);
					var OB_ADV_ID = '00f0f5287433c2851cc0cb917c7ff0465e';
					if ( _window.obApi ) {
						return;
					}
					var api = _window.obApi = function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 5088, 5196);
			...
			function fireYahooGeminiOath() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 5654, 5839);
			...
			function fireBing() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 5844, 6512);
				(function( w, d, t, r, u ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 5871, 6382);
					var f, n, i;
					w[ u ] = w[ u ] || [], f = function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 5949, 6070);
						var o = { ti: "4074038" };
						o.q = w[ u ], w[ u ] = new UET( o ), w[ u ].push( "pageLoad" )
					}, n = d.createElement( t ), n.src = r, n.async = 1, n.onload = n.onreadystatechange = function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 6156, 6303);
			...
			function fireAdRoll() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 6517, 6817);
			...
			function fireTwitter() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 6822, 6934);
				kit.loadTwitter();
				twq( 'init', 'nvzbs' );
				twq( 'track', 'PageView' );
			}

			function fireLinkedIn() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 6939, 7321);
				window._linkedin_data_partner_id = "195308";
				(function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 7019, 7312);
			...
			function fireDCMFloodlight() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 7326, 7541);
			...
			function fireDCMFloodlightEvents( tracksAnonId ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 7546, 8322);
			...
			function fireDCMFloodlightEventsGTM( tracksAnonId ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 8327, 8519);
				window.dataLayer.push( {
					...
					'Tracks Anon Id': tracksAnonId,
						...
						function fireExperianAddressableTV() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 8527, 8831);
				(function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 8571, 8822);
			...
			function fireIconMedia() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 8836, 9109);
			...
			function firePinterest() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 9114, 9249);
				kit.loadPinterest();
				window.pintrk( 'load', '2613194105266', {} );
				window.pintrk( 'page' );
			}

			function fireClickCease() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 9254, 9922);
			...
			function setupTracksClickTracking() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 9927, 12259);
				$( 'body' ).on( 'click', 'a, .click-tracking-enable', function( event ) {___jdce_logger("lacuna_cache/exported_22kt4i.js", 10023, 12251);
					...
					if ( window.ga ) {
						...
						if ( props.href && 0 !== props.href.indexOf( '#' ) && -1 !== [ '', '_top', '_self' ].indexOf( props.target ) ) {
							...
							setTimeout( function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 12161, 12222);
			...
			function applyLinkers() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 12264, 12779);
				kit.linkQueryVars( [
					{
						includeRegExps: [
			...
			$document.on( 'a8c-analytics:fire-sensitive-pixels', function() {___jdce_logger("lacuna_cache/exported_22kt4i.js", 13169, 14717);

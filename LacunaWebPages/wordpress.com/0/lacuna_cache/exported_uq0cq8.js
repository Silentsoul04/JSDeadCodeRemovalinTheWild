	...
	( function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 4, 2215);
		'use strict';

		var html = document.documentElement;

		var extend = function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 89, 486);
			var args = [].slice.call( arguments );

			var obj0 = args.slice( 0, 1 )[0] || {};
			obj0 = 'object' === typeof obj0 ? obj0 : {};

			args.slice( 1 ).forEach( function( _obj ) {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 265, 462);
		...
		window.a8cGAOptimize = window.a8cGAOptimize || {
			...
			isEnabled: function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 849, 941);
				return !! ( a8cGAOptimize.config.id && a8cGAOptimize.config.enabled );
			},

			startAsyncDim: function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 962, 1625);
				...
				a8cGAOptimize.refs.asyncDimInterval = setInterval( function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 1422, 1612);
			...
			endAsyncDim: function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 1644, 2054);
				...
				setTimeout( function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 1956, 2043);
					html.className = html.className.replace( /\s?async-dim/g, '' );
				}, 0 );
			},

			push: function() {___jdce_logger("lacuna_cache/exported_uq0cq8.js", 2066, 2130);

(function(win,doc){
	var _b = {
		...
		showBanner : function() {
			...
			inner_html += _b.getLabel("find_out_more_on",lang) + '<a style="color:#fff" id="cookie-notice" href="' + _b.cookieNoticeUrl() + '" target="_blank">' + _b.getLabel("how_we_use",lang) + "</a>.</p>";
			inner_html += "<div class='cookie-consent-actions' style='margin-right: 20px;'><a style=\"color:#fff\" href=\"javascript:euCookieConsent.add()\">" + _b.getLabel("accept",lang) + "</a></div><div class='cookie-consent-actions'><a style=\"color:#fff\" href=\"javascript:euCookieConsent.refuse()\">" + _b.getLabel("refuse",lang) + "</a></div>";

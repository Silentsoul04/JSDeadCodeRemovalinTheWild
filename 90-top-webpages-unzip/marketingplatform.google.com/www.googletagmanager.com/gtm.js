...
function lc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.h[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var nc={},oc=null,pc=Math.random();nc.m="GTM-MPHTW35";nc.Ab="a20";var qc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},rc="www.googletagmanager.com/gtm.js";var sc=rc,tc=null,uc=null,vc=null,wc="//www.googletagmanager.com/a?id="+nc.m+"&cv=9",xc={},yc={},zc=function(){var a=oc.sequence||0;oc.sequence=a+1;return a};var Ac={},Bc=function(a,b){Ac[a]=Ac[a]||[];Ac[a][b]=!0},Cc=function(a){for(var b=[],c=Ac[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
var xi=function(a,b,c){function d(){var h=a();g+=e?(wa()-e)*h.playbackRate/1E3:0;e=wa()}var e=0,g=0;return{Jb:function(h,k,l){var m=a(),n=m.Jd,p=void 0!==l?Math.round(l):void 0!==k?Math.round(m.Jd*k):Math.round(m.Lf),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(p/n*100),q=D.hidden?!1:.5<=pi(c);d();var r=rg(c,"gtm.video",[b]);r["gtm.videoProvider"]="youtube";r["gtm.videoStatus"]=h;r["gtm.videoUrl"]=m.url;r["gtm.videoTitle"]=m.title;r["gtm.videoDuration"]=Math.round(n);r["gtm.videoCurrentTime"]=
Math.round(p);r["gtm.videoElapsedTime"]=Math.round(g);r["gtm.videoPercent"]=t;r["gtm.videoVisible"]=q;Mf(r)},Lg:function(){e=wa()},mc:function(){d()}}};var yi=C.clearTimeout,zi=C.setTimeout,M=function(a,b,c){if(ld()){b&&G(b)}else return Kb(a,b,c)},Ai=function(){return C.location.href},Bi=function(a){return oe(pe(a),"fragment")},Ci=function(a){return ne(pe(a))},Di=null;
...
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var z=[],A=x.split(","),B=0;B<A.length;B++){var E=Number(A[B]);if(isNaN(E))return[];n.test(A[B])||z.push(E)}return z}function c(){var x=0,z=0;return function(){var A=oi(),B=A.height;x=Math.max(u.scrollLeft+A.width,x);z=Math.max(u.scrollTop+B,z);return{Nf:x,Of:z}}}function d(){q=W("self");
r=q.document;u=r.scrollingElement||r.body&&r.body.parentNode;y=c()}function e(x,z,A,B){var E=l(z),F={},J;for(J in E){F.oa=J;if(E.hasOwnProperty(F.oa)){var N=Number(F.oa);x<N||(Fi({event:"gtm.scrollDepth","gtm.scrollThreshold":N,"gtm.scrollUnits":A.toLowerCase(),"gtm.scrollDirection":B,"gtm.triggers":E[F.oa].join(",")}),ug("sdl",z,function(V){return function(S){delete S[V.oa];return S}}(F),{}))}F={oa:F.oa}}}function g(){var x=y(),z=x.Nf,A=x.Of,B=z/u.scrollWidth*100,E=A/u.scrollHeight*100;e(z,"horiz.pix",
p.yb,t.yd);e(B,"horiz.pct",p.xb,t.yd);e(A,"vert.pix",p.yb,t.Dd);e(E,"vert.pct",p.xb,t.Dd);tg("sdl","pending",!1)}function h(){var x=250,z=!1;r.scrollingElement&&r.documentElement&&q.addEventListener&&(x=50,z=!0);var A=0,B=!1,E=function(){B?A=zi(E,x):(A=0,g(),Mi("sdl")&&!a()&&(Pb(q,"scroll",F),Pb(q,"resize",F),tg("sdl","init",!1)));B=!1},F=function(){z&&y();A?B=!0:(A=zi(E,x),tg("sdl","pending",!0))};return F}function k(x,z,A){if(z){var B=b(String(x));ug("sdl",A,function(E){for(var F=0;F<B.length;F++){var J=
String(B[F]);E.hasOwnProperty(J)||(E[J]=[]);E[J].push(z)}return E},{})}}function l(x){return vg("sdl",x,{})}function m(x){G(x.vtp_gtmOnSuccess);var z=x.vtp_uniqueTriggerId,A=x.vtp_horizontalThresholdsPixels,B=x.vtp_horizontalThresholdsPercent,E=x.vtp_verticalThresholdUnits,F=x.vtp_verticalThresholdsPixels,J=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case p.yb:k(A,z,"horiz.pix");break;case p.xb:k(B,z,"horiz.pct")}switch(E){case p.yb:k(F,z,"vert.pix");break;case p.xb:k(J,
z,"vert.pct")}Mi("sdl")?vg("sdl","pending")||(w||(d(),w=!0),G(function(){return g()})):(d(),w=!0,u&&(Ni("sdl"),tg("sdl","pending",!0),G(function(){g();if(a()){var N=h();Ob(q,"scroll",N);Ob(q,"resize",N)}else tg("sdl","init",!1)})))}var n=/^\s*$/,p={xb:"PERCENT",yb:"PIXELS"},t={Dd:"vertical",yd:"horizontal"},q,r,u,w=!1,y;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?m(x):Jf(function(){m(x)})})}();
...
var U=Ei("gtm.element",1);U&&t(function(){var T=ce(),P=T&&T.getByName&&T.getByName(r),pa=Yi(W("gaplugins").Linker,P);U&&U.href&&(U.href=pa.decorate(U.href,d.vtp_useHashDecorateLink),G(d.vtp_gtmOnSuccess))});}else if("DECORATE_FORM"==d.vtp_trackType){}else if("TRACK_DATA"==d.vtp_trackType){}else{d.vtp_enableEcommerce&&(y("require","ec","ec.js"),A());if(d.vtp_doubleClick||"DISPLAY_FEATURES"==d.vtp_advertisingFeaturesType){var Y=
...
y){var x=w.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(y)return w.setAttribute("src",c(x)),!0}return!1}function e(w,y){if(!w.getAttribute("data-gtm-yt-inspected-"+y.Yc)&&(w.setAttribute("data-gtm-yt-inspected-"+y.Yc,"true"),d(w,y.Nd))){w.id||(w.id=a());var x=W("YT"),z=x.get(w.id);z||(z=new x.Player(w.id));var A=h(z,y),B={},E;for(E in A)B.Ha=E,A.hasOwnProperty(B.Ha)&&z.addEventListener(B.Ha,function(F){return function(J){return A[F.Ha](J.data)}}(B)),B={Ha:B.Ha}}}
function g(w){G(function(){function y(){for(var z=x.getElementsByTagName("iframe"),A=z.length,B=0;B<A;B++)e(z[B],w)}var x=W("document");y();Xh(y)})}function h(w,y){var x,z;function A(){O=xi(function(){return{url:R,title:U,Jd:I,Lf:w.getCurrentTime(),playbackRate:Y}},y.Yc,w.getIframe());I=0;U=R="";Y=1;return B}function B(T){switch(T){case q.PLAYING:I=Math.round(w.getDuration());R=w.getVideoUrl();if(w.getVideoData){var P=w.getVideoData();U=P?P.title:""}Y=w.getPlaybackRate();y.Ef?O.Jb("start"):O.mc();
K=m(y.Ag,y.zg,w.getDuration());return E(T);default:return B}}function E(){da=w.getCurrentTime();ea=(new Date).getTime();O.Lg();Q();return F}function F(T){var P;switch(T){case q.ENDED:return N(T);case q.PAUSED:P="pause";case q.BUFFERING:var pa=w.getCurrentTime()-da;P=1<Math.abs(((new Date).getTime()-ea)/1E3*Y-pa)?"seek":P||"buffering";w.getCurrentTime()&&(y.Df?O.Jb(P):O.mc());S();return J;case q.UNSTARTED:return A(T);default:return F}}function J(T){switch(T){case q.ENDED:return N(T);case q.PLAYING:return E(T);
case q.UNSTARTED:return A(T);default:return J}}function N(){for(;z;){var T=x;yi(z);T()}y.Cf&&O.Jb("complete",1);return A(q.UNSTARTED)}function V(){}function S(){z&&(yi(z),z=0,x=V)}function Q(){if(K.length&&0!==Y){var T=-1,P;do{P=K[0];if(P.ma>w.getDuration())return;T=(P.ma-w.getCurrentTime())/Y;if(0>T&&(K.shift(),0===K.length))return}while(0>T);x=function(){z=0;x=V;0<K.length&&K[0].ma===P.ma&&(K.shift(),O.Jb("progress",P.de,P.me));Q()};z=zi(x,1E3*T)}}var O,K=[],I,R,U,Y,da,ea,Ba=A(q.UNSTARTED);z=0;
x=V;return{onStateChange:function(T){Ba=Ba(T)},onPlaybackRateChange:function(T){da=w.getCurrentTime();ea=(new Date).getTime();O.mc();Y=T;S();Q()}}}function k(w){for(var y=w.split(","),x=y.length,z=[],A=0;A<x;A++){var B=parseInt(y[A],10);isNaN(B)||100<B||0>B||z.push(B/100)}z.sort(function(E,F){return E-F});return z}function l(w){for(var y=w.split(","),x=y.length,z=[],A=0;A<x;A++){var B=parseInt(y[A],10);isNaN(B)||0>B||z.push(B)}z.sort(function(E,F){return E-F});return z}function m(w,y,x){var z=w.map(function(E){return{ma:E,
me:E,de:void 0}});if(!y.length)return z;var A=y.map(function(E){return{ma:E*x,me:void 0,de:E}});if(!z.length)return A;var B=z.concat(A);B.sort(function(E,F){return E.ma-F.ma});return B}function n(w){w.vtp_triggerStartOption?p(w):Pd(function(){p(w)})}function p(w){var y=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,z=!!w.vtp_capturePause,A=k(w.vtp_progressThresholdsPercent+""),B=l(w.vtp_progressThresholdsTimeInSeconds+""),E=!!w.vtp_fixMissingApi;if(y||x||z||A.length||B.length){var F={Ef:y,Cf:x,Df:z,
zg:A,Ag:B,Nd:E,Yc:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},J=W("YT"),N=function(){g(F)};G(w.vtp_gtmOnSuccess);if(J)J.ready&&J.ready(N);else{var V=W("onYouTubeIframeAPIReady");Gi("onYouTubeIframeAPIReady",function(){V&&V();N()});G(function(){for(var S=W("document"),Q=S.getElementsByTagName("script"),O=Q.length,K=0;K<O;K++){var I=Q[K].getAttribute("src");if(b(I,"iframe_api")||b(I,"player_api"))return}for(var R=S.getElementsByTagName("iframe"),U=R.length,Y=0;Y<U;Y++)if(!u&&d(R[Y],F.Nd)){M("https://www.youtube.com/iframe_api");
u=!0;break}})}}else G(w.vtp_gtmOnSuccess)}var t=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},r,u=!1;Z.__ytl=n;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0}();

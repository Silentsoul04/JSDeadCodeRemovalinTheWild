        ...
        $.ajax({
          ...
          error: function(t) {
            ...
            t.responseJSON.o
              ...
              : (n.$el.find("#sport2017EndList").html("暂无数据⋯⋯"),
                n.$el.find("#sport2017LiveList").html("暂无数据⋯⋯"),

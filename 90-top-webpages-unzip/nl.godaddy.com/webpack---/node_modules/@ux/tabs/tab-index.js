...
export default class TabIndex extends Component {
  ...
  conveyorArrowStyle(side) {
    const { breakpoint, conveyorMarginLeft } = this.state;
  ...
  render() {
    ...
    return (
      <div className='ux-conveyor-clip'>
        <a { ...this.controlAttributes('prev') } aria-label='previous'>
          <span className='sr-only'>Previous</span>
        </a>

        <div { ...other } ref={ ref => { this.conveyor = ref; } } className='ux-conveyor'>
          <ul className='nav nav-tabs' ref={ ref => { this.tabs = ref; } } style={ marginLeftStyle } role='tablist'>
        ...
        <a { ...this.controlAttributes('next') } aria-label='next'>

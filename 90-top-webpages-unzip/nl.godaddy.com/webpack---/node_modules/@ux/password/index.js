import { withNamespace } from '@ux/namespace-component';
...
export class Password extends FormElement {
  constructor(...args) {
    ...
    // intended.
    //
    component.button = component.props.button || component.select('_show');
     ...
     * @private
     */
    component.action = function action(e) {
      e.preventDefault();

      const hidden = component.select('type') === 'password';

      component.setState({
        button: hidden ? component.select('_hide') : component.select('_show'),
...
export default withNamespace(Password);



// WEBPACK FOOTER //
// ./node_modules/@ux/password/index.js
...
function range(start = 0, end = start, step = 1) {
  return arrayFrom({ length: (end - start) / step }, (v, i) => start + (i * step));
}
...
export default class Pagination extends React.Component {
  ...
  _firstLinkSection() {
    ...
    return (
      <li className={ classes }>
        <a href='#'
          className='page-link'
          onClick={ (evt) => this.onNavigationClick(evt, 'first') }>
  ...
  _lastLinkSection() {
    ...
    return (
      <li className={ classes }>
        <a href='#'
          className='page-link'
          onClick={ (evt) => this.onNavigationClick(evt, 'last') }>
  ...
  _prevLinkSection() {
    ...
    return (
      <li className={ classes }>
        <a href='#'
          className='page-link'
          onClick={ (evt) => this.onNavigationClick(evt, 'prev') }>
  ...
  _nextLinkSection() {
    ...
    return (
      <li className={ classes }>
        <a href='#'
          className='page-link'
          onClick={ (evt) => this.onNavigationClick(evt, 'next') }>
  ...
  componentDidUpdate(prevProps) {
    if (this.props.totalItems !== prevProps.totalItems) {
      ...
      this.setState({ pageSelected: FIRST_PAGE_NUMBER });
    }
  }

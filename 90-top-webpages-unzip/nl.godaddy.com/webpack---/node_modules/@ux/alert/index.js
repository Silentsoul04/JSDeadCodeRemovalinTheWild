...
import { BLOCK, NONE, DIRECTIONS } from './constants';
...
export default class Alert extends Component {
  ...
  render() {
    ...
    return (
      <div className={ classNames } role='alert' aria-label={ this.props.icon }>
        { this.props.dismissible && <Close onClick={ this.close } /> }
        <Header icon={ this.props.icon } heading={ this.props.header }>
          { this.props.message }
        </Header>
        <Details onClick={ this.toggle } display={ this.state.display }>
          { this.props.children }
        </Details>
      </div>
    );

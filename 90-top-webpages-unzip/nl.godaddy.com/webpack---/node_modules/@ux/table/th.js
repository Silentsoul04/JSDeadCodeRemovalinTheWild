...
export default class Th extends Component {
  ...
  sortable() {
    ...
    return <th
      role='button'
      className={ this.classNames(className, 'ux-table-sort') }
      tabIndex='0'
      onKeyDown={ this.handleKeyDown }
      onClick={ this.sort }
      style={ style }>
      { children }
      <span className={ this.classNames('uxicon', `uxicon-drop-${dir}`, iconVisible ? 'visible' : 'invisible') } />
    </th>;
  }

...
class CheckboxItem extends Component {
  render() {
    ...
    return (
      <label className={ props.className } onChange={ props.onChange } ref={ r => { this.componentRef = r; } }>
        <input
          onChange={ function () {} }
          ...
          aria-checked={ props.isSelected } /> { props.children }
      </label>
    );
  }
}
...
class DropdownItem extends NamespaceConsumer {
  ...
  render() {
    const props = this.props;
    const { isSelected, type, disabled, ...other } = props;
    const className = this.classNames(
      other.className,
      this.namespace(
        this.classNames('dropdown-item', { active: props.active, disabled })
      )
    );
    ...
    return React.createElement(itemProps.href ? 'a' : 'span', {
      ...
      disabled,
      className,
      'ref': r => { this.componentRef = r; }, /* eslint-disable-line quote-props */
      'role': 'menuitem',

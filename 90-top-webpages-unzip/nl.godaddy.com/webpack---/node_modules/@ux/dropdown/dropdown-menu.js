...
class DropdownMenu extends NamespaceConsumer {
   ...
   */
  render() {
    const { menuAlignment = alignmentTypes.left,
    ...
    return (
      <div className={ this.namespace('dropdown-menu', alignMenuClass, autoAlign, mobileFullscreen) }
        ref={ r => this.wrapper = r }
        role='menu' >
        <div className={ this.namespace('dropdown-overlay') }
          onClick={ props.toggle }
          onKeyDown={ props.toggle }
          role='button'
          tabIndex={ -1 } />
        <div className={ this.namespace('dropdown-menu-background') }>
          <button type='button' className={ this.namespace('close') } onClick={ props.toggle } aria-label='Close'></button>

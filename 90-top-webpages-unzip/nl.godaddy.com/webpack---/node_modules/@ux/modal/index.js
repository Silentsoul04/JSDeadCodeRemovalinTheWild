...
import { withEventDistContext } from '@ux/component';
  ...
  render() {
    ...
    return (
      <div
        ...
        { ...this.show }
        ref={ r => { this.modalOuter = r; } } >
        <div
          role='dialog'
          aria-label={ id }
          id={ id }
          className={ this.classNames(this.namespace('modal-dialog'), props.className) } >
          <div className={ this.namespace('modal-content') } ref={ r => { this.modalDialog = r; } } style={ props.style }>

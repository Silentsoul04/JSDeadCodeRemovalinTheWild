...
export default class Criteria extends Component {
  ...
  render() {
    ...
    if (enableModern) {
      return <Validate name={ name || '' } validate={ this.validate } onValidChange={ this.onValidChange }>
        <CSSTransition classNames='ux-criteria' in={ standalone || visible && !validates } timeout={ 400 }>
          <div role='status' aria-live={ ariaLiveChange }
            className={ this.classNames('ux-criteria', { standalone: standalone, valid: validates }) }>
            <div className={ this.classNames('ux-criteria-content', {
    ...
    return <Validate name={ name || '' } validate={ this.validate } onValidChange={ this.onValidChange }>
      <div role='status' aria-live={ ariaLiveChange } style={{ display }}
        className={ this.classNames('ux-criteria ux-criteria-relative', { standalone: standalone }) }>
...
// WEBPACK FOOTER //
// ./node_modules/@ux/criteria/criteria.js
...
export default class Rule extends Component {
   ...
   */
  render() {
    const { name, onValidChange, iconDesign } = this.props;
    ...
    return <div className={ this.classNames('ux-criteria-rule', { 'ux-criteria-rule-checked': isValid }) }
      aria-hidden={ ariaCriteriaItem } >
      <Validates name={ name || '' } validates={ isValid } onValidChange={ onValidChange } />
      <div className={ `${iconStateClass}` }/>

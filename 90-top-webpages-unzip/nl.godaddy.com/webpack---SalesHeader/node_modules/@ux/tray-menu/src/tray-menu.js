...
export class TrayMenu extends NamespaceConsumer {
  constructor() {
    ...
    const { open, onToggle, trayAlignment } = this.props;
    this.state = {
      ...this.state,
      open: open || false,
  ...
  render() {
    ...
    return (
      <div className={ wrapperClassNames } ref={ r => { this.wrapperDiv = r; } }>
        <TrayButton type={ props.type }
          aria-expanded={ open }
          ariaLabel={ props.ariaLabel }
          showOpenCaret={ props.showOpenCaret }
          onClick={ evt => {this.toggle(evt);} }
          dataAttrs={ dataAttrs }
          traySpanClass={ props.traySpanClass }>
          { props.name }
        </TrayButton>
        <Tray className={ trayClassNames } ref={ r => { this.trayMenuElement = r; } }>
          { props.showClose && <TrayClose onClick={ evt => {this.toggle(evt);} } /> }
          { props.children }
        </Tray>
      </div>
    );

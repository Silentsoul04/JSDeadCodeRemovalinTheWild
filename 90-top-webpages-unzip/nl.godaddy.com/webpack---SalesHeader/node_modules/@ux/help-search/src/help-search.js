...
class HelpSearch extends NamespaceConsumer {
  ...
  doSearchQuery() {
    ...
    request.get(helpSearchUrl + searchArgs, { mode: '' }, (err, data) => {
      if (err) {
  ...
  renderSearchPanel() {
    ...
    return (
      <div className={ this.namespace('col-lg-9', 'col-md-8') }>
        <div className={ this.namespace('help-search-hdr') }>
          <div className={ this.namespace('margin-compressed', 'h3') }><FormattedMessage id={ 'Sales:HelpSearch:Input:Heading' } /></div>
          <FormattedMessage id={ 'Sales:HelpSearch:Input:Desc' } />
        </div>
        <Form action='#' onSubmit={ this.submitForm }>
          <label htmlFor='help-search' className='sr-only'>
            <FormattedMessage id={ 'Sales:HelpSearch:Input:Accessbility:Label' }/>
          </label>
          <textarea
            id='help-search'
          ...
          />
          <label htmlFor='help-search' className={ this.namespace('help-search-input-limit') }>
            <FormattedMessage id={ 'Sales:HelpSearch:Input:SearchLimit' }/>
          </label>
          <br/>
          <Button
            ...
            <FormattedMessage id={ 'Sales:HelpSearch:Input:Submit' } />
          </Button>
        </Form>
      </div>
    );
  ...
  renderResult(results, idx) {
    if (results.length <= idx) { return null; }
    ...
    const data = [{
      title: result.title,
      href: `#${idx + 1}`,
      graphic: (<img src={ result.imageUrl } alt=''
        style={{ display: 'none' }}/>),
    ...
    return (
      <div className={ this.namespace('help-search-rslt-item', 'card') }>
  ...
  renderResultsColumn(columnIdx) {
    ...
    return (
      <div className={ this.namespace('help-search-rslt-col', 'col-lg-6',
  ...
  renderResultsPanel() {
    return (
      <div className={ this.namespace('col-md-12') }>
        <div className={ this.namespace('help-search-rslt-hdr', 'help-search-hdr') }>
          <button
            aria-label={ this.props.messages['Sales:HelpSearch:Results:Previous'] }
            className={ this.namespace('help-search-back', 'uxicon',
              'uxicon-chevron-left-lt', 'hidden-sm-down', 'btn', 'btn-link') }
            href='#'
            style={{ visibility: this.state.results ? 'visible' : 'hidden' }}
            onClick={ this.startOver }>
          </button>
          <div className={ this.namespace('margin-compressed', 'h3') }>
            <FormattedMessage id={ 'Sales:HelpSearch:Results:Heading' } />
          </div>
          <button
            ...
            href='#'
            onClick={ this.startOver }>
            <FormattedMessage id={ 'Sales:HelpSearch:Results:StartOver' } />
          </button>
        </div>
        ...
        <div className={ this.namespace('row') }>
          <div className={ this.namespace('help-search-more-answers') }
            style={{ visibility: this.state.resultCount ? 'visible' : 'hidden' }}>
            <a className={ this.namespace('no-underline') }
              aria-label={ this.props.messages['Sales:HelpSearch:Results:MoreAnswers'] }
              href={ this.getSearchLink() }>
              <FormattedMessage id={ 'Sales:HelpSearch:Results:MoreAnswers' } />
            </a>
          </div>
        </div>
      </div>
  ...
  render() {
    return (
      <IntlProvider locale={ this.props.market } messages={ this.props.messages }>
        <div className={ this.namespace('help-search-ctl', 'row') }>

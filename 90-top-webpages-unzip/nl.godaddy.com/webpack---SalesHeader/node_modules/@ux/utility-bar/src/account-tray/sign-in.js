  ...
  render() {
    ...
    return (
      <IntlProvider locale={ props.market } messages={ props.messages }>
        <div className={ this.namespace('col-xl-7', 'push-xl-5', 'col-lg-6', 'push-lg-6', 'col-md-6', 'sign-in', 'divider') }>
          <TrayTitle>
            <FormattedMessage id={ golf.registeredUser } />
          </TrayTitle>
          <p>
            <FormattedMessage id={ golf.signInAccountMessage } />
          </p>
          <Link
            ...
            <FormattedMessage id={ golf.login } />
          </Link>
        </div>
      </IntlProvider>
    );

  ...
  render() {
    ...
    if (!this.isMobile) {
      if (props.loggedIn) {
        ...
        name = <FormattedMessage id={ golf.login } />;
      }
    }

    const trayName = (
      <span className={ this.namespace('title-text') }>
        { name }
      </span>
    );
    ...
    return (
      <IntlProvider locale={ props.market } messages={ props.messages }>
        <TrayMenu type='base'
          ...
          <div className={ this.namespace(props.seechange ? 'container-fluid' : 'container') }>
            <div className={ this.namespace('row') }>
              <div className={ this.namespace('col-xl-7', 'push-xl-5', 'col-lg-6', 'push-lg-6', 'mb-5') }>

                <UserDetails { ...props } />

                { !props.loggedIn && (<div className={ this.namespace('row') }>
                  <SignIn { ...props } />

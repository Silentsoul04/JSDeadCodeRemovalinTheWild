...
class ContactTray extends NamespaceConsumer {
  ...
  renderInternal() {
    ...
    return (
      <div className={ this.namespace('basic-phone-container') }>
        <Link urlArgs={ props.urlArgs }
          href={ trayHref }
          className={ this.namespace('btn', 'basic-phone-btn') }
          data-eid={ trayNameEid }>
  ...
  renderTrayName(trayName, includesPhoneNumber) {
    return (
      <div>
        ...
        <span className={ this.namespace('basic-phone-text', 'hidden-sm-down') }>
          { trayName }
        </span>
      </div>
    );
  ...
  renderPhoneIcon() {
    ...
    return (
      <div title={ props.messages[golf.contactUs] } className={ this.namespace('uxicon', 'uxicon-phone') }></div>
    );
  }
  ...
  renderCityContacts(supportDetails) {
    ...
    const altContacts = altContactsData.map((contact, idx) => {
      ...
      return (
        <li key={ idx }>
          ...
          <a className={ this.namespace('contact-link') }
            data-eid={ trayNameEid  }
    ...
    return (
      <ul className={ this.namespace('alt-contact-list', 'list-unstyled') }>
        { altContacts }
      </ul>
    );
  }
  ...
  renderFederatedPartner() {
    ...
    return (
      <div className={ this.namespace('federated-partner') }>
        <div className={ this.namespace('partner-description') }>{ phoneDescription }</div>
        <a
          href={ hrefPhoneNumber }
  ...
  renderCityContactsTray(supportDetails, trayName, includesPhoneNumber) {
    ...
    return (
      <TrayMenu
        ariaLabel={ messages[golf.contactUs] }
  ...
  renderFullTray(supportDetails, trayName, includesPhoneNumber) {
    ...
    return (
      <TrayMenu
        ariaLabel={ props.messages[golf.contactUs] }
        ...
        <div className={ this.namespace('container') }>
          <div className={ this.namespace('row') }>
            <div className={ this.namespace('col-lg-4', 'col-md-6', 'content-wrap') }>
              <TrayTitle>
              ...
              <div className={ this.namespace('contact-link-info') }>
                <FormattedMessage id='Shared:UtilityBar:SupportPhone:GlobalDirectory:GlobalDirectory' />
              </div>
              <Link urlArgs={ props.urlArgs } { ...props.urls.contactUs }
                data-eid={ eids.globalDirectory }
                className={ this.namespace('contact-link') }>
                <FormattedMessage id={ golf.globalDirectory } />
              </Link>
            </div>

            <div className={ this.namespace('col-lg-4', 'col-md-6', 'content-wrap', 'divider') }>
              { this.renderChatSection(supportDetails) }
            </div>

            <div className={ this.namespace('col-md-4', 'help-mobile', 'hidden-md-up') }>
              <TrayTitle>
              ...
              <div>
                <Link className={ this.namespace('btn', 'btn-default') }
                  urlArgs={ props.urlArgs }
                  { ...props.urls.help } data-eid={ eids.help } >
                  <FormattedMessage id={ golf.help } />
                </Link>
              </div>
            </div>
          </div>
  ...
  renderHelpSearchContactTray(supportDetails, trayName, includesPhoneNumber, phoneNumber) {
    ...
    return (
      <TrayMenu
        ...
        <div className={ this.namespace('container') }>
          <div className={ this.namespace('row') }>
            <div className={ this.namespace('col-lg-8', 'col-md-7', 'content-wrap', 'help-search-wrap') }>
              <HelpSearch
              ...
              { !showPhoneNumbers &&
                <button
                  ...
                  type='button'
                  onClick={ (e) => { this.showSupportContacts(); e.preventDefault(); e.stopPropagation(); } }
                  className={ this.namespace('btn', 'btn-link', 'show-button') }>
                  <FormattedMessage id={ golf.showSupportNumbersText }  />
                </button>
              }
            </div>
            <div className={ this.namespace('col-lg-4', 'col-md-5', 'content-wrap') }>
              { showPhoneNumbers &&
                <div className={ this.namespace('help-search-contact-info') }>
                  <div className={ this.namespace('help-search-contact-header', 'help-search-hdr') }>
                  ...
                  <div>
                    <Link urlArgs={ props.urlArgs } { ...props.urls.contactUs }
                      ...
                      <FormattedMessage id={ golf.globalDirectoryList } />
                    </Link>
                  </div>
                </div>
              }
              <div className={ this.namespace('help-search-chat') } style={{ display: showPhoneNumbers ? 'block' : 'none' }}>
                { this.renderChatSection(supportDetails) }
              </div>
            </div>
          </div>

...
import { Cookies, Delegate } from '@ux/header-util';
...
import verify, { refreshCookie, VerificationModal } from './verify';
...
class ActualExitLink extends NamespaceConsumer {
  ...
  delegate() {
    ...
    return (
      <form method='post' action={ props.action }>
        ...
        <button type='submit' className={ this.namespace('delegate-link') }>
          <Icon name='x' />
  ...
  impersonate() {
    return (
      <a href={ this.props.action } className={ this.namespace('delegate-link') }>
        <Icon name='x' />
        { ' ' /* deliberate space between icon and message */ }
    ...
    return (
      <div className={ wrapper }>
        <div className={ animated }>
          <div className={ this.namespace('pull-left') }>
            <FormattedMessage { ...props.label } />
          </div>
          <div className={ this.namespace('pull-right') }>
            <ExitLink type={ type } action={ props.action } secret={ props.secret } />
          </div>
        </div>
      </div>
    );
...
export class ActualAccountDelegation extends NamespaceConsumer {
  ...
  static get type() {
    ...
    switch (auth) {
      case 'e2s2s': return [delegate, impersonate];
      case 'e2s': return impersonate;
      case 's2s': return delegate;
      case 'e2s2snpr': return [delegate, impersonate];
      case 'e2snpr': return impersonate;
      case 's2snpr': return delegate;
      default: return 'none';
    }
  }
      ...
      <IntlProvider locale={ props.market } messages={ props.messages }>
        <div className={ wrapper }>
          ...
          { this.state.showVerificationModal &&
            <VerificationModal
              displayName={ props.customer.displayName() }
              ...
              onDismiss={ () => { this.setState({ showVerificationModal: false }); } }

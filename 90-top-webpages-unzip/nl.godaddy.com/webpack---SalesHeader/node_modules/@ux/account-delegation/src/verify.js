...
class VerificationModal extends NamespaceConsumer {
  render() {
    ...
    const footer = !props.refreshFailed && (
      <Button design='primary' disabled={ props.pending } onClick={ !props.pending && props.onOk } >
        { props.pending ?
    ...
    return (
      <Modal footer={ footer }
        ...
        <div className={ this.namespace('verification-modal') }>
          <FormattedMessage id='Shared:AccountDelegation:validateAuthShopper' values={ props } />

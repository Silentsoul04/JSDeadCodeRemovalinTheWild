...
export default class Currency {
   ...
   */
  formatDecimal(decimalValue, locale, currency, formatFlags = { excludeSymbol: false, excludeDecimal: false }) {
   ...
   * @returns {string} formatted currency
   */
  formatInteger(integerValue, locale, currency, formatFlags = { excludeSymbol: false, excludeDecimal: false }) {
   ...
   * @returns {string} formatted currency
   */
  formatMicrounits(microunitsValue, locale, currency, formatFlags = { excludeSymbol: false, excludeDecimal: false }) {

...
window.ire('identify',{customerId:currentUserIdHashShort,customerEmail:currentUserEmailHash});window.ire('generateClickId',function(clickId){localStorage.setItem('irclickid',clickId);var THIRTY_DAYS_MAX=30*24*60*60;docCookies.setItem('irclickid',clickId,THIRTY_DAYS_MAX,'/','.rootDomain');});},};window.a8cAnalytics.initCookieBanner();$(document).trigger('a8c-analytics:loaded');});
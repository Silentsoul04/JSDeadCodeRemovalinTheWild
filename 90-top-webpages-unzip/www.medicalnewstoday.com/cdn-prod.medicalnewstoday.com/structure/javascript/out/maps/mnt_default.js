...
function checkAdsRequirement(){
    ...
    if(!is_userMobile||(is_userMobile&&glob_responsiveOverride)){
        ...
        if(requestSidebarAds>0){
            ...
            if(!isGetMrecAdsAjaxAlreadyTrigger){getMrecAdsAjax(currentMrecCounts,totalMrecNeeded,requestSidebarAds);}
...
function getSizeMapping(adSlotName){
    ...
    if(adSlotName == "DLB1"){
        var mapping = AdBridg.sizeMapping().
            addSize([1000, 10], [[728, 90], [970, 90]]). // 1000+, show mixed ads
        ...
        var mapping = AdBridg.sizeMapping().
            addSize([989, 10], [[300, 250],[300, 600]]). // 1000+ show one ad type
        ...
        var mapping = AdBridg.sizeMapping().
            ...
            addSize([360, 100], [[320,250], [300,250]]). // 1000+, show mixed ads
    ...
    if(glob_mntcookie==1 || !glob_TrueOnGDPR){
        ...
        if (window.location.pathname!=="/privacy-policy" &&
            ...
            $.ajax({
                ...
                data: {type:"show",deviceInfo:glob_deviceInfo,currentPath:window.location.pathname},
                cache: false,
...
function scrollAccept(){
    ...
    $element.animate({scrollTop: $element.height()}, 1250);
}
...
function GDPRReject(){
    ...
    if(glob_mntcookie!=1){
        ...
        $.ajax({
            type: "GET",
            url: "/account/GDPRModalCounter.php",
            data: {type:"cancel",deviceInfo:glob_deviceInfo,currentPath:window.location.pathname},
            cache: false
...
$("#navigation #search_toggle").click(function(event) {
        ...
        if(is_userTablet){
            navigation.find("#search_area").css({'transition':'initial'});
            navigation.find("#searchwrapper").css({'transition':'initial'});
        }
        ...
        if(is_userMobile&&!glob_responsiveOverride){
            if (navigation.find("#search_area").hasClass("show")) {
                ...
                fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Search', eventAction: 'Search click - Main nav', eventLabel: 'Search open - Main nav'});});

            }else{
                navigation.find("#search_area").css({'height':""});
                if($("html").hasClass("noscroll")){
...
$(document).click(function() {
    ...
    if ($("#navigation #search_area").hasClass("show")){
        ...
        $("#navigation #search_toggle").css({'background-position': '0 -550px'});
    ...
    if ($("#navigation_scroll #search_area").hasClass("show")) {
        ...
        $("#navigation_scroll #search_toggle").css({'background-position': '0 -550px'});
...
$(document).ready(function() {
	...
	$('.article_toc a[href*="#"]:not([href="#"])').click(function(event) {
		...
		if(index>0){
			fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: 'tabs - '+glob_pageType, eventAction: 'TAB - '+index, eventLabel: articleID});});
		}
...
$(".topic_popular_list li > a").click(function(){
	...
	if(categorySelected){
		...
		fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+targetMenu+' - Topics', eventAction: 'Menu click - Single topic', eventLabel: 'Menu click - '+categorySelected });});
	}
});
...
$(".topic_all_list li > a").click(function(){
	...
	if(categorySelected){
		...
		fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+targetMenu+' - Topics', eventAction: 'Menu click - '+categorySelected, eventLabel: 'Menu click - '+categorySelected });});
	}
});
    ...
    $(window).unload(function(){
        ...
        if(($("#navigation #search").hasClass("active")||$(".navigation_scroll_search #search").hasClass("active")||$("#search_toggle").hasClass("active"))&&!searchCompleted){
            if($("#navigation #search").hasClass("active")){
                fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Search', eventAction: 'Search - Interrupted', eventLabel: 'Search - Interrupted'});});
            }else{
                fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Sticky menu - Search', eventAction: 'Search - Interrupted', eventLabel: 'Search - Interrupted'});});
            }
    ...
    if($(this).parent().hasClass("main_nav")){
        ...
        if($(this).hasClass("navigation_scroll_search")){
           ...
           if (typeof articleID !== 'undefined'&&articleID) {
                ...
                fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Search', eventAction: 'Search click - Article sticky nav', eventLabel: 'Search open - Article sticky nav'});});
            }else{
                //Click in general pages 
                fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Search', eventAction: 'Search click - Non-article sticky nav', eventLabel: 'Search open - Non-article sticky nav'});});
            }
...
$("#navigation #header_search_button,#navigation_scroll #header_search_button").click(function(event){
    ...
    if($(this).prev("input").val()!==""){
        ...
        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+eventCategory, eventAction: 'Search - Completed via button', eventLabel: 'Search - Completed via button'});});
...
function displayResult(item, val, text) {
    ...
    if(item.hasClass("message")){
        ...
        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+eventCategory, eventAction: 'Search - Completed via typeahead', eventLabel: 'Search - Completed via typeahead'});});
        searchCompleted = true;
	...
	function showMobileNewsletterWindow(){
        ...
        var newsModalTid=setInterval(function(){
            ...
            if(glob_mntcookie==1){
                ...
                fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "UI Elements", eventAction: "Article Modal - "+glob_deviceInfo, eventLabel: "Visible" });});
...
function sendMNThistoryGa(e) {
    ...
    // ADB enabled
    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: 'Ad Block', eventAction: 'Ad Block Enabled', eventLabel: 'Enabled',nonInteraction: true});});
    adBlockValue = "Enabled";
    //ga('set', 'dimension15', "adb-on");
     }else{
    // ADB disabled
    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: 'Ad Block', eventAction: 'Ad Block Disabled', eventLabel: 'Disabled',nonInteraction: true});});
...
$( document ).ready(function() {
    ...
    $(window).unload(function(){
        if($(".newsletter_selection_container_outer").hasClass("active_open")){
            fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Modal - Follow', eventAction: 'Modal - Follow incomplete', eventLabel: 'Modal - Follow incomplete'});});
        }
    });
    ...
    $(".menu_forums > a").click(function(event){
        //Menu item - forums
        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Forums', eventAction: 'Menu click - Forums', eventLabel: 'Menu click - Forums' });});
    });
    ...
    $(".topic_bar li ul li > a").click(function(event){
        ...
        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Topics', eventAction: 'Menu click - '+targetField, eventLabel: 'Menu click - '+targetElement });});
    });
    ...
    $(".menu_login .sign_up a").click(function(event){
        ...
        //Send ga event 
        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Create account', eventAction: 'Register - Main nav', eventLabel: 'Register - Main nav' });});
    });
    ...
    $(".nav_scroll_create_account").click(function(event){
        ...
        if(!signupClickFromDropDown){
            fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Main menu - Create account', eventAction: 'Register - Sticky nav', eventLabel: 'Register - Sticky nav' });});
        }
    ...
    $("#footer_social .fa-facebook,#footer_social .fa-linkedin,#footer_social .fa-google-plus,#footer_social .fa-pinterest,#footer_social .fa-twitter").click(function(event){
        ...
        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Footer', eventAction: footerSocialLabel, eventLabel: footerSocialLabel });});
    });
        ...
        if(element.parents("#navigation").length||element.parents("#navigation_scroll").length){
            ...
            if(element.parent().hasClass("active")){
                ...
                if(is_userMobile&&!glob_responsiveOverride){
                    ...
                    element.next(".topics").css({"overflow-y":"scroll"});
                }
    	...
    	if(data){
    		switch (data["eventLabel"]) {
			  case "25%":
			    ...
			    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "Scroll events", eventAction: "26-50%", eventLabel: window.location.href});});
			    passInitCheck = true;
			    passedDepth = "26-50";
			    break;
			  case "50%":
			  	//Reach 50%, we fires 50-75%
			    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "Scroll events", eventAction: "51-75%", eventLabel: window.location.href});});
			    passInitCheck = true;
			  ...
			  case "75%":
			    ...
			    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "Scroll events", eventAction: "76-99%", eventLabel: window.location.href});});
			    passInitCheck = true;
			    passedDepth = "76-99";
			    break;
			  case "100%":
			  	//Reach 100%
			    passInitCheck = true;
			    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "Scroll events", eventAction: "100%", eventLabel: window.location.href});});
			    passedDepth = "100";
			    break;
			}
    	}
...
if(!passInitCheck){
	...
	fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "Scroll events", eventAction: "0", eventLabel: window.location.href,nonInteraction: true});});
}
firstCheckSent = false;
$(window).scroll(function(){
	if(!passInitCheck&&!firstCheckSent){
		fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: "Scroll events", eventAction: "1-25%", eventLabel: window.location.href});});
		firstCheckSent = true;
		passedDepth = "1-25";
	}
});
...
function getNewsLetterRegisterObj(registrationEntryPoint){
    ...
    if(newsLetterRegisterObj.gaLabel){
        ga('send', 'event', { eventCategory: "New HCP - Ingress", eventAction: "Ingress - "+newsLetterRegisterObj.gaLabel+" - "+glob_deviceInfo+" - "+gaSkinLabel, eventLabel: "Ingress - "+newsLetterRegisterObj.gaLabel+" - "+glob_deviceInfo+" - "+gaSkinLabel+" - "+document.location.pathname });
    }
        ...
        if(targetwebsite==='facebook'){
            ...
            hoverBtnDom.addEventListener("click",function(event){
                ...
                if(parentDivDom.getAttribute("data-sharing-is-enable")!="no"){
                    ...
                    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Article image hover - share', eventAction: 'Article share - Facebook', eventLabel: 'Article share - Facebook['+buttonTargetArticleID+"]" });});
            ...
            hoverBtnDom.addEventListener("click",function(event){
                ...
                if(parentDivDom.getAttribute("data-sharing-is-enable")!="no"){
                    ...
                    fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Article image hover - share', eventAction: 'Article share - Twitter', eventLabel: 'Article share - Twitter['+buttonTargetArticleID+"]" });});
            ...
            if(IsPinterestPluginExist()){
                ...
                hoverBtnDom.addEventListener("click",function(event){
                    ...
                    if(parentDivDom.getAttribute("data-sharing-is-enable")!="no"){
                        ...
                        fireOrSaveJsFunctions(0,function() {ga('send', 'event', { eventCategory: glob_menu_prefix+" - "+glob_deviceInfo+" - "+'Article image hover - share', eventAction: 'Article share - Pinterest', eventLabel: 'Article share - Pinterest['+buttonTargetArticleID+"]" });});

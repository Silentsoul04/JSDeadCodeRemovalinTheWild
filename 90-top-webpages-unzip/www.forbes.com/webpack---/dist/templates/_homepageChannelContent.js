...
var pug_match_html=/["&<>]/;
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}export function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (row, rowLetterId, rowTitle, showDescription, svgIcons) {pug_mixins["iconPreview"] = pug_interp = function(item){
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cspan class=\"paid-content__brand-name\"\u003E" + (pug_escape(null == (pug_interp = item.paidContentData.brandName) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003Cspan" + (" class=\"paid-content__type\""+pug_attr("style", pug_style({'color': item.paidContentData.primaryColor}), true, false)) + "\u003E" + (pug_escape(null == (pug_interp = ` ${item.paidContentData.label}`) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E";
};

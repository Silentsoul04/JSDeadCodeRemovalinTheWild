...
},{"messages":11,"utils":26}],7:[function(require,module,exports){
'use strict';
...
},{"./event-emitter":8}],10:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./postmessage-transport":15}],15:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../assets/common/js/q":1,"../event-emitter":9,"../utils":26,"./whitelist":17,"logger":10,"metrics":46}],16:[function(require,module,exports){
...
},{"./data":16,"utils":26}],18:[function(require,module,exports){
var Q = require('q');
var utils = require('utils');
...
},{"config":29,"q":1,"utils":26}],19:[function(require,module,exports){
...
},{"../../../utils/lowercase-object-keys":58,"../text-encoding":19,"./browser-detection":21,"./crc32":22,"./curry":23,"./doc-ready":24,"./espn-whitelist":25,"./promise":27,"./url":28,"base64-js":2,"ua-parser-js":5}],27:[function(require,module,exports){
'use strict';
...
},{"../multi-reg":39,"./render":32,"logger":10,"utils":26}],30:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":26,"./utils":37}],31:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":26}],32:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./addresses":30,"./display-name":31,"./marketing":33,"./newsletters":34,"./phones":35,"./profile":36}],33:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../marketing/marketing-utils":38,"utils":26}],34:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../marketing/marketing-utils":38,"utils":26}],35:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":26,"./utils":37}],36:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":26,"./utils":37}],37:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../common/utils":26}],39:[function(require,module,exports){

module.exports = require('./multi-reg');


},{"./multi-reg":40}],40:[function(require,module,exports){
...
},{"messages":11,"q":1}],42:[function(require,module,exports){
'use strict';
...
},{"./config":44,"./metricsUtil":48,"logger":10,"messages":11,"utils":26}],43:[function(require,module,exports){
'use strict';
...
},{"logger":10,"messages":11,"utils":26}],44:[function(require,module,exports){
'use strict';
...
},{"./attatchSubscribers":42,"./basicLogTypes":43,"./config":44,"./constants":45,"./init":47,"./timed":49}],47:[function(require,module,exports){
'use strict';
...
},{"./config":44,"utils":26}],48:[function(require,module,exports){
'use strict';
...
},{"./config":44,"./constants":45,"logger":10,"q":1,"session.swid":"session.swid","session.token":"session.token","session.unid":"session.unid","utils":26}],49:[function(require,module,exports){
'use strict';
...
},{"./basicLogTypes":43,"utils":26}],50:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./map":54,"./schema":55,"utils":26}],53:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../common/utils":26,"./compression":51,"./encoding":52,"./map":54,"./schema":55}],54:[function(require,module,exports){
(function () {
    'use strict';
...
(function () {
    ...
    Adapter.prototype.writeSessionData = function (data, dfd) {
        ...
        if (typeof data.token === 'object') {
            ...
            newValue = encoding.encodeToken({ token: data.token });
...
},{"../../../../assets/common/js/q":1,"../../common/environment-helper":7,"../../common/event-emitter":9,"../../common/trust-state/constants.js":20,"../../common/utils":26,"../ageband-gating":50,"../guest-encoding":53,"cookie":6,"logger":10,"messages":11,"metrics":46}],57:[function(require,module,exports){
'use strict';
...
},{"../components/common/polyfills/console":12,"../components/common/postmessage-transport":14,"../components/common/postmessage-transport/frames":13,"../components/common/utils":26,"../components/outer/session-old/secure-client-session-adapter":56,"cookie":6,"messages":11}],58:[function(require,module,exports){
/**
...
},{"./patch":41}],"session.s2":[function(require,module,exports){
...
},{"./patch":41}],"session.swid":[function(require,module,exports){
...
},{"./patch":41}],"session.token":[function(require,module,exports){
...
},{"../../common/session/readAll":18,"./patch":41}],"session.unid":[function(require,module,exports){
var patch = require('./patch');
...
},{"./patch":41}],"session":[function(require,module,exports){
'use strict';
...
},{"./api-key":"session.apiKey","./patch":41,"./s2":"session.s2","./swid":"session.swid","./token":"session.token","./unid":"session.unid","cookie":6,"logger":10,"messages":11,"q":1}]},{},[57,"session","session.apiKey","session.s2","session.token","session.swid","session.unid"]);

...
function launchReauth(opts) {
    ...
    apiHelper.runWorkflow('reauth', null, params, true).then(function (data) {
        if (data.reauthSuccess) {
            deferred.resolve({ data: utils.clone(data.guest) });
        } else {
            deferred.reject({
                success: true,
...
function launchEmailVerification(opts) {
    ...
    function onDone() {
        if (result.status === 'success') {
            ...
            deferred.reject({ error_codes: result.failureCode || 'UNKNOWN_ERROR' });
        } else {
            deferred.reject({ error_codes: 'CANCEL_BY_USER' });
        }
    }
}
...
function launchLicensePlate(opts) {
    ...
    if (!pairingCode) {
        dfd.reject({ error_codes: 'MISSING_PAIRING_CODE' });
    } else {
    ...
    function onClose() {
        if (result.status === 'success') {
            ...
            dfd.reject({ error_codes: result.failureCode || 'UNKNOWN_ERROR' });
        } else {
            dfd.reject({ error_codes: 'CANCEL_BY_USER' });
        }
    }
}
...
function getLicensePlateDataBag(opts) {
    ...
    licensePlate.peek(opts)
        .then(function (response) {
            ...
            dfd.reject({ error_codes: response});
        });
    }
...
},{"../components/outer/config":78,"../components/outer/license-plate":80,"../outer/api-helper":106,"./errors":8,"cookie":11,"messages":21,"q":1,"session":"session","utils":42}],8:[function(require,module,exports){
...
function validateExperience(experience) {
    ...
    if (!(/^[A-Z0-9\.\-\_]+\.EXP$/g).test(experience)) {return false;}
...
},{"utils":42}],10:[function(require,module,exports){
(function () {
    'use strict';
...
function write(key, value, domain, path, expires, secure) {
    ...
    if (!domain || domain.indexOf('.') === -1) {
        messages.publish('log.send', {
            ...
            success: 'false',
            process_time: 0,
            info: { topHost: topHost, domain: ('' + domain) },
            timestamp: new Date(),
...
},{"messages":21,"utils":42}],12:[function(require,module,exports){
(function () {
    'use strict';
...
},{"messages":21,"utils":42}],13:[function(require,module,exports){
'use strict';
...
},{"./event-emitter":14}],16:[function(require,module,exports){
(function () {
    'use strict';
    ...
    function getKeyErrors(response) {
        var errors = utils.get(response, 'error.errors'),
            ...
            hasNoErrors = (
                !errors || !keyCategory || !utils.get(errors, 'length')
            );
...
},{"utils":42}],17:[function(require,module,exports){
'use strict';
            ...
            read().then(function (data) {
                ...
                dao.getBySwid(swid, accessToken, conversationId, correlationId, reporting)
                    .then(function (response) {
                        ...
                        log.success();
                        session.guest.write({ guest: guest })
                            .then(function () {
                                storePromise.isGetActive = false;
...
},{"./store-promise":18,"dao":59,"exceptions":16,"metrics":71,"q":1,"session":"session","utils":42}],18:[function(require,module,exports){
module.exports = {
    isGetActive: false,
    guestPromise: null
};
...
(function () {
    ...
    function getAge(DOB) {
        ...
        var dateParts = DOB.split('-').map(function (d) { return parseInt(d, 10); });
...
},{"cookie":11,"logger":20,"utils":42}],23:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./postmessage-transport":26}],26:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../assets/common/js/q":1,"../event-emitter":15,"../utils":42,"./whitelist":28,"logger":20,"metrics":71}],27:[function(require,module,exports){
...
},{"./data":27,"utils":42}],29:[function(require,module,exports){
module.exports={
  "fields": [
    "email",
    "firstName",
...
},{"./fields.json":29,"./ppc-utils.js":31,"utils":42}],31:[function(require,module,exports){
(function () {
    'use strict';
...
},{"config":49,"q":1,"utils":42}],34:[function(require,module,exports){
...
},{"../../../utils/lowercase-object-keys":111,"../text-encoding":34,"./browser-detection":37,"./crc32":38,"./curry":39,"./doc-ready":40,"./espn-whitelist":41,"./promise":43,"./url":44,"base64-js":3,"ua-parser-js":6}],43:[function(require,module,exports){
'use strict';
...
},{"utils":42}],47:[function(require,module,exports){
(function () {
    'use strict';
    ...
    Workflow.prototype.run = function (name, data) {
        ...
        promise.then(function () {
            emitStepComplete();
            handlers.success.apply({ workflow: self, step: step }, arguments);
        });

        promise.catch(function () {
            emitStepComplete();
            handlers.failure.apply({ workflow: self, step: step }, arguments);
        });

        promise.progress(function () {
            emitStepComplete();
            handlers.cancel.apply({ workflow: self, step: step }, arguments);
        });
...
},{"./emitter":45,"./step":48,"logger":20,"utils":42}],48:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./emitter":45,"q":1,"utils":42}],49:[function(require,module,exports){
'use strict';
...
},{"../multi-reg":64,"./render":52,"logger":20,"utils":42}],50:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":42,"./utils":57}],51:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":42}],52:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./addresses":50,"./display-name":51,"./marketing":53,"./newsletters":54,"./phones":55,"./profile":56}],53:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../marketing/marketing-utils":63,"utils":42}],54:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../marketing/marketing-utils":63,"utils":42}],55:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":42,"./utils":57}],56:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../common/utils":42,"./utils":57}],57:[function(require,module,exports){
(function () {
    'use strict';
...
function notifyResolveMASE(params) {
    var request = { 'lookupValue': params.lookupValue };
...
function authenticateViaSocialNetwork(payload, isOneClickCreate, correlationId, conversationId, reporting) {
    return makeRequest('POST', '/guest/login/social', payload, {
            ...
            'conversation-id': conversationId,
            'oneid-reporting': buildReportingHeader(reporting)
        }, isOneClickCreate ? { 'oneClick': true } : {}
    );
}
...
function apiKeyWrapper(daoMethod, params) {
    return function () {
        ...
        return sessionApiKey.read().then(function (key) {
            ...
            return daoMethod(utils.assign(args, { authorization: 'APIKEY ' + key }));
        }, function (response) {
            ...
            if (exceptions.find(exceptions.getKeyErrors(response), ['API_KEY_INVALID', 'RATE_LIMITED'])) {
                ...
                return sessionApiKey.write(null).then(function () {
                    ...
                    return daoMethod(utils.assign(args, { authorization: 'APIKEY ' + key })).then(function (response) {
                        if (exceptions.find(exceptions.getKeyErrors(response), ['API_KEY_INVALID', 'RATE_LIMITED'])) {
                            throw response;
                        }
...
},{"./request":60,"./response":61,"config":49,"debug":12,"exceptions":16,"logger":20,"messages":21,"q":1,"session.apiKey":"session.apiKey","session.s2":"session.s2","utils":42}],59:[function(require,module,exports){
(function () {
    'use strict';
...
},{"./dao":58}],60:[function(require,module,exports){
var logger = require('logger');
var Q = require('q');
...
},{"logger":20,"q":1}],61:[function(require,module,exports){
(function () {
    'use strict';
...
(function () {
    ...
    function transformProxyMapToList(proxy) {
        return Object.keys(proxy).map(function (proxyName) {
            return { name: proxyName, data: proxy[proxyName] };
        });
    }
...
},{"./multi-reg":65}],65:[function(require,module,exports){
...
},{"utils":42}],66:[function(require,module,exports){
'use strict';
var Q = require('q');
var config = require('config');
var messages = require('messages');
...
},{"config":49,"logger":20,"messages":21,"q":1,"utils":42}],67:[function(require,module,exports){
'use strict';
...
},{"./config":69,"./metricsUtil":73,"logger":20,"messages":21,"utils":42}],68:[function(require,module,exports){
'use strict';
...
},{"logger":20,"messages":21,"utils":42}],69:[function(require,module,exports){
'use strict';
...
},{"./attatchSubscribers":67,"./basicLogTypes":68,"./config":69,"./constants":70,"./init":72,"./timed":75}],72:[function(require,module,exports){
'use strict';
...
},{"./config":69,"utils":42}],73:[function(require,module,exports){
'use strict';
...
},{"./config":69,"./constants":70,"logger":20,"q":1,"session.swid":"session.swid","session.token":"session.token","session.unid":"session.unid","utils":42}],74:[function(require,module,exports){
'use strict';
...
},{"../config":69}],75:[function(require,module,exports){
'use strict';
...
},{"./basicLogTypes":68,"utils":42}],76:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../environment":79,"cookie":11,"logger":20,"utils":42}],77:[function(require,module,exports){
...
},{"messages":21}],78:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../assets/common/js/q":1,"messages":21,"utils":42}],79:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../common/build-identifier":10,"../common/environment-helper":13,"../common/utils":42,"./ageband-country-cookie":76,"debug":12,"logger":20,"messages":21}],80:[function(require,module,exports){
'use strict';
...
},{"../analytics":77,"dao":59,"exceptions":16,"metrics":71,"q":1,"utils":42}],81:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../common/postmessage-transport":25,"../../common/postmessage-transport/frames":24,"messages":21,"session":"session"}],82:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../components/common/get-complete-guest-object":17,"../../../components/common/progressive-profile-collection":30,"../../../components/outer/config":78,"q":1,"session":"session","utils":42}],83:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../workflow-manager":105,"WorkflowHistory":46,"logger":20,"messages":21,"session":"session","utils":42}],84:[function(require,module,exports){
...
},{"./shim":94}],85:[function(require,module,exports){
...
},{"../ageband-country-cookie":76,"./blue-cookie":84,"./guest":88,"./navy":92,"./s2":"session.s2","./shim":94,"./token":"session.token","./trust-state":95,"messages":21,"q":1}],86:[function(require,module,exports){
...
},{"./shim":94}],87:[function(require,module,exports){
...
},{"./shim":94}],88:[function(require,module,exports){
...
function encryptGuest(data, accessToken) {
    ...
    var checksum = utils.crc32(JSON.stringify({ guest: data.guest })).toString(16);
...
},{"../../../../assets/common/js/sjcl":2,"../ageband-country-cookie":76,"../environment":79,"./idn":89,"./token":"session.token","q":1,"utils":42}],89:[function(require,module,exports){
...
},{"./shim":94}],90:[function(require,module,exports){
'use strict';
...
function invalidate(tokens, correlationId, conversationId) {
    ...
    var info = { called_gc_logout_endpoint: false };
...
},{"../../../../src/components/outer/environment":79,"dao":59,"exceptions":16,"metrics":71,"q":1,"session.token":"session.token","utils":42}],91:[function(require,module,exports){
...
},{"./token":"session.token","q":1}],92:[function(require,module,exports){
...
function read() {
    return Q.resolve({ value: cookie.read('oidNAVY') });
}
...
},{"cookie":11,"q":1,"utils":42}],93:[function(require,module,exports){
...
},{"./shim":94}],94:[function(require,module,exports){
...
},{"messages":21,"q":1}],95:[function(require,module,exports){
...
},{"../environment.js":79,"./../../common/trust-state/constants.js":36,"./shim":94,"cookie":11,"q":1,"utils":42}],96:[function(require,module,exports){
...
function TokenRefresh(loggingInfo) {
    ...
    if (breadcrumbs) {
        breadcrumbs.track(workflow, [
            { prop: 'token.access_token', format: utils.maskToken },
            { prop: 'token.refresh_token', format: utils.maskToken },
            { prop: 'tokenData.access_token', format: utils.maskToken },
            { prop: 'tokenData.refresh_token', format: utils.maskToken },
            { prop: 'tokenData.id_token', format: utils.hashString },
            { prop: 'token.expires' },
...
},{"../../../workflows/outer/token-refresh":176,"../sleep-timer":96,"exceptions":16,"metrics":71,"q":1,"utils":42}],98:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../common/time-span":35,"logger":20,"utils":42}],99:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../assets/common/js/q":1,"./../../common/trust-state/constants.js":36,"logger":20,"messages":21,"session":"session"}],100:[function(require,module,exports){
(function () {
    'use strict';
...
},{"messages":21}],101:[function(require,module,exports){
(function () {
    'use strict';
...
},{"messages":21}],102:[function(require,module,exports){
...
(function () {
    ...
    function _appendIframe() {
        ...
        var iframeLoadTimeout = setTimeout(function () {
            messages.publish('lightbox.showError', { reason: 'inner.timeout' }); // show lightbox error page if not cancelled
        }, 1000 * 90);
...
},{"../../../../outer/responder-lite":109,"../../environment":79,"../do-not-disturb":101,"./scroll":103,"logger":20,"messages":21,"metrics":71,"utils":42}],103:[function(require,module,exports){
(function () {
    'use strict';
...
},{"utils":42}],104:[function(require,module,exports){
(function () {
    'use strict';
...
},{"messages":21,"session":"session","utils":42}],105:[function(require,module,exports){
...
},{"../../assets/common/js/q":1,"messages":21,"utils":42}],107:[function(require,module,exports){
/**
 * @file
 * Documentation for the public API exposed by the DisneyID UI v2
 * currently in development.
...
function configure(opts) {
    ...
    if (opts.isTest) {
        initCompleteDfd = { promise: { then: function (cb) { cb(); } } };
    }
}
...
function init() {
    ...
    if (state.initialized) {
        ...
        initWorkflow.on('session-state-known', function (data) {
            var payload = { loggedIn: data.isLoggedIn, guest: data.guest };
...
function getDeviceId(loginValue) {
    return session.deviceId.read({ loginValue: loginValue });
}
...
function getInlineNewsletters(opts, campaignId) {
    ...
    workflow.run('start', { opts: opts, campaignId: campaignId });
...
function setInlineNewsletters(opts, data) {
    ...
    workflow.run('start', { opts: opts, buData: data });
...
function launchGuestFlow(opts, guestCredential) {
    ...
    workflow.run('validate', {guestCredential: guestCredential, opts: opts});
...
function setLogLevel(level, preserve) {
    ...
    messages.publish('setLogLevel', { level: level });
...
function getEditableProfileFields(opts) {
    ...
    progressiveProfileCollection.get().then(function (editableProfileFields) {
        ...
        deferred.resolve({ data: editableProfileFields });
    }, function () {
        deferred.reject({
            success: true,
            error_codes: ERRORS.UNKNOWN_ERROR
...
function setEditableProfileFields(opts, data) {
    ...
    apiHelper.runWorkflow('ppcApi', null, {
        guestData: data,
        loggingInfo: { correlationId: opts.correlationId }
        ...
        if (data.isUnresolvableError) {
            ...
            deferred.resolve({ data: data.output });
        }
    }).catch(function (reason) {
        deferred.reject({ error_codes: reason });
    });
...
function forceTokenRefresh(opts) {
    ...
    tokenRefresh.refresh(loggingInfo).then(function (data) {
        deferred.resolve({ data: utils.get(data, 'data.token') });
    }, function (response) {
...
function getActivityStatus(opts, activity) {
    ...
    apiHelper.runWorkflow('checkActivity', null, { activityCode: activity }, true).then(function (data) {
        if (!!data.error_code) {
            deferred.reject({
                success: true,
            ...
            deferred.resolve({ data: data.approvalStatus });
        }
    });
...
function getTrustStateStatus() {
    ...
    session.trustState.read().then(function (data) {
        deferred.resolve({ data: data.state });
    });
...
},{"../../assets/common/js/q":1,"../common/api":7,"../common/errors":8,"../common/reporting":9,"../components/common/event-emitter":15,"../components/common/trust-state/constants.js":36,"../components/inner/language-preferences/languages":62,"../components/metrics":71,"../components/outer/config":78,"../components/outer/environment":79,"../components/outer/progressive-profile-collection":82,"../components/outer/session-timer":83,"../components/outer/sleep-timer":96,"../components/outer/token-refresh":97,"../components/outer/trust-state":99,"../components/outer/ui/do-not-disturb":101,"../components/outer/ui/web-ui":102,"../components/outer/workflow-manager":105,"./api-helper":106,"WorkflowHistory":46,"cookie":11,"dao":59,"logger":20,"messages":21,"session":"session","utils":42}],108:[function(require,module,exports){
'use strict';
...
},{"../components/common/polyfills/console":23,"../components/metrics/requests/web":74,"../components/outer/patch-bay":81,"../components/outer/trust-state/web.js":100,"./api":107,"./workflows-bootstrap":110,"cookie":11,"logger":20,"metrics":71,"utils":42}],109:[function(require,module,exports){
...
},{"messages":21}],110:[function(require,module,exports){
...
},{"../components/outer/workflow-manager":105,"../workflows/outer/cagoots":121,"../workflows/outer/get-guest":124,"../workflows/outer/guest-flow":130,"../workflows/outer/initialization":133,"../workflows/outer/inline-newsletters/get":141,"../workflows/outer/inline-newsletters/set":143,"../workflows/outer/obo":158,"../workflows/outer/session-state-tasks":162,"../workflows/outer/session-transfer":168}],111:[function(require,module,exports){
/**
...
},{"session":"session","step":48}],113:[function(require,module,exports){
(function () {
    'use strict';
...
},{"exceptions":16,"step":48,"utils":42}],114:[function(require,module,exports){
'use strict';
...
},{"dao":59,"exceptions":16,"logger":20,"metrics":71,"step":48,"utils":42}],115:[function(require,module,exports){
'use strict';
...
},{"dao":59,"exceptions":16,"logger":20,"metrics":71,"step":48,"utils":42}],116:[function(require,module,exports){
(function () {
    'use strict';
...
},{"q":1,"session":"session","step":48,"utils":42}],117:[function(require,module,exports){
'use strict';
...
},{"../../../../components/common/get-complete-guest-object":17,"step":48,"utils":42}],118:[function(require,module,exports){
'use strict';
...
},{"session":"session","step":48}],119:[function(require,module,exports){
(function () {
    'use strict';
...
},{"dao":59,"session":"session","step":48,"utils":42}],120:[function(require,module,exports){
(function () {
    'use strict';
    ...
    module.exports = require('step').extend({
        execute: function () {
            ...
            Q.all([
                session.guest.write({ guest: this.data.guest }),
...
},{"q":1,"session":"session","step":48,"touchid":66,"utils":42}],121:[function(require,module,exports){
...
},{"../../common/shared/steps/parse-errors":113,"../shared/steps/check-do-not-disturb":172,"../shared/steps/gating":173,"../token-refresh/steps/ppu":182,"../token-refresh/steps/read-token":183,"./steps/execute-check-authorization":122,"./steps/update-last-checked":123,"workflow":47}],122:[function(require,module,exports){
...
},{"../../../../components/outer/sleep-timer":96,"dao":59,"exceptions":16,"metrics":71,"step":48,"utils":42}],123:[function(require,module,exports){
...
module.exports = require('step').extend({
    execute: function () {
        ...
        session.token.read().then(function (tokenData) {
            ...
            session.token.write({ token: token }).then(function () {
                step.success();
            }, function () {
                step.success();
            });
...
},{"session":"session","step":48,"utils":42}],124:[function(require,module,exports){
'use strict';
...
},{"../../common/shared/steps/ensure-logged-out":112,"../../common/shared/steps/parse-errors":113,"../shared/steps/read-token":175,"./steps/check-cache":125,"./steps/check-for-toggle":126,"./steps/execute":127,"./steps/read-guest-from-storage":128,"./steps/save-guest":129,"utils":42,"workflow":47}],125:[function(require,module,exports){
...
},{"step":48}],126:[function(require,module,exports){
var config = require('config');
...
},{"config":49,"step":48}],127:[function(require,module,exports){
...
},{"dao":59,"exceptions":16,"metrics":71,"step":48,"utils":42}],128:[function(require,module,exports){
'use strict';
...
},{"session":"session","step":48,"utils":42}],129:[function(require,module,exports){
...
module.exports = require('step').extend({
    execute: function () {
        ...
        session.guest.write({ guest: step.data.guest }).finally(function () {
            step.success();
        });
    }
});

},{"session":"session","step":48}],130:[function(require,module,exports){
'use strict';
...
},{"./steps/check-for-account":131,"./steps/validate":132,"workflow":47}],131:[function(require,module,exports){
'use strict';
...
},{"dao":59,"metrics":71,"step":48,"utils":42}],132:[function(require,module,exports){
'use strict';
...
},{"step":48}],133:[function(require,module,exports){
...
},{"../shared/steps/read-token":175,"./steps/anonymize":134,"./steps/delete-blue-cookies":135,"./steps/events":136,"./steps/get-guest":137,"./steps/obo":138,"./steps/token-refresh":139,"workflow":47}],134:[function(require,module,exports){
...
},{"dao":59,"session":"session","step":48}],135:[function(require,module,exports){
'use strict';
...
},{"cookie":11,"messages":21,"step":48}],136:[function(require,module,exports){
...
},{"step":48}],137:[function(require,module,exports){
    ...
    execute: function () {
        ...
        if (breadcrumbs) {
            breadcrumbs.track(wf, [
                { prop: 'token.access_token', format: utils.maskToken },
                { prop: 'token.id_token', format: utils.hashString },
                { prop: 'token.expires' }
            ]);
        }
...
},{"../../../../components/outer/workflow-manager":105,"step":48,"utils":42}],138:[function(require,module,exports){
...
module.exports = require('step').extend({
    execute: function () {
        ...
        oboWorkflow.on('done', function (data) {
            if (data.guest) {
                step.data.guest = data.guest;
                step.workflow.emit('login', { guest: data.guest });
                step.success();
            } else {
                step.failure();
            }
...
},{"../../../../components/outer/workflow-manager":105,"step":48,"utils":42}],139:[function(require,module,exports){
...
},{"../../../../components/outer/token-refresh":97,"step":48,"utils":42}],140:[function(require,module,exports){
'use strict';
...
},{"../../inner/shared/steps/get-complete-guest-object":117,"../../inner/shared/steps/get-logged-in-status":118,"./steps/get/":145,"./steps/get/get-legal":144,"./steps/get/marketing-list":146,"./steps/get/response":147,"./steps/shared/check-location":152,"./steps/shared/check-profile":153,"./steps/shared/guest-newsletters":154,"./steps/shared/handle-error":155,"./steps/shared/marketing":156,"./steps/shared/site-config":157,"workflow":47}],142:[function(require,module,exports){
(function () {
...
},{"../../../components/outer/config/index":78,"q":1}],143:[function(require,module,exports){
'use strict';
...
},{"../../inner/newsletters/steps/execute":115,"../../inner/newsletters/steps/execute-update":114,"../../inner/shared/steps/get-complete-guest-object":117,"../../inner/shared/steps/get-logged-in-status":118,"../../inner/shared/steps/reload-guest-data":119,"../../inner/shared/steps/save-guest":120,"./steps/set/":149,"./steps/set/execute-prep":148,"./steps/set/marketing-list":150,"./steps/set/response":151,"./steps/shared/check-location":152,"./steps/shared/check-profile":153,"./steps/shared/guest-newsletters":154,"./steps/shared/handle-error":155,"./steps/shared/marketing":156,"./steps/shared/site-config":157,"workflow":47}],144:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../l10n":142,"q":1,"step":48,"utils":42}],145:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../errors":140,"step":48}],146:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../errors":140,"../../l10n":142,"q":1,"step":48}],147:[function(require,module,exports){
(function () {
    'use strict';
...
},{"step":48,"utils":42}],148:[function(require,module,exports){
(function () {
    'use strict';
...
},{"step":48}],149:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../errors":140,"step":48}],150:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../errors":140,"../../l10n":142,"q":1,"step":48}],151:[function(require,module,exports){
(function () {
    'use strict';
...
},{"step":48}],152:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../errors":140,"step":48,"utils":42}],153:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../../components/common/guest-utils/index":19,"../../errors":140,"step":48,"utils":42}],154:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../../components/outer/config/index":78,"../../errors":140,"step":48}],155:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../errors":140,"step":48,"utils":42}],156:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../../components/inner/marketing/marketing-utils.js":63,"../../errors":140,"step":48,"utils":42}],157:[function(require,module,exports){
(function () {
    'use strict';
...
},{"../../../../../components/outer/config/index":78,"../../errors":140,"step":48}],158:[function(require,module,exports){
...
},{"../../common/shared/steps/parse-errors":113,"../../inner/shared/steps/create-session":116,"../shared/steps/gating":173,"../shared/steps/ppu":174,"./steps/execute":159,"./steps/logout-and-reload":160,"./steps/read-obo-token":161,"utils":42,"workflow":47}],159:[function(require,module,exports){
...
},{"dao":59,"exceptions":16,"metrics":71,"q":1,"session":"session","step":48,"utils":42}],160:[function(require,module,exports){
...
},{"q":1,"session":"session","step":48,"utils":42}],161:[function(require,module,exports){
...
},{"session":"session","step":48}],162:[function(require,module,exports){
...
},{"../initialization/steps/token-refresh":139,"../shared/steps/cagoots":171,"./steps/check-state":163,"./steps/increment-refresh-counter":164,"./steps/reset-refresh-counter":165,"./steps/sync-logged-in":166,"./steps/sync-logged-out":167,"workflow":47}],163:[function(require,module,exports){
...
},{"../../../../components/common/retry-counter":32,"../../../../components/outer/config":78,"../../../../components/outer/token":98,"session":"session","step":48,"utils":42}],164:[function(require,module,exports){
...
},{"../../../../components/common/retry-counter":32,"step":48,"utils":42}],165:[function(require,module,exports){
...
},{"../../../../components/common/retry-counter":32,"step":48}],166:[function(require,module,exports){
...
},{"messages":21,"q":1,"session":"session","step":48,"utils":42}],167:[function(require,module,exports){
...
},{"messages":21,"step":48}],168:[function(require,module,exports){
'use strict';
...
},{"../../common/shared/steps/parse-errors":113,"../../inner/shared/steps/create-session":116,"../shared/steps/gating":173,"../shared/steps/ppu":174,"./steps/complete":169,"./steps/execute":170,"workflow":47}],169:[function(require,module,exports){
...
},{"messages":21,"q":1,"step":48}],170:[function(require,module,exports){
...
},{"dao":59,"exceptions":16,"metrics":71,"step":48,"utils":42}],171:[function(require,module,exports){
...
},{"../../../../components/outer/workflow-manager":105,"step":48}],172:[function(require,module,exports){
...
},{"../../../../components/outer/ui/do-not-disturb":101,"step":48}],173:[function(require,module,exports){
...
},{"messages":21,"step":48}],174:[function(require,module,exports){
...
},{"../../../../outer/api-helper":106,"session":"session","step":48,"utils":42}],175:[function(require,module,exports){
...
},{"../../../../components/outer/token":98,"session":"session","step":48}],176:[function(require,module,exports){
...
},{"../../../../components/common/mutex":22,"../../../../components/outer/environment":79,"step":48}],178:[function(require,module,exports){
...
},{"session":"session","step":48,"utils":42}],179:[function(require,module,exports){
...
},{"messages":21,"step":48,"utils":42}],180:[function(require,module,exports){
...
module.exports = require('step').extend({
    execute: function () {
        ...
        session.guest.read({ token: oldToken }).then(function (data) {
...
},{"session":"session","step":48,"utils":42}],181:[function(require,module,exports){
'use strict';
...
},{"../../../../components/outer/environment":79,"messages":21,"session":"session","step":48,"utils":42}],182:[function(require,module,exports){
...
},{"messages":21,"q":1,"step":48}],183:[function(require,module,exports){
...
},{"session":"session","step":48}],184:[function(require,module,exports){
...
},{"../../../../components/outer/sleep-timer":96,"dao":59,"exceptions":16,"metrics":71,"step":48,"utils":42}],185:[function(require,module,exports){
...
},{"step":48}],186:[function(require,module,exports){
...
module.exports = require('step').extend({
    execute: function () {
        ...
        session.token.write({ token: token }).then(function (data) {
            step.success();
        }, function () {
            step.failure();
        });
...
},{"session":"session","step":48,"utils":42}],"session.apiKey":[function(require,module,exports){
...
},{"./shim":94}],"session.s2":[function(require,module,exports){
...
},{"../config":78,"./shim":94,"cookie":11,"logger":20,"q":1,"utils":42}],"session.swid":[function(require,module,exports){
...
},{"./shim":94,"cookie":11,"messages":21,"q":1,"utils":42}],"session.token":[function(require,module,exports){
...
},{"../../common/session/readAll":33,"./shim":94}],"session.unid":[function(require,module,exports){
/**
...
},{"q":1}],"session":[function(require,module,exports){
...
},{"./api-key":"session.apiKey","./blue-cookie":84,"./delete-all":85,"./device-id":86,"./dob":87,"./guest":88,"./idn":89,"./invalidate-tokens":90,"./is-logged-in":91,"./navy":92,"./obo":93,"./s2":"session.s2","./swid":"session.swid","./token":"session.token","./trust-state":95,"./unid":"session.unid"}]},{},[108,104,"session","session.apiKey","session.s2","session.token","session.swid","session.unid"]);

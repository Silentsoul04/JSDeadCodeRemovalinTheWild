...
class ScrollListener {
  constructor({ throttleTimeout, parent, initialTrigger }) {
    this.callbacks = {};
...
export default {
   ...
   * @return {Number} - handler identifier.
   */
  add({ throttleTimeout = 350, parent, callback, initialTrigger = true }) {
    let listener = listeners[throttleTimeout];
    if (!listener) {
      listener = new ScrollListener({ throttleTimeout, parent, initialTrigger });

...
export const facebookTransformShareData = shareData => ({
  ...
  link: withUtmTracking({ shareUrl: shareData.shareMetaUpdatedUrl || shareData.url, platform: 'facebook' }),
...
export const pinterestTransformShareData = shareData => ({
  ...
  url: withUtmTracking({ shareUrl: shareData.shareMetaUpdatedUrl || shareData.url, platform: 'pinterest' }),
...
export const twitterTransformShareData = shareData => ({
  text: shareData.text,
  url: withUtmTracking({ shareUrl: shareData.shareMetaUpdatedUrl || shareData.url, platform: 'twitter' }),
});
...
export const copyTransformShareData = shareData => ({
  url: withUtmTracking({ shareUrl: shareData.shareMetaUpdatedUrl || shareData.url, platform: 'copy' }),
});
...
export const emailTransformShareData = shareData => ({
  ...
  body: withUtmTracking({ shareUrl: shareData.shareMetaUpdatedUrl || shareData.url, platform: 'email' }),
});

...
import { AdFormat } from '../base/format';
...
class AdFormatProgrammatic extends AdFormat {
  ...
  buildFormat() {
    ...
    if (!banner) {
      window.raven && window.raven.captureMessage('buildFormat error: slot does not exist', { tags: { wid: this.config.wid } });
      return;
    }
...
export { AdFormatProgrammatic, AdFormatProgrammaticResponsive };

...
import { AdUnit } from '../../core/base';
import { programmatic, lazyRender } from '../../core/mixins';
...
class AdExBase extends AdUnit.withMixins(programmatic) {
  ...
  setupSizes() {
    ...
    if (isDesktop && adIsFilteredByPlacement) {
      this.filterProgrammaticSizes({min: bzfd.adSizes.PROGRAMMATIC_LEADERBOARD});
    }
   ...
   */
  runFeatureFlags() {
    return abeagle.getExperimentVariant(this.featureFlag, {rejectErrors: false})
      .then((variant) => {

...
import { createDestinationLogoByName } from './header/svg/logos';
import { HamburgerIcon } from './header/svg/icons/hamburger';
import { SearchIcon } from './header/svg/icons/search';
import { SettingsIcon } from './header/svg/icons/settings';
import { createBadgeSVGByName } from './header/svg/badges';
import { BuzzFeedOriginalsLogo } from './header/svg/logos/bfo';
import { CloseIcon } from './header/svg/icons/close';
import { CaretIcon } from './header/svg/icons/caret';
import { DefaultUserIcon } from './header/svg/icons/default-user';
import { createBrandLogoByName, createBrandTaglineByName } from './header/svg/brands';
  ...
  return (
    <div>
      <SVGDefs>
        ...
        {badges.map(({ name }) => createBadgeSVGByName(name))}

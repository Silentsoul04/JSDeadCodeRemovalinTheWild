...
Application.addModule('feed-filter', function(context) {
  ...
  function _fireUpdateOriginParam() {
    context.broadcast('feed-update-origin', {'origin': _getOriginParam(_config.filter)});
  }

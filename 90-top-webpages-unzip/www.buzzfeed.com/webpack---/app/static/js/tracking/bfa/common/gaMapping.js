import { gaMap as videoPlayerMapping } from '@buzzfeed/buzzblocks/js/services/video-player-analytics/bfa-ga';
import { gaMap as gdprMapping } from '@buzzfeed/buzzblocks/components/gdpr-consent/bfa-ga';
import { gaFeedTrackingMapper } from '@buzzfeed/site-tracking/feed';
import { gaMap as gaBFReviewsPackageMapper } from '@buzzfeed/buzzblocks/components/bf-reviews-package/bfa-ga';
import { gaMap as gaBBPackageMapper } from '@buzzfeed/buzzblocks/components/package/bfa-ga';
import { gaMap as feedHeaderMapper } from '@buzzfeed/buzzblocks/components/feed-header/bfa-ga';

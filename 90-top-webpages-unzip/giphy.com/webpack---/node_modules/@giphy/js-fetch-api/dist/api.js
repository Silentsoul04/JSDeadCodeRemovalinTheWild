...
var GiphyFetch = /** @class */ (function () {
    function GiphyFetch(apiKey) {
        ...
        this.getQS = function (options) {
            ...
            return qs_1.default.stringify(__assign({}, options, { api_key: _this.apiKey }, js_util_1.getGiphySDKRequestParams()));
        };
        this.apiKey = apiKey;
    }
    /**
    ...
    GiphyFetch.prototype.search = function (term, options) {
        if (options === void 0) { options = {}; }
        var qsParams = this.getQS(__assign({}, options, { q: term }));
        var pingbackType = options.type === 'text' ? 'TEXT_SEARCH' : 'GIF_SEARCH';
    ...
    GiphyFetch.prototype.random = function (options) {
        return request_1.default(getType(options) + "/random?" + this.getQS(options), gif_1.normalizeGif);
    };
    /**
